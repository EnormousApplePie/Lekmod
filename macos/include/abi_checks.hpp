...
static_assert(sizeof(Database::Connection) == 184, "Engine database connection layout");
static_assert(alignof(Database::Connection) == 8, "Engine database connection alignment");
