...
function OnOK()
	...
	EUI_options.SetValue( "DB_bAnchorLeft", Controls.LRAnchorToggleCheckbox:IsChecked() )
...
function UpdateGameOptionsDisplay()
	...
	Controls.LRAnchorToggleCheckbox:SetCheck( EUI_options.GetValue( "DB_bAnchorLeft" ) ~= 0 )
