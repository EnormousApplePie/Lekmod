...
void CvPlayer::DoSpawnGreatPerson(PlayerTypes eMinor)
{
...
#endif
	{
		...
		if(pkUnitEntry && pkUnitEntry->GetSpecialUnitType() == eSpecialUnitGreatPerson)
		{
			...
			if(strcmp(pkUnitEntry->GetType(), "UNIT_WRITER") == 1 ||\
				strcmp(pkUnitEntry->GetType(), "UNIT_ARTIST") == 1 ||\
				strcmp(pkUnitEntry->GetType(), "UNIT_MERCHANT") == 1 ||\
				strcmp(pkUnitEntry->GetType(), "UNIT_SCIENTIST") == 1 ||\
				strcmp(pkUnitEntry->GetType(), "UNIT_ENGINEER") == 1 ||\
				strcmp(pkUnitEntry->GetType(), "UNIT_MUSICIAN") == 1 ||\
				strcmp(pkUnitEntry->GetType(), "UNIT_GREAT_GENERAL") == 1)
#else
