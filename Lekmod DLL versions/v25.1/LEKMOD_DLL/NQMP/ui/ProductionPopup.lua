...
function ProductionSelected( ePurchaseEnum, iData)
	...
	g_bTheVeniceException = (player:MayNotAnnex() or player:IsAllowPuppetPurchasing()) and (not g_IsProductionMode);
...
function OnPopup( popupInfo )
    ...
    if city and city:IsPuppet() then
		if ((player:MayNotAnnex() or player:IsAllowPuppetPurchasing()) and not g_IsProductionMode) then
