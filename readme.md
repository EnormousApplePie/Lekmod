...
## Features
- New and reworked civilizations with unique abilities and units
- Extensive balance changes for units, buildings, technologies, and policies
- Improved behavior and bugfixes
- Enhanced multiplayer stability and compatibility
- Support for both Standard UI and Enhanced User Interface (EUI) up to v1.28
- Custom mapscript (Lekmap) for varied and balanced map generation
...
1. Game: Sid Meier's Civilization V - Complete Edition (Steam Version)
...
`...\Sid Meier's Civilization V\Assets\DLC\LEKMODvXX_X\LEKMODvXX_X\`
...
#### B. LEKMOD v32 and lower - NO EUI support
##### 1. Download the version you wish to install
##### 2. Extract the contents of the zip file
...
#### 1. Download Lekmap
#### 2. Extract the contents of the zip file
#### 3. Copy the extracted files into your MAPS folder, replacing any existing files
For Windows, usually under: `C:\Program Files (x86)\Steam\steamapps\common\Sid Meier's Civilization V\Assets\Maps`
To find your game folder, right click Civilization V in your Steam library, select Properties, go to the Local Files tab, and click Browse Local Files.
The final path should look like this:
`...\Sid Meier's Civilization V\Assets\Maps\Lekmap vX_X\Lekmap vX_X\`
#### 4. Launch the game. You should see "LEKMAP" in the map selection options.
...
If you encounter any issues during installation or gameplay, you can refer to the LEKMOD Discord server for assistance. Check install-troubleshooting channel.
...
- **EUI Compatibility**: LEKMOD v33 and higher support EUI up to version 1.28. Users with EUI v1.29 or higher may experience compatibility issues.
