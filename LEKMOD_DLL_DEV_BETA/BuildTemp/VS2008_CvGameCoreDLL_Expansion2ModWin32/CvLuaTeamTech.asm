; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\Users\EnormousApplePie\Desktop\Lekmod DLL versions\v31\LEKMOD_DLL\CvGameCoreDLL_Expansion2\Lua\CvLuaTeamTech.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG217620 DB	'SetHasTech', 00H
	ORG $+1
$SG217621 DB	'HasTech', 00H
$SG217622 DB	'GetNumTechsKnown', 00H
	ORG $+3
$SG217623 DB	'HasResearchedAllTechs', 00H
	ORG $+2
$SG217624 DB	'GetLastTechAcquired', 00H
$SG217625 DB	'SetNoTradeTech', 00H
	ORG $+1
$SG217626 DB	'IsNoTradeTech', 00H
	ORG $+2
$SG217627 DB	'IncrementTechCount', 00H
	ORG $+1
$SG217628 DB	'GetTechCount', 00H
	ORG $+3
$SG217629 DB	'SetResearchProgress', 00H
$SG217630 DB	'SetResearchProgressTimes100', 00H
$SG217631 DB	'GetResearchProgress', 00H
$SG217632 DB	'GetResearchProgressTimes100', 00H
$SG217633 DB	'ChangeResearchProgress', 00H
	ORG $+1
$SG217634 DB	'ChangeResearchProgressTimes100', 00H
	ORG $+1
$SG217635 DB	'ChangeResearchProgressPercent', 00H
	ORG $+2
$SG217636 DB	'GetResearchCost', 00H
$SG217637 DB	'GetResearchLeft', 00H
$SG217640 DB	'TeamTech', 00H
	ORG $+3
$SG217956 DB	'Instance does not exist.', 00H
	ORG $+3
$SG218026 DB	'__instance', 00H
	ORG $+5
$SG218032 DB	'Not a valid instance.  Either the instance is NULL or yo'
...
; Function compile flags: /Ogtpy
; File c:\users\enormousapplepie\desktop\lekmod dll versions\v31\lekmod_dll\cvgamecoredll_expansion2\lua\cvluateamtech.cpp
...
; 242  : 	(pkType->*func)(CvLuaArgs::toValue<arg1>(L, idx), CvLuaArgs::toValue<arg2>(L, idx + 1));
	...
	test	eax, eax
	setne	al
	mov	BYTE PTR $T218170[esp+20], al
	mov	ecx, DWORD PTR $T218170[esp+20]
	push	ecx
	push	2
	push	esi
	call	_lua_tointeger
