; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\Users\EnormousApplePie\Desktop\Lekmod Files\Lekmod DLL versions\v29\LEKMOD_DLL\CvGameCoreDLL_Expansion2\CvAStar.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG219409 DB	'.\CvAStar.cpp', 00H
	ORG $+2
$SG219415 DB	'.\CvAStar.cpp', 00H
	ORG $+2
$SG220556 DB	'Game Turn, Player, Unit, From X, From Y, To X, To Y, Inf'
	DB	'o, Checksum', 00H
$SG220557 DB	'AStar_GC.log', 00H
	ORG $+3
$SG220558 DB	'AStar_APP.log', 00H
	ORG $+2
$SG220559 DB	'?', 00H
	ORG $+2
$SG220560 DB	'%03d, %s, UnitID: %d, ', 00H
	ORG $+1
$SG220582 DB	'%d, %d, %d, %d, %d, %8x', 00H
CONST	ENDS
...
; Function compile flags: /Ogtpy
; File c:\users\enormousapplepie\desktop\lekmod files\lekmod dll versions\v29\lekmod_dll\cvgamecoredll_expansion2\cvastar.cpp
...
; Function compile flags: /Ogtpy
; File c:\users\enormousapplepie\desktop\lekmod files\lekmod dll versions\v29\lekmod_dll\cvgamecoredll_expansion2\cvastarnode.h
...
; 3993 : 	CvAStar::CvAStar();
	...
	lea	ecx, DWORD PTR $T222758[esp+652]
	mov	DWORD PTR __$EHRec$[esp+660], ebx
	mov	DWORD PTR $T222758[esp+652], ebx
	mov	DWORD PTR $T222758[esp+656], ebx
	mov	DWORD PTR $T222758[esp+660], ebx
	mov	DWORD PTR $T222758[esp+664], ebx
	mov	DWORD PTR $T222758[esp+668], ebx
	mov	DWORD PTR $T222758[esp+672], ebx
	mov	DWORD PTR $T222758[esp+676], ebx
	mov	DWORD PTR $T222758[esp+680], ebx
	mov	DWORD PTR $T222758[esp+684], ebx
	mov	DWORD PTR $T222758[esp+688], ebx
	mov	DWORD PTR $T222758[esp+692], ebx
	mov	DWORD PTR $T222758[esp+696], ebx
	mov	DWORD PTR $T222758[esp+736], ebx
	mov	DWORD PTR $T222758[esp+740], ebx
	mov	DWORD PTR $T222758[esp+744], ebx
	mov	DWORD PTR $T222758[esp+748], ebx
	mov	DWORD PTR $T222758[esp+752], ebx
	mov	DWORD PTR $T222758[esp+756], ebx
	mov	BYTE PTR $T222758[esp+731], bl
	mov	BYTE PTR $T222758[esp+732], bl
...
; 1249 : 		if((pUnit->IsDeclareWar() || (finder->GetInfo() & MOVE_DECLARE_WAR)))
	...
	mov	ecx, edi
	mov	BYTE PTR _bMoveFlags$219722[esp+12], 132 ; 00000084H
...
; 1251 : 			bMoveFlags |= CvUnit::MOVEFLAG_ATTACK;
	...
	mov	BYTE PTR _bMoveFlags$219722[esp+12], 133 ; 00000085H
$LN4@PathDestVa:
...
; 1256 : 			bMoveFlags |= CvUnit::MOVEFLAG_IGNORE_STACKING;
	...
	or	BYTE PTR _bMoveFlags$219722[esp+12], 16	; 00000010H
$LN2@PathDestVa:
...
; 1259 : 		if(!(pUnit->canMoveOrAttackInto(*pToPlot, bMoveFlags)))
	...
	mov	edx, DWORD PTR _bMoveFlags$219722[esp+12]
	push	edx
	push	esi
	mov	ecx, edi
...
; 1409 : 				iCost += (GC.getPATH_DAMAGE_WEIGHT() * std::max(0, GC.getFeatureInfo(pToPlot->getFeatureType())->getTurnDamage())) / GC.getMAX_HIT_POINTS();
	...
	mov	DWORD PTR $T223314[esp+56], eax
	test	eax, eax
	mov	DWORD PTR $T223315[esp+56], 0
	lea	eax, DWORD PTR $T223314[esp+56]
	jg	SHORT $LN117@PathCost
	lea	eax, DWORD PTR $T223315[esp+56]
$LN117@PathCost:
	mov	eax, DWORD PTR [eax]
...
$LN51@PathCost:
	...
	sub	ecx, eax
	mov	DWORD PTR $T223318[esp+52], ecx
	mov	DWORD PTR $T223321[esp+52], 0
	lea	eax, DWORD PTR $T223318[esp+52]
	test	ecx, ecx
	jg	SHORT $LN207@PathCost
	lea	eax, DWORD PTR $T223321[esp+52]
$LN207@PathCost:
	mov	eax, DWORD PTR [eax]
...
; 1858 : 	kToNodeCacheData.bContainsVisibleEnemyDefender = pToPlot->getBestDefender(NO_PLAYER, unit_owner, pUnit).pointer() != NULL;
	...
	push	eax
	push	-1
	lea	ecx, DWORD PTR $T223703[esp+124]
	push	ecx
	mov	ecx, ebp
	...
	cmp	DWORD PTR [eax], 0
	mov	ecx, DWORD PTR $T223703[esp+96]
	setne	dl
...
; 2237 : 		iMoves = std::min(iMoves, pUnit->movesLeft());
	...
	mov	DWORD PTR $T223963[esp], eax
	cmp	eax, 2147483647				; 7fffffffH
	lea	eax, DWORD PTR $T223963[esp]
...
$LN12@PathAdd:
	...
	sub	ebp, eax
	add	esp, 24					; 00000018H
	mov	DWORD PTR $T223966[esp+16], ebp
	mov	DWORD PTR $T223969[esp+16], 0
	test	ebp, ebp
	jle	SHORT $LN51@PathAdd
	cmp	ebp, 2147483647				; 7fffffffH
	lea	eax, DWORD PTR $T223966[esp+16]
...
$LN51@PathAdd:
	lea	eax, DWORD PTR $T223969[esp+16]
	mov	eax, DWORD PTR [eax]
	jmp	SHORT $LN59@PathAdd
$LN2@PathAdd:
...
; 2578 : 				iCost += (GC.getPATH_DAMAGE_WEIGHT() * std::max(0, GC.getFeatureInfo(pToPlot->getFeatureType())->getTurnDamage())) / GC.getMAX_HIT_POINTS();
	...
	mov	ecx, eax
	call	?getTurnDamage@CvFeatureInfo@@QBEHXZ	; CvFeatureInfo::getTurnDamage
	mov	DWORD PTR $T224238[esp+16], eax
	test	eax, eax
	mov	DWORD PTR $T224239[esp+16], 0
	lea	eax, DWORD PTR $T224238[esp+16]
	jg	SHORT $LN105@IgnoreUnit@2
	lea	eax, DWORD PTR $T224239[esp+16]
$LN105@IgnoreUnit@2:
	mov	eax, DWORD PTR [eax]
	imul	eax, DWORD PTR ?gGlobals@@3VCvGlobals@@A+6944
	cdq
...
$LN34@IgnoreUnit@2:
	mov	ecx, 200				; 000000c8H
	sub	ecx, eax
	mov	DWORD PTR $T224240[esp+16], ecx
	mov	DWORD PTR $T224243[esp+16], 0
	lea	eax, DWORD PTR $T224240[esp+16]
	test	ecx, ecx
...
; 3022 : 		iMoves = std::min(iMoves, pUnit->movesLeft());
	...
	mov	esi, 1
	call	?movesLeft@CvUnit@@QBEHXZ		; CvUnit::movesLeft
	mov	DWORD PTR $T224662[esp+8], eax
	cmp	eax, 2147483647				; 7fffffffH
	lea	eax, DWORD PTR $T224662[esp+8]
...
$LN9@IgnoreUnit@4:
	...
	sub	ebp, eax
	add	esp, 24					; 00000018H
	mov	DWORD PTR $T224665[esp+16], ebp
	mov	DWORD PTR $T224668[esp+16], 0
	test	ebp, ebp
	jle	SHORT $LN50@IgnoreUnit@4
	cmp	ebp, 2147483647				; 7fffffffH
	lea	eax, DWORD PTR $T224665[esp+16]
...
$LN50@IgnoreUnit@4:
	lea	eax, DWORD PTR $T224668[esp+16]
...
; 3371 : 	iCost = std::max(1,iCost);
	...
	cmp	ebx, 1
	mov	DWORD PTR $T225062[esp+12], 1
	pop	ebx
	lea	eax, DWORD PTR _iCost$[esp+4]
	jg	SHORT $LN83@InfluenceC
	lea	eax, DWORD PTR $T225062[esp+8]
$LN83@InfluenceC:
	mov	eax, DWORD PTR [eax]
...
; 3372 : 	iCost = std::min(3,iCost);
	...
	cmp	eax, 3
	mov	DWORD PTR $T225063[esp+8], 3
	lea	eax, DWORD PTR _iCost$[esp+4]
	jl	SHORT $LN87@InfluenceC
	lea	eax, DWORD PTR $T225063[esp+8]
$LN87@InfluenceC:
...
; 3479 : 		CvCityConnections::RouteInfo* pRouteInfo = pCityConnections->GetRouteInfo(uiFirstCityIndex, uiSecondCityIndex);
	...
	mov	DWORD PTR _pRouteInfo$220283[esp+12], eax
...
; 3494 : 		if(pRouteInfo->m_cRouteState & CvCityConnections::HAS_WATER_ROUTE)
	...
	mov	ecx, DWORD PTR _pRouteInfo$220283[esp+12]
	test	BYTE PTR [ecx], 2
	je	SHORT $LN8@RouteGetEx
...
_ePlotOwnerPlayer$220313 = 8				; size = 4
_parent$ = 8						; size = 4
_node$ = 12						; size = 4
_data$ = 16						; size = 4
_pointer$ = 20						; size = 4
...
; 3569 : 		PlayerTypes ePlotOwnerPlayer = pNewPlot->getOwner();
	...
	mov	DWORD PTR _ePlotOwnerPlayer$220313[esp+16], esi
...
; 3577 : 				eMajorPlayer = ePlotOwnerPlayer;
	...
	mov	eax, DWORD PTR _ePlotOwnerPlayer$220313[esp+16]
...
; 3583 : 				eMinorPlayer = ePlotOwnerPlayer;
	...
	mov	ebx, DWORD PTR _ePlotOwnerPlayer$220313[esp+16]
$LN7@RouteValid:
...
; 3680 : 		CvCityConnections::RouteInfo* pRouteInfo = pCityConnections->GetRouteInfo(uiFirstCityIndex, uiSecondCityIndex);
	...
	mov	ecx, edi
	call	?GetRouteInfo@CvCityConnections@@QAEPAURouteInfo@1@II@Z ; CvCityConnections::GetRouteInfo
	mov	DWORD PTR _pRouteInfo$220355[esp+12], eax
...
; 3695 : 		if(pRouteInfo->m_cRouteState & CvCityConnections::HAS_WATER_ROUTE)
	...
	mov	edx, DWORD PTR _pRouteInfo$220355[esp+12]
	test	BYTE PTR [edx], 2
	je	SHORT $LN7@RouteGetNu
...
_TEXT	SEGMENT
_strBaseString$220552 = -96				; size = 28
_strOutBuf$220551 = -68					; size = 28
$T226033 = -40						; size = 28
__$EHRec$ = -12						; size = 12
_pkUnit$ = 8						; size = 4
_strMsg$ = 12						; size = 4
...
; 4109 : 		CvString strOutBuf;
	...
	lea	ecx, DWORD PTR _strOutBuf$220551[esp+108]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ

; 4110 : 		CvString strBaseString;

	lea	ecx, DWORD PTR _strBaseString$220552[esp+108]
...
; 4114 : 		FILogFile* pLog = LOGFILEMGR.GetLog((gDLL->IsGameCoreThread())?"AStar_GC.log":"AStar_APP.log", FILogFile::kDontTimeStamp, "Game Turn, Player, Unit, From X, From Y, To X, To Y, Info, Checksum");
	...
	call	edx
	mov	esi, OFFSET $SG220557
	test	al, al
	jne	SHORT $LN5@LogPathGen
	mov	esi, OFFSET $SG220558
$LN5@LogPathGen:
...
$LN7@LogPathGen:
	...
	push	eax
	lea	ecx, DWORD PTR _strBaseString$220552[esp+120]
...
; 4118 : 		strOutBuf = strBaseString + strMsg;
	...
	push	edx
	lea	eax, DWORD PTR _strBaseString$220552[esp+132]
	push	eax
	lea	ecx, DWORD PTR $T226033[esp+136]
	push	ecx
	...
	call	DWORD PTR __imp_?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ
	push	eax
	lea	ecx, DWORD PTR _strOutBuf$220551[esp+112]
	call	DWORD PTR __imp_?assign@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV12@PBD@Z
	lea	ecx, DWORD PTR $T226033[esp+108]
	mov	BYTE PTR __$EHRec$[esp+116], 1
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
...
__unwindfunclet$?LogPathGeneration@@YAXPBVCvUnit@@AAVCvString@@@Z$0:
	lea	ecx, DWORD PTR _strOutBuf$220551[ebp]
	jmp	??1CvString@@QAE@XZ			; CvString::~CvString
__unwindfunclet$?LogPathGeneration@@YAXPBVCvUnit@@AAVCvString@@@Z$1:
	lea	ecx, DWORD PTR _strBaseString$220552[ebp]
	jmp	??1CvString@@QAE@XZ			; CvString::~CvString
...
; 4712 : 				auto_ptr<ICvPlot1> pDllPlot = GC.WrapPlotPointer(pPlot);
	...
	push	ecx
	lea	ecx, DWORD PTR $T226479[esp+32]
	push	ecx
	mov	ecx, OFFSET ?gGlobals@@3VCvGlobals@@A	; gGlobals
	call	?WrapPlotPointer@CvGlobals@@QAE?AV?$auto_ptr@VICvPlot1@@@std@@PAVCvPlot@@@Z ; CvGlobals::WrapPlotPointer
	mov	esi, DWORD PTR [eax]
	mov	DWORD PTR [eax], 0
	mov	DWORD PTR _pDllPlot$220792[esp+32], esi
	mov	eax, DWORD PTR $T226479[esp+28]
...
__unwindfunclet$?UIPathAdd@@YAHPAVCvAStarNode@@0HPBXPAVCvAStar@@@Z$1:
	lea	ecx, DWORD PTR _pDllPlot$220792[ebp]
...
_TEXT	SEGMENT
_pDllUnit$220868 = -20					; size = 4
_pDllPlot$220883 = -16					; size = 4
__$EHRec$ = -12						; size = 12
_parent$ = 8						; size = 4
$T226655 = 12						; size = 4
_node$ = 12						; size = 4
...
; 4737 : 		auto_ptr<ICvUnit1> pDllUnit(GC.GetEngineUserInterface()->GetHeadSelectedUnit());
	...
	call	eax
	mov	ebp, eax
	mov	DWORD PTR _pDllUnit$220868[esp+36], ebp
...
; 4745 : 				auto_ptr<ICvPlot1> pDllPlot = GC.WrapPlotPointer(pPlot);
	...
	push	esi
	lea	ecx, DWORD PTR $T226655[esp+36]
	push	ecx
	mov	ecx, OFFSET ?gGlobals@@3VCvGlobals@@A	; gGlobals
	call	?WrapPlotPointer@CvGlobals@@QAE?AV?$auto_ptr@VICvPlot1@@@std@@PAVCvPlot@@@Z ; CvGlobals::WrapPlotPointer
	mov	esi, DWORD PTR [eax]
	mov	DWORD PTR [eax], 0
	mov	DWORD PTR _pDllPlot$220883[esp+36], esi
	mov	eax, DWORD PTR $T226655[esp+32]
...
__unwindfunclet$?AttackPathAdd@@YAHPAVCvAStarNode@@0HPBXPAVCvAStar@@@Z$0:
	lea	ecx, DWORD PTR _pDllUnit$220868[ebp]
...
__unwindfunclet$?AttackPathAdd@@YAHPAVCvAStarNode@@0HPBXPAVCvAStar@@@Z$2:
	lea	ecx, DWORD PTR _pDllPlot$220883[ebp]
	jmp	??1?$auto_ptr@VICvPlot1@@@std@@QAE@XZ	; std::auto_ptr<ICvPlot1>::~auto_ptr<ICvPlot1>
...
; 4983 : 	kToNodeCacheData.bContainsVisibleEnemyDefender = pToPlot->getBestDefender(NO_PLAYER, unit_owner, pUnit).pointer() != NULL;
	...
	mov	BYTE PTR [esi+88], cl
	push	-1
	lea	ecx, DWORD PTR $T227002[esp+120]
	push	ecx
	mov	ecx, ebx
	call	?getBestDefender@CvPlot@@QAE?AV?$FObjectHandle@VCvUnit@@@@W4PlayerTypes@@0PBVCvUnit@@_N222@Z ; CvPlot::getBestDefender
	cmp	DWORD PTR [eax], 0
	mov	ecx, DWORD PTR $T227002[esp+92]
	setne	dl
	xor	dl, BYTE PTR [esi+89]
	and	dl, 1
	xor	BYTE PTR [esi+89], dl
...
; 6021 : 		kPathArray.setsize(uiNodeCount);
	...
	push	ebx
	mov	ecx, edi
	mov	DWORD PTR $T228223[esp+16], ebx
	call	?SetSize@?$FFastVector@VCvPathNode@@$00$0A@$0A@UFDefaultFastVectorAllocator@?$BaseVector@VCvPathNode@@$00@@@@IAEXI@Z ; FFastVector<CvPathNode,1,0,0,BaseVector<CvPathNode,1>::FDefaultFastVectorAllocator>::SetSize
	cmp	DWORD PTR [edi+8], ebx
	lea	eax, DWORD PTR [edi+8]
	jb	SHORT $LN14@CopyPath
	lea	eax, DWORD PTR $T228223[esp+12]
$LN14@CopyPath:
	mov	eax, DWORD PTR [eax]
...
_x$ = -4						; size = 4
tv515 = 8						; size = 4
_iExtraChildren$219506 = 8				; size = 4
_node$ = 8						; size = 4
...
; 585  : 		for(int i = 0; i < iExtraChildren; i++)
	...
	xor	ebx, ebx
	mov	DWORD PTR _iExtraChildren$219506[esp+20], eax
	test	eax, eax
...
$LN4@CreateChil:
	inc	ebx
	cmp	ebx, DWORD PTR _iExtraChildren$219506[esp+20]
...
; 4020 : 		m_ppaaPartialMoveNodes[iI] = FNEW(CvAStarNode[m_iRows], c_eCiv5GameplayDLL, 0);
	...
	call	??_U@YAPAXI@Z				; operator new[]
	add	esp, 4
	mov	DWORD PTR $T228590[esp+24], eax
	xor	ebx, ebx
...
__unwindfunclet$?Initialize@CvTwoLayerPathFinder@@QAEXHH_N0P6AHHHPBXPAVCvAStar@@@Z3P6AHHHHH@ZP6AHPAVCvAStarNode@@5H12@Z666P6AX12@Z71@Z$0:
	mov	eax, DWORD PTR $T228590[ebp-4]
	push	eax
	call	??_V@YAXPAX@Z				; operator delete[]
	pop	ecx
	ret	0
...
_TEXT	SEGMENT
_strLogString$220575 = -40				; size = 28
__$EHRec$ = -12						; size = 12
_bResult$220573 = 8					; size = 1
_pkUnit$ = 8						; size = 4
_iXstart$ = 12						; size = 4
_iYstart$ = 16						; size = 4
_iXdest$ = 20						; size = 4
...
; 4140 : 		if(GC.getLogging() && GC.getAILogging())
	...
	mov	ecx, OFFSET ?gGlobals@@3VCvGlobals@@A	; gGlobals
	mov	BYTE PTR _bResult$220573[esp+52], al
	call	?getLogging@CvGlobals@@QAE_NXZ		; CvGlobals::getLogging
	test	al, al
	je	$LN3@GenerateUn
	mov	ecx, OFFSET ?gGlobals@@3VCvGlobals@@A	; gGlobals
...
; 4142 : 			CvString strLogString;
	...
	lea	ecx, DWORD PTR _strLogString$220575[esp+56]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
...
; 4157 : 			strLogString.Format("%d, %d, %d, %d, %d, %8x", iXstart, iYstart, iXdest, iYdest, iInfo, uiChecksum);
	...
	push	ecx
	push	edx
	lea	eax, DWORD PTR _strLogString$220575[esp+80]
...
; 4158 : 			LogPathGeneration(pkUnit, strLogString);
	...
	lea	ecx, DWORD PTR _strLogString$220575[esp+88]
	push	ecx
	push	edi
...
; 4160 : 		return bResult;
	...
	mov	al, BYTE PTR _bResult$220573[esp+52]
	pop	ebp
	pop	ebx
	pop	edi
	pop	esi
...
__unwindfunclet$?GenerateUnitPath@CvTwoLayerPathFinder@@QAE_NPBVCvUnit@@HHHHH_N@Z$0:
	lea	ecx, DWORD PTR _strLogString$220575[ebp]
	jmp	??1CvString@@QAE@XZ			; CvString::~CvString
...
; 4326 : 						pNode = pNode->m_pParent;
	...
	mov	DWORD PTR $T228941[esp+12], ebx
	test	ebx, ebx
...
; 4330 : 						currentPlot = kMap.plotUnchecked(pNode->m_iX, pNode->m_iY);
	...
	inc	edx
	add	eax, edi
	cmp	edx, DWORD PTR $T228941[esp+12]
...
; 5528 : 		int iTurnsCalculated = TurnsToReachTarget(pUnit, pTarget, false /*bReusePaths*/, bIgnoreUnits);
	...
	mov	eax, esi
	mov	DWORD PTR $T229166[esp+48], esp
	test	eax, eax
