...
_iFromMovementCost$218196 = -16				; size = 4
_pTraits$ = -16						; size = 4
_eFeature$ = -12					; size = 4
$T219195 = -8						; size = 4
_eTerrain$ = -4						; size = 4
...
$T219209 = 12						; size = 4
$T219206 = 12						; size = 4
_iMovementCost$218199 = 12				; size = 4
$T219194 = 12						; size = 4
_pFeatureInfo$ = 12					; size = 4
_pFromPlot$ = 12					; size = 4
$T219208 = 16						; size = 4
$T219207 = 16						; size = 4
_eFromPlotRoute$218190 = 16				; size = 4
...
; 49   : 			iRegularCost = std::max(1, (iRegularCost - pUnit->getExtraMoveDiscount()));
	...
	sub	ecx, eax
	cmp	ecx, 1
	mov	DWORD PTR $T219194[esp+40], ecx
	mov	DWORD PTR $T219195[esp+44], 1
	lea	eax, DWORD PTR $T219194[esp+40]
	jg	SHORT $LN95@GetCostsFo
	lea	eax, DWORD PTR $T219195[esp+44]
$LN95@GetCostsFo:
...
; 93   : 		RouteTypes eToPlotRoute = pToPlot->getRouteType();
	...
	mov	ecx, edi
	mov	DWORD PTR _eFromPlotRoute$218190[esp+40], ebx
	call	?getRouteType@CvPlot@@QBE?AW4RouteTypes@@XZ ; CvPlot::getRouteType
...
; 97   : 				eFromPlotRoute = ROUTE_ROAD;
	...
	mov	DWORD PTR _eFromPlotRoute$218190[esp+40], 0
	mov	ebx, DWORD PTR _eFromPlotRoute$218190[esp+40]
$LN141@GetCostsFo:
...
; 108  : 		int iFromFlatMovementCost = (pFromRouteInfo != NULL)? pFromRouteInfo->getFlatMovementCost() : 0;
	...
	mov	ecx, ebx
	mov	DWORD PTR _iFromMovementCost$218196[esp+44], eax
...
; 107  : 		int iFromMovementCost = (pFromRouteInfo != NULL)? pFromRouteInfo->getMovementCost() : 0;
	...
	mov	DWORD PTR _iFromMovementCost$218196[esp+44], 0
...
; 118  : 		int iFlatMovementCost = (pRouteInfo != NULL)? pRouteInfo->getFlatMovementCost() : 0;
	...
	mov	ecx, ebp
	mov	DWORD PTR _iMovementCost$218199[esp+40], eax
	call	?getFlatMovementCost@CvRouteInfo@@QBEHXZ ; CvRouteInfo::getFlatMovementCost
	mov	ebp, eax
...
; 117  : 		int iMovementCost = (pRouteInfo != NULL)? pRouteInfo->getMovementCost() : 0;
	...
	mov	DWORD PTR _iMovementCost$218199[esp+40], 0
...
; 129  : 		iRouteCost = std::max(iFromMovementCost + kUnitTeam.getRouteChange(eFromPlotRoute), iMovementCost + kUnitTeam.getRouteChange(eToPlotRoute));
	...
	mov	edx, DWORD PTR _eFromPlotRoute$218190[esp+40]
	mov	ecx, DWORD PTR _kUnitTeam$[esp+44]
	mov	esi, eax
	add	esi, DWORD PTR _iMovementCost$218199[esp+40]
	push	edx
	mov	DWORD PTR $T219206[esp+44], esi
	call	?getRouteChange@CvTeam@@QBEHW4RouteTypes@@@Z ; CvTeam::getRouteChange
	add	eax, DWORD PTR _iFromMovementCost$218196[esp+44]
	mov	DWORD PTR $T219207[esp+40], eax
	cmp	eax, esi
	lea	eax, DWORD PTR $T219206[esp+40]
...
; 133  : 		iRouteFlatCost = std::max(iFromFlatMovementCost * iBaseMoves, iFlatMovementCost * iBaseMoves);
	...
	imul	ebx, eax
	cmp	ebx, ebp
	mov	DWORD PTR $T219208[esp+40], ebp
	mov	DWORD PTR $T219209[esp+40], ebx
...
_TEXT	SEGMENT
_bIsVisibleEnemyUnit$218296 = -37			; size = 1
_iToPlotX$218292 = -36					; size = 4
_iToPlotY$218293 = -32					; size = 4
_pAdjUnitNode$218288 = -28				; size = 4
_iDirection0$218298 = -24				; size = 4
_iFromPlotY$218291 = -20				; size = 4
_iFromPlotX$218290 = -16				; size = 4
_unit_team_type$218294 = -12				; size = 4
_kUnitTeam$218297 = -8					; size = 4
_unit_domain_type$218295 = -4				; size = 4
_pUnit$ = 8						; size = 4
_pFromPlot$ = 12					; size = 4
_pToPlot$ = 16						; size = 4
...
; 383  : 		int iToPlotX = pToPlot->getX();
	...
	mov	DWORD PTR _iFromPlotX$218290[esp+56], eax

; 384  : 		int iToPlotY = pToPlot->getY();

	movsx	eax, WORD PTR [esi+2]
	mov	DWORD PTR _iFromPlotY$218291[esp+56], ecx

; 385  : 		TeamTypes unit_team_type     = pUnit->getTeam();

	mov	ecx, ebp
	mov	DWORD PTR _iToPlotX$218292[esp+56], edx
	mov	DWORD PTR _iToPlotY$218293[esp+56], eax
	call	?getTeam@CvUnit@@QBE?AW4TeamTypes@@XZ	; CvUnit::getTeam
	mov	edi, eax
...
; 386  : 		DomainTypes unit_domain_type = pUnit->getDomainType();
	...
	mov	ecx, ebp
	mov	DWORD PTR _unit_team_type$218294[esp+56], edi
	call	?getDomainType@CvUnit@@QBE?AW4DomainTypes@@XZ ; CvUnit::getDomainType
...
; 387  : 		bool bIsVisibleEnemyUnit     = pToPlot->isVisibleEnemyUnit(pUnit);
	...
	push	ebp
	mov	ecx, esi
	mov	DWORD PTR _unit_domain_type$218295[esp+60], eax
	call	?isVisibleEnemyUnit@CvPlot@@QBE_NPBVCvUnit@@@Z ; CvPlot::isVisibleEnemyUnit
	mov	BYTE PTR _bIsVisibleEnemyUnit$218296[esp+56], al
...
; 388  : 		CvTeam& kUnitTeam = GET_TEAM(unit_team_type);
	...
	imul	eax, 2984				; 00000ba8H
	add	eax, DWORD PTR ?m_aTeams@CvTeam@@1PAV1@A ; CvTeam::m_aTeams
	mov	DWORD PTR _kUnitTeam$218297[esp+56], eax

; 389  : 
; 390  : 		for(int iDirection0 = 0; iDirection0 < NUM_DIRECTION_TYPES; iDirection0++)

	xor	eax, eax
	mov	DWORD PTR _iDirection0$218298[esp+56], eax
	npad	4
$LL106@IsSlowedBy:
...
; 392  : 			CvPlot* pAdjPlot = plotDirection(iFromPlotX, iFromPlotY, ((DirectionTypes)iDirection0));
	...
	mov	ecx, DWORD PTR _iFromPlotY$218291[esp+56]
	mov	edx, DWORD PTR _iFromPlotX$218290[esp+56]
	push	eax
	push	ecx
	push	edx
...
; 409  : 							if(pEnemyAdjPlot->getX() == iToPlotX && pEnemyAdjPlot->getY() == iToPlotY)
	...
	cmp	ecx, DWORD PTR _iToPlotX$218292[esp+56]
	jne	SHORT $LN24@IsSlowedBy
	movsx	edx, WORD PTR [eax+2]
	cmp	edx, DWORD PTR _iToPlotY$218293[esp+56]
	je	$LN94@IsSlowedBy
$LN24@IsSlowedBy:
...
$LL101@IsSlowedBy:
	mov	edi, DWORD PTR _pAdjUnitNode$218288[esp+56]
$LN19@IsSlowedBy:
...
; 434  : 					pAdjUnitNode = pAdjPlot->nextUnitNode(pAdjUnitNode);
	...
	mov	DWORD PTR _pAdjUnitNode$218288[esp+56], eax
...
; 445  : 					if(pLoopUnit->isInvisible(unit_team_type,false)) continue;
	...
	push	1
	mov	edi, eax
	mov	eax, DWORD PTR _unit_team_type$218294[esp+60]
	push	0
	push	eax
	mov	ecx, esi
...
; 454  : 					if(unit_loop_team_type == BARBARIAN_TEAM || kUnitTeam.isAtWar(unit_loop_team_type))
	...
	mov	ecx, DWORD PTR _kUnitTeam$218297[esp+56]
	push	edi
...
; 460  : 						if(loop_unit_domain_type != unit_domain_type)
	...
	mov	ecx, DWORD PTR _unit_domain_type$218295[esp+56]
	cmp	eax, ecx
...
; 489  : 							if(!bIsVisibleEnemyUnit)
	...
	cmp	BYTE PTR _bIsVisibleEnemyUnit$218296[esp+56], 0
...
; 423  : 				while(pAdjUnitNode != NULL)
	...
	cmp	DWORD PTR _pAdjUnitNode$218288[esp+56], 0
...
; 390  : 		for(int iDirection0 = 0; iDirection0 < NUM_DIRECTION_TYPES; iDirection0++)
	...
	mov	eax, DWORD PTR _iDirection0$218298[esp+56]
	inc	eax
	cmp	eax, 6
	mov	DWORD PTR _iDirection0$218298[esp+56], eax
	jl	$LL106@IsSlowedBy
...
; 222  : 	return std::max(1, std::min(iRegularCost, std::min(iRouteCost, iRouteFlatCost)));
	...
	mov	DWORD PTR $T219596[esp+28], 1
	lea	eax, DWORD PTR _iRouteFlatCost$[esp+28]
...
$LN21@MovementCo:
	...
	lea	eax, DWORD PTR $T219596[esp+28]
$LN25@MovementCo:
	mov	eax, DWORD PTR [eax]
$LN10@MovementCo:
	pop	edi
...
; 248  : 	return std::max(1, std::min(iRegularCost, std::min(iRouteCost, iRouteFlatCost)));
	...
	add	esp, 28					; 0000001cH
	cmp	ecx, DWORD PTR _iRouteCost$[esp+28]
	mov	DWORD PTR $T219632[esp+28], 1
	lea	eax, DWORD PTR _iRouteFlatCost$[esp+28]
...
$LN17@MovementCo@2:
	...
	lea	eax, DWORD PTR $T219632[esp+28]
$LN21@MovementCo@2:
	mov	eax, DWORD PTR [eax]
$LN6@MovementCo@2:
	pop	edi
