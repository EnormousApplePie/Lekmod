; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\Users\EnormousApplePie\Desktop\Lekmod Files\Lekmod DLL versions\v29\LEKMOD_DLL\CvGameCoreDLL_Expansion2\Lua\CvLuaTeamTech.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG217616 DB	'SetHasTech', 00H
	ORG $+1
$SG217617 DB	'HasTech', 00H
$SG217618 DB	'GetNumTechsKnown', 00H
	ORG $+3
$SG217619 DB	'HasResearchedAllTechs', 00H
	ORG $+2
$SG217620 DB	'GetLastTechAcquired', 00H
$SG217621 DB	'SetNoTradeTech', 00H
	ORG $+1
$SG217622 DB	'IsNoTradeTech', 00H
	ORG $+2
$SG217623 DB	'IncrementTechCount', 00H
	ORG $+1
$SG217624 DB	'GetTechCount', 00H
	ORG $+3
$SG217625 DB	'SetResearchProgress', 00H
$SG217626 DB	'SetResearchProgressTimes100', 00H
$SG217627 DB	'GetResearchProgress', 00H
$SG217628 DB	'GetResearchProgressTimes100', 00H
$SG217629 DB	'ChangeResearchProgress', 00H
	ORG $+1
$SG217630 DB	'ChangeResearchProgressTimes100', 00H
	ORG $+1
$SG217631 DB	'ChangeResearchProgressPercent', 00H
	ORG $+2
$SG217632 DB	'GetResearchCost', 00H
$SG217633 DB	'GetResearchLeft', 00H
$SG217636 DB	'TeamTech', 00H
	ORG $+3
$SG217952 DB	'Instance does not exist.', 00H
	ORG $+3
$SG218022 DB	'__instance', 00H
	ORG $+5
$SG218028 DB	'Not a valid instance.  Either the instance is NULL or yo'
...
; Function compile flags: /Ogtpy
; File c:\users\enormousapplepie\desktop\lekmod files\lekmod dll versions\v29\lekmod_dll\cvgamecoredll_expansion2\lua\cvluateamtech.cpp
...
; 242  : 	(pkType->*func)(CvLuaArgs::toValue<arg1>(L, idx), CvLuaArgs::toValue<arg2>(L, idx + 1));
	...
	test	eax, eax
	setne	al
	mov	BYTE PTR $T218166[esp+20], al
	mov	ecx, DWORD PTR $T218166[esp+20]
	push	ecx
	push	2
	push	esi
	call	_lua_tointeger
