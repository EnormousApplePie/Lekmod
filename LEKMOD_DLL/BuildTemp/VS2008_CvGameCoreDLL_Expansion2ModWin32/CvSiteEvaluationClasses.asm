; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\Users\EnormousApplePie\Desktop\Lekmod Files\Lekmod DLL versions\v29\LEKMOD_DLL\CvGameCoreDLL_Expansion2\CvSiteEvaluationClasses.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG222900 DB	'FLAVOR_GROWTH', 00H
	ORG $+2
$SG222901 DB	'FLAVOR_EXPANSION', 00H
	ORG $+3
$SG222902 DB	'FLAVOR_NAVAL', 00H
	ORG $+3
$SG222920 DB	'GAMEOPTION_AI_GIMP_NO_BUILDING_SETTLERS', 00H
$SG222971 DB	'FLAVOR_GROWTH', 00H
	ORG $+2
$SG222972 DB	'FLAVOR_EXPANSION', 00H
	ORG $+3
$SG222977 DB	'FLAVOR_GOLD', 00H
$SG222978 DB	'FLAVOR_TILE_IMPROVEMENT', 00H
$SG222983 DB	'FLAVOR_PRODUCTION', 00H
	ORG $+2
$SG222984 DB	'FLAVOR_WONDER', 00H
	ORG $+2
$SG222988 DB	'FLAVOR_SCIENCE', 00H
	ORG $+1
$SG222992 DB	'FLAVOR_HAPPINESS', 00H
	ORG $+3
$SG222996 DB	'FLAVOR_RELIGION', 00H
$SG223043 DB	'IMPROVEMENT_TERRACE_FARM', 00H
	ORG $+3
$SG223120 DB	'IMPROVEMENT_BRAZILWOOD_CAMP', 00H
$SG223128 DB	'IMPROVEMENT_KASBAH', 00H
	ORG $+1
$SG223136 DB	'IMPROVEMENT_POLDER', 00H
CONST	ENDS
...
; Function compile flags: /Ogtpy
; File c:\users\enormousapplepie\desktop\lekmod files\lekmod dll versions\v29\lekmod_dll\cvgamecoredll_expansion2\cvcityspecializationai.h
...
; File c:\users\enormousapplepie\desktop\lekmod files\lekmod dll versions\v29\lekmod_dll\cvgamecoredll_expansion2\cvsiteevaluationclasses.cpp
rdata$r	SEGMENT
...
_iDY$223053 = -12					; size = 4
_iCapitalArea$ = -8					; size = 4
$T224596 = -4						; size = 4
$T224592 = -4						; size = 4
_ePlotResource$223086 = -4				; size = 4
_pPlot$ = 8						; size = 4
_iSweetSpot$223161 = 12					; size = 4
_pPlayer$ = 12						; size = 4
$T224517 = 16						; size = 4
$T224516 = 16						; size = 4
_eYield$ = 16						; size = 4
...
; 364  : 		for (int iDY = -7; iDY <= 7; iDY++)
	...
	mov	eax, -7					; fffffff9H
	mov	DWORD PTR _iDX$223049[esp+104], -7	; fffffff9H
	mov	DWORD PTR _iDY$223053[esp+104], eax
...
; 367  : 			CvPlot* pLoopPlot = plotXY(pPlot->getX(), pPlot->getY(), iDX, iDY);
	...
	push	eax
	mov	eax, DWORD PTR _iDX$223049[esp+108]
	push	eax
	push	edi
	push	ebp
	call	?plotXY@@YAPAVCvPlot@@HHHH@Z		; plotXY
...
; 377  : 				if (iDistance <= 7)
	...
	cmp	edi, 7
	mov	DWORD PTR _iDistance$223059[esp+104], edi
	jg	$LN90@PlotFoundV
...
; 394  : 							int iRingModifier = m_iRingModifier[iDistance];
	...
	mov	eax, DWORD PTR _iDistance$223059[esp+104]
...
; 408  : 									iFoodValue = iRingModifier * ComputeFoodValue(pLoopPlot, pPlayer) * /*15*/ GC.getSETTLER_FOOD_MULTIPLIER();
	...
	mov	eax, DWORD PTR [ebx]
	push	ecx
	mov	DWORD PTR $T224565[esp+108], edx
	mov	edx, DWORD PTR [eax+24]
	push	esi
	mov	ecx, ebx
	call	edx
	imul	eax, DWORD PTR $T224565[esp+104]
	imul	eax, ebp
...
; 412  : 									iProductionValue = iRingModifier * ComputeProductionValue(pLoopPlot, pPlayer) * /*3*/ GC.getSETTLER_PRODUCTION_MULTIPLIER();
	...
	mov	DWORD PTR $T224569[esp+104], eax
...
; 432  : 								iResourceValue = iRingModifier * ComputeTradeableResourceValue(pLoopPlot, pPlayer) * /*1*/ GC.getSETTLER_RESOURCE_MULTIPLIER();
	...
	mov	DWORD PTR $T224592[esp+104], eax
	mov	eax, DWORD PTR _pPlayer$[esp+100]
	push	eax
	push	esi
	mov	ecx, ebx
	call	edx
	mov	edi, eax
	imul	edi, DWORD PTR $T224592[esp+104]
	imul	edi, ebp

; 433  : 								if (iDistance)

	cmp	DWORD PTR _iDistance$223059[esp+104], 0
...
; 434  : 									iStrategicValue = ComputeStrategicValue(pLoopPlot, pPlayer, iDistance) * /*1*/ GC.getSETTLER_STRATEGIC_MULTIPLIER();  // the ring is included in the computation
	...
	mov	ecx, ebx
	call	edx
	imul	eax, DWORD PTR $T224596[esp+104]
...
; 473  : 							ResourceTypes ePlotResource = pLoopPlot->getResourceType();
	...
	mov	DWORD PTR _ePlotResource$223086[esp+104], eax
...
; 480  : 									if (iDistance == 1)
	...
	cmp	DWORD PTR _iDistance$223059[esp+104], eax
...
; 491  : 								if (iDistance <= NUM_CITY_RINGS)
	...
	cmp	DWORD PTR _iDistance$223059[esp+104], 3
...
; 516  : 									if (ePlotResource == NO_RESOURCE)
	...
	cmp	DWORD PTR _ePlotResource$223086[esp+104], -1
	jne	SHORT $LN50@PlotFoundV
...
$LN90@PlotFoundV:
	mov	eax, DWORD PTR _iDY$223053[esp+104]
	inc	eax
	cmp	eax, 7
	mov	DWORD PTR _iDY$223053[esp+104], eax
	jle	$LL211@PlotFoundV
	mov	eax, DWORD PTR _iDX$223049[esp+104]
	inc	eax
	cmp	eax, 7
	mov	DWORD PTR _iDX$223049[esp+104], eax
...
; 678  : 		iSweetSpot = max(4,iSweetSpot);
	...
	mov	DWORD PTR $T224516[esp+100], 4
	dec	ecx
	cmp	eax, 4
	setl	dl
	xor	eax, eax
	...
	mov	DWORD PTR _iSweetSpot$223161[esp+100], eax
	cmp	eax, 4
	lea	eax, DWORD PTR _iSweetSpot$223161[esp+100]
	jg	SHORT $LN199@PlotFoundV
	lea	eax, DWORD PTR $T224516[esp+100]
$LN199@PlotFoundV:
	mov	eax, DWORD PTR [eax]
	mov	DWORD PTR _iSweetSpot$223161[esp+100], eax
...
; 679  : 		iSweetSpot = min(6,iSweetSpot);
	...
	cmp	eax, 6
	mov	DWORD PTR $T224517[esp+100], 6
	lea	eax, DWORD PTR _iSweetSpot$223161[esp+100]
	jl	SHORT $LN203@PlotFoundV
	lea	eax, DWORD PTR $T224517[esp+100]
$LN203@PlotFoundV:
	mov	eax, DWORD PTR [eax]
...
; 1209 : 			if(iDistance > NUM_CITY_RINGS) continue;
	...
	cmp	eax, 3
	mov	DWORD PTR _iDistance$223376[esp+32], eax
...
; 1215 : 				rtnValue += iRingModifier * ComputeFoodValue(pLoopPlot, pPlayer) * /*6*/ GC.getSTART_AREA_FOOD_MULTIPLIER();
	...
	push	eax
	mov	DWORD PTR $T225164[esp+36], ecx
	push	edi
	mov	ecx, esi
	call	edx
	imul	eax, DWORD PTR $T225164[esp+32]
...
; 1216 : 				rtnValue += iRingModifier * ComputeHappinessValue(pLoopPlot, pPlayer) * /*12*/ GC.getSTART_AREA_HAPPINESS_MULTIPLIER();
	...
	mov	DWORD PTR $T225168[esp+32], eax
	mov	eax, DWORD PTR _pPlayer$[esp+28]
	push	eax
	push	edi
	mov	ecx, esi
...
; 1222 : 				rtnValue += iRingModifier * ComputeStrategicValue(pLoopPlot, pPlayer, iDistance) * /*1*/ GC.getSTART_AREA_STRATEGIC_MULTIPLIER();
	...
	mov	eax, DWORD PTR _iDistance$223376[esp+32]
	push	eax
	push	ecx
	push	edi
	mov	ecx, esi
