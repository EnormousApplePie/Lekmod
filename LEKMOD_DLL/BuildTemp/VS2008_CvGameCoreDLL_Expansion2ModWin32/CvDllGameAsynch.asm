; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\Users\EnormousApplePie\Desktop\Lekmod Files\Lekmod DLL versions\v29\LEKMOD_DLL\CvGameCoreDLL_Expansion2\CvDllGameAsynch.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_DATA	SEGMENT
_CIV5_XP2_DLL_VERSION DD FLAT:$SG217165
_DATA	ENDS
CONST	SEGMENT
$SG217165 DB	'1.0.0', 00H
	ORG $+2
...
; File c:\users\enormousapplepie\desktop\lekmod files\lekmod dll versions\v29\lekmod_dll\cvgamecoredll_expansion2\cvdllgameasynch.cpp
rdata$r	SEGMENT
...
; 27   : 		guidInterface == ICvGame1::GetInterfaceId())
	...
	mov	DWORD PTR $T218620[esp+20], ecx
	lea	ecx, DWORD PTR $T218620[esp+16]
	mov	DWORD PTR $T218620[esp+24], edx
	mov	DWORD PTR $T218620[esp+16], eax
	mov	eax, DWORD PTR _guidICvUnknown+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T218620[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	...
	mov	DWORD PTR $T218622[esp+20], ecx
	lea	ecx, DWORD PTR $T218622[esp+16]
	mov	DWORD PTR $T218622[esp+24], edx
	mov	DWORD PTR $T218622[esp+16], eax
	mov	eax, DWORD PTR _guidICvGame1+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T218622[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	jne	SHORT $LN1@QueryInter
