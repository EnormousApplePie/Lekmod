; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\Users\EnormousApplePie\Desktop\Lekmod Files\Lekmod DLL versions\v29\LEKMOD_DLL\CvGameCoreDLL_Expansion2\CvGameTextMgr.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG217590 DB	'%04d', 00H
	ORG $+3
$SG217591 DB	'TXT_KEY_TIME_BC_SAVE', 00H
	ORG $+3
$SG217599 DB	'TXT_KEY_TIME_BC', 00H
$SG217608 DB	'%04d', 00H
	ORG $+3
$SG217609 DB	'%04d', 00H
	ORG $+3
$SG217610 DB	'TXT_KEY_TIME_AD_SAVE', 00H
	ORG $+3
$SG217613 DB	'TXT_KEY_TIME_AD', 00H
$SG217626 DB	'%04d', 00H
	ORG $+3
$SG217627 DB	'0001', 00H
	ORG $+3
$SG217628 DB	'TXT_KEY_TIME_AD_SAVE', 00H
	ORG $+3
$SG217631 DB	'TXT_KEY_TIME_AD', 00H
$SG217644 DB	'Months', 00H
	ORG $+1
$SG217646 DB	'Seasons', 00H
$SG217658 DB	'Months', 00H
	ORG $+1
$SG217665 DB	'-', 00H
	ORG $+2
$SG217670 DB	', ', 00H
	ORG $+1
$SG217674 DB	'TXT_KEY_TIME_TURN', 00H
	ORG $+2
$SG217678 DB	'Seasons', 00H
$SG217684 DB	'-', 00H
	ORG $+2
$SG217690 DB	', ', 00H
	ORG $+1
$SG217694 DB	'Months', 00H
	ORG $+1
$SG217700 DB	'-', 00H
	ORG $+2
$SG217706 DB	', ', 00H
	ORG $+1
$SG217709 DB	'TXT_KEY_TIME_WEEK', 00H
	ORG $+2
$SG217713 DB	'Months', 00H
	ORG $+1
$SG217721 DB	'-', 00H
	ORG $+2
$SG217722 DB	'-', 00H
...
; 244  : 	std::string result;
	...
	mov	DWORD PTR $T218008[esp+48], 0
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
...
; 249  : 	return CvString(result);
	...
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@ABV01@@Z
	lea	ecx, DWORD PTR _result$[esp+48]
	mov	DWORD PTR $T218008[esp+48], 1
...
__unwindfunclet$?format@CvString@@SA?AV1@PBDZZ$1:
	mov	eax, DWORD PTR $T218008[ebp]
	and	eax, 1
	je	$LN5@format
	and	DWORD PTR $T218008[ebp], -2		; fffffffeH
...
; 515  : 	Localization::String text = Localization::Lookup(szString);
	...
	mov	DWORD PTR $T218111[esp+120], ebx
...
; 522  : 	return str;
	...
	push	edi
	mov	ecx, esi
	mov	DWORD PTR $T218111[esp+120], 1
...
__unwindfunclet$??$GetLocalizedText@PBDPBD@@YA?AVCvString@@PBDABQBD1@Z$1:
	mov	eax, DWORD PTR $T218111[ebp]
	and	eax, 1
	je	$LN5@GetLocaliz
	and	DWORD PTR $T218111[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp-4]
	jmp	??1CvString@@QAE@XZ			; CvString::~CvString
$LN5@GetLocaliz:
	ret	0
...
; 502  : 	Localization::String text = Localization::Lookup(szString);
	...
	push	ecx
	mov	DWORD PTR __$EHRec$[esp+128], ebx
	mov	DWORD PTR $T218134[esp+120], ebx
	call	DWORD PTR __imp_?Lookup@Localization@@YA?AVString@1@PBD@Z
	add	esp, 8
...
; 509  : 	return str;
	...
	push	edi
	mov	ecx, esi
	mov	DWORD PTR $T218134[esp+120], 1
	call	DWORD PTR __imp_?assign@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV12@PBDI@Z
	lea	ecx, DWORD PTR _text$[esp+112]
	mov	BYTE PTR __$EHRec$[esp+120], bl
	call	DWORD PTR __imp_??1String@Localization@@UAE@XZ
...
__unwindfunclet$??$GetLocalizedText@H@@YA?AVCvString@@PBDH@Z$1:
	mov	eax, DWORD PTR $T218134[ebp]
	and	eax, 1
	je	$LN5@GetLocaliz@2
	and	DWORD PTR $T218134[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp-4]
	jmp	??1CvString@@QAE@XZ			; CvString::~CvString
$LN5@GetLocaliz@2:
	ret	0
...
; 515  : 	Localization::String text = Localization::Lookup(szString);
	...
	push	ecx
	mov	DWORD PTR __$EHRec$[esp+128], ebx
	mov	DWORD PTR $T218154[esp+120], ebx
	call	DWORD PTR __imp_?Lookup@Localization@@YA?AVString@1@PBD@Z
	add	esp, 8
...
; 522  : 	return str;
	...
	push	edi
	mov	ecx, esi
	mov	DWORD PTR $T218154[esp+120], 1
	call	DWORD PTR __imp_?assign@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV12@PBDI@Z
	lea	ecx, DWORD PTR _text$[esp+112]
	mov	BYTE PTR __$EHRec$[esp+120], bl
	call	DWORD PTR __imp_??1String@Localization@@UAE@XZ
...
__unwindfunclet$??$GetLocalizedText@$$BY04$$CBDPBD@@YA?AVCvString@@PBDAAY04$$CBDABQBD@Z$1:
	mov	eax, DWORD PTR $T218154[ebp]
	and	eax, 1
	je	$LN5@GetLocaliz@3
	and	DWORD PTR $T218154[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp-4]
	jmp	??1CvString@@QAE@XZ			; CvString::~CvString
$LN5@GetLocaliz@3:
	ret	0
...
; Function compile flags: /Ogtpy
; File c:\users\enormousapplepie\desktop\lekmod files\lekmod dll versions\v29\lekmod_dll\cvgamecoredll_expansion2\cvgametextmgr.cpp
xdata$x	ENDS
...
; 29   : 			strString = GetLocalizedText("TXT_KEY_TIME_BC_SAVE", CvString::format("%04d", -iTurnYear).GetCString(), CvString::format("%04d", iGameTurn).GetCString());
	...
	push	edi
	lea	eax, DWORD PTR $T218176[esp+148]
	...
	neg	esi
	push	esi
	lea	ecx, DWORD PTR $T218178[esp+148]
	push	OFFSET $SG217590
	push	ecx
	mov	DWORD PTR $T218175[esp+156], eax
	call	?format@CvString@@SA?AV1@PBDZZ		; CvString::format
	add	esp, 12					; 0000000cH
	mov	bl, 1
	mov	ecx, eax
	...
	call	DWORD PTR __imp_?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ
	lea	edx, DWORD PTR $T218175[esp+144]
	push	edx
	mov	DWORD PTR $T218177[esp+148], eax
	lea	eax, DWORD PTR $T218177[esp+148]
	push	eax
	lea	ecx, DWORD PTR $T218179[esp+152]
	...
	call	DWORD PTR __imp_??4?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV01@ABV01@@Z
	lea	ecx, DWORD PTR $T218179[esp+144]
	mov	BYTE PTR __$EHRec$[esp+152], bl
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	lea	ecx, DWORD PTR $T218178[esp+144]
	mov	BYTE PTR __$EHRec$[esp+152], 0
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	lea	ecx, DWORD PTR $T218176[esp+144]
...
; 33   : 			strString = GetLocalizedText("TXT_KEY_TIME_BC", -(iTurnYear));
	...
	neg	esi
	push	esi
	lea	edx, DWORD PTR $T218180[esp+148]
...
; 40   : 			strString = GetLocalizedText("TXT_KEY_TIME_AD_SAVE", CvString::format("%04d", iTurnYear).GetCString(), CvString::format("%04d", iGameTurn).GetCString());
	...
	push	edi
	lea	eax, DWORD PTR $T218182[esp+148]
	...
	call	DWORD PTR __imp_?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ
	push	esi
	lea	ecx, DWORD PTR $T218184[esp+148]
	push	OFFSET $SG217609
	push	ecx
	mov	DWORD PTR $T218181[esp+156], eax
	call	?format@CvString@@SA?AV1@PBDZZ		; CvString::format
	add	esp, 12					; 0000000cH
	mov	bl, 5
	mov	ecx, eax
	mov	BYTE PTR __$EHRec$[esp+152], bl
	call	DWORD PTR __imp_?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ
	lea	edx, DWORD PTR $T218181[esp+144]
	push	edx
	mov	DWORD PTR $T218183[esp+148], eax
	lea	eax, DWORD PTR $T218183[esp+148]
	push	eax
	lea	ecx, DWORD PTR $T218185[esp+152]
	...
	call	DWORD PTR __imp_??4?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV01@ABV01@@Z
	lea	ecx, DWORD PTR $T218185[esp+144]
	mov	BYTE PTR __$EHRec$[esp+152], bl
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
...
; 44   : 			strString = GetLocalizedText("TXT_KEY_TIME_AD", iTurnYear);
	...
	push	esi
	lea	edx, DWORD PTR $T218186[esp+148]
...
; 51   : 			strString = GetLocalizedText("TXT_KEY_TIME_AD_SAVE", "0001", CvString::format("%04d", iGameTurn).GetCString());
	...
	push	edi
	lea	eax, DWORD PTR $T218188[esp+148]
	...
	call	DWORD PTR __imp_?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ
	lea	ecx, DWORD PTR $T218187[esp+144]
	push	ecx
	push	OFFSET $SG217627
	lea	edx, DWORD PTR $T218189[esp+152]
	push	OFFSET $SG217628
	push	edx
	mov	DWORD PTR $T218187[esp+160], eax
...
; 55   : 			strString = GetLocalizedText("TXT_KEY_TIME_AD", 1);
	...
	push	1
	lea	eax, DWORD PTR $T218190[esp+148]
...
_kResult$217712 = -1340					; size = 64
_kResult$217693 = -1340					; size = 64
_kResult$217677 = -1340					; size = 64
_kResult$217656 = -1340					; size = 64
_strWeekBuffer$ = -1276					; size = 28
_strMonth$217661 = -1248				; size = 28
$T218315 = -1220					; size = 28
$T218319 = -1192					; size = 28
$T218318 = -1164					; size = 28
$T218304 = -1136					; size = 28
$T218317 = -1108					; size = 28
$T218306 = -1080					; size = 28
$T218321 = -1052					; size = 28
$T218308 = -1024					; size = 28
$T218326 = -996						; size = 28
$T218313 = -968						; size = 28
$T218325 = -940						; size = 28
$T218311 = -912						; size = 28
...
$T218307 = -408						; size = 28
$T218320 = -380						; size = 28
_kCalendarInfo$217711 = -352				; size = 260
_kMonthInfo$217692 = -352				; size = 260
_kSeasonInfo$217676 = -352				; size = 260
_kInfo$217657 = -352					; size = 260
_lstrMonth$217659 = -92					; size = 80
__$EHRec$ = -12						; size = 12
_strString$ = 8						; size = 4
_iGameTurn$ = 12					; size = 4
_bSave$ = 16						; size = 1
...
; 85   : 			Database::SingleResult kResult;
	...
	push	0
	lea	ecx, DWORD PTR _kResult$217656[esp+1392]
	mov	esi, edx
	call	DWORD PTR __imp_??0SingleResult@Database@@QAE@PBD@Z

; 86   : 			CvBaseInfo kInfo;

	lea	ecx, DWORD PTR _kInfo$217657[esp+1388]
...
; 87   : 			DB.SelectAt(kResult, "Months", iMonth);
	...
	lea	ecx, DWORD PTR _kResult$217656[esp+1396]
	push	ecx
	mov	ecx, DWORD PTR ?gGlobals@@3VCvGlobals@@A+912
...
; 88   : 			kInfo.CacheResult(kResult);
	...
	lea	edx, DWORD PTR _kResult$217656[esp+1388]
	push	edx
	lea	ecx, DWORD PTR _kInfo$217657[esp+1392]
...
; 90   : 			Localization::String lstrMonth = Localization::Lookup(kInfo.GetDescription());
	...
	lea	ecx, DWORD PTR _kInfo$217657[esp+1424]
	call	DWORD PTR __imp_?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ
	push	eax
	lea	eax, DWORD PTR _lstrMonth$217659[esp+1392]
	push	eax
	call	DWORD PTR __imp_?Lookup@Localization@@YA?AVString@1@PBD@Z
	add	esp, 8
...
; 95   : 				strString = (strYearBuffer + "-" + strMonth);
	...
	push	ecx
	lea	edx, DWORD PTR $T218301[esp+1396]
	push	edx
	call	DWORD PTR __imp_??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@PBD@Z
	lea	ecx, DWORD PTR _strMonth$217661[esp+1400]
	push	ecx
	push	eax
	lea	edx, DWORD PTR $T218302[esp+1408]
	push	edx
	...
	lea	ecx, DWORD PTR $T218302[esp+1388]
	mov	BYTE PTR __$EHRec$[esp+1396], 6
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	lea	ecx, DWORD PTR $T218301[esp+1388]
...
; 99   : 				strString = (strMonth + CvString(", ") + strYearBuffer);
	...
	lea	ecx, DWORD PTR $T218303[esp+1392]
	call	??0CvString@@QAE@PBD@Z			; CvString::CvString
	...
	push	eax
	lea	eax, DWORD PTR _strMonth$217661[esp+1392]
	push	eax
	lea	ecx, DWORD PTR $T218304[esp+1396]
	push	ecx
	...
	push	edx
	push	eax
	lea	eax, DWORD PTR $T218305[esp+1408]
	mov	bl, 9
	push	eax
	...
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	lea	ecx, DWORD PTR $T218304[esp+1388]
	mov	BYTE PTR __$EHRec$[esp+1396], 8
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	lea	ecx, DWORD PTR $T218303[esp+1388]
$LN160@setDateStr:
	mov	BYTE PTR __$EHRec$[esp+1396], 5
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
...
; 101  : 		}
	...
	lea	ecx, DWORD PTR _strMonth$217661[esp+1388]
	mov	BYTE PTR __$EHRec$[esp+1396], 4
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	lea	ecx, DWORD PTR _lstrMonth$217659[esp+1388]
	...
	lea	ecx, DWORD PTR _kResult$217656[esp+1388]
...
; 110  : 		strString = GetLocalizedText("TXT_KEY_TIME_TURN", (iTempGameTurn + 1));
	...
	inc	esi
	push	esi
	lea	edx, DWORD PTR $T218306[esp+1392]
...
; 115  : 		CvBaseInfo kSeasonInfo;
	...
	lea	ecx, DWORD PTR _kSeasonInfo$217676[esp+1388]
	call	??0CvBaseInfo@@QAE@XZ			; CvBaseInfo::CvBaseInfo

; 116  : 		Database::SingleResult kResult;

	push	0
	lea	ecx, DWORD PTR _kResult$217677[esp+1392]
...
; 117  : 		DB.SelectAt(kResult, "Seasons", iTempGameTurn % iNumSeasons);
	...
	mov	ecx, DWORD PTR ?gGlobals@@3VCvGlobals@@A+912
	lea	eax, DWORD PTR _kResult$217677[esp+1388]
...
; 118  : 		kSeasonInfo.CacheResult(kResult);
	...
	lea	ecx, DWORD PTR _kResult$217677[esp+1388]
	push	ecx
	lea	ecx, DWORD PTR _kSeasonInfo$217676[esp+1392]
	call	?CacheResult@CvBaseInfo@@QAE_NAAVResults@Database@@@Z ; CvBaseInfo::CacheResult

; 119  : 		const char* Desc = kSeasonInfo.GetDescription();

	lea	ecx, DWORD PTR _kSeasonInfo$217676[esp+1424]
	call	DWORD PTR __imp_?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ
	mov	esi, eax
...
; 122  : 			strString = (strYearBuffer + "-" + CvString(Desc));
	...
	push	edx
	lea	eax, DWORD PTR $T218308[esp+1396]
	push	eax
	mov	BYTE PTR __$EHRec$[esp+1408], 14	; 0000000eH
	call	DWORD PTR __imp_??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@PBD@Z
	push	esi
	push	eax
	lea	ecx, DWORD PTR $T218309[esp+1408]
	mov	bl, 15					; 0000000fH
	push	ecx
	mov	BYTE PTR __$EHRec$[esp+1420], bl
	call	DWORD PTR __imp_??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@0@Z
...
; 126  : 			strString = (CvString(Desc) + CvString(", ") + strYearBuffer);
	...
	lea	ecx, DWORD PTR $T218310[esp+1392]
	call	??0CvString@@QAE@PBD@Z			; CvString::CvString
	mov	edi, eax
	push	esi
	...
	push	edi
	push	eax
	lea	edx, DWORD PTR $T218312[esp+1396]
	push	edx
	...
	push	ecx
	push	eax
	lea	edx, DWORD PTR $T218313[esp+1408]
	mov	bl, 19					; 00000013H
	push	edx
	mov	BYTE PTR __$EHRec$[esp+1420], bl
	call	esi
...
; 134  : 		CvBaseInfo kMonthInfo;
	...
	lea	ecx, DWORD PTR _kMonthInfo$217692[esp+1388]
	call	??0CvBaseInfo@@QAE@XZ			; CvBaseInfo::CvBaseInfo

; 135  : 		Database::SingleResult kResult;

	push	0
	lea	ecx, DWORD PTR _kResult$217693[esp+1392]
...
; 136  : 		DB.SelectAt(kResult, "Months", iTempGameTurn % iNumMonths);
	...
	idiv	edi
	mov	ecx, DWORD PTR ?gGlobals@@3VCvGlobals@@A+912
	lea	eax, DWORD PTR _kResult$217693[esp+1388]
...
; 137  : 		kMonthInfo.CacheResult(kResult);
	...
	lea	ecx, DWORD PTR _kResult$217693[esp+1388]
	push	ecx
	lea	ecx, DWORD PTR _kMonthInfo$217692[esp+1392]
	call	?CacheResult@CvBaseInfo@@QAE_NAAVResults@Database@@@Z ; CvBaseInfo::CacheResult

; 138  : 
; 139  : 		const char* Descr = kMonthInfo.GetDescription();

	lea	ecx, DWORD PTR _kMonthInfo$217692[esp+1424]
	call	DWORD PTR __imp_?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ
	mov	esi, eax
...
; 143  : 			strString = (strYearBuffer + "-" + CvString(Descr));
	...
	lea	edx, DWORD PTR _strYearBuffer$[esp+1392]
	push	edx
	lea	eax, DWORD PTR $T218315[esp+1396]
	push	eax
	mov	BYTE PTR __$EHRec$[esp+1408], 23	; 00000017H
	call	DWORD PTR __imp_??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@PBD@Z
	push	esi
	push	eax
	lea	ecx, DWORD PTR $T218316[esp+1408]
	mov	bl, 24					; 00000018H
	push	ecx
	mov	BYTE PTR __$EHRec$[esp+1420], bl
	call	DWORD PTR __imp_??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@0@Z
...
; 147  : 			strString = (CvString(Descr) + CvString(", ") + strYearBuffer);
	...
	lea	ecx, DWORD PTR $T218317[esp+1392]
	call	??0CvString@@QAE@PBD@Z			; CvString::CvString
	mov	edi, eax
	push	esi
	...
	push	edi
	push	eax
	lea	edx, DWORD PTR $T218319[esp+1396]
	push	edx
	...
	push	ecx
	push	eax
	lea	edx, DWORD PTR $T218320[esp+1408]
	mov	bl, 28					; 0000001cH
	push	edx
	mov	BYTE PTR __$EHRec$[esp+1420], bl
	call	esi
...
; 156  : 		strWeekBuffer = GetLocalizedText("TXT_KEY_TIME_WEEK", ((iTempGameTurn % GC.getWEEKS_PER_MONTHS()) + 1));
	...
	lea	eax, DWORD PTR $T218321[esp+1388]
	inc	edx
	push	edx
...
; 160  : 		CvBaseInfo kCalendarInfo;
	...
	lea	ecx, DWORD PTR _kCalendarInfo$217711[esp+1388]
	cdq
	idiv	edi
	mov	esi, edx
	call	??0CvBaseInfo@@QAE@XZ			; CvBaseInfo::CvBaseInfo
...
; 161  : 		Database::SingleResult kResult;
	...
	push	0
	lea	ecx, DWORD PTR _kResult$217712[esp+1392]
...
; 163  : 		DB.SelectAt(kResult, "Months", idx);
	...
	lea	ecx, DWORD PTR _kResult$217712[esp+1396]
	push	ecx
	mov	ecx, DWORD PTR ?gGlobals@@3VCvGlobals@@A+912
...
; 164  : 		kCalendarInfo.CacheResult(kResult);
	...
	lea	edx, DWORD PTR _kResult$217712[esp+1388]
	push	edx
	lea	ecx, DWORD PTR _kCalendarInfo$217711[esp+1392]
	call	?CacheResult@CvBaseInfo@@QAE_NAAVResults@Database@@@Z ; CvBaseInfo::CacheResult

; 165  : 
; 166  : 		const char* Descr = kCalendarInfo.GetDescription();

	lea	ecx, DWORD PTR _kCalendarInfo$217711[esp+1424]
	call	DWORD PTR __imp_?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ
...
; 171  : 			strString = (strYearBuffer + "-" + CvString(Descr) + "-" + strWeekBuffer);
	...
	push	eax
	lea	ecx, DWORD PTR $T218323[esp+1396]
	push	ecx
	...
	push	eax
	lea	eax, DWORD PTR $T218325[esp+1420]
	push	eax
	...
	push	ecx
	push	eax
	lea	edx, DWORD PTR $T218326[esp+1432]
	mov	bl, 36					; 00000024H
	push	edx
...
; 175  : 			strString = (strWeekBuffer + ", " + CvString(Descr) + ", " + strYearBuffer);
	...
	lea	ecx, DWORD PTR $T218327[esp+1392]
	call	??0CvString@@QAE@PBD@Z			; CvString::CvString
	mov	esi, eax
	mov	edi, DWORD PTR __imp_??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@PBD@Z
	...
	push	eax
	lea	ecx, DWORD PTR $T218328[esp+1396]
	push	ecx
	...
	mov	esi, DWORD PTR __imp_??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@0@Z
	push	eax
	lea	edx, DWORD PTR $T218329[esp+1408]
	push	edx
	mov	BYTE PTR __$EHRec$[esp+1420], 39	; 00000027H
	call	esi
	push	OFFSET $SG217729
	push	eax
	lea	eax, DWORD PTR $T218330[esp+1420]
	push	eax
	...
	push	ecx
	push	eax
	lea	edx, DWORD PTR $T218331[esp+1432]
	mov	bl, 41					; 00000029H
	push	edx
	mov	BYTE PTR __$EHRec$[esp+1444], bl
	call	esi
...
$LN162@setDateStr:
	lea	ecx, DWORD PTR _kResult$217712[esp+1388]
	call	DWORD PTR __imp_??1Results@Database@@UAE@XZ
	lea	ecx, DWORD PTR _kCalendarInfo$217711[esp+1388]
	mov	BYTE PTR __$EHRec$[esp+1396], 1
	call	??1CvBaseInfo@@QAE@XZ
...
__unwindfunclet$?setDateStr@CvGameTextMgr@@SAXAAVCvString@@H_NW4CalendarTypes@@HW4GameSpeedTypes@@@Z$2:
	lea	ecx, DWORD PTR _kResult$217656[ebp]
