; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\Users\EnormousApplePie\Desktop\Cleanup (v1)\Lekmod Files\Lekmod DLL versions\v30\LEKMOD_DLL\CvGameCoreDLL_Expansion2\CvPopupReturn.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; 40   : 		_THROW_NCEE(std::bad_alloc, NULL);
	...
	lea	eax, DWORD PTR $T218609[esp+8]
	push	eax
	lea	ecx, DWORD PTR $T218604[esp+16]
	mov	DWORD PTR $T218609[esp+12], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@ABQBD@Z
	push	OFFSET __TI2?AVbad_alloc@std@@
	lea	ecx, DWORD PTR $T218604[esp+16]
	push	ecx
	mov	DWORD PTR $T218604[esp+20], OFFSET ??_7bad_alloc@std@@6B@
...
; 1260 : 		_THROW(length_error, "vector<T> too long");
	...
	lea	ecx, DWORD PTR $T218679[esp+84]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z
	lea	ecx, DWORD PTR $T218678[esp+80]
	mov	DWORD PTR __$EHRec$[esp+88], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@XZ
	lea	eax, DWORD PTR $T218679[esp+80]
	push	eax
	lea	ecx, DWORD PTR $T218678[esp+96]
	mov	BYTE PTR __$EHRec$[esp+92], 1
	mov	DWORD PTR $T218678[esp+84], OFFSET ??_7logic_error@std@@6B@
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@ABV01@@Z
	push	OFFSET __TI3?AVlength_error@std@@
	lea	ecx, DWORD PTR $T218678[esp+84]
	push	ecx
	mov	BYTE PTR __$EHRec$[esp+96], 0
	mov	DWORD PTR $T218678[esp+88], OFFSET ??_7length_error@std@@6B@
	call	__CxxThrowException@8
$LN13@Xlen:
$LN12@Xlen:
	int	3
...
; 40   : 		_THROW_NCEE(std::bad_alloc, NULL);
	...
	lea	eax, DWORD PTR $T218742[esp+8]
	push	eax
	lea	ecx, DWORD PTR $T218738[esp+16]
	mov	DWORD PTR $T218742[esp+12], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@ABQBD@Z
	push	OFFSET __TI2?AVbad_alloc@std@@
	lea	ecx, DWORD PTR $T218738[esp+16]
	push	ecx
	mov	DWORD PTR $T218738[esp+20], OFFSET ??_7bad_alloc@std@@6B@
	call	__CxxThrowException@8
$LN9@Allocate@2:
$LN8@Allocate@2:
	int	3
...
; Function compile flags: /Ogtpy
; File c:\users\enormousapplepie\desktop\cleanup (v1)\lekmod files\lekmod dll versions\v30\lekmod_dll\cvgamecoredll_expansion2\cvpopupreturn.h
...
; Function compile flags: /Ogtpy
; File c:\users\enormousapplepie\desktop\cleanup (v1)\lekmod files\lekmod dll versions\v30\lekmod_dll\cvgamecoredll_expansion2\cvpopupreturn.cpp
...
; 200  : 	kStream <<  m_aiBitField.size() ;
	...
	lea	eax, DWORD PTR $T218933[esp+12]
	sar	edx, 2
	push	eax
	mov	ecx, edi
	mov	DWORD PTR $T218933[esp+16], edx
	call	?Write@FDataStream@@IAEXABI@Z		; FDataStream::Write
...
; 206  : 	kStream <<  m_aszEditBoxString.size() ;
	...
	mov	eax, edx
	shr	eax, 31					; 0000001fH
	lea	ecx, DWORD PTR $T218934[esp+12]
	add	eax, edx
	push	ecx
	mov	ecx, edi
	mov	DWORD PTR $T218934[esp+16], eax
	call	?Write@FDataStream@@IAEXABI@Z		; FDataStream::Write
...
; 218  : 	kStream <<  m_aiPulldownID.size() ;
	...
	lea	edx, DWORD PTR $T218936[esp+12]
	sar	ecx, 2
	mov	DWORD PTR $T218936[esp+12], ecx
	push	edx
	mov	ecx, edi
	call	?Write@FDataStream@@IAEXABI@Z		; FDataStream::Write
...
; 224  : 	kStream <<  m_aiListBoxID.size() ;
	...
	lea	edx, DWORD PTR $T218937[esp+12]
	sar	ecx, 2
	mov	DWORD PTR $T218937[esp+12], ecx
	push	edx
	mov	ecx, edi
	call	?Write@FDataStream@@IAEXABI@Z		; FDataStream::Write
...
; 230  : 	kStream <<  m_aiSpinBoxID.size() ;
	...
	lea	edx, DWORD PTR $T218938[esp+12]
	sar	ecx, 2
	mov	DWORD PTR $T218938[esp+12], ecx
	push	edx
	mov	ecx, edi
	call	?Write@FDataStream@@IAEXABI@Z		; FDataStream::Write
...
; 236  : 	kStream <<  m_aiButtonID.size() ;
	...
	lea	edx, DWORD PTR $T218939[esp+12]
	sar	ecx, 2
	mov	DWORD PTR $T218939[esp+12], ecx
	push	edx
	mov	ecx, edi
	call	?Write@FDataStream@@IAEXABI@Z		; FDataStream::Write
...
; 1260 : 		_THROW(length_error, "vector<T> too long");
	...
	push	OFFSET ??_C@_0BD@OLBABOEK@vector?$DMT?$DO?5too?5long?$AA@
	lea	ecx, DWORD PTR $T219141[esp+84]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z
	lea	ecx, DWORD PTR $T219140[esp+80]
	mov	DWORD PTR __$EHRec$[esp+88], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@XZ
	lea	eax, DWORD PTR $T219141[esp+80]
	push	eax
	lea	ecx, DWORD PTR $T219140[esp+96]
	mov	BYTE PTR __$EHRec$[esp+92], 1
	mov	DWORD PTR $T219140[esp+84], OFFSET ??_7logic_error@std@@6B@
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@ABV01@@Z
	push	OFFSET __TI3?AVlength_error@std@@
	lea	ecx, DWORD PTR $T219140[esp+84]
	push	ecx
	mov	BYTE PTR __$EHRec$[esp+96], 0
	mov	DWORD PTR $T219140[esp+88], OFFSET ??_7length_error@std@@6B@
	call	__CxxThrowException@8
$LN13@Xlen@2:
$LN12@Xlen@2:
	int	3
...
; 52   : 	::new (_Vptr) _T1(_Val);
	...
	mov	DWORD PTR $T219213[esp+16], ecx
...
; 155  : 		_Construct(_Ptr, _Val);
	...
	mov	ecx, DWORD PTR __Ptr$[esp+12]
	mov	DWORD PTR __Vptr$219554[esp+12], ecx
	mov	DWORD PTR $T219557[esp+16], ecx
	mov	DWORD PTR __$EHRec$[esp+24], 0
	test	ecx, ecx
...
__unwindfunclet$?construct@?$allocator@VCvString@@@std@@QAEXPAVCvString@@ABV3@@Z$0:
	mov	eax, DWORD PTR __Vptr$219554[ebp-4]
	push	eax
	mov	ecx, DWORD PTR $T219557[ebp]
	push	ecx
	call	??3@YAXPAX0@Z				; operator delete
	add	esp, 8
	ret	0
...
; 131  : 		_Al.construct(_Dest, *_First);
	...
	mov	DWORD PTR __Vptr$219983[ebp], esi
	mov	DWORD PTR $T219986[ebp], esi
...
__unwindfunclet$??$_Uninit_copy@PAVCvString@@PAV1@V?$allocator@VCvString@@@std@@@std@@YAPAVCvString@@PAV1@00AAV?$allocator@VCvString@@@0@U_Nonscalar_ptr_iterator_tag@0@U_Range_checked_iterator_tag@0@@Z$2:
	mov	eax, DWORD PTR __Vptr$219983[ebp]
	push	eax
	mov	ecx, DWORD PTR $T219986[ebp]
	push	ecx
	call	??3@YAXPAX0@Z				; operator delete
	add	esp, 8
	ret	0
...
; 404  : 		_Al.construct(_First, _Val);
	...
	mov	DWORD PTR __Vptr$220402[ebp], esi
	mov	DWORD PTR $T220405[ebp], esi
	mov	BYTE PTR __$EHRec$[ebp+12], 1
	cmp	esi, ebx
...
__unwindfunclet$??$_Uninit_fill_n@PAVCvString@@IV1@V?$allocator@VCvString@@@std@@@std@@YAXPAVCvString@@IABV1@AAV?$allocator@VCvString@@@0@U_Nonscalar_ptr_iterator_tag@0@U_Range_checked_iterator_tag@0@@Z$2:
	mov	eax, DWORD PTR __Vptr$220402[ebp]
	push	eax
	mov	ecx, DWORD PTR $T220405[ebp]
	push	ecx
	call	??3@YAXPAX0@Z				; operator delete
	add	esp, 8
	ret	0
...
; 822  : 		_STD _Ptr_cat(_First, _Dest), _STD _Range_checked_iterator_tag()));
	...
	mov	BYTE PTR $T220456[esp+4], 0
	mov	eax, DWORD PTR $T220456[esp+4]
	mov	ecx, DWORD PTR __Cat$220461[esp+4]
	push	eax
	mov	eax, DWORD PTR __Dest$[esp+4]
	push	ecx
...
; 942  : 		_STD _Ptr_cat(_First, _First), _STD _Range_checked_iterator_tag());
	...
	mov	edx, DWORD PTR __Al$[esp]
	mov	BYTE PTR $T220690[esp+4], 0
	mov	eax, DWORD PTR $T220690[esp+4]
	mov	ecx, DWORD PTR __Cat$220695[esp+4]
	push	eax
...
; 207  : 	return (_STDEXT unchecked_uninitialized_copy(_First, _Last, _Dest, _Al));
	...
	mov	ecx, DWORD PTR __Cat$220712[esp]
	mov	edx, DWORD PTR __Al$[esp]
	mov	BYTE PTR $T220708[esp+4], 0
	mov	eax, DWORD PTR $T220708[esp+4]
	push	eax
	mov	eax, DWORD PTR __Dest$[esp+4]
	push	ecx
	mov	ecx, DWORD PTR __Last$[esp+8]
...
; 721  : 			erase(begin() + _Newsize, end());
	...
	push	esi
	push	eax
	lea	eax, DWORD PTR $T220914[esp+12]
	push	eax
...
; 1254 : 		_STDEXT unchecked_uninitialized_fill_n(_Ptr, _Count, _Val, this->_Alval);
	...
	mov	edx, DWORD PTR __Cat$221082[esp]
	push	esi
	mov	esi, DWORD PTR __Count$[esp+4]
	push	edi
	mov	edi, DWORD PTR __Ptr$[esp+8]
	mov	BYTE PTR $T221078[esp+12], 0
	mov	eax, DWORD PTR $T221078[esp+12]
	push	eax
	mov	eax, DWORD PTR __Val$[esp+12]
	push	edx
	push	ecx
...
; 864  : 		_STD _Move_cat(_Dest), _STD _Range_checked_iterator_tag()));
	...
	mov	ecx, DWORD PTR __Cat$221119[esp]
	mov	edx, DWORD PTR __Al$[esp]
	mov	BYTE PTR $T221115[esp+4], 0
	mov	eax, DWORD PTR $T221115[esp+4]
	push	eax
	mov	eax, DWORD PTR __Dest$[esp+4]
	push	ecx
	mov	ecx, DWORD PTR __Last$[esp+8]
...
; 713  : 		resize(_Newsize, _Ty());
	...
	sub	eax, edi
	sar	eax, 2
	mov	DWORD PTR $T221251[esp+12], 0
	cmp	edx, eax
	jbe	SHORT $LN38@resize@2
	lea	edi, DWORD PTR $T221251[esp+12]
	push	edi
	sub	edx, eax
	push	edx
	push	esi
...
; 713  : 		resize(_Newsize, _Ty());
	...
	push	esi
	push	eax
	lea	eax, DWORD PTR $T221232[esp+16]
	push	eax
	call	?erase@?$vector@HV?$allocator@H@std@@@std@@QAE?AV?$_Vector_iterator@HV?$allocator@H@std@@@2@V?$_Vector_const_iterator@HV?$allocator@H@std@@@2@0@Z ; std::vector<int,std::allocator<int> >::erase
$LN3@resize@2:
	pop	edi
...
; 1148 : 			_Ptr, this->_Alval));
	...
	mov	edx, DWORD PTR __Cat$221604[esp]
	mov	BYTE PTR $T221600[esp+4], 0
	mov	eax, DWORD PTR $T221600[esp+4]
	push	eax
	mov	eax, DWORD PTR __Ptr$[esp+4]
	push	edx
...
_TEXT	SEGMENT
__Tmp$217761 = -92					; size = 28
__Tmp$217751 = -64					; size = 28
__Whereoff$217737 = -36					; size = 4
_this$ = -32						; size = 4
__Ncopied$217738 = -28					; size = 4
__Newvec$217736 = -24					; size = 4
__Capacity$ = -20					; size = 4
__$EHRec$ = -16						; size = 16
__Cat$221820 = 8					; size = 1
__Cat$221748 = 8					; size = 1
__Where$ = 8						; size = 4
tv525 = 12						; size = 4
__Count$ = 12						; size = 4
$T221816 = 16						; size = 1
...
; 1178 : 			_Ufill(_Newvec + _Whereoff, _Count, _Val);	// add new stuff
	...
	add	esp, 8
	mov	DWORD PTR __Ncopied$217738[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+12], eax
	push	edx
	lea	eax, DWORD PTR [ebx*8]
	mov	DWORD PTR __Newvec$217736[ebp], ecx
	sub	eax, ebx
	lea	ecx, DWORD PTR [ecx+eax*4]
	push	edi
	push	ecx
	mov	ecx, esi
	mov	DWORD PTR __Whereoff$217737[ebp], ebx
...
; 1181 : 				_Newvec);	// move prefix
	...
	mov	ecx, DWORD PTR __Cat$221748[ebp]
	mov	eax, DWORD PTR [esi+4]
	mov	BYTE PTR $T221744[ebp], 0
	mov	edx, DWORD PTR $T221744[ebp]
	push	edx
	mov	edx, DWORD PTR __Newvec$217736[ebp]
	push	ecx
	...
	push	ecx
	push	eax
	mov	DWORD PTR __Ncopied$217738[ebp], 1
	call	??$_Uninit_copy@PAVCvString@@PAV1@V?$allocator@VCvString@@@std@@@std@@YAPAVCvString@@PAV1@00AAV?$allocator@VCvString@@@0@U_Nonscalar_ptr_iterator_tag@0@U_Range_checked_iterator_tag@0@@Z ; std::_Uninit_copy<CvString *,CvString *,std::allocator<CvString> >
...
; 1184 : 				_Newvec + (_Whereoff + _Count));	// move suffix
	...
	mov	ecx, DWORD PTR __Newvec$217736[ebp]
	mov	eax, DWORD PTR [esi+8]
	add	ebx, edi
	add	esp, 24					; 00000018H
	...
	mov	BYTE PTR $T221816[ebp], 0
	mov	edx, DWORD PTR $T221816[ebp]
	push	edx
	mov	edx, DWORD PTR __Cat$221820[ebp]
	push	edx
	push	esi
	push	ecx
	push	eax
	...
	push	eax
	mov	DWORD PTR __Ncopied$217738[ebp], 2
	call	??$_Uninit_copy@PAVCvString@@PAV1@V?$allocator@VCvString@@@std@@@std@@YAPAVCvString@@PAV1@00AAV?$allocator@VCvString@@@0@U_Nonscalar_ptr_iterator_tag@0@U_Range_checked_iterator_tag@0@@Z ; std::_Uninit_copy<CvString *,CvString *,std::allocator<CvString> >
...
; 1205 : 			_Myend = _Newvec + _Capacity;
	...
	sub	ecx, eax
	mov	eax, DWORD PTR __Newvec$217736[ebp]
	lea	edx, DWORD PTR [eax+ecx*4]
...
; 1186 : 			if (1 < _Ncopied)
	...
	mov	ebx, DWORD PTR __Ncopied$217738[ebp]
	cmp	ebx, 1

; 1187 : 				_Destroy(_Newvec, _Newvec + _Whereoff);

	mov	esi, DWORD PTR __Whereoff$217737[ebp]
	mov	edi, DWORD PTR __Newvec$217736[ebp]
...
; 1211 : 			_Ty _Tmp = _Val;	// in case _Val is in sequence
	...
	push	ecx
	lea	ecx, DWORD PTR __Tmp$217751[ebp]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@ABV01@@Z
...
; 1218 : 				_Tmp);	// insert new stuff off end
	...
	lea	edx, DWORD PTR __Tmp$217751[ebp]
	push	edx
	mov	eax, -1840700269			; 92492493H
	imul	ecx
	add	edx, ecx
...
; 1235 : 			_Ty _Tmp = _Val;	// in case _Val is in sequence
	...
	mov	eax, DWORD PTR __Val$[ebp]
	push	eax
	lea	ecx, DWORD PTR __Tmp$217761[ebp]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@ABV01@@Z
...
; 1248 : 				_Tmp);	// insert into hole
	...
	lea	eax, DWORD PTR __Tmp$217761[ebp]
	push	eax
	mov	eax, DWORD PTR __Where$[ebp]
	add	ebx, eax
	push	ebx
...
; 721  : 			erase(begin() + _Newsize, end());
	...
	push	eax
	lea	edx, DWORD PTR $T221877[esp+28]
	push	edx
...
; 713  : 		resize(_Newsize, _Ty());
	...
	mov	esi, ecx
	mov	ecx, esp
	mov	DWORD PTR $T221966[esp+36], esp
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
...
; 24   : 		CvPopup_SetAtGrow(m_aiSelectedRadioButton, iI, popupReturn.getSelectedRadioButton(iI));
	...
	mov	DWORD PTR $T223382[esp+40], 0
	cmp	edi, eax
	jbe	SHORT $LN942@PopupRetur
	lea	edx, DWORD PTR $T223382[esp+40]
	push	edx
	mov	edx, edi
	sub	edx, eax
	push	edx
...
$LN942@PopupRetur:
	...
	lea	eax, DWORD PTR [eax+edx+4]
	mov	DWORD PTR $T223432[esp+40], eax
	cmp	eax, ecx
	je	SHORT $LN929@PopupRetur
	mov	ebp, DWORD PTR $T223432[esp+40]
	mov	eax, ecx
	sub	eax, ecx
	sar	eax, 2
	lea	edx, DWORD PTR [eax*4]
	add	ebp, edx
	mov	DWORD PTR __Result$223387[esp+40], ebp
	test	eax, eax
	jle	SHORT $LN927@PopupRetur
	mov	eax, DWORD PTR $T223432[esp+40]
	push	edx
	push	ecx
	push	edx
	push	eax
...
$LN927@PopupRetur:
	...
	mov	ecx, DWORD PTR __Result$223387[esp+40]
...
; 29   : 		CvPopup_SetAtGrow(m_aiBitField, iI, popupReturn.getCheckboxBitfield(iI));
	...
	mov	DWORD PTR $T223776[esp+40], eax
	mov	eax, ecx
	sub	eax, edx
	sar	eax, 2
	cmp	edi, eax
	jbe	SHORT $LN943@PopupRetur
	lea	edx, DWORD PTR $T223776[esp+40]
	push	edx
	mov	edx, edi
	sub	edx, eax
	push	edx
...
$LN943@PopupRetur:
	...
	mov	DWORD PTR $T223786[esp+40], eax
	cmp	eax, ecx
	je	SHORT $LN931@PopupRetur
	mov	ebp, DWORD PTR $T223786[esp+40]
	mov	eax, ecx
	sub	eax, ecx
	sar	eax, 2
	lea	edx, DWORD PTR [eax*4]
	...
	push	edx
	push	ecx
	mov	ecx, DWORD PTR $T223786[esp+48]
	push	edx
	push	ecx
	call	DWORD PTR __imp__memmove_s
	add	esp, 16					; 00000010H
...
; 34   : 		CvPopup_SetAtGrow(m_aszEditBoxString, iI, popupReturn.getEditBoxString(iI));
	...
	sub	esp, 28					; 0000001cH
	mov	ecx, esp
	mov	DWORD PTR $T223898[esp+68], esp
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	lea	edx, DWORD PTR [edi+1]
	push	edx
	mov	ecx, ebx
...
; 39   : 		CvPopup_SetAtGrow(m_aiSpinnerWidgetValues, iI, popupReturn.getSpinnerWidgetValue(iI));
	...
	sar	eax, 2
	lea	edx, DWORD PTR [edi+1]
	mov	DWORD PTR $T224228[esp+36], 0
	cmp	edx, eax
	jbe	SHORT $LN944@PopupRetur
	lea	ebx, DWORD PTR $T224228[esp+36]
	push	ebx
	sub	edx, eax
	push	edx
	push	ecx
...
$LN944@PopupRetur:
	...
	mov	DWORD PTR $T224242[esp+36], ebx
	cmp	ebx, ecx
	...
	push	edx
	push	ecx
	mov	ecx, DWORD PTR $T224242[esp+44]
	push	edx
	push	ecx
	call	DWORD PTR __imp__memmove_s
	add	esp, 16					; 00000010H
...
; 44   : 		CvPopup_SetAtGrow(m_aiPulldownID, iI, popupReturn.getSelectedPullDownValue(iI));
	...
	sub	eax, ebx
	sar	eax, 2
	mov	DWORD PTR $T224632[esp+40], 0
	cmp	edi, eax
	jbe	SHORT $LN945@PopupRetur
	lea	ebx, DWORD PTR $T224632[esp+40]
	push	ebx
	mov	ebx, edi
	sub	ebx, eax
	push	ebx
...
$LN945@PopupRetur:
	...
	mov	DWORD PTR $T224641[esp+40], ebx
	cmp	ebx, ecx
	...
	mov	eax, DWORD PTR $T224641[esp+40]
	push	edx
	push	ecx
	push	edx
	push	eax
...
; 49   : 		CvPopup_SetAtGrow(m_aiListBoxID, iI, popupReturn.getSelectedListBoxValue(iI));
	...
	sar	eax, 2
	lea	edx, DWORD PTR [edi+1]
	mov	DWORD PTR $T225027[esp+36], 0
	cmp	edx, eax
	jbe	SHORT $LN946@PopupRetur
	lea	ebx, DWORD PTR $T225027[esp+36]
	push	ebx
	sub	edx, eax
	push	edx
	push	ecx
...
$LN946@PopupRetur:
	...
	lea	ebx, DWORD PTR [ebx+edi*4+4]
	mov	DWORD PTR $T225041[esp+36], ebx
	cmp	ebx, ecx
	...
	mov	eax, DWORD PTR $T225041[esp+36]
	push	edx
	push	ecx
	push	edx
	push	eax
...
; 54   : 		CvPopup_SetAtGrow(m_aiSpinBoxID, iI, popupReturn.getSpinnerWidgetValue(iI));
	...
	sar	eax, 2
	lea	edx, DWORD PTR [edi+1]
	mov	DWORD PTR $T225431[esp+36], 0
	cmp	edx, eax
	jbe	SHORT $LN947@PopupRetur
	lea	ebx, DWORD PTR $T225431[esp+36]
	push	ebx
	sub	edx, eax
	push	edx
	push	ecx
...
$LN947@PopupRetur:
	...
	lea	ebx, DWORD PTR [ebx+edi*4+4]
	mov	DWORD PTR $T225481[esp+36], ebx
	cmp	ebx, ecx
	...
	push	ecx
	push	edx
	mov	edx, DWORD PTR $T225481[esp+48]
	push	edx
	call	DWORD PTR __imp__memmove_s
	add	esp, 16					; 00000010H
$LN820@PopupRetur:
...
; 59   : 		CvPopup_SetAtGrow(m_aiButtonID, iI, popupReturn.GetButtonClicked(iI));
	...
	sub	eax, ebx
	sar	eax, 2
	mov	DWORD PTR $T225835[esp+40], 0
	cmp	edi, eax
	jbe	SHORT $LN948@PopupRetur
	lea	ebx, DWORD PTR $T225835[esp+40]
	push	ebx
	mov	ebx, edi
	sub	ebx, eax
	push	ebx
...
$LN948@PopupRetur:
	...
	mov	DWORD PTR $T225845[esp+40], ebx
	cmp	ebx, ecx
	...
	mov	eax, DWORD PTR $T225845[esp+40]
	push	edx
	push	ecx
	push	edx
	push	eax
...
_TEXT	SEGMENT
_this$ = -8						; size = 4
__Result$228800 = -4					; size = 4
$T228728 = -4						; size = 4
__Result$227554 = -4					; size = 4
$T227525 = -4						; size = 4
__Result$226741 = -4					; size = 4
$T226669 = -4						; size = 4
$T226275 = -4						; size = 4
tv2848 = 8						; size = 4
tv2719 = 8						; size = 4
tv2617 = 8						; size = 4
tv2574 = 8						; size = 4
__Result$228406 = 8					; size = 4
__Result$228002 = 8					; size = 4
$T228324 = 8						; size = 4
$T227920 = 8						; size = 4
__Result$227203 = 8					; size = 4
$T227121 = 8						; size = 4
$T226791 = 8						; size = 4
_source$ = 8						; size = 4
...
; 70   : 		CvPopup_SetAtGrow(m_aiSelectedRadioButton, iI, source.getSelectedRadioButton(iI));
	...
	mov	DWORD PTR $T226275[esp+24], 0
	cmp	edi, eax
	jbe	SHORT $LN630@operator@2
	lea	edx, DWORD PTR $T226275[esp+24]
	push	edx
	mov	edx, edi
	sub	edx, eax
	push	edx
...
; 75   : 		CvPopup_SetAtGrow(m_aiBitField, iI, source.getCheckboxBitfield(iI));
	...
	sub	eax, ebx
	sar	eax, 2
	mov	DWORD PTR $T226669[esp+24], 0
	cmp	edi, eax
	jbe	SHORT $LN631@operator@2
	lea	edx, DWORD PTR $T226669[esp+24]
	push	edx
	mov	edx, edi
	sub	edx, eax
	push	edx
...
$LN631@operator@2:
	...
	mov	DWORD PTR __Result$226741[esp+24], ebp
	test	eax, eax
...
$LN180@operator@2:
	mov	ebp, DWORD PTR _this$[esp+24]
	mov	ecx, DWORD PTR __Result$226741[esp+24]
	add	ebp, 16					; 00000010H
	mov	DWORD PTR [ebp+8], ecx
$LN155@operator@2:
	mov	eax, DWORD PTR _this$[esp+24]
...
$LL24@operator@2:
	...
	sub	esp, 28					; 0000001cH
	mov	ecx, esp
	mov	DWORD PTR $T226791[esp+48], esp
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	lea	edx, DWORD PTR [edi+1]
	push	edx
	mov	ecx, ebp
...
; 85   : 		CvPopup_SetAtGrow(m_aiSpinnerWidgetValues, iI, source.getSpinnerWidgetValue(iI));
	...
	sar	eax, 2
	lea	edx, DWORD PTR [edi+1]
	mov	DWORD PTR $T227121[esp+20], 0
	cmp	edx, eax
	jbe	SHORT $LN632@operator@2
	lea	ebx, DWORD PTR $T227121[esp+20]
	push	ebx
	sub	edx, eax
	push	edx
	push	ecx
...
$LN632@operator@2:
	...
	lea	edx, DWORD PTR [eax*4]
	lea	ebp, DWORD PTR [edx+ebx]
	mov	DWORD PTR __Result$227203[esp+20], ebp
	test	eax, eax
...
$LN284@operator@2:
	mov	ebp, DWORD PTR _this$[esp+24]
	mov	eax, DWORD PTR __Result$227203[esp+20]
	add	ebp, 48					; 00000030H
	mov	DWORD PTR [ebp+8], eax
$LN259@operator@2:
	mov	ecx, DWORD PTR [esi+120]
...
; 90   : 		CvPopup_SetAtGrow(m_aiPulldownID, iI, source.getSelectedPullDownValue(iI));
	...
	sub	eax, ebx
	sar	eax, 2
	mov	DWORD PTR $T227525[esp+24], 0
	cmp	edi, eax
	jbe	SHORT $LN633@operator@2
	lea	edx, DWORD PTR $T227525[esp+24]
	push	edx
	mov	edx, edi
	sub	edx, eax
	push	edx
...
$LN633@operator@2:
	...
	mov	DWORD PTR __Result$227554[esp+24], ebp
	test	eax, eax
...
$LN365@operator@2:
	mov	ebp, DWORD PTR _this$[esp+24]
	mov	ecx, DWORD PTR __Result$227554[esp+24]
	add	ebp, 64					; 00000040H
	mov	DWORD PTR [ebp+8], ecx
$LN340@operator@2:
	mov	eax, DWORD PTR _this$[esp+24]
...
; 95   : 		CvPopup_SetAtGrow(m_aiListBoxID, iI, source.getSelectedListBoxValue(iI));
	...
	sar	eax, 2
	lea	edx, DWORD PTR [edi+1]
	mov	DWORD PTR $T227920[esp+20], 0
	cmp	edx, eax
	jbe	SHORT $LN634@operator@2
	lea	ebx, DWORD PTR $T227920[esp+20]
	push	ebx
	sub	edx, eax
	push	edx
	push	ecx
...
$LN634@operator@2:
	...
	lea	edx, DWORD PTR [eax*4]
	lea	ebp, DWORD PTR [ebx+edx]
	mov	DWORD PTR __Result$228002[esp+20], ebp
	test	eax, eax
...
$LN442@operator@2:
	mov	ebp, DWORD PTR _this$[esp+24]
	mov	ecx, DWORD PTR __Result$228002[esp+20]
	add	ebp, 80					; 00000050H
	mov	DWORD PTR [ebp+8], ecx
$LN417@operator@2:
	mov	edx, DWORD PTR [esi+88]
...
; 100  : 		CvPopup_SetAtGrow(m_aiSpinBoxID, iI, source.getSpinnerWidgetValue(iI));
	...
	sar	eax, 2
	lea	edx, DWORD PTR [edi+1]
	mov	DWORD PTR $T228324[esp+20], 0
	cmp	edx, eax
	jbe	SHORT $LN635@operator@2
	lea	ebp, DWORD PTR $T228324[esp+20]
	push	ebp
	sub	edx, eax
	push	edx
	push	ecx
...
$LN635@operator@2:
	...
	lea	edx, DWORD PTR [eax*4]
	lea	ebx, DWORD PTR [edx+ebp]
	mov	DWORD PTR __Result$228406[esp+20], ebx
	test	eax, eax
...
$LN523@operator@2:
	mov	ebx, DWORD PTR _this$[esp+24]
	mov	eax, DWORD PTR __Result$228406[esp+20]
	add	ebx, 112				; 00000070H
	mov	DWORD PTR [ebx+8], eax
$LN498@operator@2:
	mov	ecx, DWORD PTR [esi+120]
...
; 105  : 		CvPopup_SetAtGrow(m_aiButtonID, iI, source.GetButtonClicked(iI));
	...
	sub	eax, edx
	sar	eax, 2
	mov	DWORD PTR $T228728[esp+24], 0
	cmp	edi, eax
	jbe	SHORT $LN636@operator@2
	lea	edx, DWORD PTR $T228728[esp+24]
	push	edx
	mov	edx, edi
	sub	edx, eax
	push	edx
...
$LN636@operator@2:
	...
	lea	edx, DWORD PTR [eax*4]
	lea	ebp, DWORD PTR [ebx+edx]
	mov	DWORD PTR __Result$228800[esp+24], ebp
	test	eax, eax
...
$LN604@operator@2:
	mov	ebp, DWORD PTR _this$[esp+24]
	mov	ecx, DWORD PTR __Result$228800[esp+24]
	add	ebp, 96					; 00000060H
	mov	DWORD PTR [ebp+8], ecx
$LN579@operator@2:
	mov	eax, DWORD PTR _this$[esp+24]
...
; 128  : 		CvPopup_SetAtGrow(m_aiSelectedRadioButton, i, iValue);
	...
	cmp	eax, edi
	jg	SHORT $LN81@read
	mov	DWORD PTR $T229150[esp+80], 0
	cmp	esi, eax
	jbe	SHORT $LN594@read
	lea	edx, DWORD PTR $T229150[esp+80]
	push	edx
	mov	edx, esi
	sub	edx, eax
	push	edx
...
; 135  : 		CvPopup_SetAtGrow(m_aiBitField, i, iValue);
	...
	sub	eax, edi
	sar	eax, 2
	mov	DWORD PTR $T229532[esp+80], 0
	cmp	esi, eax
	jbe	SHORT $LN595@read
	lea	edx, DWORD PTR $T229532[esp+80]
	push	edx
	mov	edx, esi
	sub	edx, eax
	push	edx
...
; 141  : 		CvString strValue;
	...
	lea	ecx, DWORD PTR _strValue$217409[esp+80]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ

; 142  : 		kStream >>  strValue ;

	mov	ecx, DWORD PTR _kStream$[esp+76]
	lea	edx, DWORD PTR _strValue$217409[esp+80]
	push	edx
...
; 143  : 		CvPopup_SetAtGrow(m_aszEditBoxString, i, strValue);
	...
	sub	esp, 28					; 0000001cH
	mov	ecx, esp
	mov	DWORD PTR $T229645[esp+108], esp
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
...
; 150  : 		CvPopup_SetAtGrow(m_aiSpinnerWidgetValues, i, iValue);
	...
	sub	eax, edi
	sar	eax, 2
	mov	DWORD PTR $T229953[esp+80], 0
	cmp	esi, eax
	jbe	SHORT $LN596@read
	lea	edx, DWORD PTR $T229953[esp+80]
	push	edx
	mov	edx, esi
	sub	edx, eax
	push	edx
...
; 157  : 		CvPopup_SetAtGrow(m_aiPulldownID, i, iValue);
	...
	sub	eax, edi
	sar	eax, 2
	mov	DWORD PTR $T230336[esp+80], 0
	cmp	esi, eax
	jbe	SHORT $LN597@read
	lea	edx, DWORD PTR $T230336[esp+80]
	push	edx
	mov	edx, esi
	sub	edx, eax
	push	edx
...
; 164  : 		CvPopup_SetAtGrow(m_aiListBoxID, i, iValue);
	...
	sub	eax, edi
	sar	eax, 2
	mov	DWORD PTR $T230719[esp+80], 0
	cmp	esi, eax
	jbe	SHORT $LN598@read
	lea	edx, DWORD PTR $T230719[esp+80]
	push	edx
	mov	edx, esi
	sub	edx, eax
	push	edx
...
; 171  : 		CvPopup_SetAtGrow(m_aiSpinBoxID, i, iValue);
	...
	sub	eax, edi
	sar	eax, 2
	mov	DWORD PTR $T231102[esp+80], 0
	cmp	esi, eax
	jbe	SHORT $LN599@read
	lea	edx, DWORD PTR $T231102[esp+80]
	push	edx
	mov	edx, esi
	sub	edx, eax
	push	edx
...
; 178  : 		CvPopup_SetAtGrow(m_aiButtonID, i, iValue);
	...
	sub	eax, edi
	sar	eax, 2
	mov	DWORD PTR $T231485[esp+80], 0
	cmp	esi, eax
	jbe	SHORT $LN600@read
	lea	edx, DWORD PTR $T231485[esp+80]
	push	edx
	mov	edx, esi
	sub	edx, eax
	push	edx
...
__unwindfunclet$?read@PopupReturn@@QAEXAAVFDataStream@@@Z$0:
	lea	ecx, DWORD PTR _strValue$217409[ebp]
	jmp	??1CvString@@QAE@XZ			; CvString::~CvString
