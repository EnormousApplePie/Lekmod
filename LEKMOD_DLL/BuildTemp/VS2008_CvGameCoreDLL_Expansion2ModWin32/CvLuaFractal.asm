...
CONST	SEGMENT
$SG217752 DB	'FRAC_WRAP_X', 00H
$SG217754 DB	'FRAC_WRAP_Y', 00H
$SG217756 DB	'FRAC_PERCENT', 00H
	ORG $+3
$SG217758 DB	'FRAC_POLAR', 00H
	ORG $+1
$SG217760 DB	'FRAC_CENTER_RIFT', 00H
	ORG $+3
$SG217762 DB	'FRAC_INVERT_HEIGHTS', 00H
$SG217769 DB	'Fractal', 00H
$SG217771 DB	'Fractal', 00H
$SG217772 DB	'Create', 00H
	ORG $+1
$SG217773 DB	'CreateRifts', 00H
$SG217795 DB	'GetHeight', 00H
	ORG $+2
$SG217796 DB	'BuildRidges', 00H
$SG217797 DB	'__index', 00H
$SG217798 DB	'__gc', 00H
	ORG $+3
$SG217848 DB	'Invalid number of arguments.', 00H
CONST	ENDS
...
; 112  : 	CvFractal* pFractal = new(ptr) CvFractal();
	...
	mov	DWORD PTR $T217919[esp+28], eax
