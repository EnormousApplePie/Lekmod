...
CONST	SEGMENT
$SG218555 DB	'LOAD ERROR: Unit Type not found', 00H
$SG218639 DB	'%03d, ', 00H
	ORG $+1
$SG218643 DB	', ', 00H
	ORG $+1
$SG218644 DB	', ', 00H
	ORG $+1
$SG218652 DB	'Unknown Unit', 00H
	ORG $+3
$SG218655 DB	'Unit, %s, %d', 00H
	ORG $+3
$SG218659 DB	'Special request for unit of type: %s, %s, %d', 00H
CONST	ENDS
...
; 181  : 	return m_UnitAIWeights.GetWeight(eUnit);
	...
	mov	edx, DWORD PTR [eax+ecx*8]
	mov	eax, DWORD PTR [eax+ecx*8+4]
	mov	DWORD PTR _elem$219887[esp+8], edx
...
_TEXT	SEGMENT
_pLog$218636 = -276					; size = 4
_elem$220029 = -272					; size = 8
_elem$219999 = -272					; size = 8
_strTemp$218658 = -264					; size = 28
$T219897 = -264						; size = 28
_strTempString$218657 = -236				; size = 28
$T219898 = -236						; size = 28
_strDesc$218651 = -208					; size = 28
$T219899 = -208						; size = 28
_strOutBuf$218649 = -180				; size = 28
_strBaseString$218638 = -152				; size = 28
_strTemp$218654 = -124					; size = 28
_playerName$218633 = -96				; size = 28
_cityName$218634 = -68					; size = 28
$T219896 = -40						; size = 28
__$EHRec$ = -12						; size = 12
...
$LN32@LogPossibl:
	push	eax
	lea	ecx, DWORD PTR _playerName$218633[esp+296]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z

; 248  : 		CvString cityName = m_pCity->getName();

	lea	ecx, DWORD PTR _cityName$218634[esp+292]
	push	ecx
...
; 251  : 		FILogFile* pLog = LOGFILEMGR.GetLog(m_pCity->GetCityStrategyAI()->GetLogFileName(playerName, cityName), FILogFile::kDontTimeStamp);
	...
	lea	edx, DWORD PTR _cityName$218634[esp+292]
	mov	edi, eax
	push	edx
	lea	eax, DWORD PTR _playerName$218633[esp+296]
	push	eax
	lea	ecx, DWORD PTR $T219896[esp+300]
	push	ecx
	mov	ecx, DWORD PTR [esi]
	...
	mov	DWORD PTR _pLog$218636[esp+292], eax
	mov	BYTE PTR __$EHRec$[esp+300], 1
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
...
; 254  : 		CvString strBaseString;
	...
	lea	ecx, DWORD PTR _strBaseString$218638[esp+292]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
...
; 255  : 		strBaseString.Format("%03d, ", GC.getGame().getElapsedGameTurns());
	...
	push	eax
	lea	ecx, DWORD PTR _strBaseString$218638[esp+296]
...
; 256  : 		strBaseString += playerName + ", " + cityName + ", ";
	...
	lea	edx, DWORD PTR _playerName$218633[esp+308]
	push	edx
	lea	eax, DWORD PTR $T219897[esp+312]
	push	eax
	call	edi
	lea	ecx, DWORD PTR _cityName$218634[esp+316]
	push	ecx
	push	eax
	lea	edx, DWORD PTR $T219898[esp+324]
	push	edx
	mov	BYTE PTR __$EHRec$[esp+336], 4
	call	DWORD PTR __imp_??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@0@Z
	push	OFFSET $SG218643
	push	eax
	lea	eax, DWORD PTR $T219899[esp+336]
	mov	bl, 5
	push	eax
	...
	lea	ecx, DWORD PTR $T219899[esp+292]
...
; 262  : 			CvString strOutBuf = strBaseString;
	...
	lea	ecx, DWORD PTR _strBaseString$218638[esp+292]
	push	ecx
	lea	ecx, DWORD PTR _strOutBuf$218649[esp+296]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@ABV01@@Z
...
$LN60@LogPossibl:
	push	eax
	lea	ecx, DWORD PTR _strDesc$218651[esp+296]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z
...
; 269  : 				CvString strTemp;
	...
	lea	ecx, DWORD PTR _strTemp$218654[esp+292]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
...
; 270  : 				strTemp.Format("Unit, %s, %d", strDesc.GetCString(), m_Buildables.GetWeight(iI));
	...
	mov	DWORD PTR _elem$219999[esp+292], ecx
	push	eax
	lea	ecx, DWORD PTR _strDesc$218651[esp+296]
	mov	BYTE PTR __$EHRec$[esp+304], 9
	call	DWORD PTR __imp_?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ
	push	eax
	lea	edx, DWORD PTR _strTemp$218654[esp+300]
...
; 271  : 				strOutBuf += strTemp;
	...
	lea	eax, DWORD PTR _strTemp$218654[esp+292]
	push	eax
	lea	ecx, DWORD PTR _strOutBuf$218649[esp+296]
	call	DWORD PTR __imp_??Y?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV01@ABV01@@Z
...
; 275  : 				CvString strTempString;
	...
	lea	ecx, DWORD PTR _strTempString$218657[esp+292]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
...
; 278  : 				CvString strTemp;
	...
	lea	ecx, DWORD PTR _strTemp$218658[esp+292]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
...
; 279  : 				strTemp.Format("Special request for unit of type: %s, %s, %d", strTempString.GetCString(), strDesc.GetCString(), m_Buildables.GetWeight(iI));
	...
	lea	ecx, DWORD PTR _strDesc$218651[esp+292]
	mov	BYTE PTR __$EHRec$[esp+300], 11		; 0000000bH
	mov	DWORD PTR _elem$220029[esp+292], edx
	call	DWORD PTR __imp_?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ
	push	edi
	push	eax
	lea	ecx, DWORD PTR _strTempString$218657[esp+300]
	call	DWORD PTR __imp_?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ
	push	eax
	lea	eax, DWORD PTR _strTemp$218658[esp+304]
...
; 283  : 			pLog->Msg(strOutBuf);
	...
	lea	ecx, DWORD PTR _strOutBuf$218649[esp+292]
	call	DWORD PTR __imp_?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ
	mov	ecx, DWORD PTR _pLog$218636[esp+292]
	mov	edx, DWORD PTR [ecx]
	push	eax
...
; 285  : 	}
	...
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	lea	ecx, DWORD PTR _playerName$218633[esp+292]
...
__unwindfunclet$?LogPossibleBuilds@CvUnitProductionAI@@QAEXW4UnitAITypes@@@Z$3:
	lea	ecx, DWORD PTR _strBaseString$218638[ebp]
	jmp	??1CvString@@QAE@XZ			; CvString::~CvString
...
$T220372 = -104						; size = 4
$T220373 = -100						; size = 4
_elem$220410 = -96					; size = 8
_FStringFixedBuffer_sTemp$ = -88			; size = 76
__$EHRec$ = -12						; size = 12
_iNumUnits$218578 = 8					; size = 4
_kStream$ = 8						; size = 4
...
; 134  : 		kStream << iNumUnits;
	...
	lea	edx, DWORD PTR _iNumUnits$218578[esp+120]
	push	edx
	mov	ecx, edi
	mov	DWORD PTR _iNumUnits$218578[esp+124], eax
	call	?Write@FDataStream@@IAEXABH@Z		; FDataStream::Write
...
; 137  : 		for(int iI = 0; iI < iNumUnits; iI++)
	...
	xor	esi, esi
	cmp	DWORD PTR _iNumUnits$218578[esp+120], esi
	jle	SHORT $LN4@Write
	npad	9
$LL6@Write:
...
; 145  : 				kStream << m_UnitAIWeights.GetWeight(iI);
	...
	add	esp, 8
	lea	edx, DWORD PTR $T220372[esp+124]
	mov	DWORD PTR _elem$220410[esp+124], ecx
	mov	DWORD PTR $T220372[esp+124], eax
	push	edx
...
; 149  : 				kStream << (int)0;
	...
	lea	eax, DWORD PTR $T220373[esp+124]
	mov	DWORD PTR $T220373[esp+124], 0
	push	eax
$LN47@Write:
	mov	ecx, edi
	call	?Write@FDataStream@@IAEXABH@Z		; FDataStream::Write
	inc	esi
	cmp	esi, DWORD PTR _iNumUnits$218578[esp+120]
	jl	SHORT $LL6@Write
$LN4@Write:
...
_TEXT	SEGMENT
__Tmp$220665 = -24					; size = 8
__Tmp$220594 = -16					; size = 8
__Tmp$220620 = -8					; size = 8
___$ReturnUdt$ = 8					; size = 4
__First$ = 12						; size = 4
__Last$ = 16						; size = 4
...
; 3050 : 				std::iter_swap(_Plast++, _Gfirst);
	...
	mov	edi, DWORD PTR [edx]
	mov	DWORD PTR __Tmp$220594[esp+44], ebp
	mov	ebp, DWORD PTR [eax]
	mov	DWORD PTR [edx], ebp
	mov	ebp, DWORD PTR [eax+4]
	mov	DWORD PTR [edx+4], ebp
	mov	edx, DWORD PTR __Tmp$220594[esp+44]
	mov	DWORD PTR [eax], edi
	mov	DWORD PTR [eax+4], edx
$LN20@Unguarded_:
	add	eax, 8
...
; 3057 : 				std::iter_swap(--_Pfirst, _Glast - 1);
	...
	mov	ebp, DWORD PTR [ecx+4]
	mov	edi, DWORD PTR [ecx]
	mov	DWORD PTR __Tmp$220620[esp+44], ebp
	mov	ebp, DWORD PTR [edx]
	mov	DWORD PTR [ecx], ebp
	mov	ebp, DWORD PTR [edx+4]
	mov	DWORD PTR [ecx+4], ebp
	mov	DWORD PTR [edx], edi
	mov	edi, DWORD PTR __Tmp$220620[esp+44]
	mov	DWORD PTR [edx+4], edi
$LN13@Unguarded_:
	sub	ebx, 8
	sub	edx, 8
...
; 3066 : 			std::iter_swap(_Pfirst++, _Gfirst++);
	...
	mov	DWORD PTR __Tmp$220665[esp+40], ebp
	mov	ebp, DWORD PTR [edi+4]
	mov	DWORD PTR __Tmp$220665[esp+44], ebp
	mov	ebp, DWORD PTR [edx]
	mov	DWORD PTR [edi], ebp
	mov	ebp, DWORD PTR [edx+4]
	mov	DWORD PTR [edi+4], ebp
	mov	edi, DWORD PTR __Tmp$220665[esp+40]
	mov	DWORD PTR [edx], edi
	mov	edi, DWORD PTR __Tmp$220665[esp+44]
	mov	DWORD PTR [edx+4], edi
	jmp	$LL23@Unguarded_
$LN6@Unguarded_:
...
_TEXT	SEGMENT
_bValid$218549 = -53					; size = 1
_iNumEntries$218543 = -52				; size = 4
_iWeight$ = -48						; size = 4
_uiVersion$ = -44					; size = 4
_szError$218554 = -40					; size = 28
__$EHRec$ = -12						; size = 12
_kStream$ = 8						; size = 4
...
; 85   : 		kStream >> iNumEntries;
	...
	lea	eax, DWORD PTR _iNumEntries$218543[esp+72]
	push	eax
	call	?Read@FDataStream@@IAEXAAH@Z		; FDataStream::Read
...
; 87   : 		for(int iI = 0; iI < iNumEntries; iI++)
	...
	cmp	DWORD PTR _iNumEntries$218543[esp+72], ebx
	jle	$LN63@Read
	or	ebp, -1
$LL8@Read:
...
; 91   : 			iType = CvInfosSerializationHelper::ReadHashed(kStream, &bValid);
	...
	lea	ecx, DWORD PTR _bValid$218549[esp+72]
	push	ecx
	push	edx
	mov	BYTE PTR _bValid$218549[esp+80], 1
...
; 92   : 			if(iType != -1 || !bValid)
	...
	cmp	edi, ebp
	jne	SHORT $LN4@Read
	cmp	BYTE PTR _bValid$218549[esp+72], 0
	jne	SHORT $LN7@Read
$LN4@Read:
...
; 101  : 					CvString szError;
	...
	lea	ecx, DWORD PTR _szError$218554[esp+72]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ

; 102  : 					szError.Format("LOAD ERROR: Unit Type not found");

	lea	eax, DWORD PTR _szError$218554[esp+72]
...
$LN7@Read:
	inc	ebx
	cmp	ebx, DWORD PTR _iNumEntries$218543[esp+72]
	jl	$LL8@Read
$LN63@Read:
	pop	edi
$LN6@Read:
...
__unwindfunclet$?Read@CvUnitProductionAI@@QAEXAAVFDataStream@@@Z$0:
	lea	ecx, DWORD PTR _szError$218554[ebp]
	jmp	??1CvString@@QAE@XZ			; CvString::~CvString
...
; 3087 : 			std::_Unguarded_partition(_First, _Last);
	...
	push	edi
	lea	eax, DWORD PTR __Mid$218817[esp+28]
	push	ebx
	push	eax
...
; 3090 : 		if (_Mid.first - _First < _Last - _Mid.second)
	...
	mov	ebp, DWORD PTR __Mid$218817[esp+40]
	mov	eax, esi
	cdq
	sub	eax, edx
	sar	eax, 1
	...
	sar	eax, 1
	add	esi, eax
	mov	eax, DWORD PTR __Mid$218817[esp+36]
	mov	ecx, edi
	mov	edx, eax
	sub	ecx, ebp
	sub	edx, ebx
...
; 3098 : 			_Last = _Mid.first;
	...
	mov	edi, DWORD PTR __Mid$218817[esp+36]
$LN26@Sort:
	mov	eax, edi
	sub	eax, ebx
	sar	eax, 3
...
; 218  : 					iWeight = CityStrategyAIHelpers::ReweightByTurnsLeft(m_UnitAIWeights.GetWeight(eUnit), iTurnsLeft);
	...
	push	eax
	push	ecx
	mov	DWORD PTR _elem$221408[esp+32], edx
