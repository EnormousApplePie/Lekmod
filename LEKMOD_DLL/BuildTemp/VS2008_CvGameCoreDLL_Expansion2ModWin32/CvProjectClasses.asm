; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\Users\EnormousApplePie\Desktop\Lekmod Files\Lekmod DLL versions\v29\LEKMOD_DLL\CvGameCoreDLL_Expansion2\CvProjectClasses.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG217565 DB	'MaxGlobalInstances', 00H
	ORG $+1
$SG217566 DB	'MaxTeamInstances', 00H
	ORG $+3
$SG217567 DB	'Cost', 00H
	ORG $+3
$SG217568 DB	'NukeInterception', 00H
	ORG $+3
$SG217569 DB	'CultureBranchesRequired', 00H
$SG217570 DB	'TechShare', 00H
	ORG $+2
$SG217571 DB	'VictoryDelayPercent', 00H
$SG217572 DB	'Spaceship', 00H
	ORG $+2
$SG217573 DB	'AllowsNukes', 00H
$SG217574 DB	'MovieDefineTag', 00H
	ORG $+1
$SG217576 DB	'VictoryPrereq', 00H
	ORG $+2
$SG217578 DB	'TechPrereq', 00H
	ORG $+1
$SG217580 DB	'EveryoneSpecialUnit', 00H
$SG217582 DB	'CreateSound', 00H
$SG217584 DB	'AnyonePrereqProject', 00H
$SG217586 DB	'Quantity', 00H
	ORG $+3
$SG217587 DB	'ProjectType', 00H
$SG217588 DB	'ResourceType', 00H
	ORG $+3
$SG217589 DB	'Project_ResourceQuantityRequirements', 00H
	ORG $+3
$SG217590 DB	'Resources', 00H
	ORG $+2
$SG217592 DB	'Victories', 00H
	ORG $+6
$SG217605 DB	'select VictoryType, Threshold, MinThreshold from Project'
	DB	'_VictoryThresholds where ProjectType = ''%s'';', 00H
	ORG $+3
$SG217611 DB	'VictoryType', 00H
$SG217614 DB	'Threshold', 00H
	ORG $+2
$SG217616 DB	'MinThreshold', 00H
	ORG $+3
$SG217617 DB	'ProjectType', 00H
$SG217618 DB	'Project_Flavors', 00H
$SG217619 DB	'AmountNeeded', 00H
	ORG $+3
$SG217620 DB	'ProjectType', 00H
$SG217621 DB	'PrereqProjectType', 00H
	ORG $+2
$SG217622 DB	'Project_Prereqs', 00H
$SG217623 DB	'Projects', 00H
CONST	ENDS
PUBLIC	?GetVictoryPrereq@CvProjectEntry@@QBEHXZ	; CvProjectEntry::GetVictoryPrereq
; Function compile flags: /Ogtpy
; File c:\users\enormousapplepie\desktop\lekmod files\lekmod dll versions\v29\lekmod_dll\cvgamecoredll_expansion2\cvprojectclasses.cpp
...
; 40   : 		_THROW_NCEE(std::bad_alloc, NULL);
	...
	lea	eax, DWORD PTR $T218537[esp+8]
	push	eax
	lea	ecx, DWORD PTR $T218532[esp+16]
	mov	DWORD PTR $T218537[esp+12], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@ABQBD@Z
	push	OFFSET __TI2?AVbad_alloc@std@@
	lea	ecx, DWORD PTR $T218532[esp+16]
	push	ecx
	mov	DWORD PTR $T218532[esp+20], OFFSET ??_7bad_alloc@std@@6B@
...
; 1260 : 		_THROW(length_error, "vector<T> too long");
	...
	lea	ecx, DWORD PTR $T218871[esp+84]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z
	lea	ecx, DWORD PTR $T218870[esp+80]
	mov	DWORD PTR __$EHRec$[esp+88], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@XZ
	lea	eax, DWORD PTR $T218871[esp+80]
	push	eax
	lea	ecx, DWORD PTR $T218870[esp+96]
	mov	BYTE PTR __$EHRec$[esp+92], 1
	mov	DWORD PTR $T218870[esp+84], OFFSET ??_7logic_error@std@@6B@
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@ABV01@@Z
	push	OFFSET __TI3?AVlength_error@std@@
	lea	ecx, DWORD PTR $T218870[esp+84]
	push	ecx
	mov	BYTE PTR __$EHRec$[esp+96], 0
	mov	DWORD PTR $T218870[esp+88], OFFSET ??_7length_error@std@@6B@
	call	__CxxThrowException@8
$LN13@Xlen:
$LN12@Xlen:
	int	3
...
_TEXT	SEGMENT
tv419 = -596						; size = 4
_iThreshold$217613 = -596				; size = 4
_szProjectType$ = -592					; size = 4
_kDBResults$217598 = -588				; size = 64
_szQuery$217599 = -524					; size = 512
__$EHRec$ = -12						; size = 12
_kResults$ = 8						; size = 4
_kUtility$ = 12						; size = 4
...
; 77   : 		Database::Results kDBResults;
	...
	push	0
	lea	ecx, DWORD PTR _kDBResults$217598[esp+616]
	call	DWORD PTR __imp_??0Results@Database@@QAE@PBD@Z

; 78   : 		char szQuery[512] = {0};

	push	511					; 000001ffH
	lea	edx, DWORD PTR _szQuery$217599[esp+617]
	push	0
	push	edx
	mov	DWORD PTR __$EHRec$[esp+632], 0
	mov	BYTE PTR _szQuery$217599[esp+624], 0
	call	_memset
...
; 79   : 		sprintf_s(szQuery, "select VictoryType, Threshold, MinThreshold from Project_VictoryThresholds where ProjectType = '%s';", szProjectType);
	...
	push	edi
	lea	eax, DWORD PTR _szQuery$217599[esp+628]
...
; 80   : 		if(DB.Execute(kDBResults, szQuery))
	...
	push	-1
	lea	ecx, DWORD PTR _szQuery$217599[esp+616]
	push	ecx
	lea	edx, DWORD PTR _kDBResults$217598[esp+620]
...
; 82   : 			while(kDBResults.Step())
	...
	lea	ecx, DWORD PTR _kDBResults$217598[esp+612]
...
; 88   : 				const int iMinThreshold = kDBResults.GetInt("MinThreshold");
	...
	lea	ecx, DWORD PTR _kDBResults$217598[esp+616]
	mov	DWORD PTR _iThreshold$217613[esp+616], eax
	call	ebp
...
; 90   : 				m_piVictoryThreshold[idx] = iThreshold;
	...
	mov	edx, DWORD PTR _iThreshold$217613[esp+612]
...
__unwindfunclet$?CacheResults@CvProjectEntry@@UAE_NAAVResults@Database@@AAVCvDatabaseUtility@@@Z$0:
	lea	ecx, DWORD PTR _kDBResults$217598[ebp]
