...
; 1260 : 		_THROW(length_error, "vector<T> too long");
	...
	lea	ecx, DWORD PTR $T219635[esp+84]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z
	lea	ecx, DWORD PTR $T219634[esp+80]
	mov	DWORD PTR __$EHRec$[esp+88], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@XZ
	lea	eax, DWORD PTR $T219635[esp+80]
	push	eax
	lea	ecx, DWORD PTR $T219634[esp+96]
	mov	BYTE PTR __$EHRec$[esp+92], 1
	mov	DWORD PTR $T219634[esp+84], OFFSET ??_7logic_error@std@@6B@
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@ABV01@@Z
	push	OFFSET __TI3?AVlength_error@std@@
	lea	ecx, DWORD PTR $T219634[esp+84]
	push	ecx
	mov	BYTE PTR __$EHRec$[esp+96], 0
	mov	DWORD PTR $T219634[esp+88], OFFSET ??_7length_error@std@@6B@
...
; 40   : 		_THROW_NCEE(std::bad_alloc, NULL);
	...
	lea	eax, DWORD PTR $T219744[esp+8]
	push	eax
	lea	ecx, DWORD PTR $T219740[esp+16]
	mov	DWORD PTR $T219744[esp+12], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@ABQBD@Z
	push	OFFSET __TI2?AVbad_alloc@std@@
	lea	ecx, DWORD PTR $T219740[esp+16]
	push	ecx
	mov	DWORD PTR $T219740[esp+20], OFFSET ??_7bad_alloc@std@@6B@
	call	__CxxThrowException@8
$LN9@Allocate:
$LN8@Allocate:
	int	3
...
; 147  : 	kStream << (int)m_Plots.size();
	...
	add	esp, 8
	lea	eax, DWORD PTR $T219914[esp+8]
	sar	edx, 2
	push	eax
	mov	ecx, ebx
	mov	DWORD PTR $T219914[esp+12], edx
	call	?Write@FDataStream@@IAEXABH@Z		; FDataStream::Write
...
; 822  : 		_STD _Ptr_cat(_First, _Dest), _STD _Range_checked_iterator_tag()));
	...
	mov	BYTE PTR $T220106[esp+4], 0
	mov	eax, DWORD PTR $T220106[esp+4]
	mov	ecx, DWORD PTR __Cat$220110[esp+4]
	push	eax
	mov	eax, DWORD PTR __Dest$[esp+4]
	push	ecx
...
; 822  : 		_STD _Ptr_cat(_First, _Dest), _STD _Range_checked_iterator_tag()));
	...
	mov	edx, DWORD PTR __Al$[esp]
	mov	BYTE PTR $T220115[esp+4], 0
	mov	eax, DWORD PTR $T220115[esp+4]
	mov	ecx, DWORD PTR __Cat$220119[esp+4]
	push	eax
	mov	eax, DWORD PTR __Dest$[esp+4]
	push	ecx
	mov	ecx, DWORD PTR __Last$[esp+8]
...
; 942  : 		_STD _Ptr_cat(_First, _First), _STD _Range_checked_iterator_tag());
	...
	mov	ecx, DWORD PTR __Cat$220160[esp+4]
	push	eax
...
; 207  : 	return (_STDEXT unchecked_uninitialized_copy(_First, _Last, _Dest, _Al));
	...
	mov	ecx, DWORD PTR __Cat$220177[esp]
	mov	edx, DWORD PTR __Al$[esp]
	mov	BYTE PTR $T220173[esp+4], 0
	mov	eax, DWORD PTR $T220173[esp+4]
	push	eax
	mov	eax, DWORD PTR __Dest$[esp+4]
	push	ecx
	mov	ecx, DWORD PTR __Last$[esp+8]
...
; 207  : 	return (_STDEXT unchecked_uninitialized_copy(_First, _Last, _Dest, _Al));
	...
	mov	ecx, DWORD PTR __Cat$220196[esp]
	mov	edx, DWORD PTR __Al$[esp]
	mov	BYTE PTR $T220192[esp+4], 0
	mov	eax, DWORD PTR $T220192[esp+4]
	push	eax
	mov	eax, DWORD PTR __Dest$[esp+4]
	push	ecx
	mov	ecx, DWORD PTR __Last$[esp+8]
...
; 1254 : 		_STDEXT unchecked_uninitialized_fill_n(_Ptr, _Count, _Val, this->_Alval);
	...
	mov	edx, DWORD PTR __Cat$220328[esp]
	push	esi
	mov	esi, DWORD PTR __Count$[esp+4]
	push	edi
	mov	edi, DWORD PTR __Ptr$[esp+8]
	mov	BYTE PTR $T220324[esp+12], 0
	mov	eax, DWORD PTR $T220324[esp+12]
	push	eax
...
; 864  : 		_STD _Move_cat(_Dest), _STD _Range_checked_iterator_tag()));
	...
	mov	ecx, DWORD PTR __Cat$220400[esp]
	mov	edx, DWORD PTR __Al$[esp]
	mov	BYTE PTR $T220396[esp+4], 0
	mov	eax, DWORD PTR $T220396[esp+4]
	push	eax
	mov	eax, DWORD PTR __Dest$[esp+4]
	push	ecx
	mov	ecx, DWORD PTR __Last$[esp+8]
...
; 1148 : 			_Ptr, this->_Alval));
	...
	mov	edx, DWORD PTR __Cat$220554[esp]
	mov	BYTE PTR $T220550[esp+4], 0
	mov	eax, DWORD PTR $T220550[esp+4]
	push	eax
	mov	eax, DWORD PTR __Ptr$[esp+4]
	push	edx
...
; 1148 : 			_Ptr, this->_Alval));
	...
	mov	edx, DWORD PTR __Cat$220609[esp]
...
_TEXT	SEGMENT
__Ptr$218346 = -24					; size = 4
$T221093 = -20						; size = 1
__$EHRec$ = -16						; size = 16
__Cat$221097 = 8					; size = 1
__Count$ = 8						; size = 4
...
; 610  : 			_Umove(begin(), end(), _Ptr);
	...
	mov	ecx, DWORD PTR [esi+4]
	mov	BYTE PTR $T221093[ebp], 0
	mov	edx, DWORD PTR $T221093[ebp]
	push	edx
	mov	edx, DWORD PTR __Cat$221097[ebp]
	push	edx
	mov	ebx, eax
	...
	push	eax
	push	ecx
	mov	DWORD PTR __Ptr$218346[ebp], ebx
...
; 612  : 			this->_Alval.deallocate(_Ptr, _Count);
	...
	mov	eax, DWORD PTR __Ptr$218346[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	add	esp, 4
...
__$EHRec$ = -16						; size = 16
__Cat$221487 = 8					; size = 1
__Cat$221415 = 8					; size = 1
__Where$ = 8						; size = 4
__Tmp$218539 = 12					; size = 4
__Tmp$218521 = 12					; size = 4
__Newvec$218506 = 12					; size = 4
__Count$ = 12						; size = 4
tv515 = 16						; size = 4
$T221483 = 16						; size = 1
$T221411 = 16						; size = 1
...
; 1178 : 			_Ufill(_Newvec + _Whereoff, _Count, _Val);	// add new stuff
	...
	push	edx
	mov	ecx, esi
	mov	DWORD PTR __Newvec$218506[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+12], 0
...
; 1181 : 				_Newvec);	// move prefix
	...
	mov	edx, DWORD PTR __Cat$221415[ebp]
	mov	eax, DWORD PTR [esi+4]
	mov	BYTE PTR $T221411[ebp], 0
	mov	ecx, DWORD PTR $T221411[ebp]
	push	ecx
	mov	ecx, DWORD PTR __Newvec$218506[ebp]
	push	edx
...
; 1184 : 				_Newvec + (_Whereoff + _Count));	// move suffix
	...
	mov	eax, DWORD PTR [esi+8]
	add	esp, 24					; 00000018H
	mov	BYTE PTR $T221483[ebp], 0
	mov	edx, DWORD PTR $T221483[ebp]
	push	edx
	mov	edx, DWORD PTR __Cat$221487[ebp]
	push	edx
	lea	ecx, DWORD PTR [ebx+edi]
	mov	ebx, DWORD PTR __Newvec$218506[ebp]
	push	esi
...
; 1190 : 			this->_Alval.deallocate(_Newvec, _Capacity);
	...
	mov	edx, DWORD PTR __Newvec$218506[ebp]
	push	edx
	call	??3@YAXPAX@Z				; operator delete
	add	esp, 4
...
; 1211 : 			_Ty _Tmp = _Val;	// in case _Val is in sequence
	...
	mov	DWORD PTR __Tmp$218521[ebp], ecx
...
; 1218 : 				_Tmp);	// insert new stuff off end
	...
	lea	edx, DWORD PTR __Tmp$218521[ebp]
	sar	ecx, 2
	push	edx
	sub	edi, ecx
	push	edi
...
; 1239 : 				_Mylast);	// copy suffix
	...
	push	edi
	mov	ecx, esi
	mov	DWORD PTR __Tmp$218539[ebp], edx
...
; 1248 : 				_Tmp);	// insert into hole
	...
	lea	ecx, DWORD PTR __Tmp$218539[ebp]
	push	ecx
	add	edx, eax
	push	edx
	push	eax
...
; 819  : 			_Mylast = _Ufill(_Mylast, 1, _Val);
	...
	mov	ecx, DWORD PTR __Cat$221841[esp+8]
	mov	edx, DWORD PTR __Val$[esp+8]
	mov	BYTE PTR $T221837[esp+12], 0
	mov	eax, DWORD PTR $T221837[esp+12]
	push	eax
	push	ecx
	push	esi
	push	edx
...
; 91   : 	m_Plots.push_back(PlotPosition(sPlotX, sPlotY));
	...
	mov	WORD PTR $T221953[esp+6], si
	lea	esi, DWORD PTR [ecx+12]
	mov	ecx, DWORD PTR [esi+4]
	mov	WORD PTR $T221953[esp+4], di
	test	ecx, ecx
...
$LN42@addPlot:
	...
	mov	ecx, DWORD PTR __Cat$222179[esp+4]
	mov	BYTE PTR $T222176[esp+4], 0
	mov	eax, DWORD PTR $T222176[esp+4]
	push	eax
	push	ecx
	push	esi
	lea	edx, DWORD PTR $T221953[esp+16]
	push	edx
	push	1
	push	edi
	call	??$_Uninit_fill_n@PAU?$pair@FF@std@@IU12@V?$allocator@U?$pair@FF@std@@@2@@std@@YAXPAU?$pair@FF@0@IABU10@AAV?$allocator@U?$pair@FF@std@@@0@U_Nonscalar_ptr_iterator_tag@0@U_Range_checked_iterator_tag@0@@Z ; std::_Uninit_fill_n<std::pair<short,short> *,unsigned int,std::pair<short,short>,std::allocator<std::pair<short,short> > >
...
$LN34@addPlot:
	lea	eax, DWORD PTR $T221953[esp+4]
	push	eax
	push	1
	push	edi
	mov	ecx, esi
...
_TEXT	SEGMENT
_sPlotY$218296 = -12					; size = 2
_nPlots$ = -8						; size = 4
$T222225 = -4						; size = 4
_sPlotX$218295 = 8					; size = 2
_kStream$ = 8						; size = 4
...
; 132  : 			kStream >> sPlotX;
	...
	lea	eax, DWORD PTR _sPlotX$218295[esp+24]
	push	eax
	mov	ecx, esi
	call	?Read@FDataStream@@IAEXAAF@Z		; FDataStream::Read
...
; 133  : 			kStream >> sPlotY;
	...
	lea	ecx, DWORD PTR _sPlotY$218296[esp+28]
	push	ecx
	mov	ecx, esi
	call	?Read@FDataStream@@IAEXAAF@Z		; FDataStream::Read
...
; 134  : 			m_Plots.push_back(PlotPosition(sPlotX, sPlotY));
	...
	mov	dx, WORD PTR _sPlotX$218295[esp+24]
	mov	ax, WORD PTR _sPlotY$218296[esp+28]
	lea	ecx, DWORD PTR $T222225[esp+28]
	push	ecx
	mov	ecx, ebx
	mov	WORD PTR $T222225[esp+32], dx
	mov	WORD PTR $T222225[esp+34], ax
