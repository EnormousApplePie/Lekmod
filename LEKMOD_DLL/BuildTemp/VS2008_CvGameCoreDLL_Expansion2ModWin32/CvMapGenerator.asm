; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\Users\EnormousApplePie\Desktop\Lekmod Files\Lekmod DLL versions\v29\LEKMOD_DLL\CvGameCoreDLL_Expansion2\CvMapGenerator.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG217207 DB	'Map Script', 00H
	ORG $+1
$SG217226 DB	'SELECT * from Worlds where ID = ? LIMIT 1', 00H
	ORG $+2
$SG217250 DB	'CvMapGenerator - GetMapInitData()', 00H
	ORG $+2
$SG217253 DB	'GetMapInitData', 00H
	ORG $+1
$SG217257 DB	'Width', 00H
	ORG $+2
$SG217259 DB	'Height', 00H
	ORG $+1
$SG217261 DB	'WrapX', 00H
	ORG $+2
$SG217263 DB	'WrapY', 00H
	ORG $+2
$SG217265 DB	'TopLatitude', 00H
$SG217267 DB	'BottomLatitude', 00H
	ORG $+1
$SG217274 DB	'CvMapGenerator - GetGameInitialItemsOverrides()', 00H
$SG217277 DB	'GetGameInitialItemsOverrides', 00H
	ORG $+3
$SG217281 DB	'GrantInitialFreeTechsPerTeam', 00H
	ORG $+3
$SG217292 DB	'GrantInitialGoldPerPlayer', 00H
	ORG $+2
$SG217303 DB	'GrantInitialCulturePerPlayer', 00H
	ORG $+3
$SG217314 DB	'ClearResearchQueuePerPlayer', 00H
$SG217325 DB	'GrantInitialUnitsPerPlayer', 00H
	ORG $+1
$SG217341 DB	'CvMapGenerator - GenerateRandomMap()', 00H
	ORG $+3
$SG217344 DB	'GenerateMap', 00H
$SG217346 DB	'Cannot find map script entry point GenerateMap()', 00H
CONST	ENDS
...
;	COMDAT xdata$x
; File c:\users\enormousapplepie\desktop\lekmod files\lekmod dll versions\v29\lekmod_dll\cvgamecoredll_expansion2\cvmapgenerator.cpp
xdata$x	SEGMENT
...
; 2091 : 		return (*(begin() + _Off));
	...
	mov	ecx, DWORD PTR [ecx+8]
	xor	eax, eax
	mov	DWORD PTR __Tmp$217785[esp+12], eax
	mov	eax, DWORD PTR __Off$[esp+4]
	mov	DWORD PTR __Tmp$217785[esp+8], ecx
	push	eax
	lea	ecx, DWORD PTR __Tmp$217785[esp+12]
	call	??Y?$_Vb_const_iterator@IHV?$vector@_NV?$allocator@_N@std@@@std@@@std@@QAEAAV01@H@Z ; std::_Vb_const_iterator<unsigned int,int,std::vector<bool,std::allocator<bool> > >::operator+=
	mov	eax, DWORD PTR ___$ReturnUdt$[esp+4]
	mov	ecx, DWORD PTR __Tmp$217785[esp+8]
	mov	edx, DWORD PTR __Tmp$217785[esp+12]
	mov	DWORD PTR [eax], ecx
	mov	DWORD PTR [eax+4], edx
...
_TEXT	SEGMENT
_bOverride$217333 = -64					; size = 1
_bOverride$217322 = -64					; size = 1
_bOverride$217311 = -64					; size = 1
_bOverride$217300 = -64					; size = 1
_bOverride$217289 = -64					; size = 1
$T217813 = -60						; size = 8
$T217812 = -60						; size = 8
$T217811 = -60						; size = 8
$T217810 = -60						; size = 8
...
; 175  : 						const bool bOverride = lua_toboolean(L, -1);
	...
	test	eax, eax
	setne	al
	mov	BYTE PTR _bOverride$217289[esp+80], al
...
; 178  : 							pArgs->pkOverrides->GrantInitialFreeTechsPerTeam[eTeam] = bOverride;
	...
	mov	ecx, DWORD PTR _bOverride$217289[esp+80]
	push	ecx
	mov	ecx, DWORD PTR [ebp+4]
	push	edi
	lea	edx, DWORD PTR $T217809[esp+88]
	push	edx
...
; 196  : 						const bool bOverride = lua_toboolean(L, -1);
	...
	test	eax, eax
	setne	al
	mov	BYTE PTR _bOverride$217300[esp+80], al
...
; 199  : 							pArgs->pkOverrides->GrantInitialGoldPerPlayer[ePlayer] = bOverride;
	...
	mov	ecx, DWORD PTR _bOverride$217300[esp+80]
	push	ecx
	mov	ecx, DWORD PTR [ebp+4]
	push	edi
	lea	edx, DWORD PTR $T217810[esp+88]
	push	edx
...
; 217  : 						const bool bOverride = lua_toboolean(L, -1);
	...
	test	eax, eax
	setne	al
	mov	BYTE PTR _bOverride$217311[esp+80], al
...
; 220  : 							pArgs->pkOverrides->GrantInitialCulturePerPlayer[ePlayer] = bOverride;
	...
	mov	ecx, DWORD PTR _bOverride$217311[esp+80]
	push	ecx
	mov	ecx, DWORD PTR [ebp+4]
	push	edi
	lea	edx, DWORD PTR $T217811[esp+88]
	push	edx
...
; 238  : 						const bool bOverride = lua_toboolean(L, -1);
	...
	test	eax, eax
	setne	al
	mov	BYTE PTR _bOverride$217322[esp+80], al
...
; 241  : 							pArgs->pkOverrides->ClearResearchQueuePerPlayer[ePlayer] = bOverride;
	...
	mov	ecx, DWORD PTR _bOverride$217322[esp+80]
	push	ecx
	mov	ecx, DWORD PTR [ebp+4]
	push	edi
	lea	edx, DWORD PTR $T217812[esp+88]
	push	edx
...
; 259  : 						const bool bOverride = lua_toboolean(L, -1);
	...
	test	eax, eax
	setne	al
	mov	BYTE PTR _bOverride$217333[esp+80], al
...
; 262  : 							pArgs->pkOverrides->GrantInitialUnitsPerPlayer[ePlayer] = bOverride;
	...
	mov	ecx, DWORD PTR _bOverride$217333[esp+80]
	push	ecx
	mov	ecx, DWORD PTR [ebp+4]
	push	edi
