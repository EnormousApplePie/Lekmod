; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\Users\EnormousApplePie\Desktop\Lekmod Files\Lekmod DLL versions\v29\LEKMOD_DLL\CvGameCoreDLL_Expansion2\CvTargeting.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; Function compile flags: /Ogtpy
; File c:\users\enormousapplepie\desktop\lekmod files\lekmod dll versions\v29\lekmod_dll\cvgamecoredll_expansion2\cvtargeting.cpp
...
_stepY$ = -24						; size = 4
tv563 = -20						; size = 4
_shortAxisStepFactor$217620 = -20			; size = 4
_originalDX$ = -16					; size = 4
_originalDY$ = -12					; size = 4
_stepX$ = -8						; size = 4
_shortAxisStepFactor$217591 = -4			; size = 4
_startX$ = 8						; size = 4
_startY$ = 12						; size = 4
_dx$ = 16						; size = 4
_dy$ = 20						; size = 4
...
; 176  : 		int shortAxisStepFactor = (dx >> 1); 
	...
	sar	edx, 1
	mov	DWORD PTR _shortAxisStepFactor$217591[esp+64], edx
...
; 179  : 			shortAxisStepFactor += dy;
	...
	mov	edx, DWORD PTR _shortAxisStepFactor$217591[esp+64]
...
; 187  : 					currentDX += stepX;
	...
	mov	DWORD PTR _shortAxisStepFactor$217591[esp+64], edx
	jl	$LN32@CanSeeDisp
	sub	DWORD PTR _shortAxisStepFactor$217591[esp+64], ecx
...
$LN55@CanSeeDisp:
	sar	ecx, 1
$LN85@CanSeeDisp:
	mov	DWORD PTR _shortAxisStepFactor$217620[esp+64], ecx
...
; 263  : 			shortAxisStepFactor += dx;
	...
	add	DWORD PTR _shortAxisStepFactor$217620[esp+64], edx

; 264  : 
; 265  : 			if (shortAxisStepFactor >= dy) 

	mov	ecx, DWORD PTR _dy$[esp+60]
	cmp	DWORD PTR _shortAxisStepFactor$217620[esp+64], ecx
	jl	$LN20@CanSeeDisp

; 266  : 			{
; 267  : 				shortAxisStepFactor -= dy;

	sub	DWORD PTR _shortAxisStepFactor$217620[esp+64], ecx
...
_stepY$ = -24						; size = 4
tv564 = -20						; size = 4
_shortAxisStepFactor$217702 = -20			; size = 4
_originalDX$ = -16					; size = 4
tv572 = -12						; size = 4
_shortAxisStepFactor$217673 = -12			; size = 4
...
; 420  : 		int shortAxisStepFactor = (dx >> 1); 
	...
	sar	edx, 1
	mov	DWORD PTR _shortAxisStepFactor$217673[esp+60], edx
...
; 423  : 			shortAxisStepFactor += dy;
	...
	mov	edx, DWORD PTR _shortAxisStepFactor$217673[esp+60]
...
; 431  : 					currentDX += stepX;
	...
	sub	DWORD PTR _shortAxisStepFactor$217673[esp+60], eax
...
$LN55@CanSeeDisp@2:
	sar	eax, 1
$LN78@CanSeeDisp@2:
	mov	DWORD PTR _shortAxisStepFactor$217702[esp+60], eax
...
; 520  : 			shortAxisStepFactor += dx;
	...
	add	DWORD PTR _shortAxisStepFactor$217702[esp+60], edx

; 521  : 
; 522  : 			if (shortAxisStepFactor >= dy) 

	mov	eax, DWORD PTR _dy$[esp+56]
	cmp	DWORD PTR _shortAxisStepFactor$217702[esp+60], eax
	jl	$LN20@CanSeeDisp@2

; 523  : 			{
; 524  : 				shortAxisStepFactor -= dy;

	sub	DWORD PTR _shortAxisStepFactor$217702[esp+60], eax
