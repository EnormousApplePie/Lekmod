; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\Users\EnormousApplePie\Desktop\Lekmod Files\Lekmod DLL versions\v29\LEKMOD_DLL\CvGameCoreDLL_Expansion2\CvCityManager.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; 1260 : 		_THROW(length_error, "vector<T> too long");
	...
	lea	ecx, DWORD PTR $T220847[esp+84]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z
	lea	ecx, DWORD PTR $T220846[esp+80]
	mov	DWORD PTR __$EHRec$[esp+88], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@XZ
	lea	eax, DWORD PTR $T220847[esp+80]
	push	eax
	lea	ecx, DWORD PTR $T220846[esp+96]
	mov	BYTE PTR __$EHRec$[esp+92], 1
	mov	DWORD PTR $T220846[esp+84], OFFSET ??_7logic_error@std@@6B@
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@ABV01@@Z
	push	OFFSET __TI3?AVlength_error@std@@
	lea	ecx, DWORD PTR $T220846[esp+84]
	push	ecx
	mov	BYTE PTR __$EHRec$[esp+96], 0
	mov	DWORD PTR $T220846[esp+88], OFFSET ??_7length_error@std@@6B@
...
; 40   : 		_THROW_NCEE(std::bad_alloc, NULL);
	...
	lea	eax, DWORD PTR $T221047[esp+8]
	push	eax
	lea	ecx, DWORD PTR $T221043[esp+16]
	mov	DWORD PTR $T221047[esp+12], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@ABQBD@Z
	push	OFFSET __TI2?AVbad_alloc@std@@
	lea	ecx, DWORD PTR $T221043[esp+16]
	push	ecx
	mov	DWORD PTR $T221043[esp+20], OFFSET ??_7bad_alloc@std@@6B@
	call	__CxxThrowException@8
$LN9@Allocate:
$LN8@Allocate:
	int	3
...
; 40   : 		_THROW_NCEE(std::bad_alloc, NULL);
	...
	lea	eax, DWORD PTR $T221063[esp+8]
	push	eax
	lea	ecx, DWORD PTR $T221059[esp+16]
	mov	DWORD PTR $T221063[esp+12], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@ABQBD@Z
	push	OFFSET __TI2?AVbad_alloc@std@@
	lea	ecx, DWORD PTR $T221059[esp+16]
	push	ecx
	mov	DWORD PTR $T221059[esp+20], OFFSET ??_7bad_alloc@std@@6B@
	call	__CxxThrowException@8
$LN9@Allocate@2:
$LN8@Allocate@2:
	int	3
...
; 822  : 		_STD _Ptr_cat(_First, _Dest), _STD _Range_checked_iterator_tag()));
	...
	mov	BYTE PTR $T222512[esp+4], 0
	mov	eax, DWORD PTR $T222512[esp+4]
	mov	ecx, DWORD PTR __Cat$222516[esp+4]
	push	eax
	mov	eax, DWORD PTR __Dest$[esp+4]
	push	ecx
...
; 982  : 					? end() : _Where);
	...
	mov	DWORD PTR $T222524[esp+8], eax
	lea	eax, DWORD PTR $T222524[esp+8]
	mov	edx, DWORD PTR [eax]
	mov	eax, DWORD PTR ___$ReturnUdt$[esp+4]
	mov	DWORD PTR [eax], edx
	pop	edi
...
; 822  : 		_STD _Ptr_cat(_First, _Dest), _STD _Range_checked_iterator_tag()));
	...
	mov	edx, DWORD PTR __Al$[esp]
	mov	BYTE PTR $T222845[esp+4], 0
	mov	eax, DWORD PTR $T222845[esp+4]
	mov	ecx, DWORD PTR __Cat$222850[esp+4]
	push	eax
	mov	eax, DWORD PTR __Dest$[esp+4]
	push	ecx
	mov	ecx, DWORD PTR __Last$[esp+8]
...
; 207  : 	return (_STDEXT unchecked_uninitialized_copy(_First, _Last, _Dest, _Al));
	...
	mov	ecx, DWORD PTR __Cat$222972[esp]
	mov	edx, DWORD PTR __Al$[esp]
	mov	BYTE PTR $T222969[esp+4], 0
	mov	eax, DWORD PTR $T222969[esp+4]
	push	eax
	mov	eax, DWORD PTR __Dest$[esp+4]
	push	ecx
	mov	ecx, DWORD PTR __Last$[esp+8]
...
; Function compile flags: /Ogtpy
; File c:\users\enormousapplepie\desktop\lekmod files\lekmod dll versions\v29\lekmod_dll\cvgamecoredll_expansion2\cvcitymanager.cpp
...
; 130  : 		CityMap::const_iterator itr = ms_kCityMap.find(pkCity);
	...
	push	eax
	lea	ecx, DWORD PTR $T223004[esp+8]
	push	ecx
...
; 1141 : 			_Ptr, this->_Alval));
	...
	mov	edx, DWORD PTR __Cat$223140[esp]
	mov	BYTE PTR $T223137[esp+4], 0
	mov	eax, DWORD PTR $T223137[esp+4]
	push	eax
	mov	eax, DWORD PTR __Ptr$[esp+4]
	push	edx
...
; 864  : 		_STD _Move_cat(_Dest), _STD _Range_checked_iterator_tag()));
	...
	mov	ecx, DWORD PTR __Cat$223365[esp]
	mov	edx, DWORD PTR __Al$[esp]
	mov	BYTE PTR $T223362[esp+4], 0
	mov	eax, DWORD PTR $T223362[esp+4]
	push	eax
	mov	eax, DWORD PTR __Dest$[esp+4]
	push	ecx
	mov	ecx, DWORD PTR __Last$[esp+8]
...
; 503  : 			_Mylast = _Ucopy(_Right.begin(), _Right.end(), _Myfirst);
	...
	mov	BYTE PTR $T223650[ebp], 0
	mov	edx, DWORD PTR $T223650[ebp]
	push	edx
	mov	edx, DWORD PTR __Cat$223654[ebp]
	push	edx
...
; 1148 : 			_Ptr, this->_Alval));
	...
	mov	edx, DWORD PTR __Cat$223828[esp]
	mov	BYTE PTR $T223825[esp+4], 0
	mov	eax, DWORD PTR $T223825[esp+4]
	push	eax
	mov	eax, DWORD PTR __Ptr$[esp+4]
	push	edx
	mov	edx, DWORD PTR __First$[esp+8]
...
_TEXT	SEGMENT
__Ptr$219041 = -24					; size = 4
$T224011 = -20						; size = 1
__$EHRec$ = -16						; size = 16
__Cat$224014 = 8					; size = 1
__Count$ = 8						; size = 4
...
; 610  : 			_Umove(begin(), end(), _Ptr);
	...
	mov	ecx, DWORD PTR [esi+4]
	mov	BYTE PTR $T224011[ebp], 0
	mov	edx, DWORD PTR $T224011[ebp]
	push	edx
	mov	edx, DWORD PTR __Cat$224014[ebp]
	push	edx
	mov	ebx, eax
	mov	eax, DWORD PTR [esi+8]
	push	esi
	...
	push	eax
	push	ecx
	mov	DWORD PTR __Ptr$219041[ebp], ebx
	mov	DWORD PTR __$EHRec$[ebp+12], 0
	call	??$_Uninit_copy@V?$_Vector_iterator@PAVCvCity@@V?$allocator@PAVCvCity@@@std@@@std@@PAPAVCvCity@@V?$allocator@PAVCvCity@@@2@@std@@YAPAPAVCvCity@@V?$_Vector_iterator@PAVCvCity@@V?$allocator@PAVCvCity@@@std@@@0@0PAPAV1@AAV?$allocator@PAVCvCity@@@0@U_Nonscalar_ptr_iterator_tag@0@U_Range_checked_iterator_tag@0@@Z ; std::_Uninit_copy<std::_Vector_iterator<CvCity *,std::allocator<CvCity *> >,CvCity * *,std::allocator<CvCity *> >
...
; 612  : 			this->_Alval.deallocate(_Ptr, _Count);
	...
	mov	eax, DWORD PTR __Ptr$219041[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	add	esp, 4
...
__Where$ = 8						; size = 4
__Count$ = 12						; size = 4
__Tmp$219337 = 16					; size = 4
__Tmp$219327 = 16					; size = 4
__Val$ = 16						; size = 4
...
; 1214 : 				_VEC_ITER_BASE(_Where) + _Count);	// copy suffix
	...
	mov	DWORD PTR __Tmp$219327[esp+16], edx
...
; 1218 : 				_Tmp);	// insert new stuff off end
	...
	lea	edx, DWORD PTR __Tmp$219327[esp+16]
	sar	ecx, 2
	push	edx
	sub	edi, ecx
	push	edi
...
; 1248 : 				_Tmp);	// insert into hole
	...
	lea	ecx, DWORD PTR __Tmp$219337[esp+28]
	push	ecx
	add	ebp, eax
	push	ebp
	push	eax
...
; 775  : 			_THROW(out_of_range, "invalid map/set<T> iterator");
	...
	lea	ecx, DWORD PTR $T224411[esp+92]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z
	lea	ecx, DWORD PTR $T224410[esp+88]
	mov	DWORD PTR __$EHRec$[esp+96], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@XZ
	lea	eax, DWORD PTR $T224411[esp+88]
	push	eax
	lea	ecx, DWORD PTR $T224410[esp+104]
	mov	BYTE PTR __$EHRec$[esp+100], 1
	mov	DWORD PTR $T224410[esp+92], OFFSET ??_7logic_error@std@@6B@
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@ABV01@@Z
	push	OFFSET __TI3?AVout_of_range@std@@
	lea	ecx, DWORD PTR $T224410[esp+92]
	push	ecx
	mov	BYTE PTR __$EHRec$[esp+104], 0
	mov	DWORD PTR $T224410[esp+96], OFFSET ??_7out_of_range@std@@6B@
	call	__CxxThrowException@8
$LN311@erase@2:
$LN40@erase@2:
	push	ebp
...
; 1189 : 			_THROW(length_error, "map/set<T> too long");
	...
	lea	ecx, DWORD PTR $T225281[esp+88]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z
	lea	ecx, DWORD PTR $T225280[esp+84]
	mov	DWORD PTR __$EHRec$[esp+92], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@XZ
	lea	eax, DWORD PTR $T225281[esp+84]
	push	eax
	lea	ecx, DWORD PTR $T225280[esp+100]
	mov	BYTE PTR __$EHRec$[esp+96], 1
	mov	DWORD PTR $T225280[esp+88], OFFSET ??_7logic_error@std@@6B@
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@ABV01@@Z
	push	OFFSET __TI3?AVlength_error@std@@
	lea	ecx, DWORD PTR $T225280[esp+88]
	push	ecx
	mov	BYTE PTR __$EHRec$[esp+100], 0
	mov	DWORD PTR $T225280[esp+92], OFFSET ??_7length_error@std@@6B@
	call	__CxxThrowException@8
$LN228@Insert:
$LN17@Insert:
...
; 44   : 		for (CvCityManager::CityList::iterator itrNearby = kCityList.begin(); itrNearby != kCityList.end(); ++itrNearby)
	...
	mov	esi, ebp
	add	esp, 16					; 00000010H
	mov	DWORD PTR _iAddDistance$218537[esp+20], eax
	cmp	esi, ecx
...
; 48   : 			if (iAddDistance <= iDistance)
	...
	cmp	DWORD PTR _iAddDistance$218537[esp+20], eax
...
; 120  : 		ms_kCityMap.erase(itr);
	...
	push	eax
	lea	edx, DWORD PTR $T226527[esp+8]
	push	edx
	mov	ecx, OFFSET _ms_kCityMap
...
; 646  : 			iterator _Where = _TREE_ITERATOR(_Wherenode);
	...
	mov	edx, esi
	mov	DWORD PTR __Where$218946[esp+12], edx
...
; 650  : 				return (_Pairib(_Insert(true, _Wherenode, _Val), true));
	...
	lea	ecx, DWORD PTR $T226940[esp+12]
	cmp	esi, DWORD PTR [eax]
...
; 652  : 				--_Where;	// need to test if insert before is okay
	...
	call	?_Dec@const_iterator@?$_Tree@V?$_Tmap_traits@PAVCvCity@@V?$vector@PAVCvCity@@V?$allocator@PAVCvCity@@@std@@@std@@U?$less@PAVCvCity@@@3@V?$allocator@U?$pair@QAVCvCity@@V?$vector@PAVCvCity@@V?$allocator@PAVCvCity@@@std@@@std@@@std@@@3@$0A@@std@@@std@@QAEXXZ ; std::_Tree<std::_Tmap_traits<CvCity *,std::vector<CvCity *,std::allocator<CvCity *> >,std::less<CvCity *>,std::allocator<std::pair<CvCity * const,std::vector<CvCity *,std::allocator<CvCity *> > > >,0> >::const_iterator::_Dec
	mov	edx, DWORD PTR __Where$218946[esp+12]
$LN57@insert@2:
...
; 656  : 				return (_Pairib(_Insert(_Addleft, _Wherenode, _Val), true));
	...
	push	esi
	push	ecx
	lea	edx, DWORD PTR $T226942[esp+24]
	push	edx
	mov	ecx, edi
	call	?_Insert@?$_Tree@V?$_Tmap_traits@PAVCvCity@@V?$vector@PAVCvCity@@V?$allocator@PAVCvCity@@@std@@@std@@U?$less@PAVCvCity@@@3@V?$allocator@U?$pair@QAVCvCity@@V?$vector@PAVCvCity@@V?$allocator@PAVCvCity@@@std@@@std@@@std@@@3@$0A@@std@@@std@@IAE?AViterator@12@_NPAU_Node@?$_Tree_nod@V?$_Tmap_traits@PAVCvCity@@V?$vector@PAVCvCity@@V?$allocator@PAVCvCity@@@std@@@std@@U?$less@PAVCvCity@@@3@V?$allocator@U?$pair@QAVCvCity@@V?$vector@PAVCvCity@@V?$allocator@PAVCvCity@@@std@@@std@@@std@@@3@$0A@@std@@@2@ABU?$pair@QAVCvCity@@V?$vector@PAVCvCity@@V?$allocator@PAVCvCity@@@std@@@std@@@2@@Z ; std::_Tree<std::_Tmap_traits<CvCity *,std::vector<CvCity *,std::allocator<CvCity *> >,std::less<CvCity *>,std::allocator<std::pair<CvCity * const,std::vector<CvCity *,std::allocator<CvCity *> > > >,0> >::_Insert
	mov	ecx, DWORD PTR [eax]
...
$LN65@erase@3:
	push	edx
	lea	eax, DWORD PTR $T227110[esp+12]
	push	eax
	mov	ecx, esi
	call	?erase@?$_Tree@V?$_Tmap_traits@PAVCvCity@@V?$vector@PAVCvCity@@V?$allocator@PAVCvCity@@@std@@@std@@U?$less@PAVCvCity@@@3@V?$allocator@U?$pair@QAVCvCity@@V?$vector@PAVCvCity@@V?$allocator@PAVCvCity@@@std@@@std@@@std@@@3@$0A@@std@@@std@@QAE?AViterator@12@Vconst_iterator@12@@Z ; std::_Tree<std::_Tmap_traits<CvCity *,std::vector<CvCity *,std::allocator<CvCity *> >,std::less<CvCity *>,std::allocator<std::pair<CvCity * const,std::vector<CvCity *,std::allocator<CvCity *> > > >,0> >::erase
	mov	ecx, DWORD PTR __First$[esp+4]
...
; 77   : 	std::pair<CityMap::iterator, bool> kResult = ms_kCityMap.insert(CityMap::value_type(pkAddCity, ms_kEmptyList));
	...
	lea	ecx, DWORD PTR $T227540[esp+64]
	mov	DWORD PTR $T227540[esp+60], ebp
	call	??0?$vector@PAVCvCity@@V?$allocator@PAVCvCity@@@std@@@std@@QAE@ABV01@@Z ; std::vector<CvCity *,std::allocator<CvCity *> >::vector<CvCity *,std::allocator<CvCity *> >
	lea	eax, DWORD PTR $T227540[esp+56]
	push	eax
	...
	mov	eax, DWORD PTR $T227540[esp+64]
...
; 1421 : 		erase(begin(), end());
	...
	push	eax
	push	ecx
	lea	eax, DWORD PTR $T228133[esp+16]
	push	eax
	mov	ecx, esi
	call	?erase@?$_Tree@V?$_Tmap_traits@PAVCvCity@@V?$vector@PAVCvCity@@V?$allocator@PAVCvCity@@@std@@@std@@U?$less@PAVCvCity@@@3@V?$allocator@U?$pair@QAVCvCity@@V?$vector@PAVCvCity@@V?$allocator@PAVCvCity@@@std@@@std@@@std@@@3@$0A@@std@@@std@@QAE?AViterator@12@Vconst_iterator@12@0@Z ; std::_Tree<std::_Tmap_traits<CvCity *,std::vector<CvCity *,std::allocator<CvCity *> >,std::less<CvCity *>,std::allocator<std::pair<CvCity * const,std::vector<CvCity *,std::allocator<CvCity *> > > >,0> >::erase
...
; 540  : 		_Tidy();
	...
	push	eax
	push	ecx
	lea	eax, DWORD PTR $T228267[esp+16]
	push	eax
	mov	ecx, esi
	call	?erase@?$_Tree@V?$_Tmap_traits@PAVCvCity@@V?$vector@PAVCvCity@@V?$allocator@PAVCvCity@@@std@@@std@@U?$less@PAVCvCity@@@3@V?$allocator@U?$pair@QAVCvCity@@V?$vector@PAVCvCity@@V?$allocator@PAVCvCity@@@std@@@std@@@std@@@3@$0A@@std@@@std@@QAE?AViterator@12@Vconst_iterator@12@0@Z ; std::_Tree<std::_Tmap_traits<CvCity *,std::vector<CvCity *,std::allocator<CvCity *> >,std::less<CvCity *>,std::allocator<std::pair<CvCity * const,std::vector<CvCity *,std::allocator<CvCity *> > > >,0> >::erase
	mov	ecx, DWORD PTR [esi+4]
...
; _this$ = ecx
	...
	push	eax
	push	ecx
	lea	eax, DWORD PTR $T228405[esp+16]
	push	eax
	mov	ecx, esi
	call	?erase@?$_Tree@V?$_Tmap_traits@PAVCvCity@@V?$vector@PAVCvCity@@V?$allocator@PAVCvCity@@@std@@@std@@U?$less@PAVCvCity@@@3@V?$allocator@U?$pair@QAVCvCity@@V?$vector@PAVCvCity@@V?$allocator@PAVCvCity@@@std@@@std@@@std@@@3@$0A@@std@@@std@@QAE?AViterator@12@Vconst_iterator@12@0@Z ; std::_Tree<std::_Tmap_traits<CvCity *,std::vector<CvCity *,std::allocator<CvCity *> >,std::less<CvCity *>,std::allocator<std::pair<CvCity * const,std::vector<CvCity *,std::allocator<CvCity *> > > >,0> >::erase
	mov	ecx, DWORD PTR [esi+4]
...
??__Fms_kCityMap@@YAXXZ PROC				; `dynamic atexit destructor for 'ms_kCityMap'', COMDAT
	...
	push	eax
	push	ecx
	lea	eax, DWORD PTR $T229230[esp+12]
	push	eax
	mov	ecx, OFFSET _ms_kCityMap
	call	?erase@?$_Tree@V?$_Tmap_traits@PAVCvCity@@V?$vector@PAVCvCity@@V?$allocator@PAVCvCity@@@std@@@std@@U?$less@PAVCvCity@@@3@V?$allocator@U?$pair@QAVCvCity@@V?$vector@PAVCvCity@@V?$allocator@PAVCvCity@@@std@@@std@@@std@@@3@$0A@@std@@@std@@QAE?AViterator@12@Vconst_iterator@12@0@Z ; std::_Tree<std::_Tmap_traits<CvCity *,std::vector<CvCity *,std::allocator<CvCity *> >,std::less<CvCity *>,std::allocator<std::pair<CvCity * const,std::vector<CvCity *,std::allocator<CvCity *> > > >,0> >::erase
	mov	ecx, DWORD PTR _ms_kCityMap+4
