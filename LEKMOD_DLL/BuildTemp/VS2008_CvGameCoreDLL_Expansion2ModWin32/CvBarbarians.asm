; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\Users\EnormousApplePie\Desktop\Cleanup (v1)\Lekmod Files\Lekmod DLL versions\v30\LEKMOD_DLL\CvGameCoreDLL_Expansion2\CvBarbarians.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_BSS	ENDS
CONST	SEGMENT
$SG217878 DB	'Barb Spawn Rand call', 00H
	ORG $+3
$SG218029 DB	'Random roll to see if Barb Camp spawns this turn', 00H
	ORG $+3
$SG218037 DB	'Barb Camp Plot-Finding Roll - Coastal Bias 1', 00H
	ORG $+3
$SG218051 DB	'Barb Camp Plot-Finding Roll', 00H
$SG218091 DB	'Barb Camp Plot-Finding Roll - Coastal Bias 2', 00H
	ORG $+3
$SG218151 DB	'Barb Unit Selection', 00H
$SG218219 DB	'Barb Unit Location Spawn Roll', 00H
CONST	ENDS
...
; Function compile flags: /Ogtpy
; File c:\users\enormousapplepie\desktop\cleanup (v1)\lekmod files\lekmod dll versions\v30\lekmod_dll\cvgamecoredll_expansion2\cvbarbarians.cpp
...
_iUnitClassLoop$218104 = -20				; size = 4
_eBestUnit$ = -16					; size = 4
_kBarbarianPlayer$ = -12				; size = 4
_kGame$ = -8						; size = 4
_eLoopUnit$218112 = -4					; size = 4
_pArea$ = 8						; size = 4
_eUnitAI$ = 12						; size = 4
...
; 580  : 	for(int iUnitClassLoop = 0; iUnitClassLoop < GC.getNumUnitClassInfos(); iUnitClassLoop++)
	...
	mov	DWORD PTR _iUnitClassLoop$218104[esp+32], esi
...
; 588  : 		const UnitTypes eLoopUnit = ((UnitTypes)(kBarbarianPlayer.getCivilizationInfo().getCivilizationUnits(iUnitClassLoop)));
	...
	mov	ebx, eax
	mov	DWORD PTR _eLoopUnit$218112[esp+40], ebx
...
; 685  : 					eBestUnit = eLoopUnit;
	...
	mov	eax, DWORD PTR _eLoopUnit$218112[esp+40]
...
$LN29@GetRandomB:
	mov	esi, DWORD PTR _iUnitClassLoop$218104[esp+40]
	inc	esi
	mov	ecx, OFFSET ?gGlobals@@3VCvGlobals@@A	; gGlobals
	mov	DWORD PTR _iUnitClassLoop$218104[esp+40], esi
	call	?getNumUnitClassInfos@CvGlobals@@QAEHXZ	; CvGlobals::getNumUnitClassInfos
	cmp	esi, eax
	jl	$LL60@GetRandomB
...
; 45   : 	for (int iDX = -(iRange); iDX <= iRange; iDX++)
	...
	mov	DWORD PTR _iDX$217848[esp+32], -4	; fffffffcH
	npad	5
$LL65@IsPlotVali:
...
; 49   : 			int iLoopPlotX = iPlotX + iDX;
	...
	mov	ecx, DWORD PTR _iDX$217848[esp+32]
...
$LN5@IsPlotVali:
	...
	jle	$LL6@IsPlotVali
	mov	eax, DWORD PTR _iDX$217848[esp+32]
	inc	eax
	cmp	eax, 4
	mov	DWORD PTR _iDX$217848[esp+32], eax
	jle	$LL65@IsPlotVali
	pop	edi
	pop	esi
	pop	ebp
...
_TEXT	SEGMENT
_bWantsCoastal$218036 = -98				; size = 1
_bAlwaysRevealedBarbCamp$ = -97				; size = 1
_iMaxDistanceToLook$218040 = -96			; size = 4
_iNumCampsInExistence$ = -96				; size = 4
_eCamp$ = -92						; size = 4
_iNumCampsToAdd$218023 = -88				; size = 4
_iNumNotVisiblePlots$ = -88				; size = 4
_iCampTargetNum$218022 = -84				; size = 4
_iDY$218043 = -80					; size = 4
_iDX$218042 = -76					; size = 4
_kGame$ = -72						; size = 4
_kMap$218012 = -68					; size = 4
_iNumLandPlots$218035 = -64				; size = 4
_iNumPlots$218033 = -60					; size = 4
_iPlayerCapitalMinDistance$218038 = -56			; size = 4
_iBarbCampMinDistance$218039 = -52			; size = 4
tv783 = -48						; size = 4
$T220049 = -48						; size = 4
_iCount$218031 = -44					; size = 4
_strBuffer$218046 = -40					; size = 28
__$EHRec$ = -12						; size = 12
...
; 325  : 		for(int iI = 0; iI < kMap.numPlots(); iI++)
	...
	cmp	eax, edi
	push	esi
	mov	DWORD PTR _kMap$218012[esp+116], ebp
...
; 350  : 		int iCampTargetNum = (iFogTilesPerBarbarianCamp != 0)? iNumValidCampPlots / iFogTilesPerBarbarianCamp : 0;//getHandicapInfo().getFogTilesPerBarbarianCamp();
	...
	cdq
	idiv	ecx
	mov	DWORD PTR _iCampTargetNum$218022[esp+116], eax
	jmp	SHORT $LN56@DoCamps
$LN55@DoCamps:
	mov	DWORD PTR _iCampTargetNum$218022[esp+116], edi
$LN56@DoCamps:

; 351  : 		int iNumCampsToAdd = iCampTargetNum - iNumCampsInExistence;

	mov	esi, DWORD PTR _iCampTargetNum$218022[esp+116]
...
; 361  : 				iNumCampsToAdd /= 100;
	...
	shr	eax, 31					; 0000001fH
	add	eax, edx
	mov	DWORD PTR _iNumCampsToAdd$218023[esp+116], eax
...
; 366  : 				if(kGame.getJonRandNum(/*2*/ GC.getBARBARIAN_CAMP_ODDS_OF_NEW_CAMP_SPAWNING(), "Random roll to see if Barb Camp spawns this turn") > 0)
	...
	test	eax, eax
	setg	cl
	mov	DWORD PTR _iNumCampsToAdd$218023[esp+116], ecx
$LN41@DoCamps:
...
; 383  : 			int iNumLandPlots = kMap.getLandPlots();
	...
	mov	ecx, ebp
	xor	esi, esi
	mov	DWORD PTR _iNumPlots$218033[esp+116], edx
	call	?getLandPlots@CvMap@@QAEHXZ		; CvMap::getLandPlots
	mov	DWORD PTR _iNumLandPlots$218035[esp+116], eax
...
; 389  : 			int iBarbCampMinDistance = /*7*/ GC.getBARBARIAN_CAMP_MINIMUM_DISTANCE_ANOTHER_CAMP();
	...
	sete	BYTE PTR _bWantsCoastal$218036[esp+116]

; 390  : 			int iMaxDistanceToLook = iPlayerCapitalMinDistance > iBarbCampMinDistance ? iPlayerCapitalMinDistance : iBarbCampMinDistance;

	cmp	eax, ecx
	mov	DWORD PTR _iPlayerCapitalMinDistance$218038[esp+116], eax
	mov	DWORD PTR _iBarbCampMinDistance$218039[esp+116], ecx
	jle	SHORT $LN57@DoCamps
	mov	ebx, eax
	mov	DWORD PTR _iMaxDistanceToLook$218040[esp+116], ebx
	jmp	SHORT $LN58@DoCamps
$LN57@DoCamps:
	mov	DWORD PTR _iMaxDistanceToLook$218040[esp+116], ecx
	mov	ebx, ecx
$LN58@DoCamps:
...
; 397  : 			CvString strBuffer;
	...
	lea	ecx, DWORD PTR _strBuffer$218046[esp+116]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
...
; 406  : 				iPlotIndex = kGame.getJonRandNum(iNumPlots, "Barb Camp Plot-Finding Roll");
	...
	mov	ecx, DWORD PTR _iNumPlots$218033[esp+116]
	push	OFFSET $SG218051
	push	ecx
	inc	esi
	mov	ecx, edi
	mov	DWORD PTR _iCount$218031[esp+124], esi
	call	?getJonRandNum@CvGame@@QAEHHPBD@Z	; CvGame::getJonRandNum
...
; 423  : 									if(pLoopPlot->isCoastalLand() || !bWantsCoastal)
	...
	cmp	BYTE PTR _bWantsCoastal$218036[esp+116], al
	jne	$LN38@DoCamps
$LN30@DoCamps:
...
; 426  : 										iMaxCampsThisArea = iCampTargetNum * pLoopPlot->area()->getNumTiles() / iNumLandPlots;
	...
	mov	ecx, eax
	call	?getNumTiles@CvArea@@QBEHXZ		; CvArea::getNumTiles
	imul	eax, DWORD PTR _iCampTargetNum$218022[esp+116]
	cdq
	idiv	DWORD PTR _iNumLandPlots$218035[esp+116]
...
; 449  : 													for(iDX = -(iMaxDistanceToLook); iDX <= iMaxDistanceToLook; iDX++)
	...
	mov	DWORD PTR _iDX$218042[esp+116], ecx
	jg	$LN170@DoCamps
$LL25@DoCamps:
...
; 451  : 														for(iDY = -(iMaxDistanceToLook); iDY <= iMaxDistanceToLook; iDY++)
	...
	cmp	ecx, ebx
	mov	DWORD PTR _iDY$218043[esp+116], ecx
	jg	$LN20@DoCamps
	jmp	SHORT $LN22@DoCamps
	npad	2
$LL172@DoCamps:
	mov	ecx, DWORD PTR _iDY$218043[esp+116]
$LN22@DoCamps:
...
; 465  : 																if(iPlotDistance <= iPlayerCapitalMinDistance)
	...
	cmp	ebx, DWORD PTR _iPlayerCapitalMinDistance$218038[esp+116]
...
; 482  : 																if(iPlotDistance <= iBarbCampMinDistance)
	...
	cmp	ebx, DWORD PTR _iBarbCampMinDistance$218039[esp+116]
...
; 451  : 														for(iDY = -(iMaxDistanceToLook); iDY <= iMaxDistanceToLook; iDY++)
	...
	mov	eax, DWORD PTR _iDY$218043[esp+116]
	inc	eax
	cmp	eax, DWORD PTR _iMaxDistanceToLook$218040[esp+116]
	mov	DWORD PTR _iDY$218043[esp+116], eax
	mov	eax, DWORD PTR _iDX$218042[esp+116]
	jle	$LL172@DoCamps
	mov	ecx, DWORD PTR tv783[esp+116]
	mov	ebp, DWORD PTR _kMap$218012[esp+116]
	mov	ebx, DWORD PTR _iMaxDistanceToLook$218040[esp+116]
$LN20@DoCamps:
	inc	eax
	cmp	eax, ebx
	mov	DWORD PTR _iDX$218042[esp+116], eax
	jle	$LL25@DoCamps
$LN170@DoCamps:
...
; 547  : 													bWantsCoastal = kGame.getJonRandNum(/*5*/ GC.getBARBARIAN_CAMP_COASTAL_SPAWN_ROLL(), "Barb Camp Plot-Finding Roll - Coastal Bias 2") == 0 ? true : false;
	...
	dec	DWORD PTR _iNumCampsToAdd$218023[esp+116]
...
; 558  : 			while(iNumCampsToAdd > 0 && iCount < iNumLandPlots);
	...
	cmp	DWORD PTR _iNumCampsToAdd$218023[esp+116], 0
	jle	SHORT $LN2@DoCamps
	mov	esi, DWORD PTR _iCount$218031[esp+116]
	cmp	esi, DWORD PTR _iNumLandPlots$218035[esp+116]
	jl	$LL177@DoCamps
$LN2@DoCamps:
...
__unwindfunclet$?DoCamps@CvBarbarians@@SAXXZ$0:
	lea	ecx, DWORD PTR _strBuffer$218046[ebp]
...
_TEXT	SEGMENT
_bCanSpawnBoats$218204 = -29				; size = 1
tv627 = -28						; size = 4
_iRange$ = -24						; size = 4
tv642 = -20						; size = 4
...
; 817  : 		bool bCanSpawnBoats = kGame.getElapsedGameTurns() > /*30*/ GC.getBARBARIAN_NAVAL_UNIT_START_TURN_SPAWN();
	...
	call	?getElapsedGameTurns@CvGame@@QBEHXZ	; CvGame::getElapsedGameTurns
	cmp	eax, esi
	setg	BYTE PTR _bCanSpawnBoats$218204[esp+48]
...
; 836  : 								if(!pLoopPlot->isWater() || bCanSpawnBoats)
	...
	cmp	BYTE PTR _bCanSpawnBoats$218204[esp+48], al
	je	SHORT $LN14@DoSpawnBar
$LN6@DoSpawnBar:
