; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\Users\EnormousApplePie\Desktop\Lekmod Files\Lekmod DLL versions\v29\LEKMOD_DLL\CvGameCoreDLL_Expansion2\CvEmphasisClasses.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG217536 DB	'AvoidGrowth', 00H
$SG217537 DB	'GreatPeople', 00H
$SG217539 DB	'EmphasizeType', 00H
	ORG $+2
$SG217540 DB	'EmphasizeInfo_Yields', 00H
CONST	ENDS
PUBLIC	?IsAvoidGrowth@CvEmphasisEntry@@QBE_NXZ		; CvEmphasisEntry::IsAvoidGrowth
; Function compile flags: /Ogtpy
; File c:\users\enormousapplepie\desktop\lekmod files\lekmod dll versions\v29\lekmod_dll\cvgamecoredll_expansion2\cvemphasisclasses.cpp
...
; 1260 : 		_THROW(length_error, "vector<T> too long");
	...
	lea	ecx, DWORD PTR $T218755[esp+84]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z
	lea	ecx, DWORD PTR $T218754[esp+80]
	mov	DWORD PTR __$EHRec$[esp+88], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@XZ
	lea	eax, DWORD PTR $T218755[esp+80]
	push	eax
	lea	ecx, DWORD PTR $T218754[esp+96]
	mov	BYTE PTR __$EHRec$[esp+92], 1
	mov	DWORD PTR $T218754[esp+84], OFFSET ??_7logic_error@std@@6B@
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@ABV01@@Z
	push	OFFSET __TI3?AVlength_error@std@@
	lea	ecx, DWORD PTR $T218754[esp+84]
	push	ecx
	mov	BYTE PTR __$EHRec$[esp+96], 0
	mov	DWORD PTR $T218754[esp+88], OFFSET ??_7length_error@std@@6B@
...
_TEXT	SEGMENT
_tValue$217995 = -7					; size = 1
_bValid$217992 = -6					; size = 1
_tValue$218000 = -5					; size = 1
...
; 256  : 		int iType = ReadHashed(kStream, &bValid);
	...
	lea	ecx, DWORD PTR _bValid$217992[esp+24]
	push	ecx
	push	edi
...
; 260  : 			kStream >> tValue;
	...
	lea	edx, DWORD PTR _tValue$217995[esp+24]
	push	edx
	mov	ecx, edi
	call	?Read@FDataStream@@IAEXAA_N@Z		; FDataStream::Read
...
; 262  : 				paArray[iType] = tValue;
	...
	mov	al, BYTE PTR _tValue$217995[esp+24]
...
; 264  : 		else if(!bValid)
	...
	cmp	BYTE PTR _bValid$217992[esp+24], 0
...
; 267  : 			kStream >> tValue;
	...
	lea	edx, DWORD PTR _tValue$218000[esp+24]
	push	edx
	mov	ecx, edi
	call	?Read@FDataStream@@IAEXAA_N@Z		; FDataStream::Read
$LN6@ReadHashed:
...
; 40   : 		_THROW_NCEE(std::bad_alloc, NULL);
	...
	lea	eax, DWORD PTR $T218876[esp+8]
	push	eax
	lea	ecx, DWORD PTR $T218872[esp+16]
	mov	DWORD PTR $T218876[esp+12], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@ABQBD@Z
	push	OFFSET __TI2?AVbad_alloc@std@@
	lea	ecx, DWORD PTR $T218872[esp+16]
	push	ecx
	mov	DWORD PTR $T218872[esp+20], OFFSET ??_7bad_alloc@std@@6B@
	call	__CxxThrowException@8
$LN9@Allocate:
$LN8@Allocate:
	int	3
...
; 240  : 		if(pkEmphasis->IsAvoidGrowth())
	...
	mov	DWORD PTR _pkEmphasis$217795[esp+4], ecx
...
$LL39@SetEmphasi:
	mov	ecx, DWORD PTR _pkEmphasis$217795[esp+12]
$LN5@SetEmphasi:
