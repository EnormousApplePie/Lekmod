...
; 306  : 	static GUID DLLCALL GetInterfaceId(){ return guidICvUnknown; }
	...
	mov	eax, DWORD PTR $T218686[esp-4]
...
; 1663 : 	static GUID DLLCALL GetInterfaceId() { return guidICvTeam1; }
	...
	mov	eax, DWORD PTR $T218690[esp-4]
...
; 29   : 	        guidInterface == ICvTeam1::GetInterfaceId())
	...
	mov	DWORD PTR $T218703[esp+20], ecx
	lea	ecx, DWORD PTR $T218703[esp+16]
	mov	DWORD PTR $T218703[esp+24], edx
	mov	DWORD PTR $T218703[esp+16], eax
	mov	eax, DWORD PTR _guidICvUnknown+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T218703[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	...
	mov	DWORD PTR $T218705[esp+20], ecx
	lea	ecx, DWORD PTR $T218705[esp+16]
	mov	DWORD PTR $T218705[esp+24], edx
	mov	DWORD PTR $T218705[esp+16], eax
	mov	eax, DWORD PTR _guidICvTeam1+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T218705[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	jne	SHORT $LN1@QueryInter
