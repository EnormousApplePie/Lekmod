...
; 1663 : 	static GUID DLLCALL GetInterfaceId() { return guidICvTeam1; }
	...
	mov	eax, DWORD PTR $T219204[esp-4]
...
; 29   : 	        guidInterface == ICvTeam1::GetInterfaceId())
	...
	mov	DWORD PTR $T219217[esp+20], ecx
	lea	ecx, DWORD PTR $T219217[esp+16]
	mov	DWORD PTR $T219217[esp+24], edx
	mov	DWORD PTR $T219217[esp+16], eax
	mov	eax, DWORD PTR _guidICvUnknown+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T219217[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	...
	mov	DWORD PTR $T219219[esp+20], ecx
	lea	ecx, DWORD PTR $T219219[esp+16]
	mov	DWORD PTR $T219219[esp+24], edx
	mov	DWORD PTR $T219219[esp+16], eax
	mov	eax, DWORD PTR _guidICvTeam1+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T219219[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	jne	SHORT $LN1@QueryInter
