...
CONST	SEGMENT
$SG218094 DB	'LOAD ERROR: Building Type not found', 00H
$SG218157 DB	'%03d, ', 00H
	ORG $+1
$SG218161 DB	', ', 00H
	ORG $+1
...
$T219350 = -12						; size = 4
_elem$219366 = -8					; size = 8
$T219351 = -8						; size = 4
_iNumBuildings$218102 = 8				; size = 4
_kStream$ = 8						; size = 4
...
; 117  : 		kStream << iNumBuildings;
	...
	lea	ecx, DWORD PTR _iNumBuildings$218102[esp+24]
	push	ecx
	mov	ecx, edi
	mov	DWORD PTR _iNumBuildings$218102[esp+28], eax
	call	?Write@FDataStream@@IAEXABH@Z		; FDataStream::Write
...
; 120  : 		for(int iI = 0; iI < iNumBuildings; iI++)
	...
	xor	esi, esi
	cmp	DWORD PTR _iNumBuildings$218102[esp+24], esi
...
; 127  : 				kStream << m_BuildingAIWeights.GetWeight(iI);
	...
	mov	DWORD PTR $T219350[esp+36], eax
	add	esp, 8
	lea	eax, DWORD PTR $T219350[esp+28]
	mov	DWORD PTR _elem$219366[esp+28], edx
	push	eax
...
; 131  : 				kStream << (int)0;
	...
	lea	ecx, DWORD PTR $T219351[esp+28]
	mov	DWORD PTR $T219351[esp+28], 0
	push	ecx
$LN26@Write:
	mov	ecx, edi
	call	?Write@FDataStream@@IAEXABH@Z		; FDataStream::Write
	inc	esi
	cmp	esi, DWORD PTR _iNumBuildings$218102[esp+24]
	jl	SHORT $LL5@Write
$LN25@Write:
	pop	esi
$LN3@Write:
...
; 284  : 	return m_BuildingAIWeights.GetWeight(eBuilding);
	...
	mov	edx, DWORD PTR [eax+ecx*8]
	mov	eax, DWORD PTR [eax+ecx*8+4]
	mov	DWORD PTR _elem$219407[esp+8], edx
...
_TEXT	SEGMENT
_iI$218165 = -224					; size = 4
_pGameBuildings$218163 = -220				; size = 4
_strTemp$218171 = -216					; size = 28
$T219418 = -216						; size = 28
_strOutBuf$218173 = -188				; size = 28
$T219419 = -188						; size = 28
_strBaseString$218156 = -160				; size = 28
_playerName$218151 = -132				; size = 28
_cityName$218152 = -104					; size = 28
$T219420 = -76						; size = 28
$T219417 = -76						; size = 28
_elem$219500 = -48					; size = 8
$T219416 = -40						; size = 28
__$EHRec$ = -12						; size = 12
...
$LN28@LogPossibl:
	...
	push	edi
	push	eax
	lea	ecx, DWORD PTR _playerName$218151[esp+244]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z

; 337  : 		CvString cityName = m_pCity->getName();

	lea	ecx, DWORD PTR _cityName$218152[esp+240]
	push	ecx
...
; 340  : 		FILogFile* pLog = LOGFILEMGR.GetLog(m_pCity->GetCityStrategyAI()->GetLogFileName(playerName, cityName), FILogFile::kDontTimeStamp);
	...
	lea	edx, DWORD PTR _cityName$218152[esp+240]
	mov	edi, eax
	push	edx
	lea	eax, DWORD PTR _playerName$218151[esp+244]
	push	eax
	lea	ecx, DWORD PTR $T219416[esp+248]
	push	ecx
	mov	ecx, DWORD PTR [esi]
	...
	mov	ecx, edi
	call	eax
	lea	ecx, DWORD PTR $T219416[esp+240]
	mov	ebp, eax
	mov	BYTE PTR __$EHRec$[esp+248], 1
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
...
; 343  : 		CvString strBaseString;
	...
	lea	ecx, DWORD PTR _strBaseString$218156[esp+240]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
...
; 344  : 		strBaseString.Format("%03d, ", GC.getGame().getElapsedGameTurns());
	...
	push	eax
	lea	ecx, DWORD PTR _strBaseString$218156[esp+244]
...
; 345  : 		strBaseString += playerName + ", " + cityName + ", ";
	...
	lea	edx, DWORD PTR _playerName$218151[esp+256]
	push	edx
	lea	eax, DWORD PTR $T219417[esp+260]
	push	eax
	call	edi
	lea	ecx, DWORD PTR _cityName$218152[esp+264]
	push	ecx
	push	eax
	lea	edx, DWORD PTR $T219418[esp+272]
	push	edx
	mov	BYTE PTR __$EHRec$[esp+284], 4
	call	DWORD PTR __imp_??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@0@Z
	push	OFFSET $SG218161
	push	eax
	lea	eax, DWORD PTR $T219419[esp+284]
	mov	bl, 5
	push	eax
	...
	lea	ecx, DWORD PTR $T219419[esp+240]
	mov	BYTE PTR __$EHRec$[esp+248], bl
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	lea	ecx, DWORD PTR $T219418[esp+240]
	mov	BYTE PTR __$EHRec$[esp+248], 4
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	lea	ecx, DWORD PTR $T219417[esp+240]
	mov	BYTE PTR __$EHRec$[esp+248], 3
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
...
; 348  : 		CvBuildingXMLEntries* pGameBuildings = GC.GetGameBuildings();
	...
	mov	ecx, eax
	mov	DWORD PTR _pGameBuildings$218163[esp+240], ecx
...
; 351  : 			for(int iI = 0; iI < m_Buildables.size(); iI++)
	...
	mov	DWORD PTR _iI$218165[esp+240], 0
	jle	$LN2@LogPossibl
	jmp	SHORT $LN4@LogPossibl
	npad	8
$LL81@LogPossibl:
	mov	ecx, DWORD PTR _pGameBuildings$218163[esp+240]
$LN4@LogPossibl:
	mov	edi, DWORD PTR _iI$218165[esp+240]
...
; 356  : 					CvString strTemp;
	...
	lea	ecx, DWORD PTR _strTemp$218171[esp+240]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
...
; 357  : 					strTemp.Format("Building, %s, %d", pBuildingEntry->GetDescription(), m_Buildables.GetWeight(iI));
	...
	mov	DWORD PTR _elem$219500[esp+240], ecx
	push	eax
	lea	ecx, DWORD PTR [ebx+36]
	mov	BYTE PTR __$EHRec$[esp+252], 7
	call	DWORD PTR __imp_?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ
	push	eax
	lea	edx, DWORD PTR _strTemp$218171[esp+248]
...
; 358  : 					CvString strOutBuf = strBaseString + strTemp;
	...
	lea	eax, DWORD PTR _strTemp$218171[esp+256]
	push	eax
	lea	ecx, DWORD PTR _strBaseString$218156[esp+260]
	push	ecx
	lea	edx, DWORD PTR $T219420[esp+264]
	push	edx
	call	DWORD PTR __imp_??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@0@Z
	add	esp, 28					; 0000001cH
	push	eax
	lea	ecx, DWORD PTR _strOutBuf$218173[esp+244]
	mov	BYTE PTR __$EHRec$[esp+252], 8
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@ABV01@@Z
	lea	ecx, DWORD PTR $T219420[esp+240]
	mov	BYTE PTR __$EHRec$[esp+248], 10		; 0000000aH
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ

; 359  : 					pLog->Msg(strOutBuf);

	lea	ecx, DWORD PTR _strOutBuf$218173[esp+240]
	call	DWORD PTR __imp_?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ
...
; 360  : 				}
	...
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
$LN3@LogPossibl:
	mov	eax, DWORD PTR _iI$218165[esp+240]
	inc	eax
	cmp	eax, DWORD PTR [esi+1108]
	mov	DWORD PTR _iI$218165[esp+240], eax
	jl	$LL81@LogPossibl
$LN2@LogPossibl:
...
; 363  : 	}
	...
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	lea	ecx, DWORD PTR _playerName$218151[esp+240]
...
_TEXT	SEGMENT
__Tmp$220022 = -24					; size = 8
__Tmp$219951 = -16					; size = 8
__Tmp$219977 = -8					; size = 8
___$ReturnUdt$ = 8					; size = 4
__First$ = 12						; size = 4
__Last$ = 16						; size = 4
...
; 3050 : 				std::iter_swap(_Plast++, _Gfirst);
	...
	mov	edi, DWORD PTR [edx]
	mov	DWORD PTR __Tmp$219951[esp+44], ebp
	mov	ebp, DWORD PTR [eax]
	mov	DWORD PTR [edx], ebp
	mov	ebp, DWORD PTR [eax+4]
	mov	DWORD PTR [edx+4], ebp
	mov	edx, DWORD PTR __Tmp$219951[esp+44]
	mov	DWORD PTR [eax], edi
	mov	DWORD PTR [eax+4], edx
$LN20@Unguarded_:
	add	eax, 8
...
; 3057 : 				std::iter_swap(--_Pfirst, _Glast - 1);
	...
	mov	ebp, DWORD PTR [ecx+4]
	mov	edi, DWORD PTR [ecx]
	mov	DWORD PTR __Tmp$219977[esp+44], ebp
	mov	ebp, DWORD PTR [edx]
	mov	DWORD PTR [ecx], ebp
	mov	ebp, DWORD PTR [edx+4]
	mov	DWORD PTR [ecx+4], ebp
	mov	DWORD PTR [edx], edi
	mov	edi, DWORD PTR __Tmp$219977[esp+44]
	mov	DWORD PTR [edx+4], edi
$LN13@Unguarded_:
	sub	ebx, 8
	sub	edx, 8
...
; 3066 : 			std::iter_swap(_Pfirst++, _Gfirst++);
	...
	mov	DWORD PTR __Tmp$220022[esp+40], ebp
	mov	ebp, DWORD PTR [edi+4]
	mov	DWORD PTR __Tmp$220022[esp+44], ebp
	mov	ebp, DWORD PTR [edx]
	mov	DWORD PTR [edi], ebp
	mov	ebp, DWORD PTR [edx+4]
	mov	DWORD PTR [edi+4], ebp
	mov	edi, DWORD PTR __Tmp$220022[esp+40]
	mov	DWORD PTR [edx], edi
	mov	edi, DWORD PTR __Tmp$220022[esp+44]
	mov	DWORD PTR [edx+4], edi
	jmp	$LL23@Unguarded_
$LN6@Unguarded_:
...
_TEXT	SEGMENT
_bValid$218087 = -137					; size = 1
_sTemp$218067 = -136					; size = 4
_iI$218083 = -132					; size = 4
_iNumEntries$218066 = -128				; size = 4
_iWeight$218090 = -124					; size = 4
_uiVersion$ = -120					; size = 4
_szError$218093 = -116					; size = 28
_FStringFixedBuffer_sTemp$218081 = -88			; size = 76
__$EHRec$ = -12						; size = 12
_kStream$ = 8						; size = 4
...
; 72   : 		FStringFixedBuffer(sTemp, 64);
	...
	call	?FStringA_GetStringInitData@@YAPAUFStringAData@FStringA@@XZ ; FStringA_GetStringInitData
	add	eax, 12					; 0000000cH
	mov	DWORD PTR _sTemp$218067[esp+156], eax
	xor	ecx, ecx
	lea	edi, DWORD PTR [eax-12]
	mov	edx, 1
	mov	DWORD PTR __$EHRec$[esp+164], ebx
	mov	WORD PTR _FStringFixedBuffer_sTemp$218081[esp+164], cx
	mov	WORD PTR _FStringFixedBuffer_sTemp$218081[esp+166], dx
	mov	DWORD PTR _FStringFixedBuffer_sTemp$218081[esp+156], 64 ; 00000040H
	mov	DWORD PTR _FStringFixedBuffer_sTemp$218081[esp+160], ebx
	mov	BYTE PTR _FStringFixedBuffer_sTemp$218081[esp+168], bl
	cmp	edi, ebx
	je	SHORT $LN58@Read
	call	?FStringA_GetStringInitData@@YAPAUFStringAData@FStringA@@XZ ; FStringA_GetStringInitData
	cmp	edi, eax
	...
	add	esp, 4
$LN58@Read:
	mov	DWORD PTR _sTemp$218067[esp+156], ebx
	call	?FStringA_GetStringInitData@@YAPAUFStringAData@FStringA@@XZ ; FStringA_GetStringInitData
...
; 75   : 		kStream >> iNumEntries;
	...
	lea	ecx, DWORD PTR _iNumEntries$218066[esp+156]
	lea	eax, DWORD PTR _FStringFixedBuffer_sTemp$218081[esp+168]
	push	ecx
	mov	ecx, ebp
	mov	DWORD PTR _sTemp$218067[esp+160], eax
	call	?Read@FDataStream@@IAEXAAH@Z		; FDataStream::Read

; 76   : 
; 77   : 		for(int iI = 0; iI < iNumEntries; iI++)

	cmp	DWORD PTR _iNumEntries$218066[esp+156], ebx
	mov	DWORD PTR _iI$218083[esp+156], ebx
	jle	$LN100@Read
$LL8@Read:
...
; 80   : 			iType = CvInfosSerializationHelper::ReadHashed(kStream, &bValid);
	...
	lea	edx, DWORD PTR _bValid$218087[esp+156]
	push	edx
	push	ebp
	mov	BYTE PTR _bValid$218087[esp+164], 1
...
; 81   : 			if(iType != -1 || !bValid)
	...
	cmp	edi, -1
	jne	SHORT $LN4@Read
	cmp	BYTE PTR _bValid$218087[esp+156], bl
	jne	SHORT $LN7@Read
$LN4@Read:
...
; 84   : 				kStream >> iWeight;
	...
	lea	eax, DWORD PTR _iWeight$218090[esp+156]
	push	eax
	mov	ecx, ebp
	call	?Read@FDataStream@@IAEXAAH@Z		; FDataStream::Read
...
; 87   : 					m_BuildingAIWeights.IncreaseWeight(iType, iWeight);
	...
	mov	ecx, DWORD PTR [esi]
	mov	edx, DWORD PTR _iWeight$218090[esp+156]
...
; 91   : 					CvString szError;
	...
	lea	ecx, DWORD PTR _szError$218093[esp+156]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ

; 92   : 					szError.Format("LOAD ERROR: Building Type not found");

	lea	eax, DWORD PTR _szError$218093[esp+156]
...
; 95   : 				}
	...
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
$LN7@Read:
	mov	eax, DWORD PTR _iI$218083[esp+156]
	inc	eax
	cmp	eax, DWORD PTR _iNumEntries$218066[esp+156]
	mov	DWORD PTR _iI$218083[esp+156], eax
	jl	$LL8@Read
$LN100@Read:
...
; 98   : 	}
	...
	call	?FStringA_GetStringInitData@@YAPAUFStringAData@FStringA@@XZ ; FStringA_GetStringInitData
	lea	ecx, DWORD PTR _FStringFixedBuffer_sTemp$218081[esp+156]
	pop	edi
	cmp	ecx, eax
	je	SHORT $LN89@Read
	cmp	WORD PTR _FStringFixedBuffer_sTemp$218081[esp+162], bx
	jne	SHORT $LN89@Read
	mov	edx, ecx
	push	edx
	call	??_V@YAXPAX@Z				; operator delete[]
...
__unwindfunclet$?Read@CvBuildingProductionAI@@QAEXAAVFDataStream@@@Z$0:
	lea	ecx, DWORD PTR _sTemp$218067[ebp]
...
; 3087 : 			std::_Unguarded_partition(_First, _Last);
	...
	push	edi
	lea	eax, DWORD PTR __Mid$218329[esp+28]
	push	ebx
	push	eax
...
; 3090 : 		if (_Mid.first - _First < _Last - _Mid.second)
	...
	mov	ebp, DWORD PTR __Mid$218329[esp+40]
	mov	eax, esi
	cdq
	sub	eax, edx
	sar	eax, 1
	...
	sar	eax, 1
	add	esi, eax
	mov	eax, DWORD PTR __Mid$218329[esp+36]
	mov	ecx, edi
	mov	edx, eax
	sub	ecx, ebp
	sub	edx, ebx
...
; 3098 : 			_Last = _Mid.first;
	...
	mov	edi, DWORD PTR __Mid$218329[esp+36]
$LN26@Sort:
	mov	eax, edi
	sub	eax, ebx
	sar	eax, 3
...
; 310  : 			iWeight = CityStrategyAIHelpers::ReweightByTurnsLeft(m_BuildingAIWeights.GetWeight((BuildingTypes)iBldgLoop), iTurnsLeft);
	...
	push	eax
	push	ecx
	mov	DWORD PTR _elem$220899[esp+32], edx
