...
; 29   : 	        guidInterface == ICvUnitInfo1::GetInterfaceId())
	...
	mov	DWORD PTR $T219069[esp+20], ecx
	lea	ecx, DWORD PTR $T219069[esp+16]
	mov	DWORD PTR $T219069[esp+24], edx
	mov	DWORD PTR $T219069[esp+16], eax
	mov	eax, DWORD PTR _guidICvUnknown+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T219069[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	...
	mov	DWORD PTR $T219071[esp+20], ecx
	lea	ecx, DWORD PTR $T219071[esp+16]
	mov	DWORD PTR $T219071[esp+24], edx
	mov	DWORD PTR $T219071[esp+16], eax
	mov	eax, DWORD PTR _guidICvUnitInfo1+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T219071[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	jne	SHORT $LN1@QueryInter
