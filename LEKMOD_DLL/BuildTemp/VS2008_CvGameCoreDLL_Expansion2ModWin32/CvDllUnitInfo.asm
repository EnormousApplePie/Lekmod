; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\Users\EnormousApplePie\Desktop\Lekmod Files\Lekmod DLL versions\v29\LEKMOD_DLL\CvGameCoreDLL_Expansion2\CvDllUnitInfo.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File c:\users\enormousapplepie\desktop\lekmod files\lekmod dll versions\v29\lekmod_dll\cvgamecoredll_expansion2\cvdllunitinfo.cpp
rdata$r	SEGMENT
...
; 29   : 	        guidInterface == ICvUnitInfo1::GetInterfaceId())
	...
	mov	DWORD PTR $T218546[esp+20], ecx
	lea	ecx, DWORD PTR $T218546[esp+16]
	mov	DWORD PTR $T218546[esp+24], edx
	mov	DWORD PTR $T218546[esp+16], eax
	mov	eax, DWORD PTR _guidICvUnknown+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T218546[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	...
	mov	DWORD PTR $T218548[esp+20], ecx
	lea	ecx, DWORD PTR $T218548[esp+16]
	mov	DWORD PTR $T218548[esp+24], edx
	mov	DWORD PTR $T218548[esp+16], eax
	mov	eax, DWORD PTR _guidICvUnitInfo1+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T218548[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	jne	SHORT $LN1@QueryInter
