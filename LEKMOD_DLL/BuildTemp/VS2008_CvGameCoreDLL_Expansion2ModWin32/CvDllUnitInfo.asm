...
; 306  : 	static GUID DLLCALL GetInterfaceId(){ return guidICvUnknown; }
	...
	mov	eax, DWORD PTR $T219089[esp-4]
...
; 1784 : 	static GUID DLLCALL GetInterfaceId() { return guidICvUnitInfo1; }
	...
	mov	eax, DWORD PTR $T219093[esp-4]
...
; 29   : 	        guidInterface == ICvUnitInfo1::GetInterfaceId())
	...
	mov	DWORD PTR $T219109[esp+20], ecx
	lea	ecx, DWORD PTR $T219109[esp+16]
	mov	DWORD PTR $T219109[esp+24], edx
	mov	DWORD PTR $T219109[esp+16], eax
	mov	eax, DWORD PTR _guidICvUnitInfo1+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T219109[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	jne	SHORT $LN1@QueryInter
