...
; 306  : 	static GUID DLLCALL GetInterfaceId(){ return guidICvUnknown; }
	...
	mov	eax, DWORD PTR $T218587[esp-4]
...
; 931  : 	static GUID DLLCALL GetInterfaceId() { return guidICvDeal1; }
	...
	mov	eax, DWORD PTR $T218591[esp-4]
...
; 30   : 	        guidInterface == ICvDeal1::GetInterfaceId())
	...
	mov	DWORD PTR $T218616[esp+20], ecx
	lea	ecx, DWORD PTR $T218616[esp+16]
	mov	DWORD PTR $T218616[esp+24], edx
	mov	DWORD PTR $T218616[esp+16], eax
	mov	eax, DWORD PTR _guidICvUnknown+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T218616[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	...
	mov	DWORD PTR $T218618[esp+20], ecx
	lea	ecx, DWORD PTR $T218618[esp+16]
	mov	DWORD PTR $T218618[esp+24], edx
	mov	DWORD PTR $T218618[esp+16], eax
	mov	eax, DWORD PTR _guidICvDeal1+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T218618[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	jne	SHORT $LN1@QueryInter
