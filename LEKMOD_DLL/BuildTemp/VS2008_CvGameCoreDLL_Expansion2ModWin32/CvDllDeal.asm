; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\Users\EnormousApplePie\Desktop\Lekmod Files\Lekmod DLL versions\v29\LEKMOD_DLL\CvGameCoreDLL_Expansion2\CvDllDeal.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File c:\users\enormousapplepie\desktop\lekmod files\lekmod dll versions\v29\lekmod_dll\cvgamecoredll_expansion2\cvdlldeal.cpp
rdata$r	SEGMENT
...
; 306  : 	static GUID DLLCALL GetInterfaceId(){ return guidICvUnknown; }
	...
	mov	eax, DWORD PTR $T218541[esp-4]
...
; 30   : 	        guidInterface == ICvDeal1::GetInterfaceId())
	...
	mov	DWORD PTR $T218570[esp+20], ecx
	lea	ecx, DWORD PTR $T218570[esp+16]
	mov	DWORD PTR $T218570[esp+24], edx
	mov	DWORD PTR $T218570[esp+16], eax
	mov	eax, DWORD PTR _guidICvUnknown+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T218570[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	...
	mov	DWORD PTR $T218572[esp+20], ecx
	lea	ecx, DWORD PTR $T218572[esp+16]
	mov	DWORD PTR $T218572[esp+24], edx
	mov	DWORD PTR $T218572[esp+16], eax
	mov	eax, DWORD PTR _guidICvDeal1+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T218572[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	jne	SHORT $LN1@QueryInter
