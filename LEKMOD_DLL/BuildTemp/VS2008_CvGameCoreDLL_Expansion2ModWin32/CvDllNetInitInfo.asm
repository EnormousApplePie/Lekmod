; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\Users\EnormousApplePie\Desktop\Lekmod Files\Lekmod DLL versions\v29\LEKMOD_DLL\CvGameCoreDLL_Expansion2\CvDllNetInitInfo.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_DATA	SEGMENT
_CIV5_XP2_DLL_VERSION DD FLAT:$SG217489
_DATA	ENDS
CONST	SEGMENT
$SG217489 DB	'1.0.0', 00H
	ORG $+2
$SG218713 DB	'true', 00H
	ORG $+3
$SG218714 DB	'false', 00H
	ORG $+2
$SG218715 DB	'NetInitInfo : m_szLoadFileName="%s", m_szMapScriptName="'
	...
	ORG $+2
$SG218856 DB	'net_message_debug.log', 00H
	ORG $+2
$SG218860 DB	'Success', 00H
$SG218861 DB	'Failed', 00H
	ORG $+1
$SG218862 DB	'Evaluating Map Path: (%s)', 0aH, 'Original Path: %s', 0aH
	DB	'New Path: %s', 00H
	ORG $+3
...
; Function compile flags: /Ogtpy
; File c:\users\enormousapplepie\desktop\lekmod files\lekmod dll versions\v29\lekmod_dll\cvgamecoredll_expansion2\cvdllnetinitinfo.cpp
...
; 155  : 	       );
	...
	mov	edi, OFFSET $SG218713
	test	al, al
	jne	SHORT $LN4@GetDebugSt
	mov	edi, OFFSET $SG218714
$LN4@GetDebugSt:
...
; 52   : 	::new (_Vptr) _T1(_Val);
	...
	mov	DWORD PTR $T220311[esp+16], ecx
...
; 306  : 	static GUID DLLCALL GetInterfaceId(){ return guidICvUnknown; }
	...
	mov	eax, DWORD PTR $T220347[esp-4]
...
; 2375 : 		_THROW(length_error, "vector<bool> too long");
	...
	lea	ecx, DWORD PTR $T220386[esp+84]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z
	lea	ecx, DWORD PTR $T220385[esp+80]
	mov	DWORD PTR __$EHRec$[esp+88], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@XZ
	lea	eax, DWORD PTR $T220386[esp+80]
	push	eax
	lea	ecx, DWORD PTR $T220385[esp+96]
	mov	BYTE PTR __$EHRec$[esp+92], 1
	mov	DWORD PTR $T220385[esp+84], OFFSET ??_7logic_error@std@@6B@
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@ABV01@@Z
	push	OFFSET __TI3?AVlength_error@std@@
	lea	ecx, DWORD PTR $T220385[esp+84]
	push	ecx
	mov	BYTE PTR __$EHRec$[esp+96], 0
	mov	DWORD PTR $T220385[esp+88], OFFSET ??_7length_error@std@@6B@
...
; 1260 : 		_THROW(length_error, "vector<T> too long");
	...
	lea	ecx, DWORD PTR $T220433[esp+84]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z
	lea	ecx, DWORD PTR $T220432[esp+80]
	mov	DWORD PTR __$EHRec$[esp+88], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@XZ
	lea	eax, DWORD PTR $T220433[esp+80]
	push	eax
	lea	ecx, DWORD PTR $T220432[esp+96]
	mov	BYTE PTR __$EHRec$[esp+92], 1
	mov	DWORD PTR $T220432[esp+84], OFFSET ??_7logic_error@std@@6B@
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@ABV01@@Z
	push	OFFSET __TI3?AVlength_error@std@@
	lea	ecx, DWORD PTR $T220432[esp+84]
	push	ecx
	mov	BYTE PTR __$EHRec$[esp+96], 0
	mov	DWORD PTR $T220432[esp+88], OFFSET ??_7length_error@std@@6B@
	call	__CxxThrowException@8
$LN13@Xlen@2:
$LN12@Xlen@2:
	int	3
...
; 40   : 		_THROW_NCEE(std::bad_alloc, NULL);
	...
	lea	eax, DWORD PTR $T220512[esp+8]
	push	eax
	lea	ecx, DWORD PTR $T220508[esp+16]
	mov	DWORD PTR $T220512[esp+12], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@ABQBD@Z
	push	OFFSET __TI2?AVbad_alloc@std@@
	lea	ecx, DWORD PTR $T220508[esp+16]
	push	ecx
	mov	DWORD PTR $T220508[esp+20], OFFSET ??_7bad_alloc@std@@6B@
	call	__CxxThrowException@8
$LN9@Allocate:
$LN8@Allocate:
	int	3
...
; 70   : 		m_saveTo << container.size();
	...
	lea	edx, DWORD PTR $T220525[esp]
	push	edx
	mov	DWORD PTR $T220525[esp+4], eax
	call	?Write@FDataStream@@IAEXABI@Z		; FDataStream::Write
...
; 65   : 	        guidInterface == ICvNetInitInfo1::GetInterfaceId())
	...
	mov	DWORD PTR $T220661[esp+20], ecx
	lea	ecx, DWORD PTR $T220661[esp+16]
	mov	DWORD PTR $T220661[esp+24], edx
	mov	DWORD PTR $T220661[esp+16], eax
	mov	eax, DWORD PTR _guidICvUnknown+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T220661[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	...
	mov	DWORD PTR $T220663[esp+20], ecx
	lea	ecx, DWORD PTR $T220663[esp+16]
	mov	DWORD PTR $T220663[esp+24], edx
	mov	DWORD PTR $T220663[esp+16], eax
	mov	eax, DWORD PTR _guidICvNetInitInfo1+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T220663[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	jne	SHORT $LN1@QueryInter
...
; 251  : 	logFile->DebugMsg("Evaluating Map Path: (%s)\nOriginal Path: %s\nNew Path: %s", (bResult)? "Success": "Failed", m_szMapScriptName.c_str(), strMapScriptPath.c_str());
	...
	mov	DWORD PTR tv149[esp+1104], OFFSET $SG218860
	jne	SHORT $LN4@Commit
	mov	DWORD PTR tv149[esp+1104], OFFSET $SG218861
$LN4@Commit:
...
; 1260 : 		_THROW(length_error, "vector<T> too long");
	...
	push	OFFSET ??_C@_0BD@OLBABOEK@vector?$DMT?$DO?5too?5long?$AA@
	lea	ecx, DWORD PTR $T220748[esp+84]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z
	lea	ecx, DWORD PTR $T220747[esp+80]
	mov	DWORD PTR __$EHRec$[esp+88], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@XZ
	lea	eax, DWORD PTR $T220748[esp+80]
	push	eax
	lea	ecx, DWORD PTR $T220747[esp+96]
	mov	BYTE PTR __$EHRec$[esp+92], 1
	mov	DWORD PTR $T220747[esp+84], OFFSET ??_7logic_error@std@@6B@
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@ABV01@@Z
	push	OFFSET __TI3?AVlength_error@std@@
	lea	ecx, DWORD PTR $T220747[esp+84]
	push	ecx
	mov	BYTE PTR __$EHRec$[esp+96], 0
	mov	DWORD PTR $T220747[esp+88], OFFSET ??_7length_error@std@@6B@
	call	__CxxThrowException@8
$LN13@Xlen@3:
$LN12@Xlen@3:
	int	3
...
; 40   : 		_THROW_NCEE(std::bad_alloc, NULL);
	...
	lea	eax, DWORD PTR $T220815[esp+8]
	push	eax
	lea	ecx, DWORD PTR $T220811[esp+16]
	mov	DWORD PTR $T220815[esp+12], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@ABQBD@Z
	push	OFFSET __TI2?AVbad_alloc@std@@
	lea	ecx, DWORD PTR $T220811[esp+16]
	push	ecx
	mov	DWORD PTR $T220811[esp+20], OFFSET ??_7bad_alloc@std@@6B@
	call	__CxxThrowException@8
$LN9@Allocate@2:
$LN8@Allocate@2:
	int	3
...
; 70   : 		m_saveTo << container.size();
	...
	shr	eax, 31					; 0000001fH
	add	eax, edx
	lea	edx, DWORD PTR $T220821[esp]
	push	edx
	mov	DWORD PTR $T220821[esp+4], eax
	call	?Write@FDataStream@@IAEXABI@Z		; FDataStream::Write
...
; 155  : 		_Construct(_Ptr, _Val);
	...
	mov	ecx, DWORD PTR __Ptr$[esp+12]
	mov	DWORD PTR __Vptr$220889[esp+12], ecx
	mov	DWORD PTR $T220892[esp+16], ecx
	mov	DWORD PTR __$EHRec$[esp+24], 0
	test	ecx, ecx
...
__unwindfunclet$?construct@?$allocator@VCustomOption@CvPreGame@@@std@@QAEXPAVCustomOption@CvPreGame@@ABV34@@Z$0:
	mov	eax, DWORD PTR __Vptr$220889[ebp-4]
	push	eax
	mov	ecx, DWORD PTR $T220892[ebp]
	push	ecx
	call	??3@YAXPAX0@Z				; operator delete
	add	esp, 8
	ret	0
...
; 404  : 		_Al.construct(_First, _Val);
	...
	mov	DWORD PTR __Vptr$220932[ebp], esi
	mov	DWORD PTR $T220935[ebp], esi
...
__unwindfunclet$??$_Uninit_fill_n@PAVCustomOption@CvPreGame@@IV12@V?$allocator@VCustomOption@CvPreGame@@@std@@@std@@YAXPAVCustomOption@CvPreGame@@IABV12@AAV?$allocator@VCustomOption@CvPreGame@@@0@U_Nonscalar_ptr_iterator_tag@0@U_Range_checked_iterator_tag@0@@Z$2:
	mov	eax, DWORD PTR __Vptr$220932[ebp]
	push	eax
	mov	ecx, DWORD PTR $T220935[ebp]
	push	ecx
	call	??3@YAXPAX0@Z				; operator delete
	add	esp, 8
	ret	0
...
; 199  : 	std::for_each(readFrom.begin(), readFrom.end(), SerializeFromSequenceContainer<const ElementType, const std::vector<ElementType> >(saveTo, readFrom));
	...
	push	edi
	shr	eax, 31					; 0000001fH
	lea	ecx, DWORD PTR $T221454[esp+8]
	add	eax, edx
	push	ecx
	mov	ecx, ebx
	mov	DWORD PTR $T221454[esp+12], eax
	call	?Write@FDataStream@@IAEXABI@Z		; FDataStream::Write
...
; 131  : 		_Al.construct(_Dest, *_First);
	...
	mov	DWORD PTR __Vptr$221604[ebp], esi
	mov	DWORD PTR $T221598[ebp], esi
	mov	BYTE PTR __$EHRec$[ebp+12], 1
	cmp	esi, ebx
...
__unwindfunclet$??$_Uninit_copy@PAVCustomOption@CvPreGame@@PAV12@V?$allocator@VCustomOption@CvPreGame@@@std@@@std@@YAPAVCustomOption@CvPreGame@@PAV12@00AAV?$allocator@VCustomOption@CvPreGame@@@0@U_Nonscalar_ptr_iterator_tag@0@U_Range_checked_iterator_tag@0@@Z$2:
	mov	eax, DWORD PTR __Vptr$221604[ebp]
	push	eax
	mov	ecx, DWORD PTR $T221598[ebp]
	push	ecx
	call	??3@YAXPAX0@Z				; operator delete
	add	esp, 8
	ret	0
...
; 942  : 		_STD _Ptr_cat(_First, _First), _STD _Range_checked_iterator_tag());
	...
	mov	BYTE PTR $T221622[esp+4], 0
	mov	eax, DWORD PTR $T221622[esp+4]
	mov	ecx, DWORD PTR __Cat$221626[esp+4]
	push	eax
...
; 29   : 		_Func(*_ChkFirst);
	...
	mov	eax, 1
	shl	eax, cl
	lea	edx, DWORD PTR $T221800[esp+20]
	push	edx
	test	eax, DWORD PTR [edi]
	setne	cl
	mov	BYTE PTR $T221800[esp+24], cl
...
; 822  : 		_STD _Ptr_cat(_First, _Dest), _STD _Range_checked_iterator_tag()));
	...
	mov	edx, DWORD PTR __Al$[esp]
	mov	BYTE PTR $T222203[esp+4], 0
	mov	eax, DWORD PTR $T222203[esp+4]
	mov	ecx, DWORD PTR __Cat$222207[esp+4]
	push	eax
	mov	eax, DWORD PTR __Dest$[esp+4]
	push	ecx
...
; 1254 : 		_STDEXT unchecked_uninitialized_fill_n(_Ptr, _Count, _Val, this->_Alval);
	...
	mov	BYTE PTR $T222220[esp+12], 0
	mov	eax, DWORD PTR $T222220[esp+12]
	push	eax
	mov	eax, DWORD PTR __Val$[esp+12]
	push	edx
	push	ecx
...
; 207  : 	return (_STDEXT unchecked_uninitialized_copy(_First, _Last, _Dest, _Al));
	...
	mov	ecx, DWORD PTR __Cat$222242[esp]
	mov	edx, DWORD PTR __Al$[esp]
	mov	BYTE PTR $T222238[esp+4], 0
	mov	eax, DWORD PTR $T222238[esp+4]
	push	eax
	mov	eax, DWORD PTR __Dest$[esp+4]
	push	ecx
	mov	ecx, DWORD PTR __Last$[esp+8]
...
; 199  : 	std::for_each(readFrom.begin(), readFrom.end(), SerializeFromSequenceContainer<const ElementType, const std::vector<ElementType> >(saveTo, readFrom));
	...
	lea	ecx, DWORD PTR $T222661[esp+16]
	push	ecx
	mov	ecx, edi
	mov	DWORD PTR $T222661[esp+20], eax
	call	?Write@FDataStream@@IAEXABI@Z		; FDataStream::Write
	mov	eax, DWORD PTR [esi]
	mov	ebx, DWORD PTR [esi+8]
	mov	DWORD PTR $T222646[esp+20], ebx
	mov	DWORD PTR $T222646[esp+24], 0
	test	eax, eax
	jbe	SHORT $LN9@operator@11
	push	eax
	lea	ecx, DWORD PTR $T222646[esp+24]
	call	??Y?$_Vb_const_iterator@IHV?$vector@_NV?$allocator@_N@std@@@std@@@std@@QAEAAV01@H@Z ; std::_Vb_const_iterator<unsigned int,int,std::vector<bool,std::allocator<bool> > >::operator+=
$LN9@operator@11:
	mov	edx, DWORD PTR $T222646[esp+24]
	mov	ecx, DWORD PTR $T222646[esp+20]
	push	esi
	push	edi
	push	edx
	push	ecx
	xor	eax, eax
	push	eax
	lea	edx, DWORD PTR $T222648[esp+40]
	push	ebx
	push	edx
...
; 2589 : 		_Iter_random(_First, _Dest), _Ptr_cat(_First, _Dest), _Range_checked_iterator_tag()));
	...
	mov	ecx, DWORD PTR __Cat$222752[esp]
	mov	edx, DWORD PTR $T222749[esp]
	push	esi
	mov	esi, DWORD PTR ___$ReturnUdt$[esp+4]
	mov	BYTE PTR $T222747[esp+8], 0
	mov	eax, DWORD PTR $T222747[esp+8]
	push	eax
...
; 1141 : 			_Ptr, this->_Alval));
	...
	mov	edx, DWORD PTR __Cat$223456[esp]
	mov	BYTE PTR $T223452[esp+4], 0
	mov	eax, DWORD PTR $T223452[esp+4]
	push	eax
	mov	eax, DWORD PTR __Ptr$[esp+4]
	push	edx
...
; 864  : 		_STD _Move_cat(_Dest), _STD _Range_checked_iterator_tag()));
	...
	mov	ecx, DWORD PTR __Cat$223492[esp]
	mov	edx, DWORD PTR __Al$[esp]
	mov	BYTE PTR $T223488[esp+4], 0
	mov	eax, DWORD PTR $T223488[esp+4]
	push	eax
	mov	eax, DWORD PTR __Dest$[esp+4]
	push	ecx
	mov	ecx, DWORD PTR __Last$[esp+8]
...
; 2366 : 			_Myvec.erase(_Myvec.begin() + _Words, _Myvec.end());
	...
	push	edx
	lea	eax, DWORD PTR $T223519[esp+16]
	push	eax
...
; 2742 : 		_Iter_random(_First, _Dest), _Ptr_cat(_First, _Dest), _STD _Range_checked_iterator_tag());
	...
	mov	ecx, DWORD PTR __Cat$223620[esp]
	mov	edx, DWORD PTR $T223617[esp]
	push	esi
	mov	esi, DWORD PTR ___$ReturnUdt$[esp+4]
	mov	BYTE PTR $T223615[esp+8], 0
	mov	eax, DWORD PTR $T223615[esp+8]
	push	eax
	mov	eax, DWORD PTR __Dest$[esp+12]
	push	ecx
	mov	ecx, DWORD PTR __Dest$[esp+12]
...
; 1060 : 		erase(begin(), end());
	...
	push	eax
	push	edx
	lea	eax, DWORD PTR $T223845[esp+12]
	push	eax
...
; 1148 : 			_Ptr, this->_Alval));
	...
	mov	edx, DWORD PTR __Cat$223930[esp]
	mov	BYTE PTR $T223927[esp+4], 0
	mov	eax, DWORD PTR $T223927[esp+4]
	push	eax
	mov	eax, DWORD PTR __Ptr$[esp+4]
	push	edx
	mov	edx, DWORD PTR __First$[esp+8]
...
__Next$ = -8						; size = 8
__Last$ = -8						; size = 8
__Cat$224563 = 8					; size = 1
$T224561 = 8						; size = 1
___$ReturnUdt$ = 8					; size = 4
__Tmp$224682 = 12					; size = 8
...
; 2235 : 		iterator _Next = std::copy(_Last, end(), _First);
	...
	mov	DWORD PTR $T224116[esp+44], ebx
	mov	DWORD PTR $T224116[esp+48], 0
	test	ebp, ebp
	jbe	SHORT $LN108@erase@3
	push	ebp
	lea	ecx, DWORD PTR $T224116[esp+48]
	call	??Y?$_Vb_const_iterator@IHV?$vector@_NV?$allocator@_N@std@@@std@@@std@@QAEAAV01@H@Z ; std::_Vb_const_iterator<unsigned int,int,std::vector<bool,std::allocator<bool> > >::operator+=
$LN108@erase@3:
	mov	eax, DWORD PTR __Cat$224563[esp+40]
	mov	ecx, DWORD PTR $T224561[esp+40]
	mov	BYTE PTR $T224559[esp+44], 0
	mov	edx, DWORD PTR $T224559[esp+44]
	push	edx
	mov	edx, DWORD PTR __First$[esp+52]
	push	eax
	mov	eax, DWORD PTR __First$[esp+52]
	push	ecx
	mov	ecx, DWORD PTR $T224116[esp+60]
	push	edx
	mov	edx, DWORD PTR $T224116[esp+60]
	push	eax
...
; 2239 : 		return (begin() + _Off);
	...
	xor	eax, eax
	push	esi
	lea	ecx, DWORD PTR __Tmp$224682[esp+44]
	mov	DWORD PTR __Tmp$224682[esp+44], edi
	mov	DWORD PTR __Tmp$224682[esp+48], eax
	call	??Y?$_Vb_const_iterator@IHV?$vector@_NV?$allocator@_N@std@@@std@@@std@@QAEAAV01@H@Z ; std::_Vb_const_iterator<unsigned int,int,std::vector<bool,std::allocator<bool> > >::operator+=
	mov	eax, DWORD PTR ___$ReturnUdt$[esp+40]
	mov	edx, DWORD PTR __Tmp$224682[esp+40]
	mov	ecx, DWORD PTR __Tmp$224682[esp+44]
	pop	edi
	pop	esi
	pop	ebp
	mov	DWORD PTR [eax], edx
...
; 572  : 				clear();	// new sequence empty, erase existing sequence
	...
	push	eax
	push	ecx
	lea	eax, DWORD PTR $T224994[esp+16]
	push	eax
	mov	ecx, esi
	call	?erase@?$vector@VCustomOption@CvPreGame@@V?$allocator@VCustomOption@CvPreGame@@@std@@@std@@QAE?AV?$_Vector_iterator@VCustomOption@CvPreGame@@V?$allocator@VCustomOption@CvPreGame@@@std@@@2@V?$_Vector_const_iterator@VCustomOption@CvPreGame@@V?$allocator@VCustomOption@CvPreGame@@@std@@@2@0@Z ; std::vector<CvPreGame::CustomOption,std::allocator<CvPreGame::CustomOption> >::erase
	pop	ebp
...
_TEXT	SEGMENT
__Tmp$219509 = -156					; size = 68
__Tmp$219499 = -88					; size = 68
__Capacity$ = -20					; size = 4
__$EHRec$ = -16						; size = 16
__Cat$225254 = 8					; size = 1
__Cat$225182 = 8					; size = 1
__Where$ = 8						; size = 4
__Newvec$219484 = 12					; size = 4
__Count$ = 12						; size = 4
tv493 = 16						; size = 4
$T225251 = 16						; size = 1
$T225179 = 16						; size = 1
...
; 1178 : 			_Ufill(_Newvec + _Whereoff, _Count, _Val);	// add new stuff
	...
	shl	eax, 4
	push	edx
	mov	DWORD PTR __Newvec$219484[ebp], ecx
	add	eax, ebx
...
; 1181 : 				_Newvec);	// move prefix
	...
	mov	ecx, DWORD PTR __Cat$225182[ebp]
	mov	eax, DWORD PTR [esi+4]
	mov	BYTE PTR $T225179[ebp], 0
	mov	edx, DWORD PTR $T225179[ebp]
	push	edx
	mov	edx, DWORD PTR __Newvec$219484[ebp]
	push	ecx
...
; 1184 : 				_Newvec + (_Whereoff + _Count));	// move suffix
	...
	mov	ecx, DWORD PTR __Newvec$219484[ebp]
	mov	eax, DWORD PTR [esi+8]
	add	ebx, edi
	mov	edx, ebx
	shl	edx, 4
	...
	mov	BYTE PTR $T225251[ebp], 0
	mov	edx, DWORD PTR $T225251[ebp]
	push	edx
	mov	edx, DWORD PTR __Cat$225254[ebp]
	push	edx
	push	esi
	push	ecx
	push	eax
...
; 1205 : 			_Myend = _Newvec + _Capacity;
	...
	shl	edx, 4
	add	edx, eax
	mov	eax, DWORD PTR __Newvec$219484[ebp]
	lea	ecx, DWORD PTR [eax+edx*4]
...
; 1211 : 			_Ty _Tmp = _Val;	// in case _Val is in sequence
	...
	push	ecx
	lea	ecx, DWORD PTR __Tmp$219499[ebp]
	call	??0CustomOption@CvPreGame@@QAE@ABV01@@Z	; CvPreGame::CustomOption::CustomOption
...
; 1218 : 				_Tmp);	// insert new stuff off end
	...
	mov	ecx, DWORD PTR [esi+8]
	lea	edx, DWORD PTR __Tmp$219499[ebp]
	push	edx
	mov	edx, ecx
...
; 1235 : 			_Ty _Tmp = _Val;	// in case _Val is in sequence
	...
	mov	eax, DWORD PTR __Val$[ebp]
	push	eax
	lea	ecx, DWORD PTR __Tmp$219509[ebp]
	call	??0CustomOption@CvPreGame@@QAE@ABV01@@Z	; CvPreGame::CustomOption::CustomOption
...
; 1248 : 				_Tmp);	// insert into hole
	...
	lea	eax, DWORD PTR __Tmp$219509[ebp]
	push	eax
	mov	eax, DWORD PTR __Where$[ebp]
	add	ebx, eax
	push	ebx
...
; 2244 : 		erase(begin(), end());
	...
	push	edi
	mov	edi, DWORD PTR [esi+8]
	mov	DWORD PTR $T225285[esp+16], edi
	mov	DWORD PTR $T225285[esp+20], 0
	test	eax, eax
	jbe	SHORT $LN20@clear@2
	push	eax
	lea	ecx, DWORD PTR $T225285[esp+20]
	call	??Y?$_Vb_const_iterator@IHV?$vector@_NV?$allocator@_N@std@@@std@@@std@@QAEAAV01@H@Z ; std::_Vb_const_iterator<unsigned int,int,std::vector<bool,std::allocator<bool> > >::operator+=
$LN20@clear@2:
	mov	ecx, DWORD PTR $T225285[esp+20]
	mov	edx, DWORD PTR $T225285[esp+16]
	push	ecx
	push	edx
	xor	eax, eax
	push	eax
	push	edi
	lea	eax, DWORD PTR $T225288[esp+32]
	push	eax
	mov	ecx, esi
...
; 721  : 			erase(begin() + _Newsize, end());
	...
	push	esi
	push	eax
	lea	eax, DWORD PTR $T226357[esp+12]
	push	eax
	call	?erase@?$vector@IV?$allocator@I@std@@@std@@QAE?AV?$_Vector_iterator@IV?$allocator@I@std@@@2@V?$_Vector_const_iterator@IV?$allocator@I@std@@@2@0@Z ; std::vector<unsigned int,std::allocator<unsigned int> >::erase
$LN1@resize:
	pop	edi
...
; 819  : 			_Mylast = _Ufill(_Mylast, 1, _Val);
	...
	mov	edx, DWORD PTR __Cat$226470[esp+12]
	mov	eax, DWORD PTR __Val$[esp+12]
	mov	BYTE PTR $T226466[esp+16], 0
	mov	ecx, DWORD PTR $T226466[esp+16]
	push	ecx
	push	edx
	push	esi
	push	eax
...
; 823  : 			insert(end(), _Val);
	...
	push	ecx
	push	edi
	lea	edx, DWORD PTR $T226437[esp+20]
	push	edx
	mov	ecx, esi
...
; 2318 : 				std::copy_backward(begin() + _Off, _Oldend, end());
	...
	mov	DWORD PTR $T226494[esp+48], ebx
	mov	DWORD PTR $T226494[esp+52], 0
	je	SHORT $LN79@Insert_x
	push	eax
	lea	ecx, DWORD PTR $T226494[esp+52]
	call	??Y?$_Vb_const_iterator@IHV?$vector@_NV?$allocator@_N@std@@@std@@@std@@QAEAAV01@H@Z ; std::_Vb_const_iterator<unsigned int,int,std::vector<bool,std::allocator<bool> > >::operator+=
$LN79@Insert_x:
	push	ebp
	lea	ecx, DWORD PTR $T226496[esp+52]
	push	ecx
	lea	ecx, DWORD PTR $T226495[esp+56]
	mov	DWORD PTR $T226495[esp+56], ebx
	mov	DWORD PTR $T226495[esp+60], 0
	...
	mov	edx, DWORD PTR $T226494[esp+52]
	mov	ecx, DWORD PTR $T226494[esp+48]
	push	edx
	...
	push	edx
	push	eax
	lea	ecx, DWORD PTR $T226497[esp+72]
	push	ecx
...
; 84   : 	container.clear();
	...
	push	eax
	push	ecx
	lea	eax, DWORD PTR $T226844[esp+92]
	push	eax
	mov	ecx, esi
	call	?erase@?$vector@VCustomOption@CvPreGame@@V?$allocator@VCustomOption@CvPreGame@@@std@@@std@@QAE?AV?$_Vector_iterator@VCustomOption@CvPreGame@@V?$allocator@VCustomOption@CvPreGame@@@std@@@2@V?$_Vector_const_iterator@VCustomOption@CvPreGame@@V?$allocator@VCustomOption@CvPreGame@@@std@@@2@0@Z ; std::vector<CvPreGame::CustomOption,std::allocator<CvPreGame::CustomOption> >::erase
...
; 92   : 		container.push_back(v);
	...
	lea	eax, DWORD PTR _v$219373[esp+84]
	push	eax
	mov	ecx, esi
...
_TEXT	SEGMENT
__Tmp$226924 = -16					; size = 8
__Tmp$226982 = -8					; size = 8
__Where$ = 8						; size = 8
__Count$ = 16						; size = 4
__Val$ = 20						; size = 1
...
; 2292 : 		std::fill(begin() + _Off, begin() + (_Off + _Count), _Val);
	...
	xor	eax, eax
	push	edx
	lea	ecx, DWORD PTR __Tmp$226924[esp+32]
	mov	DWORD PTR __Tmp$226924[esp+32], esi
	mov	DWORD PTR __Tmp$226924[esp+36], eax
	call	??Y?$_Vb_const_iterator@IHV?$vector@_NV?$allocator@_N@std@@@std@@@std@@QAEAAV01@H@Z ; std::_Vb_const_iterator<unsigned int,int,std::vector<bool,std::allocator<bool> > >::operator+=
	xor	eax, eax
	push	edi
	lea	ecx, DWORD PTR __Tmp$226982[esp+32]
	mov	DWORD PTR __Tmp$226982[esp+32], esi
	mov	DWORD PTR __Tmp$226982[esp+36], eax
	call	??Y?$_Vb_const_iterator@IHV?$vector@_NV?$allocator@_N@std@@@std@@@std@@QAEAAV01@H@Z ; std::_Vb_const_iterator<unsigned int,int,std::vector<bool,std::allocator<bool> > >::operator+=
	mov	ecx, DWORD PTR __Tmp$226924[esp+32]
	mov	edx, DWORD PTR __Tmp$226924[esp+28]
	lea	eax, DWORD PTR __Val$[esp+24]
	push	eax
	mov	eax, DWORD PTR __Tmp$226982[esp+36]
	push	ecx
	mov	ecx, DWORD PTR __Tmp$226982[esp+36]
	push	edx
	push	eax
	push	ecx
	call	??$_Fill@V?$_Vb_iterator@IHV?$vector@_NV?$allocator@_N@std@@@std@@@std@@_N@std@@YAXV?$_Vb_iterator@IHV?$vector@_NV?$allocator@_N@std@@@std@@@0@0AB_N@Z ; std::_Fill<std::_Vb_iterator<unsigned int,int,std::vector<bool,std::allocator<bool> > >,bool>
...
; 2153 : 		return (begin() + _Off);
	...
	xor	eax, eax
	push	esi
	lea	ecx, DWORD PTR __Tmp$227105[esp+8]
	mov	DWORD PTR __Tmp$227105[esp+8], edi
	mov	DWORD PTR __Tmp$227105[esp+12], eax
	call	??Y?$_Vb_const_iterator@IHV?$vector@_NV?$allocator@_N@std@@@std@@@std@@QAEAAV01@H@Z ; std::_Vb_const_iterator<unsigned int,int,std::vector<bool,std::allocator<bool> > >::operator+=
	mov	eax, DWORD PTR ___$ReturnUdt$[esp+4]
	mov	ecx, DWORD PTR __Tmp$227105[esp+4]
	mov	edx, DWORD PTR __Tmp$227105[esp+8]
	pop	edi
	mov	DWORD PTR [eax], ecx
	mov	DWORD PTR [eax+4], edx
	pop	esi
...
; 2116 : 		insert(end(), _Val);
	...
	mov	eax, DWORD PTR [esi+8]
	mov	DWORD PTR $T227113[esp+12], eax
	mov	eax, DWORD PTR [esi]
	mov	DWORD PTR $T227113[esp+16], 0
	test	eax, eax
	jbe	SHORT $LN20@push_back@2
	push	eax
	lea	ecx, DWORD PTR $T227113[esp+16]
	call	??Y?$_Vb_const_iterator@IHV?$vector@_NV?$allocator@_N@std@@@std@@@std@@QAEAAV01@H@Z ; std::_Vb_const_iterator<unsigned int,int,std::vector<bool,std::allocator<bool> > >::operator+=
$LN20@push_back@2:
	mov	ecx, DWORD PTR __Val$[esp+8]
	mov	edx, DWORD PTR $T227113[esp+16]
	mov	eax, DWORD PTR $T227113[esp+12]
	push	ecx
	push	edx
	push	eax
	lea	ecx, DWORD PTR $T227114[esp+24]
	push	ecx
	mov	ecx, esi
...
; 84   : 	container.clear();
	...
	push	edi
	mov	edi, DWORD PTR [esi+8]
	mov	DWORD PTR $T227326[esp+24], edi
	mov	DWORD PTR $T227326[esp+28], ebp
	cmp	eax, ebp
	jbe	SHORT $LN25@SerializeT@2
	push	eax
	lea	ecx, DWORD PTR $T227326[esp+28]
	call	??Y?$_Vb_const_iterator@IHV?$vector@_NV?$allocator@_N@std@@@std@@@std@@QAEAAV01@H@Z ; std::_Vb_const_iterator<unsigned int,int,std::vector<bool,std::allocator<bool> > >::operator+=
$LN25@SerializeT@2:
	mov	ecx, DWORD PTR $T227326[esp+28]
	mov	edx, DWORD PTR $T227326[esp+24]
	push	ecx
	push	edx
	xor	eax, eax
	push	eax
	push	edi
	lea	eax, DWORD PTR $T227329[esp+40]
	push	eax
	mov	ecx, esi
	call	?erase@?$vector@_NV?$allocator@_N@std@@@std@@QAE?AV?$_Vb_iterator@IHV?$vector@_NV?$allocator@_N@std@@@std@@@2@V?$_Vb_const_iterator@IHV?$vector@_NV?$allocator@_N@std@@@std@@@2@0@Z ; std::vector<bool,std::allocator<bool> >::erase
...
; 91   : 		loadFrom >> v;
	...
	lea	edx, DWORD PTR _v$213827[esp+24]
	push	edx
	mov	ecx, ebx
	call	?Read@FDataStream@@IAEXAA_N@Z		; FDataStream::Read
...
$LN119@SerializeT@2:
	...
	mov	edx, eax
$LN66@SerializeT@2:
	mov	eax, DWORD PTR _v$213827[esp+24]
	push	eax
	push	1
	push	edx
	push	ecx
