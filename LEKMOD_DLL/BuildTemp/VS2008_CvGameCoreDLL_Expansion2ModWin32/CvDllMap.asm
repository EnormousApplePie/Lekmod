; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\Users\EnormousApplePie\Documents\GitHub\Lekmod\LEKMOD_DLL\CvGameCoreDLL_Expansion2\CvDllMap.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
;	COMDAT ??_R2ICvMap1@@8
; File c:\users\enormousapplepie\documents\github\lekmod\lekmod_dll\cvgamecoredll_expansion2\cvdllmap.cpp
rdata$r	SEGMENT
...
; 128  : 	return (NULL != pkCity)? new CvDllCity(pkCity) : NULL;
	...
	add	esp, 4
	mov	DWORD PTR $T219341[esp+12], eax
...
__unwindfunclet$?FindCity@CvDllMap@@UAGPAVICvCity1@@HHW4PlayerTypes@@W4TeamTypes@@_N21W4DirectionTypes@@PAV2@@Z$0:
	mov	eax, DWORD PTR $T219341[ebp-4]
	push	eax
...
; 1121 : 	static GUID DLLCALL GetInterfaceId() { return guidICvMap1; }
	...
	mov	eax, DWORD PTR $T219393[esp-4]
...
; 32   : 	        guidInterface == ICvMap1::GetInterfaceId())
	...
	mov	DWORD PTR $T219430[esp+20], ecx
	lea	ecx, DWORD PTR $T219430[esp+16]
	mov	DWORD PTR $T219430[esp+24], edx
	mov	DWORD PTR $T219430[esp+16], eax
	mov	eax, DWORD PTR _guidICvUnknown+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T219430[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	...
	mov	DWORD PTR $T219432[esp+20], ecx
	lea	ecx, DWORD PTR $T219432[esp+16]
	mov	DWORD PTR $T219432[esp+24], edx
	mov	DWORD PTR $T219432[esp+16], eax
	mov	eax, DWORD PTR _guidICvMap1+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T219432[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	jne	SHORT $LN1@QueryInter
...
; 166  : 		return (NULL != pkPlot)? new CvDllPlot(pkPlot) : NULL;
	...
	add	esp, 4
	mov	DWORD PTR $T219500[esp+12], eax
	mov	DWORD PTR __$EHRec$[esp+24], 0
	test	eax, eax
	je	SHORT $LN1@GetPlotByI
	push	esi
...
__unwindfunclet$?GetPlotByIndex@CvDllMap@@UBGPAVICvPlot1@@H@Z$0:
	mov	eax, DWORD PTR $T219500[ebp-4]
	push	eax
...
; 176  : 		return (NULL != pkPlot)? new CvDllPlot(pkPlot) : NULL;
	...
	call	??2CvDllPlot@@SAPAXI@Z			; CvDllPlot::operator new
	add	esp, 4
	mov	DWORD PTR $T219700[esp+24], eax
...
__unwindfunclet$?GetPlot@CvDllMap@@UBGPAVICvPlot1@@HH@Z$0:
	mov	eax, DWORD PTR $T219700[ebp-4]
	push	eax
	call	??3CvDllPlot@@SAXPAX@Z			; CvDllPlot::operator delete
	pop	ecx
	ret	0
