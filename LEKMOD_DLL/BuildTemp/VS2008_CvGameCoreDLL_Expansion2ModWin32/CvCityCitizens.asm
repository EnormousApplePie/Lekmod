; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	s:\LEKMOD_DLL\CvGameCoreDLL_Expansion2\CvCityCitizens.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG224873 DB	'ECONOMICAISTRATEGY_LOSING_MONEY', 00H
$SG224882 DB	'AIGRANDSTRATEGY_CULTURE', 00H
$SG225558 DB	'UNITCLASS_SCIENTIST', 00H
$SG225562 DB	'UNITCLASS_WRITER', 00H
	ORG $+3
$SG225567 DB	'UNITCLASS_ARTIST', 00H
	ORG $+3
$SG225572 DB	'UNITCLASS_MUSICIAN', 00H
	ORG $+1
$SG225579 DB	'UNITCLASS_MERCHANT', 00H
	ORG $+1
$SG225583 DB	'UNITCLASS_ENGINEER', 00H
	ORG $+1
$SG225826 DB	'UNITCLASS_WRITER', 00H
	ORG $+3
$SG225829 DB	'UNITCLASS_ARTIST', 00H
	ORG $+3
$SG225832 DB	'UNITCLASS_MUSICIAN', 00H
	ORG $+1
$SG225835 DB	'UNITCLASS_SCIENTIST', 00H
$SG225838 DB	'UNITCLASS_ENGINEER', 00H
	ORG $+1
$SG225841 DB	'UNITCLASS_MERCHANT', 00H
	ORG $+1
$SG225863 DB	'UNITCLASS_WRITER', 00H
	ORG $+3
$SG225866 DB	'UNITCLASS_ARTIST', 00H
	ORG $+3
$SG225869 DB	'UNITCLASS_MUSICIAN', 00H
	ORG $+1
$SG225872 DB	'UNITCLASS_SCIENTIST', 00H
$SG225875 DB	'UNITCLASS_ENGINEER', 00H
	ORG $+1
$SG225878 DB	'UNITCLASS_MERCHANT', 00H
	ORG $+1
$SG225881 DB	'UNITCLASS_PROPHET', 00H
	ORG $+2
$SG225893 DB	'UNIT_ARTIST', 00H
$SG225897 DB	'TXT_KEY_NOTIFICATION_GREAT_PERSON_ACTIVE_PLAYER', 00H
$SG225900 DB	'TXT_KEY_NOTIFICATION_SUMMARY_GREAT_PERSON', 00H
CONST	ENDS
...
; Function compile flags: /Ogtpy
; File s:\lekmod_dll\cvgamecoredll_expansion2\cvcitycitizens.cpp
...
_TEXT	SEGMENT
_bValid$225925 = -13					; size = 1
_uiNumEntries$ = -12					; size = 4
_tValue$225928 = -8					; size = 4
_tValue$225933 = -4					; size = 4
_kStream$ = 8						; size = 4
_paArray$ = 12						; size = 4
...
; 256  : 		int iType = ReadHashed(kStream, &bValid);
	...
	lea	ecx, DWORD PTR _bValid$225925[esp+32]
	push	ecx
	push	edi
...
; 260  : 			kStream >> tValue;
	...
	lea	edx, DWORD PTR _tValue$225928[esp+32]
	push	edx
	mov	ecx, edi
	call	?Read@FDataStream@@IAEXAAH@Z		; FDataStream::Read
...
; 262  : 				paArray[iType] = tValue;
	...
	mov	eax, DWORD PTR _tValue$225928[esp+32]
...
; 264  : 		else if(!bValid)
	...
	cmp	BYTE PTR _bValid$225925[esp+32], 0
...
; 267  : 			kStream >> tValue;
	...
	lea	edx, DWORD PTR _tValue$225933[esp+32]
	push	edx
	mov	ecx, edi
	call	?Read@FDataStream@@IAEXAAH@Z		; FDataStream::Read
$LN6@ReadHashed:
...
; 3293 : 		auto_ptr<ICvCity1> pCity = GC.WrapCityPointer(GetCity());
	...
	push	esi
	lea	eax, DWORD PTR $T227359[esp+20]
	push	eax
	mov	ecx, OFFSET ?gGlobals@@3VCvGlobals@@A	; gGlobals
	call	?WrapCityPointer@CvGlobals@@QAE?AV?$auto_ptr@VICvCity1@@@std@@PAVCvCity@@@Z ; CvGlobals::WrapCityPointer
	mov	esi, DWORD PTR [eax]
	mov	DWORD PTR [eax], 0
	mov	DWORD PTR _pCity$225704[esp+16], esi
	mov	eax, DWORD PTR $T227359[esp+16]
...
__unwindfunclet$?DoRemoveSpecialistFromBuilding@CvCityCitizens@@QAEXW4BuildingTypes@@_N1@Z$1:
	lea	ecx, DWORD PTR _pCity$225704[ebp-4]
...
; 3353 : 		auto_ptr<ICvCity1> pCity = GC.WrapCityPointer(GetCity());
	...
	mov	eax, DWORD PTR [esi]
	push	eax
	lea	ecx, DWORD PTR $T227468[esp+40]
	push	ecx
	mov	ecx, OFFSET ?gGlobals@@3VCvGlobals@@A	; gGlobals
	call	?WrapCityPointer@CvGlobals@@QAE?AV?$auto_ptr@VICvCity1@@@std@@PAVCvCity@@@Z ; CvGlobals::WrapCityPointer
	mov	edi, DWORD PTR [eax]
	mov	DWORD PTR [eax], 0
	mov	DWORD PTR _pCity$225724[esp+36], edi
	mov	eax, DWORD PTR $T227468[esp+36]
...
__unwindfunclet$?DoRemoveAllSpecialistsFromBuilding@CvCityCitizens@@QAEXW4BuildingTypes@@_N@Z$1:
	lea	ecx, DWORD PTR _pCity$225724[ebp]
	jmp	??1?$auto_ptr@VICvCity1@@@std@@QAE@XZ	; std::auto_ptr<ICvCity1>::~auto_ptr<ICvCity1>
...
_TEXT	SEGMENT
_this$ = -712						; size = 4
_strSummary$225898 = -708				; size = 80
_strText$225895 = -628					; size = 80
_kPopupInfo$225852 = -548				; size = 536
__$EHRec$ = -12						; size = 12
_eUnit$ = 8						; size = 4
...
; 3656 : 			GC.GetEngineUserInterface()->AddPopup(kPopupInfo);
	...
	mov	ecx, DWORD PTR ?gGlobals@@3VCvGlobals@@A+8568
	mov	DWORD PTR _kPopupInfo$225852[esp+728], eax
	mov	DWORD PTR _kPopupInfo$225852[esp+724], ebx
	mov	DWORD PTR _kPopupInfo$225852[esp+732], -1
	mov	DWORD PTR _kPopupInfo$225852[esp+736], 0
	mov	BYTE PTR _kPopupInfo$225852[esp+740], 0
	mov	BYTE PTR _kPopupInfo$225852[esp+741], 0
	mov	DWORD PTR _kPopupInfo$225852[esp+744], 60 ; 0000003cH
	mov	BYTE PTR _kPopupInfo$225852[esp+748], 0
	mov	eax, DWORD PTR [ecx]
	mov	eax, DWORD PTR [eax+180]
	lea	edx, DWORD PTR _kPopupInfo$225852[esp+724]
	push	edx
	call	eax
$LN122@DoSpawnGre:
...
; 3760 : 		Localization::String strText = Localization::Lookup("TXT_KEY_NOTIFICATION_GREAT_PERSON_ACTIVE_PLAYER");
	...
	lea	ecx, DWORD PTR _strText$225895[esp+728]
...
; 3761 : 		Localization::String strSummary = Localization::Lookup("TXT_KEY_NOTIFICATION_SUMMARY_GREAT_PERSON");
	...
	lea	edx, DWORD PTR _strSummary$225898[esp+736]
...
; 3762 : 		GET_PLAYER(GetOwner()).GetNotifications()->Add(NOTIFICATION_GREAT_PERSON_ACTIVE_PLAYER, strText.toUTF8(), strSummary.toUTF8(), GetCity()->getX(), GetCity()->getY(), eUnit);
	...
	push	ecx
	push	edx
	lea	ecx, DWORD PTR _strSummary$225898[esp+744]
	mov	BYTE PTR __$EHRec$[esp+752], 1
	call	edi
	push	eax
	lea	ecx, DWORD PTR _strText$225895[esp+748]
	call	edi
	push	eax
...
; 3763 : 	}
	...
	lea	ecx, DWORD PTR _strSummary$225898[esp+728]
...
; 1324 : 	int iFoodYieldValue = (GC.getAI_CITIZEN_VALUE_FOOD() * (pPlayer->specialistYield(eSpecialist, YIELD_FOOD) + iFoodConsumptionBonus));
	...
	push	0
	push	edi
	mov	DWORD PTR $T228292[esp+48], edx
...
; 1326 : 	int iProductionYieldValue = (GC.getAI_CITIZEN_VALUE_PRODUCTION() * pPlayer->specialistYield(eSpecialist, YIELD_PRODUCTION));
	...
	imul	ebx, DWORD PTR $T228292[esp+40]
	push	1
	push	edi
	mov	ecx, esi
	mov	DWORD PTR $T228296[esp+44], eax
	call	?specialistYield@CvPlayer@@QBEHW4SpecialistTypes@@W4YieldTypes@@@Z ; CvPlayer::specialistYield
	imul	eax, DWORD PTR $T228296[esp+36]
...
; 1331 : 	int iGoldYieldValue = (GC.getAI_CITIZEN_VALUE_GOLD() * pPlayer->specialistYield(eSpecialist, YIELD_GOLD));
	...
	push	2
	mov	DWORD PTR $T228300[esp+40], ecx
	push	edi
	mov	ecx, esi
...
; 1332 : 	int iScienceYieldValue = (GC.getAI_CITIZEN_VALUE_SCIENCE() * pPlayer->specialistYield(eSpecialist, YIELD_SCIENCE));
	...
	mov	DWORD PTR $T228304[esp+44], edx
	call	?specialistYield@CvPlayer@@QBEHW4SpecialistTypes@@W4YieldTypes@@@Z ; CvPlayer::specialistYield
...
; 1334 : 	int iCultureYieldValue = (GC.getAI_CITIZEN_VALUE_CULTURE() * m_pCity->GetCultureFromSpecialist(eSpecialist)); 
	...
	push	edi
	mov	DWORD PTR $T228308[esp+40], eax
...
; 1335 : 	int iFaithYieldValue = (GC.getAI_CITIZEN_VALUE_FAITH() * pPlayer->specialistYield(eSpecialist, YIELD_FAITH));
	...
	push	5
	mov	DWORD PTR $T228312[esp+40], ecx
	push	edi
	mov	ecx, esi
...
; 1364 : 	int iGPPYieldValue = pSpecialistInfo->getGreatPeopleRateChange() * 3; // TODO: un-hardcode this
	...
	mov	edi, eax
	imul	edi, DWORD PTR $T228312[esp+36]
...
_TEXT	SEGMENT
tv701 = -12						; size = 4
_iSpecialistLoop$225544 = -12				; size = 4
_iGPPChange$ = -8					; size = 4
_iGPThreshold$225552 = -4				; size = 4
...
; 3010 : 	for(int iSpecialistLoop = 0; iSpecialistLoop < GC.getNumSpecialistInfos(); iSpecialistLoop++)
	...
	xor	ebp, ebp
	mov	ecx, OFFSET ?gGlobals@@3VCvGlobals@@A	; gGlobals
	mov	DWORD PTR _iSpecialistLoop$225544[esp+20], ebp
	call	?getNumSpecialistInfos@CvGlobals@@QAEHXZ ; CvGlobals::getNumSpecialistInfos
	test	eax, eax
	jle	$LN22@DoSpeciali
	push	ebx
...
; 3028 : 			if(pkSpecialistInfo->getGreatPeopleUnitClass() != NO_UNITCLASS)
	...
	mov	ecx, ebx
	mov	DWORD PTR _iGPThreshold$225552[esp+28], eax
	call	?getGreatPeopleUnitClass@CvSpecialistInfo@@QBEHXZ ; CvSpecialistInfo::getGreatPeopleUnitClass
	cmp	eax, -1
	je	$LN23@DoSpeciali
...
; 3010 : 	for(int iSpecialistLoop = 0; iSpecialistLoop < GC.getNumSpecialistInfos(); iSpecialistLoop++)
	...
	mov	ecx, DWORD PTR [esi+112]
	mov	ebp, DWORD PTR _iSpecialistLoop$225544[esp+28]
...
; 3102 : 				if(GetSpecialistGreatPersonProgress(eSpecialist) >= iGPThreshold)
	...
	shr	eax, 31					; 0000001fH
	add	eax, edx
	cmp	eax, DWORD PTR _iGPThreshold$225552[esp+28]
...
$LN23@DoSpeciali:
	inc	ebp
	mov	ecx, OFFSET ?gGlobals@@3VCvGlobals@@A	; gGlobals
	mov	DWORD PTR _iSpecialistLoop$225544[esp+28], ebp
	call	?getNumSpecialistInfos@CvGlobals@@QAEHXZ ; CvGlobals::getNumSpecialistInfos
	cmp	ebp, eax
	jl	$LL215@DoSpeciali
	pop	edi
...
; 274  : 		bool bWorkPlot = IsCanWork(pHomePlot);
	...
	mov	BYTE PTR _bWorkPlot$224845[esp+12], al

; 275  : 		SetWorkingPlot(pHomePlot, bWorkPlot, /*bUseUnassignedPool*/ false);

	mov	eax, DWORD PTR _bWorkPlot$224845[esp+12]
	push	0
	push	eax
	push	edi
	mov	ecx, esi
...
; 3228 : 		auto_ptr<ICvCity1> pCity = GC.WrapCityPointer(pkCity);
	...
	push	edi
	lea	ecx, DWORD PTR $T229483[esp+28]
	push	ecx
	mov	ecx, OFFSET ?gGlobals@@3VCvGlobals@@A	; gGlobals
	call	?WrapCityPointer@CvGlobals@@QAE?AV?$auto_ptr@VICvCity1@@@std@@PAVCvCity@@@Z ; CvGlobals::WrapCityPointer
	mov	edi, DWORD PTR [eax]
	mov	DWORD PTR [eax], 0
	mov	DWORD PTR _pCity$225668[esp+24], edi
	mov	eax, DWORD PTR $T229483[esp+24]
...
__unwindfunclet$?DoAddSpecialistToBuilding@CvCityCitizens@@QAEXW4BuildingTypes@@_N@Z$1:
	lea	ecx, DWORD PTR _pCity$225668[ebp-4]
	jmp	??1?$auto_ptr@VICvCity1@@@std@@QAE@XZ	; std::auto_ptr<ICvCity1>::~auto_ptr<ICvCity1>
