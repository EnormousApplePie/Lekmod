; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\Users\EnormousApplePie\Desktop\Cleanup (v1)\Lekmod Files\Lekmod DLL versions\v30\LEKMOD_DLL\CvGameCoreDLL_Expansion2\cvStopWatch.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_BSS	ENDS
CONST	SEGMENT
$SG217193 DB	'stopwatch.log', 00H
	ORG $+2
$SG217196 DB	', %d, %s, %f', 00H
	ORG $+3
$SG217201 DB	', %d, %s,%s %f', 00H
	ORG $+1
$SG217203 DB	', %s, %f', 00H
CONST	ENDS
...
; File c:\users\enormousapplepie\desktop\cleanup (v1)\lekmod files\lekmod dll versions\v30\lekmod_dll\cvgamecoredll_expansion2\cvstopwatch.cpp
