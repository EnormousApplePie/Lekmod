; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\Users\EnormousApplePie\Desktop\Lekmod Files\Lekmod DLL versions\v29\LEKMOD_DLL\CvGameCoreDLL_Expansion2\CvDllUnit.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File c:\users\enormousapplepie\desktop\lekmod files\lekmod dll versions\v29\lekmod_dll\cvgamecoredll_expansion2\cvdllunit.cpp
rdata$r	SEGMENT
...
; 166  : 	return (NULL != pkPlot)? new CvDllPlot(pkPlot) : NULL;
	...
	add	esp, 4
	mov	DWORD PTR $T218999[esp+12], eax
...
__unwindfunclet$?GetPlot@CvDllUnit@@UBGPAVICvPlot1@@XZ$0:
	mov	eax, DWORD PTR $T218999[ebp-4]
	push	eax
...
; 171  : 	return new CvDllUnitInfo(&m_pUnit->getUnitInfo());
	...
	mov	esi, eax
	add	esp, 4
	mov	DWORD PTR $T219036[esp+20], esi
	xor	eax, eax
...
; 187  : 	return (NULL != pData)? new CvDllMissionData(pData) : NULL;
	...
	add	esp, 4
	mov	DWORD PTR $T219053[esp+12], eax
	mov	DWORD PTR __$EHRec$[esp+24], 0
	test	eax, eax
	je	SHORT $LN5@GetHeadMis
	push	esi
...
__unwindfunclet$?GetHeadMissionData@CvDllUnit@@UBGPAVICvMissionData1@@XZ$0:
	mov	eax, DWORD PTR $T219053[ebp-4]
	push	eax
...
; 306  : 	static GUID DLLCALL GetInterfaceId(){ return guidICvUnknown; }
	...
	mov	eax, DWORD PTR $T219146[esp-4]
...
; 34   : 		guidInterface == ICvUnit2::GetInterfaceId())
	...
	mov	DWORD PTR $T219176[esp+20], ecx
	lea	ecx, DWORD PTR $T219176[esp+16]
	mov	DWORD PTR $T219176[esp+24], edx
	mov	DWORD PTR $T219176[esp+16], eax
	mov	eax, DWORD PTR _guidICvUnknown+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T219176[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	...
	mov	DWORD PTR $T219178[esp+20], ecx
	lea	ecx, DWORD PTR $T219178[esp+16]
	mov	DWORD PTR $T219178[esp+24], edx
	mov	DWORD PTR $T219178[esp+16], eax
	mov	eax, DWORD PTR _guidICvUnit1+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T219178[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	jne	SHORT $LN1@QueryInter
