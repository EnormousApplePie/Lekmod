...
; 166  : 	return (NULL != pkPlot)? new CvDllPlot(pkPlot) : NULL;
	...
	add	esp, 4
	mov	DWORD PTR $T219522[esp+12], eax
...
__unwindfunclet$?GetPlot@CvDllUnit@@UBGPAVICvPlot1@@XZ$0:
	mov	eax, DWORD PTR $T219522[ebp-4]
	push	eax
...
; 171  : 	return new CvDllUnitInfo(&m_pUnit->getUnitInfo());
	...
	mov	esi, eax
	add	esp, 4
	mov	DWORD PTR $T219559[esp+20], esi
	xor	eax, eax
...
; 306  : 	static GUID DLLCALL GetInterfaceId(){ return guidICvUnknown; }
	...
	mov	eax, DWORD PTR $T219669[esp-4]
...
; 1711 : 	static GUID DLLCALL GetInterfaceId() { return guidICvUnit1; }
	...
	mov	eax, DWORD PTR $T219673[esp-4]
...
; 170  : 	static GUID DLLCALL GetInterfaceId() { return guidICvUnit2; }
	...
	mov	eax, DWORD PTR $T219677[esp-4]
...
; 34   : 		guidInterface == ICvUnit2::GetInterfaceId())
	...
	mov	DWORD PTR $T219699[esp+20], ecx
	lea	ecx, DWORD PTR $T219699[esp+16]
	mov	DWORD PTR $T219699[esp+24], edx
	mov	DWORD PTR $T219699[esp+16], eax
	mov	eax, DWORD PTR _guidICvUnknown+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T219699[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	...
	mov	DWORD PTR $T219701[esp+20], ecx
	lea	ecx, DWORD PTR $T219701[esp+16]
	mov	DWORD PTR $T219701[esp+24], edx
	mov	DWORD PTR $T219701[esp+16], eax
	mov	eax, DWORD PTR _guidICvUnit1+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T219701[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	jne	SHORT $LN1@QueryInter
	...
	mov	DWORD PTR $T219703[esp+20], ecx
	lea	ecx, DWORD PTR $T219703[esp+16]
	mov	DWORD PTR $T219703[esp+24], edx
	mov	DWORD PTR $T219703[esp+16], eax
	mov	eax, DWORD PTR _guidICvUnit2+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T219703[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	jne	SHORT $LN1@QueryInter
...
; 285  : 	return m_pUnit->getName();
	...
	push	esi
	mov	DWORD PTR $T219743[esp+12], 0
