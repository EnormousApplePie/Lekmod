...
CONST	SEGMENT
$SG219087 DB	'IsNone', 00H
	ORG $+1
$SG219088 DB	'CalculateTotalBestNatureYield', 00H
	ORG $+2
$SG219089 DB	'CountCoastalLand', 00H
	ORG $+3
$SG219090 DB	'CountNumUniqueResourceTypes', 00H
$SG219091 DB	'GetID', 00H
	ORG $+2
$SG219092 DB	'GetNumTiles', 00H
$SG219093 DB	'GetNumOwnedTiles', 00H
	ORG $+3
$SG219094 DB	'GetNumUnownedTiles', 00H
	ORG $+1
$SG219095 DB	'GetNumRiverEdges', 00H
	ORG $+3
$SG219096 DB	'GetNumCities', 00H
	ORG $+3
$SG219097 DB	'GetNumUnits', 00H
$SG219098 DB	'GetTotalPopulation', 00H
	ORG $+1
$SG219099 DB	'GetNumStartingPlots', 00H
$SG219100 DB	'IsWater', 00H
$SG219101 DB	'GetUnitsPerPlayer', 00H
	ORG $+2
$SG219102 DB	'GetCitiesPerPlayer', 00H
	ORG $+1
$SG219103 DB	'GetPopulationPerPlayer', 00H
	ORG $+1
$SG219104 DB	'GetFreeSpecialist', 00H
	ORG $+2
$SG219105 DB	'GetNumRevealedTiles', 00H
$SG219106 DB	'GetNumUnrevealedTiles', 00H
	ORG $+2
$SG219107 DB	'GetTargetCity', 00H
	ORG $+2
$SG219108 DB	'GetYieldRateModifier', 00H
	ORG $+3
$SG219109 DB	'GetNumResources', 00H
$SG219110 DB	'GetNumTotalResources', 00H
	ORG $+3
$SG219111 DB	'GetNumImprovements', 00H
	ORG $+1
$SG219117 DB	'Area', 00H
	ORG $+3
$SG219311 DB	'__instance', 00H
	ORG $+5
$SG219317 DB	'Not a valid instance.  Either the instance is NULL or yo'
	DB	'u used ''.'' instead of '':''.', 00H
	ORG $+1
$SG219325 DB	'Instance does not exist.', 00H
	ORG $+3
$SG219336 DB	'__instances', 00H
$SG219337 DB	'__mode', 00H
	ORG $+1
$SG219338 DB	'v', 00H
	ORG $+2
$SG219340 DB	'__instances', 00H
$SG219343 DB	'__instance', 00H
	ORG $+1
$SG219344 DB	'__index', 00H
CONST	ENDS
