; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\Users\EnormousApplePie\Desktop\Lekmod Files\Lekmod DLL versions\v29\LEKMOD_DLL\CvGameCoreDLL_Expansion2\Lua\CvLuaArea.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG218526 DB	'IsNone', 00H
	ORG $+1
$SG218527 DB	'CalculateTotalBestNatureYield', 00H
	ORG $+2
$SG218528 DB	'CountCoastalLand', 00H
	ORG $+3
$SG218529 DB	'CountNumUniqueResourceTypes', 00H
$SG218530 DB	'GetID', 00H
	ORG $+2
$SG218531 DB	'GetNumTiles', 00H
$SG218532 DB	'GetNumOwnedTiles', 00H
	ORG $+3
$SG218533 DB	'GetNumUnownedTiles', 00H
	ORG $+1
$SG218534 DB	'GetNumRiverEdges', 00H
	ORG $+3
$SG218535 DB	'GetNumCities', 00H
	ORG $+3
$SG218536 DB	'GetNumUnits', 00H
$SG218537 DB	'GetTotalPopulation', 00H
	ORG $+1
$SG218538 DB	'GetNumStartingPlots', 00H
$SG218539 DB	'IsWater', 00H
$SG218540 DB	'GetUnitsPerPlayer', 00H
	ORG $+2
$SG218541 DB	'GetCitiesPerPlayer', 00H
	ORG $+1
$SG218542 DB	'GetPopulationPerPlayer', 00H
	ORG $+1
$SG218543 DB	'GetFreeSpecialist', 00H
	ORG $+2
$SG218544 DB	'GetNumRevealedTiles', 00H
$SG218545 DB	'GetNumUnrevealedTiles', 00H
	ORG $+2
$SG218546 DB	'GetTargetCity', 00H
	ORG $+2
$SG218547 DB	'GetYieldRateModifier', 00H
	ORG $+3
$SG218548 DB	'GetNumResources', 00H
$SG218549 DB	'GetNumTotalResources', 00H
	ORG $+3
$SG218550 DB	'GetNumImprovements', 00H
	ORG $+1
$SG218556 DB	'Area', 00H
	ORG $+3
$SG218750 DB	'__instance', 00H
	ORG $+5
$SG218756 DB	'Not a valid instance.  Either the instance is NULL or yo'
	DB	'u used ''.'' instead of '':''.', 00H
	ORG $+1
$SG218764 DB	'Instance does not exist.', 00H
	ORG $+3
$SG218775 DB	'__instances', 00H
$SG218776 DB	'__mode', 00H
	ORG $+1
$SG218777 DB	'v', 00H
	ORG $+2
$SG218779 DB	'__instances', 00H
$SG218782 DB	'__instance', 00H
	ORG $+1
$SG218783 DB	'__index', 00H
CONST	ENDS
PUBLIC	?GetTypeName@CvLuaArea@@SAPBDXZ			; CvLuaArea::GetTypeName
; Function compile flags: /Ogtpy
; File c:\users\enormousapplepie\desktop\lekmod files\lekmod dll versions\v29\lekmod_dll\cvgamecoredll_expansion2\lua\cvluaarea.cpp
