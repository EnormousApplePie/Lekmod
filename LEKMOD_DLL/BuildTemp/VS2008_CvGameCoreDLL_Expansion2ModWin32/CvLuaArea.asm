...
CONST	SEGMENT
$SG219049 DB	'IsNone', 00H
	ORG $+1
$SG219050 DB	'CalculateTotalBestNatureYield', 00H
	ORG $+2
$SG219051 DB	'CountCoastalLand', 00H
	ORG $+3
$SG219052 DB	'CountNumUniqueResourceTypes', 00H
$SG219053 DB	'GetID', 00H
	ORG $+2
$SG219054 DB	'GetNumTiles', 00H
$SG219055 DB	'GetNumOwnedTiles', 00H
	ORG $+3
$SG219056 DB	'GetNumUnownedTiles', 00H
	ORG $+1
$SG219057 DB	'GetNumRiverEdges', 00H
	ORG $+3
$SG219058 DB	'GetNumCities', 00H
	ORG $+3
$SG219059 DB	'GetNumUnits', 00H
$SG219060 DB	'GetTotalPopulation', 00H
	ORG $+1
$SG219061 DB	'GetNumStartingPlots', 00H
$SG219062 DB	'IsWater', 00H
$SG219063 DB	'GetUnitsPerPlayer', 00H
	ORG $+2
$SG219064 DB	'GetCitiesPerPlayer', 00H
	ORG $+1
$SG219065 DB	'GetPopulationPerPlayer', 00H
	ORG $+1
$SG219066 DB	'GetFreeSpecialist', 00H
	ORG $+2
$SG219067 DB	'GetNumRevealedTiles', 00H
$SG219068 DB	'GetNumUnrevealedTiles', 00H
	ORG $+2
$SG219069 DB	'GetTargetCity', 00H
	ORG $+2
$SG219070 DB	'GetYieldRateModifier', 00H
	ORG $+3
$SG219071 DB	'GetNumResources', 00H
$SG219072 DB	'GetNumTotalResources', 00H
	ORG $+3
$SG219073 DB	'GetNumImprovements', 00H
	ORG $+1
$SG219079 DB	'Area', 00H
	ORG $+3
$SG219273 DB	'__instance', 00H
	ORG $+5
$SG219279 DB	'Not a valid instance.  Either the instance is NULL or yo'
	DB	'u used ''.'' instead of '':''.', 00H
	ORG $+1
$SG219287 DB	'Instance does not exist.', 00H
	ORG $+3
$SG219298 DB	'__instances', 00H
$SG219299 DB	'__mode', 00H
	ORG $+1
$SG219300 DB	'v', 00H
	ORG $+2
$SG219302 DB	'__instances', 00H
$SG219305 DB	'__instance', 00H
	ORG $+1
$SG219306 DB	'__index', 00H
CONST	ENDS
...
; 67   : 			lua_pushstring(L, "__mode");
	...
	push	OFFSET $SG219299
	push	esi
	call	_lua_pushstring

; 68   : 			lua_pushstring(L, "v");

	push	OFFSET $SG219300
	push	esi
	call	_lua_pushstring
