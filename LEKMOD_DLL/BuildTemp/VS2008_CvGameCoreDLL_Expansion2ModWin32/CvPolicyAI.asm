; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	s:\Github\Lekmod\LEKMOD_DLL\CvGameCoreDLL_Expansion2\CvPolicyAI.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG221993 DB	'AIGRANDSTRATEGY_CULTURE', 00H
$SG222025 DB	'AIGRANDSTRATEGY_CONQUEST', 00H
	ORG $+3
$SG222028 DB	'FLAVOR_OFFENSE', 00H
	ORG $+1
$SG222033 DB	'AIGRANDSTRATEGY_SPACESHIP', 00H
	ORG $+2
$SG222036 DB	'FLAVOR_SPACESHIP', 00H
	ORG $+3
$SG222041 DB	'AIGRANDSTRATEGY_UNITED_NATIONS', 00H
	ORG $+1
$SG222044 DB	'FLAVOR_DIPLOMACY', 00H
	ORG $+3
$SG222049 DB	'AIGRANDSTRATEGY_CULTURE', 00H
$SG222052 DB	'FLAVOR_CULTURE', 00H
	ORG $+1
$SG222057 DB	'Choosing policy from Top Choices', 00H
	ORG $+3
$SG222060 DB	'Choosing policy at random (no good choices)', 00H
$SG222116 DB	'After Grand Strategies', 00H
	ORG $+1
$SG222117 DB	'After Free Policies', 00H
$SG222156 DB	'After Relations', 00H
$SG222163 DB	'After Tenet Happiness Boosts', 00H
	ORG $+3
$SG222170 DB	'After Public Opinion Happiness', 00H
	ORG $+1
$SG222171 DB	'Freedom random priority bump', 00H
	ORG $+3
$SG222172 DB	'Autocracy random priority bump', 00H
	ORG $+1
$SG222173 DB	'Order random priority bump', 00H
	ORG $+1
$SG222174 DB	'After Random (1 to 10)', 00H
	ORG $+1
$SG222175 DB	'Final (after Clear Victory Preference)', 00H
	ORG $+1
$SG222346 DB	'%03d, ', 00H
	ORG $+1
$SG222348 DB	', ', 00H
	ORG $+1
$SG222356 DB	'Branch %d, %d', 00H
	ORG $+2
$SG222362 DB	'Unknown', 00H
$SG222363 DB	'%s, %d', 00H
	ORG $+1
$SG222377 DB	'%03d, ', 00H
	ORG $+1
$SG222379 DB	', ', 00H
	ORG $+1
$SG222382 DB	'Unknown', 00H
$SG222383 DB	'CHOSEN, %s', 00H
	ORG $+1
$SG222397 DB	'%03d, ', 00H
	ORG $+1
$SG222399 DB	', ', 00H
	ORG $+1
$SG222400 DB	'CHOSEN, Branch %d', 00H
	ORG $+2
$SG222416 DB	'%03d, ', 00H
	ORG $+1
$SG222418 DB	', ', 00H
	ORG $+1
$SG222419 DB	'%s, Freedom: %d, Order: %d, Autocracy: %d', 00H
	ORG $+2
$SG222430 DB	'.csv', 00H
	ORG $+3
$SG222431 DB	'PolicyAILog_', 00H
	ORG $+3
$SG222433 DB	'PolicyAILog.csv', 00H
CONST	ENDS
...
; File s:\github\lekmod\lekmod_dll\cvgamecoredll_expansion2\cvpolicyai.cpp
...
_iPolicyLoop$222221 = -4				; size = 4
_iLoop$222241 = 8					; size = 4
_pPlayer$ = 8						; size = 4
_eBranch$ = 12						; size = 4
...
; 691  : 	for(int iPolicyLoop = 0; iPolicyLoop < GC.getNumPolicyInfos(); iPolicyLoop++)
	...
	mov	DWORD PTR _iPolicyLoop$222221[esp+16], edi
...
; 717  : 							for (pCity = pPlayer->firstCity(&iLoop); pCity != NULL; pCity = pPlayer->nextCity(&iLoop))
	...
	push	0
	lea	eax, DWORD PTR _iLoop$222241[esp+24]
	push	eax
	mov	ecx, ebx
...
$LN3@GetBranchB:
	push	0
	lea	ecx, DWORD PTR _iLoop$222241[esp+24]
	push	ecx
	mov	ecx, ebx
...
; 700  : 				for(iBuildingClassLoop = 0; iBuildingClassLoop < GC.getNumBuildingClassInfos(); iBuildingClassLoop++)
	...
	cmp	esi, eax
	jl	$LL10@GetBranchB
	mov	edi, DWORD PTR _iPolicyLoop$222221[esp+24]
$LN14@GetBranchB:
...
; 691  : 	for(int iPolicyLoop = 0; iPolicyLoop < GC.getNumPolicyInfos(); iPolicyLoop++)
	...
	inc	edi
	mov	ecx, OFFSET ?gGlobals@@3VCvGlobals@@A	; gGlobals
	mov	DWORD PTR _iPolicyLoop$222221[esp+24], edi
	call	?getNumPolicyInfos@CvGlobals@@QAEHXZ	; CvGlobals::getNumPolicyInfos
	cmp	edi, eax
	jl	$LL27@GetBranchB
...
; 1260 : 		_THROW(length_error, "vector<T> too long");
	...
	lea	ecx, DWORD PTR $T223728[esp+84]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z
	lea	ecx, DWORD PTR $T223727[esp+80]
	mov	DWORD PTR __$EHRec$[esp+88], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@XZ
	lea	eax, DWORD PTR $T223728[esp+80]
	push	eax
	lea	ecx, DWORD PTR $T223727[esp+96]
	mov	BYTE PTR __$EHRec$[esp+92], 1
	mov	DWORD PTR $T223727[esp+84], OFFSET ??_7logic_error@std@@6B@
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@ABV01@@Z
	push	OFFSET __TI3?AVlength_error@std@@
	lea	ecx, DWORD PTR $T223727[esp+84]
	push	ecx
	mov	BYTE PTR __$EHRec$[esp+96], 0
	mov	DWORD PTR $T223727[esp+88], OFFSET ??_7length_error@std@@6B@
...
; 40   : 		_THROW_NCEE(std::bad_alloc, NULL);
	...
	lea	eax, DWORD PTR $T223795[esp+8]
	push	eax
	lea	ecx, DWORD PTR $T223791[esp+16]
	mov	DWORD PTR $T223795[esp+12], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@ABQBD@Z
	push	OFFSET __TI2?AVbad_alloc@std@@
	lea	ecx, DWORD PTR $T223791[esp+16]
	push	ecx
	mov	DWORD PTR $T223791[esp+20], OFFSET ??_7bad_alloc@std@@6B@
	call	__CxxThrowException@8
$LN9@Allocate:
$LN8@Allocate:
	int	3
...
; 1048 : {
	...
	xor	ebx, ebx
	push	esi
	mov	DWORD PTR $T223893[esp+80], ebx
...
; 1061 : 	return strLogName;
	...
	mov	ecx, OFFSET ?gGlobals@@3VCvGlobals@@A	; gGlobals
	mov	DWORD PTR __$EHRec$[esp+88], ebx
	mov	DWORD PTR $T223893[esp+80], 1
	...
	mov	ecx, esi
	call	DWORD PTR __imp_?assign@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV12@PBD@Z
	lea	ecx, DWORD PTR $T223891[esp+80]
	mov	BYTE PTR __$EHRec$[esp+88], 1
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	lea	ecx, DWORD PTR $T223890[esp+80]
...
; 111  : 		kStream << m_PolicyAIWeights.GetWeight(i);
	...
	mov	DWORD PTR $T224319[esp+36], eax
	add	esp, 8
	lea	eax, DWORD PTR $T224319[esp+28]
	push	eax
	mov	ecx, ebx
	mov	DWORD PTR _elem$224339[esp+32], edx
	call	?Write@FDataStream@@IAEXABH@Z		; FDataStream::Write
	mov	ecx, DWORD PTR [edi]
	inc	esi
	call	?GetPolicies@CvPlayerPolicies@@QBEPAVCvPolicyXMLEntries@@XZ ; CvPlayerPolicies::GetPolicies
...
_TEXT	SEGMENT
_bDontSwitchAutocracy$222195 = -34			; size = 1
_bDontSwitchOrder$222194 = -33				; size = 1
_iTechPriority$222198 = -32				; size = 4
_iCulturePriority$222199 = -28				; size = 4
_iPublicOpinionUnhappiness$ = -24			; size = 4
_ePreferredIdeology$ = -20				; size = 4
_iHappinessPreferredIdeology$222192 = -16		; size = 4
_iHappinessCurrentIdeology$222191 = -12			; size = 4
_eCurrentIdeology$ = -8					; size = 4
_eMostPressure$ = -4					; size = 4
_bDontSwitchFreedom$222193 = 8				; size = 1
...
; 616  : 		int iHappinessPreferredIdeology = GetBranchBuildingHappiness(pPlayer, ePreferredIdeology);
	...
	push	esi
	mov	ecx, edi
	mov	DWORD PTR _iHappinessCurrentIdeology$222191[esp+60], eax
	call	?GetBranchBuildingHappiness@CvPolicyAI@@QAEHPAVCvPlayer@@W4PolicyBranchTypes@@@Z ; CvPolicyAI::GetBranchBuildingHappiness
...
; 622  : 		int iConquestPriority = pPlayer->GetGrandStrategyAI()->GetConquestPriority();
	...
	mov	ecx, esi
	mov	DWORD PTR _iHappinessPreferredIdeology$222192[esp+52], eax
	mov	BYTE PTR _bDontSwitchFreedom$222193[esp+48], 0
	mov	BYTE PTR _bDontSwitchOrder$222194[esp+52], 0
	mov	BYTE PTR _bDontSwitchAutocracy$222195[esp+52], 0
...
; 625  : 		int iCulturePriority = pPlayer->GetGrandStrategyAI()->GetCulturePriority();
	...
	mov	ecx, esi
	mov	DWORD PTR _iTechPriority$222198[esp+52], eax
	call	?GetGrandStrategyAI@CvPlayer@@QBEPAVCvGrandStrategyAI@@XZ ; CvPlayer::GetGrandStrategyAI
	mov	ecx, eax
...
; 629  : 			iConquestPriority > (iCulturePriority * (100 + iClearPrefPercent) / 100))
	...
	mov	edx, ecx
	imul	edx, ebx
	mov	DWORD PTR _iCulturePriority$222199[esp+52], eax
	...
	mov	edx, ecx
	imul	edx, DWORD PTR _iTechPriority$222198[esp+52]
	mov	eax, 1374389535				; 51eb851fH
	imul	edx
	sar	edx, 5
	mov	eax, edx
	...
	jle	SHORT $LN11@DoConsider
	mov	edx, ecx
	imul	edx, DWORD PTR _iCulturePriority$222199[esp+52]
	mov	eax, 1374389535				; 51eb851fH
	imul	edx
	sar	edx, 5
	mov	eax, edx
...
; 631  : 			bDontSwitchFreedom = true;
	...
	mov	BYTE PTR _bDontSwitchFreedom$222193[esp+48], 1
...
; 637  : 			bDontSwitchOrder = true;
	...
	mov	BYTE PTR _bDontSwitchOrder$222194[esp+52], 1
...
; 641  : 			iTechPriority > (iCulturePriority  * (100 + iClearPrefPercent) / 100))
	...
	mov	ebx, DWORD PTR _iTechPriority$222198[esp+52]
	cmp	ebx, ebp
	jle	SHORT $LN43@DoConsider
	cmp	ebx, edi
	jle	SHORT $LN43@DoConsider
	imul	ecx, DWORD PTR _iCulturePriority$222199[esp+52]
	mov	eax, 1374389535				; 51eb851fH
	imul	ecx
	sar	edx, 5
	mov	ecx, edx
...
; 643  : 			bDontSwitchAutocracy = true;
	...
	mov	BYTE PTR _bDontSwitchAutocracy$222195[esp+52], 1
$LN43@DoConsider:
...
; 647  : 		if (iTotalHappinessImprovement >= 10)
	...
	mov	eax, DWORD PTR _iHappinessPreferredIdeology$222192[esp+52]
	sub	eax, DWORD PTR _iHappinessCurrentIdeology$222191[esp+52]
...
; 649  : 			if (bDontSwitchFreedom && ePreferredIdeology == GC.getPOLICY_BRANCH_FREEDOM())
	...
	cmp	BYTE PTR _bDontSwitchFreedom$222193[esp+48], 0
...
; 653  : 			if (bDontSwitchAutocracy && ePreferredIdeology == GC.getPOLICY_BRANCH_AUTOCRACY())
	...
	cmp	BYTE PTR _bDontSwitchAutocracy$222195[esp+52], 0
...
; 657  : 			if (bDontSwitchOrder && ePreferredIdeology == GC.getPOLICY_BRANCH_ORDER())
	...
	cmp	BYTE PTR _bDontSwitchOrder$222194[esp+52], 0
...
_elem$224455 = -8					; size = 8
_elem$224441 = -8					; size = 8
_eBranch$ = 8						; size = 4
...
; 871  : 							iWeight += m_PolicyAIWeights.GetWeight(iPolicyLoop);
	...
	mov	DWORD PTR _elem$224441[esp+28], ecx
$LN6@WeighBranc:
	mov	ecx, DWORD PTR [edi]
	inc	esi
	call	?GetPolicies@CvPlayerPolicies@@QBEPAVCvPolicyXMLEntries@@XZ ; CvPlayerPolicies::GetPolicies
...
; 879  : 		iWeight += m_PolicyAIWeights.GetWeight(pkPolicyBranchInfo->GetFreePolicy());
	...
	mov	DWORD PTR _elem$224455[esp+28], edx
	pop	esi
$LN25@WeighBranc:
	pop	edi
...
_TEXT	SEGMENT
_elem$224533 = -216					; size = 8
_playerName$222342 = -208				; size = 28
_strBaseString$222340 = -180				; size = 28
_strTemp$222341 = -152					; size = 28
_strOutBuf$222339 = -124				; size = 28
$T224468 = -96						; size = 28
$T224465 = -96						; size = 28
$T224464 = -68						; size = 28
_strDesc$222343 = -40					; size = 28
__$EHRec$ = -12						; size = 12
...
; 916  : 		CvString strOutBuf;
	...
	lea	ecx, DWORD PTR _strOutBuf$222339[esp+220]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ

; 917  : 		CvString strBaseString;

	lea	ecx, DWORD PTR _strBaseString$222340[esp+220]
	mov	DWORD PTR __$EHRec$[esp+228], 0
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ

; 918  : 		CvString strTemp;

	lea	ecx, DWORD PTR _strTemp$222341[esp+220]
	mov	BYTE PTR __$EHRec$[esp+228], 1
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ

; 919  : 		CvString playerName;

	lea	ecx, DWORD PTR _playerName$222342[esp+220]
	mov	BYTE PTR __$EHRec$[esp+228], 2
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ

; 920  : 		CvString strDesc;

	lea	ecx, DWORD PTR _strDesc$222343[esp+220]
...
; 926  : 		pLog = LOGFILEMGR.GetLog(GetLogFileName(playerName), FILogFile::kDontTimeStamp);
	...
	mov	edi, eax
	lea	eax, DWORD PTR _playerName$222342[esp+232]
	push	eax
	lea	ecx, DWORD PTR $T224464[esp+236]
	push	ecx
	mov	ecx, esi
	...
	mov	ecx, edi
	call	eax
	lea	ecx, DWORD PTR $T224464[esp+232]
	mov	ebp, eax
...
; 929  : 		strBaseString.Format("%03d, ", GC.getGame().getElapsedGameTurns());
	...
	push	eax
	lea	ecx, DWORD PTR _strBaseString$222340[esp+236]
...
; 930  : 		strBaseString += playerName + ", ";
	...
	lea	edx, DWORD PTR _playerName$222342[esp+248]
	push	edx
	lea	eax, DWORD PTR $T224465[esp+252]
	push	eax
	call	DWORD PTR __imp_??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@PBD@Z
	add	esp, 24					; 00000018H
	push	eax
	...
	lea	ecx, DWORD PTR $T224465[esp+232]
	mov	BYTE PTR __$EHRec$[esp+240], 4
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
...
; 943  : 			if(m_AdoptablePolicies.GetElement(iI) < iNumBranches)
	...
	mov	eax, edx
	cmp	eax, ebx
	mov	DWORD PTR _elem$224533[esp+232], edx
	mov	DWORD PTR _elem$224533[esp+236], ecx
...
; 945  : 				strTemp.Format("Branch %d, %d", m_AdoptablePolicies.GetElement(iI), iWeight);
	...
	lea	eax, DWORD PTR _strTemp$222341[esp+244]
	push	eax
...
$LN9@LogPossibl:
	mov	eax, OFFSET $SG222362
$LN10@LogPossibl:

; 953  : 				strTemp.Format("%s, %d", szPolicyType, iWeight);

	mov	ecx, DWORD PTR _elem$224533[esp+236]
	push	ecx
	push	eax
	push	OFFSET $SG222363
	lea	edx, DWORD PTR _strTemp$222341[esp+244]
	push	edx
$LN91@LogPossibl:
	call	?Format@CvString@@QAAXPBDZZ		; CvString::Format
	add	esp, 16					; 00000010H
...
; 955  : 			strOutBuf = strBaseString + strTemp;
	...
	lea	eax, DWORD PTR _strTemp$222341[esp+232]
	push	eax
	lea	ecx, DWORD PTR _strBaseString$222340[esp+236]
	push	ecx
	lea	edx, DWORD PTR $T224468[esp+240]
	push	edx
	...
	call	DWORD PTR __imp_?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ
	push	eax
	lea	ecx, DWORD PTR _strOutBuf$222339[esp+236]
	call	DWORD PTR __imp_?assign@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV12@PBD@Z
...
; 956  : 			pLog->Msg(strOutBuf);
	...
	lea	ecx, DWORD PTR _strOutBuf$222339[esp+232]
	call	DWORD PTR __imp_?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ
...
; 958  : 	}
	...
	lea	ecx, DWORD PTR _strDesc$222343[esp+232]
	mov	BYTE PTR __$EHRec$[esp+240], 3
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	lea	ecx, DWORD PTR _playerName$222342[esp+232]
	mov	BYTE PTR __$EHRec$[esp+240], 2
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	lea	ecx, DWORD PTR _strTemp$222341[esp+232]
	mov	BYTE PTR __$EHRec$[esp+240], 1
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	lea	ecx, DWORD PTR _strBaseString$222340[esp+232]
...
_TEXT	SEGMENT
_playerName$222373 = -208				; size = 28
_strBaseString$222371 = -180				; size = 28
_strOutBuf$222370 = -152				; size = 28
$T224610 = -124						; size = 28
$T224607 = -124						; size = 28
_strTemp$222372 = -96					; size = 28
$T224606 = -68						; size = 28
_strDesc$222374 = -40					; size = 28
__$EHRec$ = -12						; size = 12
_ePolicy$ = 8						; size = 4
...
; 966  : 		CvString strOutBuf;
	...
	lea	ecx, DWORD PTR _strOutBuf$222370[esp+220]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ

; 967  : 		CvString strBaseString;

	lea	ecx, DWORD PTR _strBaseString$222371[esp+220]
	mov	DWORD PTR __$EHRec$[esp+228], 0
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ

; 968  : 		CvString strTemp;

	lea	ecx, DWORD PTR _strTemp$222372[esp+220]
	mov	BYTE PTR __$EHRec$[esp+228], 1
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ

; 969  : 		CvString playerName;

	lea	ecx, DWORD PTR _playerName$222373[esp+220]
	mov	BYTE PTR __$EHRec$[esp+228], 2
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ

; 970  : 		CvString strDesc;

	lea	ecx, DWORD PTR _strDesc$222374[esp+220]
	mov	BYTE PTR __$EHRec$[esp+228], 3
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
...
; 976  : 		pLog = LOGFILEMGR.GetLog(GetLogFileName(playerName), FILogFile::kDontTimeStamp);
	...
	call	?GetInstance@FILogFileMgr@@SAAAV1@XZ	; FILogFileMgr::GetInstance
	mov	esi, eax
	lea	eax, DWORD PTR _playerName$222373[esp+220]
	push	eax
	lea	ecx, DWORD PTR $T224606[esp+224]
	push	ecx
	mov	ecx, edi
	call	?GetLogFileName@CvPolicyAI@@ABE?AVCvString@@AAV2@@Z ; CvPolicyAI::GetLogFileName
	mov	ecx, eax
	...
	mov	ecx, esi
	call	eax
	lea	ecx, DWORD PTR $T224606[esp+220]
	mov	esi, eax
	mov	BYTE PTR __$EHRec$[esp+228], bl
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
...
; 979  : 		strBaseString.Format("%03d, ", GC.getGame().getElapsedGameTurns());
	...
	call	?getElapsedGameTurns@CvGame@@QBEHXZ	; CvGame::getElapsedGameTurns
	push	eax
	lea	ecx, DWORD PTR _strBaseString$222371[esp+224]
...
; 980  : 		strBaseString += playerName + ", ";
	...
	lea	edx, DWORD PTR _playerName$222373[esp+236]
	push	edx
	lea	eax, DWORD PTR $T224607[esp+240]
	push	eax
	call	DWORD PTR __imp_??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@PBD@Z
	add	esp, 24					; 00000018H
	push	eax
	...
	call	DWORD PTR __imp_??Y?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV01@ABV01@@Z
	lea	ecx, DWORD PTR $T224607[esp+220]
	mov	BYTE PTR __$EHRec$[esp+228], bl
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
...
$LN4@LogPolicyC:
	mov	eax, OFFSET $SG222382
$LN5@LogPolicyC:

; 984  : 		strTemp.Format("CHOSEN, %s", szPolicyType);

	push	eax
	lea	edx, DWORD PTR _strTemp$222372[esp+224]
...
; 986  : 		strOutBuf = strBaseString + strTemp;
	...
	lea	eax, DWORD PTR _strTemp$222372[esp+232]
	push	eax
	lea	ecx, DWORD PTR _strBaseString$222371[esp+236]
	push	ecx
	lea	edx, DWORD PTR $T224610[esp+240]
	push	edx
	call	DWORD PTR __imp_??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@0@Z
	add	esp, 24					; 00000018H
	mov	ecx, eax
	...
	call	DWORD PTR __imp_?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ
	push	eax
	lea	ecx, DWORD PTR _strOutBuf$222370[esp+224]
	call	DWORD PTR __imp_?assign@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV12@PBD@Z
...
_TEXT	SEGMENT
_playerName$222393 = -208				; size = 28
_strBaseString$222391 = -180				; size = 28
_strOutBuf$222390 = -152				; size = 28
$T224700 = -124						; size = 28
$T224699 = -124						; size = 28
_strTemp$222392 = -96					; size = 28
$T224698 = -68						; size = 28
_strDesc$222394 = -40					; size = 28
__$EHRec$ = -12						; size = 12
_eBranch$ = 8						; size = 4
...
; 996  : 		CvString strOutBuf;
	...
	lea	ecx, DWORD PTR _strOutBuf$222390[esp+220]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ

; 997  : 		CvString strBaseString;

	lea	ecx, DWORD PTR _strBaseString$222391[esp+220]
	mov	DWORD PTR __$EHRec$[esp+228], 0
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ

; 998  : 		CvString strTemp;

	lea	ecx, DWORD PTR _strTemp$222392[esp+220]
	mov	BYTE PTR __$EHRec$[esp+228], 1
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ

; 999  : 		CvString playerName;

	lea	ecx, DWORD PTR _playerName$222393[esp+220]
	mov	BYTE PTR __$EHRec$[esp+228], 2
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ

; 1000 : 		CvString strDesc;

	lea	ecx, DWORD PTR _strDesc$222394[esp+220]
	mov	BYTE PTR __$EHRec$[esp+228], 3
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
...
; 1006 : 		pLog = LOGFILEMGR.GetLog(GetLogFileName(playerName), FILogFile::kDontTimeStamp);
	...
	call	?GetInstance@FILogFileMgr@@SAAAV1@XZ	; FILogFileMgr::GetInstance
	mov	esi, eax
	lea	eax, DWORD PTR _playerName$222393[esp+220]
	push	eax
	lea	ecx, DWORD PTR $T224698[esp+224]
	push	ecx
	mov	ecx, edi
	call	?GetLogFileName@CvPolicyAI@@ABE?AVCvString@@AAV2@@Z ; CvPolicyAI::GetLogFileName
	mov	ecx, eax
	...
	mov	ecx, esi
	call	eax
	lea	ecx, DWORD PTR $T224698[esp+220]
	mov	esi, eax
	mov	BYTE PTR __$EHRec$[esp+228], bl
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
...
; 1009 : 		strBaseString.Format("%03d, ", GC.getGame().getElapsedGameTurns());
	...
	call	?getElapsedGameTurns@CvGame@@QBEHXZ	; CvGame::getElapsedGameTurns
	push	eax
	lea	ecx, DWORD PTR _strBaseString$222391[esp+224]
...
; 1010 : 		strBaseString += playerName + ", ";
	...
	lea	edx, DWORD PTR _playerName$222393[esp+236]
	push	edx
	lea	eax, DWORD PTR $T224699[esp+240]
	push	eax
	call	DWORD PTR __imp_??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@PBD@Z
	add	esp, 24					; 00000018H
	push	eax
	...
	mov	BYTE PTR __$EHRec$[esp+232], 6
	call	DWORD PTR __imp_??Y?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV01@ABV01@@Z
	lea	ecx, DWORD PTR $T224699[esp+220]
	mov	BYTE PTR __$EHRec$[esp+228], bl
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
...
; 1012 : 		strTemp.Format("CHOSEN, Branch %d", eBranch);
	...
	push	ecx
	lea	edx, DWORD PTR _strTemp$222392[esp+224]
...
; 1014 : 		strOutBuf = strBaseString + strTemp;
	...
	lea	eax, DWORD PTR _strTemp$222392[esp+232]
	push	eax
	lea	ecx, DWORD PTR _strBaseString$222391[esp+236]
	push	ecx
	lea	edx, DWORD PTR $T224700[esp+240]
	push	edx
	call	DWORD PTR __imp_??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@0@Z
	add	esp, 24					; 00000018H
	mov	ecx, eax
	...
	call	DWORD PTR __imp_?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ
	push	eax
	lea	ecx, DWORD PTR _strOutBuf$222390[esp+224]
	call	DWORD PTR __imp_?assign@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV12@PBD@Z
	lea	ecx, DWORD PTR $T224700[esp+220]
	mov	BYTE PTR __$EHRec$[esp+228], bl
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
...
_TEXT	SEGMENT
_playerName$222413 = -180				; size = 28
_strBaseString$222411 = -152				; size = 28
_strTemp$222412 = -124					; size = 28
$T224787 = -96						; size = 28
$T224786 = -96						; size = 28
_strOutBuf$222410 = -68					; size = 28
$T224785 = -40						; size = 28
__$EHRec$ = -12						; size = 12
...
; 1024 : 		CvString strOutBuf;
	...
	lea	ecx, DWORD PTR _strOutBuf$222410[esp+192]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ

; 1025 : 		CvString strBaseString;

	lea	ecx, DWORD PTR _strBaseString$222411[esp+192]
	mov	DWORD PTR __$EHRec$[esp+200], 0
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ

; 1026 : 		CvString strTemp;

	lea	ecx, DWORD PTR _strTemp$222412[esp+192]
	mov	BYTE PTR __$EHRec$[esp+200], 1
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ

; 1027 : 		CvString playerName;

	lea	ecx, DWORD PTR _playerName$222413[esp+192]
...
; 1033 : 		pLog = LOGFILEMGR.GetLog(GetLogFileName(playerName), FILogFile::kDontTimeStamp);
	...
	call	?GetInstance@FILogFileMgr@@SAAAV1@XZ	; FILogFileMgr::GetInstance
	mov	esi, eax
	lea	eax, DWORD PTR _playerName$222413[esp+192]
	push	eax
	lea	ecx, DWORD PTR $T224785[esp+196]
	push	ecx
	mov	ecx, edi
	call	?GetLogFileName@CvPolicyAI@@ABE?AVCvString@@AAV2@@Z ; CvPolicyAI::GetLogFileName
	mov	ecx, eax
	...
	mov	ecx, esi
	call	eax
	lea	ecx, DWORD PTR $T224785[esp+192]
	mov	esi, eax
	mov	BYTE PTR __$EHRec$[esp+200], bl
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
...
; 1036 : 		strBaseString.Format("%03d, ", GC.getGame().getElapsedGameTurns());
	...
	call	?getElapsedGameTurns@CvGame@@QBEHXZ	; CvGame::getElapsedGameTurns
	push	eax
	lea	ecx, DWORD PTR _strBaseString$222411[esp+196]
...
; 1037 : 		strBaseString += playerName + ", ";
	...
	lea	edx, DWORD PTR _playerName$222413[esp+208]
	push	edx
	lea	eax, DWORD PTR $T224786[esp+212]
	push	eax
	call	DWORD PTR __imp_??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@PBD@Z
	add	esp, 24					; 00000018H
	push	eax
	...
	call	DWORD PTR __imp_??Y?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV01@ABV01@@Z
	lea	ecx, DWORD PTR $T224786[esp+192]
	mov	BYTE PTR __$EHRec$[esp+200], bl
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
...
; 1039 : 		strTemp.Format("%s, Freedom: %d, Order: %d, Autocracy: %d", decisionState.c_str(), iWeightFreedom, iWeightOrder, iWeightAutocracy);
	...
	call	DWORD PTR __imp_?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ
	push	eax
	lea	ecx, DWORD PTR _strTemp$222412[esp+208]
...
; 1041 : 		strOutBuf = strBaseString + strTemp;
	...
	lea	edx, DWORD PTR _strTemp$222412[esp+216]
	push	edx
	lea	eax, DWORD PTR _strBaseString$222411[esp+220]
	push	eax
	lea	ecx, DWORD PTR $T224787[esp+224]
	push	ecx
	call	DWORD PTR __imp_??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@0@Z
	add	esp, 36					; 00000024H
	mov	ecx, eax
	...
	call	DWORD PTR __imp_?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ
	push	eax
	lea	ecx, DWORD PTR _strOutBuf$222410[esp+196]
	call	DWORD PTR __imp_?assign@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV12@PBD@Z
	lea	ecx, DWORD PTR $T224787[esp+192]
	mov	BYTE PTR __$EHRec$[esp+200], bl
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
...
; 393  : 	int iConquestPriority = max(0, pPlayer->GetGrandStrategyAI()->GetConquestPriority());
	...
	mov	ecx, eax
	call	?GetConquestPriority@CvGrandStrategyAI@@QAEHXZ ; CvGrandStrategyAI::GetConquestPriority
	mov	DWORD PTR $T225352[esp+104], eax
	test	eax, eax
	mov	DWORD PTR $T225353[esp+104], ebx
	lea	eax, DWORD PTR $T225352[esp+104]
	jg	SHORT $LN59@DoChooseId
	lea	eax, DWORD PTR $T225353[esp+104]
$LN59@DoChooseId:
	mov	eax, DWORD PTR [eax]
...
; 394  : 	int iDiploPriority = max(0, pPlayer->GetGrandStrategyAI()->GetUnitedNationsPriority());
	...
	mov	ecx, eax
	call	?GetUnitedNationsPriority@CvGrandStrategyAI@@QAEHXZ ; CvGrandStrategyAI::GetUnitedNationsPriority
	mov	DWORD PTR $T225354[esp+104], eax
	test	eax, eax
	mov	DWORD PTR $T225355[esp+104], ebx
	lea	eax, DWORD PTR $T225354[esp+104]
	jg	SHORT $LN63@DoChooseId
	lea	eax, DWORD PTR $T225355[esp+104]
$LN63@DoChooseId:
	mov	ecx, DWORD PTR [eax]
...
; 445  : 	for (int iPlayerLoop = 0; iPlayerLoop < MAX_MAJOR_CIVS; iPlayerLoop++)
	...
	xor	eax, eax
	xor	esi, esi
	mov	DWORD PTR _iPlayerLoop$222119[esp+104], eax
...
; 454  : 			switch(pPlayer->GetDiplomacyAI()->GetMajorCivApproach(eLoopPlayer, /*bHideTrueFeelings*/ true))
	...
	mov	ecx, DWORD PTR _pPlayer$[esp+100]
	mov	esi, eax
	mov	eax, DWORD PTR _iPlayerLoop$222119[esp+104]
	push	1
	push	eax
	call	?GetDiplomacyAI@CvPlayer@@QBEPAVCvDiplomacyAI@@XZ ; CvPlayer::GetDiplomacyAI
	mov	ecx, eax
...
; 557  : 	iHappinessDelta = max (0, 100 - pPlayer->GetCulture()->ComputeHypotheticalPublicOpinionUnhappiness(eFreedomBranch));
	...
	sub	ecx, eax
	mov	DWORD PTR $T225360[esp+104], ecx
	mov	DWORD PTR $T225361[esp+104], 0
...
; 559  : 	iHappinessDelta = max (0, 100 - pPlayer->GetCulture()->ComputeHypotheticalPublicOpinionUnhappiness(eAutocracyBranch));
	...
	mov	ecx, 100				; 00000064H
	sub	ecx, eax
	mov	DWORD PTR $T225362[esp+104], ecx
	mov	DWORD PTR $T225363[esp+104], 0
...
_TEXT	SEGMENT
__Tmp$225852 = -24					; size = 8
__Tmp$225781 = -16					; size = 8
__Tmp$225807 = -8					; size = 8
___$ReturnUdt$ = 8					; size = 4
__First$ = 12						; size = 4
__Last$ = 16						; size = 4
...
; 3050 : 				std::iter_swap(_Plast++, _Gfirst);
	...
	mov	edi, DWORD PTR [edx]
	mov	DWORD PTR __Tmp$225781[esp+44], ebp
	mov	ebp, DWORD PTR [eax]
	mov	DWORD PTR [edx], ebp
	mov	ebp, DWORD PTR [eax+4]
	mov	DWORD PTR [edx+4], ebp
	mov	edx, DWORD PTR __Tmp$225781[esp+44]
	mov	DWORD PTR [eax], edi
	mov	DWORD PTR [eax+4], edx
$LN20@Unguarded_:
	add	eax, 8
...
; 3057 : 				std::iter_swap(--_Pfirst, _Glast - 1);
	...
	mov	ebp, DWORD PTR [ecx+4]
	mov	edi, DWORD PTR [ecx]
	mov	DWORD PTR __Tmp$225807[esp+44], ebp
	mov	ebp, DWORD PTR [edx]
	mov	DWORD PTR [ecx], ebp
	mov	ebp, DWORD PTR [edx+4]
	mov	DWORD PTR [ecx+4], ebp
	mov	DWORD PTR [edx], edi
	mov	edi, DWORD PTR __Tmp$225807[esp+44]
	mov	DWORD PTR [edx+4], edi
$LN13@Unguarded_:
	sub	ebx, 8
	sub	edx, 8
...
; 3066 : 			std::iter_swap(_Pfirst++, _Gfirst++);
	...
	mov	DWORD PTR __Tmp$225852[esp+40], ebp
	mov	ebp, DWORD PTR [edi+4]
	mov	DWORD PTR __Tmp$225852[esp+44], ebp
	mov	ebp, DWORD PTR [edx]
	mov	DWORD PTR [edi], ebp
	mov	ebp, DWORD PTR [edx+4]
	mov	DWORD PTR [edi+4], ebp
	mov	edi, DWORD PTR __Tmp$225852[esp+40]
	mov	DWORD PTR [edx], edi
	mov	edi, DWORD PTR __Tmp$225852[esp+44]
	mov	DWORD PTR [edx+4], edi
	jmp	$LL23@Unguarded_
$LN6@Unguarded_:
...
; 81   : 	for(uint uiIndex = 0; uiIndex < uiPolicyCount; ++uiIndex)
	...
	mov	DWORD PTR _uiIndex$221757[esp+24], edi
...
$LN3@Read:
	mov	eax, DWORD PTR _uiIndex$221757[esp+24]
	inc	eax
	mov	DWORD PTR _uiIndex$221757[esp+24], eax
...
; 3087 : 			std::_Unguarded_partition(_First, _Last);
	...
	push	edi
	lea	eax, DWORD PTR __Mid$222678[esp+28]
	push	ebx
	push	eax
...
; 3090 : 		if (_Mid.first - _First < _Last - _Mid.second)
	...
	mov	ebp, DWORD PTR __Mid$222678[esp+40]
	mov	eax, esi
	cdq
	sub	eax, edx
	sar	eax, 1
	...
	sar	eax, 1
	add	esi, eax
	mov	eax, DWORD PTR __Mid$222678[esp+36]
	mov	ecx, edi
	mov	edx, eax
	sub	ecx, ebp
	sub	edx, ebx
...
; 3098 : 			_Last = _Mid.first;
	...
	mov	edi, DWORD PTR __Mid$222678[esp+36]
$LN26@Sort:
	mov	eax, edi
	sub	eax, ebx
	sar	eax, 3
...
_elem$227723 = -52					; size = 8
_elem$227708 = -52					; size = 8
_eCurrentGrandStrategy$ = -52				; size = 4
_iWeight$221971 = -52					; size = 4
...
; 198  : 			iWeight += m_PolicyAIWeights.GetWeight(iPolicyLoop);
	...
	mov	DWORD PTR _elem$227708[esp+72], ecx
...
; 201  : 			if(m_pCurrentPolicies->WillFinishBranchIfAdopted((PolicyTypes) iPolicyLoop))
	...
	mov	ecx, DWORD PTR [esi]
	push	ebp
	mov	DWORD PTR _iWeight$221971[esp+76], edi
...
; 209  : 						iWeight += m_PolicyAIWeights.GetWeight(iFinisherPolicy);
	...
	add	eax, edi
	mov	DWORD PTR _elem$227723[esp+72], edx
	mov	DWORD PTR _iWeight$221971[esp+72], eax
$LN39@ChooseNext:
...
$LN145@ChooseNext:
	...
	mov	edx, DWORD PTR _iWeight$221971[esp+72]
