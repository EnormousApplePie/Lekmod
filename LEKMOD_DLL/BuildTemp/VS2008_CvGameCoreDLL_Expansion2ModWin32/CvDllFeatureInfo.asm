...
_DATA	SEGMENT
_CIV5_XP2_DLL_VERSION DD FLAT:$SG217678
_DATA	ENDS
CONST	SEGMENT
$SG217678 DB	'1.0.0', 00H
	ORG $+2
...
; 306  : 	static GUID DLLCALL GetInterfaceId(){ return guidICvUnknown; }
	...
	mov	eax, DWORD PTR $T219079[esp-4]
...
; 30   : 	        guidInterface == ICvFeatureInfo1::GetInterfaceId())
	...
	mov	DWORD PTR $T219101[esp+20], ecx
	lea	ecx, DWORD PTR $T219101[esp+16]
	mov	DWORD PTR $T219101[esp+24], edx
	mov	DWORD PTR $T219101[esp+16], eax
	mov	eax, DWORD PTR _guidICvUnknown+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T219101[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	...
	mov	DWORD PTR $T219103[esp+20], ecx
	lea	ecx, DWORD PTR $T219103[esp+16]
	mov	DWORD PTR $T219103[esp+24], edx
	mov	DWORD PTR $T219103[esp+16], eax
	mov	eax, DWORD PTR _guidICvFeatureInfo1+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T219103[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	jne	SHORT $LN1@QueryInter
