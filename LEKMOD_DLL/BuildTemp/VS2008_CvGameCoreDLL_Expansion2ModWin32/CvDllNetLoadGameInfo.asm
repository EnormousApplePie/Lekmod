...
_DATA	SEGMENT
_CIV5_XP2_DLL_VERSION DD FLAT:$SG217967
_DATA	ENDS
CONST	SEGMENT
$SG217967 DB	'1.0.0', 00H
	ORG $+2
...
; 306  : 	static GUID DLLCALL GetInterfaceId(){ return guidICvUnknown; }
	...
	mov	eax, DWORD PTR $T220486[esp-4]
...
; 530  : 	static GUID DLLCALL GetInterfaceId() { return guidICvNetLoadGameInfo1; }
	...
	mov	eax, DWORD PTR $T220490[esp-4]
...
; 26   : 	        guidInterface == ICvNetLoadGameInfo1::GetInterfaceId())
	...
	mov	DWORD PTR $T220506[esp+20], ecx
	lea	ecx, DWORD PTR $T220506[esp+16]
	mov	DWORD PTR $T220506[esp+24], edx
	mov	DWORD PTR $T220506[esp+16], eax
	mov	eax, DWORD PTR _guidICvUnknown+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T220506[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	...
	mov	DWORD PTR $T220508[esp+20], ecx
	lea	ecx, DWORD PTR $T220508[esp+16]
	mov	DWORD PTR $T220508[esp+24], edx
	mov	DWORD PTR $T220508[esp+16], eax
	mov	eax, DWORD PTR _guidICvNetLoadGameInfo1+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T220508[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	jne	SHORT $LN1@QueryInter
...
; 1260 : 		_THROW(length_error, "vector<T> too long");
	...
	lea	ecx, DWORD PTR $T220563[esp+84]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z
	lea	ecx, DWORD PTR $T220562[esp+80]
	mov	DWORD PTR __$EHRec$[esp+88], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@XZ
	lea	eax, DWORD PTR $T220563[esp+80]
	push	eax
	lea	ecx, DWORD PTR $T220562[esp+96]
	mov	BYTE PTR __$EHRec$[esp+92], 1
	mov	DWORD PTR $T220562[esp+84], OFFSET ??_7logic_error@std@@6B@
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@ABV01@@Z
	push	OFFSET __TI3?AVlength_error@std@@
	lea	ecx, DWORD PTR $T220562[esp+84]
	push	ecx
	mov	BYTE PTR __$EHRec$[esp+96], 0
	mov	DWORD PTR $T220562[esp+88], OFFSET ??_7length_error@std@@6B@
...
; 40   : 		_THROW_NCEE(std::bad_alloc, NULL);
	...
	lea	eax, DWORD PTR $T220646[esp+8]
	push	eax
	lea	ecx, DWORD PTR $T220642[esp+16]
	mov	DWORD PTR $T220646[esp+12], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@ABQBD@Z
	push	OFFSET __TI2?AVbad_alloc@std@@
	lea	ecx, DWORD PTR $T220642[esp+16]
	push	ecx
	mov	DWORD PTR $T220642[esp+20], OFFSET ??_7bad_alloc@std@@6B@
	call	__CxxThrowException@8
$LN9@Allocate:
$LN8@Allocate:
	int	3
...
; 70   : 		m_saveTo << container.size();
	...
	lea	eax, DWORD PTR $T220656[esp]
	sar	edx, 2
	push	eax
	mov	DWORD PTR $T220656[esp+4], edx
	call	?Write@FDataStream@@IAEXABI@Z		; FDataStream::Write
...
; 199  : 	std::for_each(readFrom.begin(), readFrom.end(), SerializeFromSequenceContainer<const ElementType, const std::vector<ElementType> >(saveTo, readFrom));
	...
	push	edi
	lea	ecx, DWORD PTR $T220797[esp+8]
	sar	eax, 2
	push	ecx
	mov	ecx, ebx
	mov	DWORD PTR $T220797[esp+12], eax
	call	?Write@FDataStream@@IAEXABI@Z		; FDataStream::Write
...
; 942  : 		_STD _Ptr_cat(_First, _First), _STD _Range_checked_iterator_tag());
	...
	mov	BYTE PTR $T221059[esp+4], 0
	mov	eax, DWORD PTR $T221059[esp+4]
	mov	ecx, DWORD PTR __Cat$221063[esp+4]
	push	eax
...
; 822  : 		_STD _Ptr_cat(_First, _Dest), _STD _Range_checked_iterator_tag()));
	...
	mov	edx, DWORD PTR __Al$[esp]
	mov	BYTE PTR $T221266[esp+4], 0
	mov	eax, DWORD PTR $T221266[esp+4]
	mov	ecx, DWORD PTR __Cat$221271[esp+4]
	push	eax
	mov	eax, DWORD PTR __Dest$[esp+4]
	push	ecx
...
; 1254 : 		_STDEXT unchecked_uninitialized_fill_n(_Ptr, _Count, _Val, this->_Alval);
	...
	mov	edx, DWORD PTR __Cat$221287[esp]
	push	esi
	mov	esi, DWORD PTR __Count$[esp+4]
	push	edi
	mov	edi, DWORD PTR __Ptr$[esp+8]
	mov	BYTE PTR $T221283[esp+12], 0
	mov	eax, DWORD PTR $T221283[esp+12]
	push	eax
...
; 207  : 	return (_STDEXT unchecked_uninitialized_copy(_First, _Last, _Dest, _Al));
	...
	mov	ecx, DWORD PTR __Cat$221305[esp]
	mov	edx, DWORD PTR __Al$[esp]
	mov	BYTE PTR $T221301[esp+4], 0
	mov	eax, DWORD PTR $T221301[esp+4]
	push	eax
	mov	eax, DWORD PTR __Dest$[esp+4]
	push	ecx
	mov	ecx, DWORD PTR __Last$[esp+8]
...
; 1141 : 			_Ptr, this->_Alval));
	...
	mov	edx, DWORD PTR __Cat$221498[esp]
	mov	BYTE PTR $T221494[esp+4], 0
	mov	eax, DWORD PTR $T221494[esp+4]
	push	eax
	mov	eax, DWORD PTR __Ptr$[esp+4]
	push	edx
...
; 864  : 		_STD _Move_cat(_Dest), _STD _Range_checked_iterator_tag()));
	...
	mov	ecx, DWORD PTR __Cat$221534[esp]
	mov	edx, DWORD PTR __Al$[esp]
	mov	BYTE PTR $T221530[esp+4], 0
	mov	eax, DWORD PTR $T221530[esp+4]
	push	eax
	mov	eax, DWORD PTR __Dest$[esp+4]
	push	ecx
	mov	ecx, DWORD PTR __Last$[esp+8]
...
; 1148 : 			_Ptr, this->_Alval));
	...
	mov	edx, DWORD PTR __Cat$221907[esp]
	mov	BYTE PTR $T221904[esp+4], 0
	mov	eax, DWORD PTR $T221904[esp+4]
	push	eax
	mov	eax, DWORD PTR __Ptr$[esp+4]
	push	edx
	mov	edx, DWORD PTR __First$[esp+8]
...
__$EHRec$ = -16						; size = 16
__Cat$222407 = 8					; size = 1
__Cat$222335 = 8					; size = 1
__Where$ = 8						; size = 4
__Tmp$219834 = 12					; size = 4
__Tmp$219824 = 12					; size = 4
__Newvec$219809 = 12					; size = 4
__Count$ = 12						; size = 4
tv515 = 16						; size = 4
$T222403 = 16						; size = 1
$T222331 = 16						; size = 1
...
; 1178 : 			_Ufill(_Newvec + _Whereoff, _Count, _Val);	// add new stuff
	...
	push	edx
	mov	ecx, esi
	mov	DWORD PTR __Newvec$219809[ebp], eax
...
; 1181 : 				_Newvec);	// move prefix
	...
	mov	edx, DWORD PTR __Cat$222335[ebp]
	mov	eax, DWORD PTR [esi+4]
	mov	BYTE PTR $T222331[ebp], 0
	mov	ecx, DWORD PTR $T222331[ebp]
	push	ecx
	mov	ecx, DWORD PTR __Newvec$219809[ebp]
	push	edx
...
; 1184 : 				_Newvec + (_Whereoff + _Count));	// move suffix
	...
	mov	eax, DWORD PTR [esi+8]
	add	esp, 24					; 00000018H
	mov	BYTE PTR $T222403[ebp], 0
	mov	edx, DWORD PTR $T222403[ebp]
	push	edx
	mov	edx, DWORD PTR __Cat$222407[ebp]
	push	edx
	lea	ecx, DWORD PTR [ebx+edi]
	mov	ebx, DWORD PTR __Newvec$219809[ebp]
	push	esi
...
; 1190 : 			this->_Alval.deallocate(_Newvec, _Capacity);
	...
	mov	edx, DWORD PTR __Newvec$219809[ebp]
	push	edx
	call	??3@YAXPAX@Z				; operator delete
	add	esp, 4
...
; 1211 : 			_Ty _Tmp = _Val;	// in case _Val is in sequence
	...
	mov	DWORD PTR __Tmp$219824[ebp], ecx
...
; 1218 : 				_Tmp);	// insert new stuff off end
	...
	lea	edx, DWORD PTR __Tmp$219824[ebp]
	sar	ecx, 2
	push	edx
	sub	edi, ecx
	push	edi
...
; 1239 : 				_Mylast);	// copy suffix
	...
	push	edi
	mov	ecx, esi
	mov	DWORD PTR __Tmp$219834[ebp], edx
...
; 1248 : 				_Tmp);	// insert into hole
	...
	lea	ecx, DWORD PTR __Tmp$219834[ebp]
	push	ecx
	add	edx, eax
	push	edx
	push	eax
...
; 819  : 			_Mylast = _Ufill(_Mylast, 1, _Val);
	...
	mov	ecx, DWORD PTR __Cat$222536[esp+8]
	mov	edx, DWORD PTR __Val$[esp+8]
	mov	BYTE PTR $T222532[esp+12], 0
	mov	eax, DWORD PTR $T222532[esp+12]
	push	eax
	push	ecx
	push	esi
	push	edx
...
; 88   : 	for(i = 0; i < count; ++i)
	...
	push	ebp
	mov	ebp, DWORD PTR __Cat$223030[esp+24]
$LL104@SerializeT:
...
; 91   : 		loadFrom >> v;
	...
	lea	ecx, DWORD PTR _v$219698[esp+28]
	push	ecx
	push	edx
...
$LN61@SerializeT:
	...
	mov	BYTE PTR $T223027[esp+28], bl
	mov	eax, DWORD PTR $T223027[esp+28]
	push	eax
	push	ebp
	push	esi
	lea	ecx, DWORD PTR _v$219698[esp+40]
	push	ecx
	push	1
	push	edi
	call	??$_Uninit_fill_n@PAW4SlotStatus@@IW41@V?$allocator@W4SlotStatus@@@std@@@std@@YAXPAW4SlotStatus@@IABW41@AAV?$allocator@W4SlotStatus@@@0@U_Nonscalar_ptr_iterator_tag@0@U_Range_checked_iterator_tag@0@@Z ; std::_Uninit_fill_n<enum SlotStatus *,unsigned int,enum SlotStatus,std::allocator<enum SlotStatus> >
...
$LN53@SerializeT:
	lea	edx, DWORD PTR _v$219698[esp+28]
	push	edx
	push	1
	push	edi
	mov	ecx, esi
