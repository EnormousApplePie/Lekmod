; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\Users\EnormousApplePie\Desktop\Cleanup (v1)\Lekmod Files\Lekmod DLL versions\v30\LEKMOD_DLL\CvGameCoreDLL_Expansion2\CvDllDealAI.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_DATA	SEGMENT
_CIV5_XP2_DLL_VERSION DD FLAT:$SG217167
_DATA	ENDS
CONST	SEGMENT
$SG217167 DB	'1.0.0', 00H
	ORG $+2
...
; File c:\users\enormousapplepie\desktop\cleanup (v1)\lekmod files\lekmod dll versions\v30\lekmod_dll\cvgamecoredll_expansion2\cvdlldealai.cpp
rdata$r	SEGMENT
...
; 90   : 	return (NULL != pkPlayer)? new CvDllPlayer(pkPlayer) : NULL;
	...
	add	esp, 4
	mov	DWORD PTR $T219020[esp+12], eax
...
__unwindfunclet$?GetPlayer@CvDllDealAI@@UAGPAVICvPlayer1@@XZ$0:
	mov	eax, DWORD PTR $T219020[ebp-4]
	push	eax
...
; 306  : 	static GUID DLLCALL GetInterfaceId(){ return guidICvUnknown; }
	...
	mov	eax, DWORD PTR $T219081[esp-4]
...
; 952  : 	static GUID DLLCALL GetInterfaceId() { return guidICvDealAI1; }
	...
	mov	eax, DWORD PTR $T219085[esp-4]
...
; 33   : 	        guidInterface == ICvDealAI1::GetInterfaceId())
	...
	mov	DWORD PTR $T219095[esp+20], ecx
	lea	ecx, DWORD PTR $T219095[esp+16]
	mov	DWORD PTR $T219095[esp+24], edx
	mov	DWORD PTR $T219095[esp+16], eax
	mov	eax, DWORD PTR _guidICvUnknown+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T219095[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	...
	mov	DWORD PTR $T219097[esp+20], ecx
	lea	ecx, DWORD PTR $T219097[esp+16]
	mov	DWORD PTR $T219097[esp+24], edx
	mov	DWORD PTR $T219097[esp+16], eax
	mov	eax, DWORD PTR _guidICvDealAI1+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T219097[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	jne	SHORT $LN1@QueryInter
