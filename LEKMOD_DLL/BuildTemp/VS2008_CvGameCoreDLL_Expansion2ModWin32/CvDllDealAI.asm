; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\Users\EnormousApplePie\Desktop\Lekmod Files\Lekmod DLL versions\v29\LEKMOD_DLL\CvGameCoreDLL_Expansion2\CvDllDealAI.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File c:\users\enormousapplepie\desktop\lekmod files\lekmod dll versions\v29\lekmod_dll\cvgamecoredll_expansion2\cvdlldealai.cpp
rdata$r	SEGMENT
...
; 90   : 	return (NULL != pkPlayer)? new CvDllPlayer(pkPlayer) : NULL;
	...
	add	esp, 4
	mov	DWORD PTR $T219016[esp+12], eax
...
__unwindfunclet$?GetPlayer@CvDllDealAI@@UAGPAVICvPlayer1@@XZ$0:
	mov	eax, DWORD PTR $T219016[ebp-4]
	push	eax
...
; 306  : 	static GUID DLLCALL GetInterfaceId(){ return guidICvUnknown; }
	...
	mov	eax, DWORD PTR $T219077[esp-4]
...
; 33   : 	        guidInterface == ICvDealAI1::GetInterfaceId())
	...
	mov	DWORD PTR $T219093[esp+20], ecx
	lea	ecx, DWORD PTR $T219093[esp+16]
	mov	DWORD PTR $T219093[esp+24], edx
	mov	DWORD PTR $T219093[esp+16], eax
	mov	eax, DWORD PTR _guidICvDealAI1+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T219093[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	jne	SHORT $LN1@QueryInter
