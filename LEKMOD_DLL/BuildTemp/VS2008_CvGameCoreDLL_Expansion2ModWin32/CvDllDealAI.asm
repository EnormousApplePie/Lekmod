...
; 90   : 	return (NULL != pkPlayer)? new CvDllPlayer(pkPlayer) : NULL;
	...
	add	esp, 4
	mov	DWORD PTR $T219062[esp+12], eax
...
__unwindfunclet$?GetPlayer@CvDllDealAI@@UAGPAVICvPlayer1@@XZ$0:
	mov	eax, DWORD PTR $T219062[ebp-4]
	push	eax
...
; 306  : 	static GUID DLLCALL GetInterfaceId(){ return guidICvUnknown; }
	...
	mov	eax, DWORD PTR $T219123[esp-4]
...
; 952  : 	static GUID DLLCALL GetInterfaceId() { return guidICvDealAI1; }
	...
	mov	eax, DWORD PTR $T219127[esp-4]
...
; 33   : 	        guidInterface == ICvDealAI1::GetInterfaceId())
	...
	mov	DWORD PTR $T219137[esp+20], ecx
	lea	ecx, DWORD PTR $T219137[esp+16]
	mov	DWORD PTR $T219137[esp+24], edx
	mov	DWORD PTR $T219137[esp+16], eax
	mov	eax, DWORD PTR _guidICvUnknown+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T219137[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
