...
_DATA	SEGMENT
_CIV5_XP2_DLL_VERSION DD FLAT:$SG217193
_DATA	ENDS
CONST	SEGMENT
$SG217193 DB	'1.0.0', 00H
	ORG $+2
...
; 1695 : 	static GUID DLLCALL GetInterfaceId() { return guidICvTechInfo1; }
	...
	mov	eax, DWORD PTR $T218548[esp-4]
...
; 29   : 	        guidInterface == ICvTechInfo1::GetInterfaceId())
	...
	mov	DWORD PTR $T218566[esp+20], ecx
	lea	ecx, DWORD PTR $T218566[esp+16]
	mov	DWORD PTR $T218566[esp+24], edx
	mov	DWORD PTR $T218566[esp+16], eax
	mov	eax, DWORD PTR _guidICvUnknown+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T218566[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	...
	mov	DWORD PTR $T218568[esp+20], ecx
	lea	ecx, DWORD PTR $T218568[esp+16]
	mov	DWORD PTR $T218568[esp+24], edx
	mov	DWORD PTR $T218568[esp+16], eax
	mov	eax, DWORD PTR _guidICvTechInfo1+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T218568[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	jne	SHORT $LN1@QueryInter
