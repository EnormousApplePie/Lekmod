; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\Users\EnormousApplePie\Documents\GitHub\Lekmod\LEKMOD_DLL\CvGameCoreDLL_Expansion2\CvDllImprovementInfo.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_DATA	SEGMENT
_CIV5_XP2_DLL_VERSION DD FLAT:$SG217676
_DATA	ENDS
CONST	SEGMENT
$SG217676 DB	'1.0.0', 00H
	ORG $+2
...
; File c:\users\enormousapplepie\documents\github\lekmod\lekmod_dll\cvgamecoredll_expansion2\cvdllimprovementinfo.cpp
rdata$r	SEGMENT
...
; 29   : 	        guidInterface == ICvImprovementInfo1::GetInterfaceId())
	...
	mov	DWORD PTR $T219079[esp+20], ecx
	lea	ecx, DWORD PTR $T219079[esp+16]
	mov	DWORD PTR $T219079[esp+24], edx
	mov	DWORD PTR $T219079[esp+16], eax
	mov	eax, DWORD PTR _guidICvImprovementInfo1+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T219079[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	jne	SHORT $LN1@QueryInter
