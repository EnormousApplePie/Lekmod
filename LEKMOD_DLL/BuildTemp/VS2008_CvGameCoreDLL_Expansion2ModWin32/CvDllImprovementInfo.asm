...
_DATA	SEGMENT
_CIV5_XP2_DLL_VERSION DD FLAT:$SG217713
_DATA	ENDS
CONST	SEGMENT
$SG217713 DB	'1.0.0', 00H
	ORG $+2
...
; 1100 : 	static GUID DLLCALL GetInterfaceId() { return guidICvImprovementInfo1; }
	...
	mov	eax, DWORD PTR $T219100[esp-4]
...
; 29   : 	        guidInterface == ICvImprovementInfo1::GetInterfaceId())
	...
	mov	DWORD PTR $T219114[esp+20], ecx
	lea	ecx, DWORD PTR $T219114[esp+16]
	mov	DWORD PTR $T219114[esp+24], edx
	mov	DWORD PTR $T219114[esp+16], eax
	mov	eax, DWORD PTR _guidICvUnknown+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T219114[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	...
	mov	DWORD PTR $T219116[esp+20], ecx
	lea	ecx, DWORD PTR $T219116[esp+16]
	mov	DWORD PTR $T219116[esp+24], edx
	mov	DWORD PTR $T219116[esp+16], eax
	mov	eax, DWORD PTR _guidICvImprovementInfo1+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T219116[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	jne	SHORT $LN1@QueryInter
