; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\Users\EnormousApplePie\Documents\GitHub\Lekmod\LEKMOD_DLL\CvGameCoreDLL_Expansion2\CvDangerPlots.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; Function compile flags: /Ogtpy
; File c:\users\enormousapplepie\documents\github\lekmod\lekmod_dll\cvgamecoredll_expansion2\cvdangerplots.cpp
...
_this$ = -8						; size = 4
_iPlotY$222921 = -4					; size = 4
$T224820 = 8						; size = 4
_pUnit$ = 8						; size = 4
_iTurnsAway$222924 = 12					; size = 4
_pPlot$ = 12						; size = 4
...
; 737  : 			if(!kPathFinder.GeneratePath(pUnit->getX(), pUnit->getY(), iPlotX, iPlotY, 0, true /*bReuse*/))
	...
	push	ecx
	mov	ecx, edi
	mov	DWORD PTR _iPlotY$222921[esp+52], edx
...
; 743  : 			int iTurnsAway = pNode->m_iData2;
	...
	mov	DWORD PTR _iTurnsAway$222924[esp+24], eax

; 744  : 			iTurnsAway = max(iTurnsAway, 1);

	cmp	eax, 1
	mov	DWORD PTR $T224820[esp+24], 1
	lea	eax, DWORD PTR $T224820[esp+24]
	jl	SHORT $LN30@AssignUnit
	lea	eax, DWORD PTR _iTurnsAway$222924[esp+24]
$LN30@AssignUnit:
...
; 748  : 			AddDanger(iPlotX, iPlotY, iUnitCombatValue, iTurnsAway <= 1);
	...
	push	edx
	push	eax
	mov	eax, DWORD PTR _iPlotY$222921[esp+36]
	push	eax
	push	ebx
	mov	ecx, esi
...
_TEXT	SEGMENT
_this$ = -56						; size = 4
_pCityPlot$222717 = -52					; size = 4
_iRange$222696 = -52					; size = 4
tv1146 = -48						; size = 4
tv1110 = -48						; size = 4
tv1161 = -44						; size = 4
tv1125 = -44						; size = 4
_loopPlayer$222685 = -40				; size = 4
$T225211 = -36						; size = 4
_iLoop$222690 = -32					; size = 4
_iPlayer$222679 = -28					; size = 4
tv1175 = -24						; size = 4
_iPlotLoop$ = -20					; size = 4
_iRange$222716 = -20					; size = 4
_pUnitPlot$222698 = -20					; size = 4
...
; 119  : 	TeamTypes thisTeam = thisPlayer.getTeam();
	...
	mov	edx, DWORD PTR [ecx+4]
	mov	eax, DWORD PTR [edx+eax*4]
	mov	DWORD PTR $T225211[esp+72], eax
	jmp	SHORT $LN64@UpdateDang
$LN63@UpdateDang:
	mov	DWORD PTR $T225211[esp+72], -1
$LN64@UpdateDang:
...
; 122  : 	for(int iPlayer = 0; iPlayer < MAX_PLAYERS; iPlayer++)
	...
	mov	DWORD PTR _iPlayer$222679[esp+72], esi
...
; 126  : 		TeamTypes eTeam = loopPlayer.getTeam();
	...
	add	ecx, edx
	mov	DWORD PTR _loopPlayer$222685[esp+72], ecx
	cmp	eax, 63					; 0000003fH
...
; 133  : 		if(eTeam == thisTeam)
	...
	cmp	eax, DWORD PTR $T225211[esp+72]
	je	$LN43@UpdateDang
...
; 138  : 		if(ShouldIgnorePlayer(ePlayer) && !bPretendWarWithAllCivs)
	...
	mov	eax, DWORD PTR _iPlayer$222679[esp+72]
...
; 146  : 		for(pLoopUnit = loopPlayer.firstUnit(&iLoop); pLoopUnit != NULL; pLoopUnit = loopPlayer.nextUnit(&iLoop))
	...
	push	0
	lea	ecx, DWORD PTR _iLoop$222690[esp+76]
	push	ecx
	mov	ecx, DWORD PTR _loopPlayer$222685[esp+80]
...
; 154  : 			if(pLoopUnit->canRangeStrike())
	...
	mov	ecx, ebx
	mov	esi, eax
	mov	DWORD PTR _iRange$222696[esp+72], eax
...
; 156  : 				iRange += pLoopUnit->GetRange();
	...
	add	esi, eax
	mov	DWORD PTR _iRange$222696[esp+72], esi
$LN34@UpdateDang:
...
; 160  : 			AssignUnitDangerValue(pLoopUnit, pUnitPlot);
	...
	push	ebx
	mov	ecx, edi
	mov	DWORD PTR _pUnitPlot$222698[esp+80], eax
...
; 174  : 				for(int iDY = -(iRange); iDY <= iRange; iDY++)
	...
	cmp	edi, DWORD PTR _iRange$222696[esp+72]
	jg	$LN32@UpdateDang
...
$LN99@UpdateDang:
	...
	mov	eax, ecx
$LN100@UpdateDang:
	cmp	eax, DWORD PTR _iRange$222696[esp+72]
	jg	SHORT $LN29@UpdateDang
	mov	eax, DWORD PTR _pUnitPlot$222698[esp+72]
	movsx	edx, WORD PTR [eax+2]
	movsx	eax, WORD PTR [eax]
	push	edi
	push	ebp
...
; 178  : 					if(!pLoopPlot || pLoopPlot == pUnitPlot)
	...
	cmp	esi, DWORD PTR _pUnitPlot$222698[esp+72]
	je	SHORT $LN29@UpdateDang
...
; 172  : 			for(int iDX = -(iRange); iDX <= iRange; iDX++)
	...
	inc	ebp
	cmp	ebp, DWORD PTR _iRange$222696[esp+72]
	jle	$LL33@UpdateDang
$LN37@UpdateDang:
...
; 195  : 		for(pLoopCity = loopPlayer.firstCity(&iLoop); pLoopCity != NULL; pLoopCity = loopPlayer.nextCity(&iLoop))
	...
	mov	ecx, DWORD PTR _loopPlayer$222685[esp+72]
	push	0
	lea	edx, DWORD PTR _iLoop$222690[esp+76]
	push	edx
...
; 203  : 			CvPlot* pCityPlot = pLoopCity->plot();
	...
	mov	ecx, ebx
	mov	DWORD PTR _iRange$222716[esp+72], esi
	call	?plot@CvCity@@QBEPAVCvPlot@@XZ		; CvCity::plot
	mov	edi, eax
...
; 204  : 			AssignCityDangerValue(pLoopCity, pCityPlot);
	...
	push	0
	mov	ecx, ebx
	mov	DWORD PTR _pCityPlot$222717[esp+76], edi
	call	?getStrengthValue@CvCity@@QBEH_N@Z	; CvCity::getStrengthValue
...
$LN160@UpdateDang:
	...
	mov	eax, DWORD PTR _pCityPlot$222717[esp+72]
	movsx	edx, WORD PTR [eax+2]
	movsx	eax, WORD PTR [eax]
	push	edi
	push	ebp
...
$LN245@UpdateDang:
	...
	mov	esi, DWORD PTR _iRange$222716[esp+72]
$LN16@UpdateDang:
	inc	edi
	dec	edx
	cmp	edi, esi
...
; 195  : 		for(pLoopCity = loopPlayer.firstCity(&iLoop); pLoopCity != NULL; pLoopCity = loopPlayer.nextCity(&iLoop))
	...
	mov	ecx, DWORD PTR _loopPlayer$222685[esp+72]
	push	0
	lea	eax, DWORD PTR _iLoop$222690[esp+76]
	push	eax
...
; 122  : 	for(int iPlayer = 0; iPlayer < MAX_PLAYERS; iPlayer++)
	...
	inc	DWORD PTR _iPlayer$222679[esp+72]
...
; 242  : 	for(iPlotLoop = 0; iPlotLoop < GC.getMap().numPlots(); iPlotLoop++)
	...
	mov	ecx, DWORD PTR $T225211[esp+72]
	mov	ebx, ecx
	shr	ebx, 5
...
; 246  : 		if(pPlot->isRevealed(thisTeam))
	...
	mov	ebp, 1
	shl	ebp, cl
	mov	DWORD PTR _uiOffset$225552[esp+72], ebx
...
$LN243@UpdateDang:
	...
	mov	ebx, DWORD PTR _uiOffset$225552[esp+72]
	lea	eax, DWORD PTR [eax+ecx*4]
$LN6@UpdateDang:
	inc	ebp
	cmp	ebp, 6
...
; 69   : 		m_DangerPlots.resize(iGridSize);
	...
	mov	DWORD PTR $T225702[esp+12], esi
	...
	jb	SHORT $LN27@Init
$LN26@Init:
	lea	ebx, DWORD PTR $T225702[esp+12]
$LN27@Init:
	mov	edx, DWORD PTR [ebx]
...
; 798  : 	m_DangerPlots.resize(iGridSize);
	...
	mov	DWORD PTR $T225743[esp+24], eax
	...
	mov	eax, DWORD PTR _iGridSize$[esp+20]
$LN12@Read:
	mov	ecx, DWORD PTR $T225743[esp+24]
	cmp	DWORD PTR [esi], ecx
	jb	SHORT $LN18@Read
	lea	esi, DWORD PTR $T225743[esp+24]
$LN18@Read:
	mov	edx, DWORD PTR [esi]
