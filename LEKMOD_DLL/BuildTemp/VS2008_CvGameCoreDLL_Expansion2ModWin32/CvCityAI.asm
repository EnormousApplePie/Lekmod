; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\Users\EnormousApplePie\Desktop\Lekmod Files\Lekmod DLL versions\v29\LEKMOD_DLL\CvGameCoreDLL_Expansion2\CvCityAI.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG223241 DB	'FLAVOR_WONDER', 00H
	ORG $+2
$SG223244 DB	'FLAVOR_GREAT_PEOPLE', 00H
$SG223247 DB	'Random roll for whether to continue building wonders', 00H
	ORG $+3
$SG223257 DB	'%03d, ', 00H
	ORG $+1
$SG223259 DB	', ', 00H
	ORG $+1
$SG223262 DB	'%s, WONDER - Started %s, Turns: %d', 00H
CONST	ENDS
...
; Function compile flags: /Ogtpy
; File c:\users\enormousapplepie\desktop\lekmod files\lekmod dll versions\v29\lekmod_dll\cvgamecoredll_expansion2\cvcityai.cpp
...
_TEXT	SEGMENT
_buildable$223249 = -164				; size = 12
_playerName$223252 = -152				; size = 28
_strBaseString$223254 = -124				; size = 28
_strOutBuf$223255 = -96					; size = 28
$T223767 = -68						; size = 28
$T223766 = -68						; size = 28
$T223765 = -40						; size = 28
__$EHRec$ = -12						; size = 12
...
; 130  : 		pushOrder(ORDER_CONSTRUCT, buildable.m_iIndex, -1, false, false, false, false);
	...
	push	edi
	mov	ecx, esi
	mov	DWORD PTR _buildable$223249[esp+216], eax
...
; 134  : 			CvString playerName;
	...
	lea	ecx, DWORD PTR _playerName$223252[esp+180]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ

; 135  : 			FILogFile* pLog;
; 136  : 			CvString strBaseString;

	lea	ecx, DWORD PTR _strBaseString$223254[esp+180]
	mov	DWORD PTR __$EHRec$[esp+188], 0
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ

; 137  : 			CvString strOutBuf;

	lea	ecx, DWORD PTR _strOutBuf$223255[esp+180]
...
; 139  : 			m_pCityStrategyAI->LogCityProduction(buildable, false);
	...
	mov	ecx, DWORD PTR _buildable$223249[esp+188]
	push	0
...
; 142  : 			pLog = LOGFILEMGR.GetLog(kOwner.GetCitySpecializationAI()->GetLogFileName(playerName), FILogFile::kDontTimeStamp);
	...
	lea	edx, DWORD PTR _playerName$223252[esp+180]
	mov	edi, eax
	push	edx
	lea	eax, DWORD PTR $T223765[esp+184]
	push	eax
	mov	ecx, ebx
	call	?GetCitySpecializationAI@CvPlayer@@QBEPAVCvCitySpecializationAI@@XZ ; CvPlayer::GetCitySpecializationAI
	mov	ecx, eax
	...
	mov	ecx, edi
	call	eax
	lea	ecx, DWORD PTR $T223765[esp+180]
	mov	edi, eax
...
; 143  : 			strBaseString.Format("%03d, ", GC.getGame().getElapsedGameTurns());
	...
	push	eax
	lea	ecx, DWORD PTR _strBaseString$223254[esp+184]
...
; 144  : 			strBaseString += playerName + ", ";
	...
	lea	edx, DWORD PTR _playerName$223252[esp+196]
	push	edx
	lea	eax, DWORD PTR $T223766[esp+200]
	push	eax
	...
	lea	ecx, DWORD PTR $T223766[esp+180]
	mov	BYTE PTR __$EHRec$[esp+188], 2
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
...
; 150  : 			strOutBuf.Format("%s, WONDER - Started %s, Turns: %d", getName().GetCString(), GC.getBuildingInfo((BuildingTypes)buildable.m_iIndex)->GetDescription(), buildable.m_iTurnsToConstruct);
	...
	lea	ecx, DWORD PTR $T223767[esp+180]
	push	ecx
	mov	ecx, esi
	...
	mov	ebx, eax
	call	DWORD PTR __imp_?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ
	mov	edx, DWORD PTR _buildable$223249[esp+188]
	push	edx
	push	ebx
	push	eax
	lea	eax, DWORD PTR _strOutBuf$223255[esp+192]
