...
$SG222407 DB	00H
	ORG $+7
$SG222570 DB	'Deal AI: ASYNC RAND call to determine if AI will give in'
	DB	'to a human demand.', 00H
	ORG $+1
$SG222755 DB	'GAMEOPTION_AI_TWEAKS', 00H
	ORG $+3
$SG222756 DB	'GAMEOPTION_AI_GIMP_ALWAYS_WHITE_PEACE', 00H
	ORG $+2
$SG223162 DB	'AIGRANDSTRATEGY_CULTURE', 00H
$SG223179 DB	'AIGRANDSTRATEGY_CULTURE', 00H
CONST	ENDS
...
; 147  : 	int iWrappedDY = dyWrap(iY2 - iY1);
	...
	mov	ebx, ebp
	sub	ebx, eax
	mov	DWORD PTR $T225591[esp+24], ebx
...
$LN32@plotDistan:
	mov	ebx, ebp
	mov	DWORD PTR $T225591[esp+24], ebp
$LN36@plotDistan:
...
; 155  : 		iWrappedDX *= -1;  // change polarity
	...
	mov	ebx, DWORD PTR $T225591[esp+24]
	neg	eax
	sbb	eax, eax
	inc	eax
	cmp	eax, edx
...
; 203  : 	GC.getGame().GetGameDeals()->AddProposedDeal(kDeal);
	...
	mov	ecx, esp
	mov	DWORD PTR $T226160[esp+112], esp
	push	ebp
...
; 259  : 			szText = GetPlayer()->GetDiplomacyAI()->GetDiploStringForMessage(DIPLO_MESSAGE_TRADE_ACCEPT_ACCEPTABLE);
	...
	mov	ecx, eax
	call	?GetDiploStringForMessage@CvDiplomacyAI@@QAEPBDW4DiploMessageTypes@@W4PlayerTypes@@@Z ; CvDiplomacyAI::GetDiploStringForMessage
	mov	DWORD PTR _szText$222518[esp+32], eax
...
; 275  : 			gDLL->GameplayDiplomacyAILeaderMessage(GetPlayer()->GetID(), eUIState, szText, eAnimation);
	...
	mov	eax, DWORD PTR _szText$222518[esp+32]
	mov	ecx, DWORD PTR ?gGlobals@@3VCvGlobals@@A+8596
	mov	edx, DWORD PTR [ecx]
	mov	edx, DWORD PTR [edx+736]
	push	-1
...
; 503  : 	pGameDeals->AddProposedDeal(kDeal);
	...
	mov	ecx, esp
	mov	DWORD PTR $T226367[esp+96], esp
	push	edx
	call	??0CvDeal@@QAE@ABV0@@Z			; CvDeal::CvDeal
	mov	ecx, edi
	call	?AddProposedDeal@CvGameDeals@@QAEXVCvDeal@@@Z ; CvGameDeals::AddProposedDeal
...
; 1236 : 				iResourceQuantity = min(max(5,GetPlayer()->getNumCities()), iResourceQuantity);
	...
	mov	ecx, DWORD PTR [ebp]
	call	?getNumCities@CvPlayer@@QBEHXZ		; CvPlayer::getNumCities
	mov	DWORD PTR $T226468[esp+16], eax
	cmp	eax, 5
	mov	DWORD PTR $T226469[esp+20], 5
	lea	eax, DWORD PTR $T226468[esp+16]
	jg	SHORT $LN59@GetResourc
	lea	eax, DWORD PTR $T226469[esp+20]
$LN59@GetResourc:
...
_TEXT	SEGMENT
_iGoldValueOfResourcePlots$223048 = -40			; size = 4
_this$ = -36						; size = 4
_iGoldValueOfImprovedPlots$223047 = -32			; size = 4
_iGoldValueOfPlots$223046 = -28				; size = 4
_pCity$ = -24						; size = 4
_goldPerPlot$223045 = -20				; size = 4
_iI$223049 = -16					; size = 4
$T226578 = -12						; size = 4
$T226576 = -12						; size = 4
_eUsage$223061 = -12					; size = 4
$T226577 = -8						; size = 4
_iNumTurns$223064 = -8					; size = 4
_iCityLoop$223093 = -4					; size = 4
_eResource$223057 = -4					; size = 4
_iX$ = 8						; size = 4
_iY$ = 12						; size = 4
_bFromMe$ = 16						; size = 1
_eOtherPlayer$ = 20					; size = 4
...
; 1333 : 		int iGoldValueOfPlots = 0;
	...
	xor	ebp, ebp
	mov	DWORD PTR _goldPerPlot$223045[esp+56], eax
	mov	DWORD PTR _iGoldValueOfPlots$223046[esp+56], ebp

; 1334 : 		int iGoldValueOfImprovedPlots = 0;

	mov	DWORD PTR _iGoldValueOfImprovedPlots$223047[esp+56], ebp

; 1335 : 		int iGoldValueOfResourcePlots = 0;

	mov	DWORD PTR _iGoldValueOfResourcePlots$223048[esp+56], ebp

; 1336 : 		for(int iI = 0; iI < NUM_CITY_PLOTS; iI++)

	mov	DWORD PTR _iI$223049[esp+56], ebp
...
; 1343 : 					iGoldValueOfPlots += goldPerPlot; // this is a bargain, but at least it's in the ballpark
	...
	mov	eax, DWORD PTR _goldPerPlot$223045[esp+56]
	add	DWORD PTR _iGoldValueOfPlots$223046[esp+56], eax
$LN203@GetCityVal:
...
; 1347 : 					iGoldValueOfImprovedPlots += goldPerPlot * 25;
	...
	mov	ecx, DWORD PTR _goldPerPlot$223045[esp+56]
	imul	ecx, 25					; 00000019H
	add	DWORD PTR _iGoldValueOfImprovedPlots$223047[esp+56], ecx
$LN29@GetCityVal:
...
$LN100@GetCityVal:
	...
	mov	DWORD PTR _eResource$223057[esp+56], eax
...
; 1356 : 						int iResourceQuantity = pLoopPlot->getNumResource();
	...
	mov	ecx, esi
	mov	DWORD PTR _eUsage$223061[esp+56], eax
...
; 1358 : 						if(eUsage == RESOURCEUSAGE_LUXURY)
	...
	mov	eax, DWORD PTR _eUsage$223061[esp+56]
	cmp	eax, 2
	jne	$LN26@GetCityVal
...
; 1364 : 							int iNumTurns = min(1,GC.getGame().getMaxTurns() - GC.getGame().getGameTurn());
	...
	sub	esi, eax
	cmp	esi, 1
	mov	DWORD PTR $T226576[esp+56], esi
	mov	DWORD PTR $T226577[esp+56], 1
	lea	eax, DWORD PTR $T226576[esp+56]
	jl	SHORT $LN111@GetCityVal
	lea	eax, DWORD PTR $T226577[esp+56]
$LN111@GetCityVal:
	mov	eax, DWORD PTR [eax]
	mov	DWORD PTR _iNumTurns$223064[esp+56], eax

; 1365 : 							iNumTurns = max(120,iNumTurns); // let's not go hog wild here

	cmp	eax, 120				; 00000078H
	mov	DWORD PTR $T226578[esp+56], 120		; 00000078H
	lea	eax, DWORD PTR _iNumTurns$223064[esp+56]
...
; 1368 : 							iGoldValueOfResourcePlots += (iResourceQuantity * iHappinessFromResource * iNumTurns * 2);	// Ex: 1 Silk for 4 Happiness * 30 turns * 2 = 240
	...
	imul	eax, esi
	mov	esi, eax
	mov	eax, DWORD PTR _iGoldValueOfResourcePlots$223048[esp+56]
	imul	esi, edi
...
; 1370 : 							if(bFromMe)
	...
	mov	DWORD PTR _iGoldValueOfResourcePlots$223048[esp+56], ecx
...
; 1372 : 								if(GetPlayer()->getNumResourceAvailable(eResource) == 1)
	...
	mov	edx, DWORD PTR _this$[esp+56]
	mov	eax, DWORD PTR _eResource$223057[esp+56]
	mov	ecx, DWORD PTR [edx]
	push	1
	push	eax
	call	?getNumResourceAvailable@CvPlayer@@QBEHW4ResourceTypes@@_N@Z ; CvPlayer::getNumResourceAvailable
...
; 1374 : 									iGoldValueOfResourcePlots += (iResourceQuantity * iHappinessFromResource * iNumTurns * 4);
	...
	mov	ecx, DWORD PTR _iGoldValueOfResourcePlots$223048[esp+56]
	lea	edx, DWORD PTR [ecx+esi*4]
	mov	DWORD PTR _iGoldValueOfResourcePlots$223048[esp+56], edx
...
; 1382 : 							iGoldValueOfResourcePlots += (iResourceQuantity * iNumTurns * 150 / 100);
	...
	shr	eax, 31					; 0000001fH
	add	eax, edx
	add	DWORD PTR _iGoldValueOfResourcePlots$223048[esp+56], eax
$LN33@GetCityVal:
	mov	ebp, DWORD PTR _iI$223049[esp+56]
	inc	ebp
...
; 1388 : 		iGoldValueOfImprovedPlots /= 100;
	...
	mov	eax, 1374389535				; 51eb851fH
	imul	DWORD PTR _iGoldValueOfImprovedPlots$223047[esp+56]
	sar	edx, 5
	mov	ecx, edx
...
; 1390 : 		iItemValue = iItemValue + iGoldValueOfPlots + iGoldValueOfImprovedPlots + iGoldValueOfResourcePlots;
	...
	add	ecx, DWORD PTR _iGoldValueOfResourcePlots$223048[esp+56]
	add	ecx, DWORD PTR _iGoldValueOfPlots$223046[esp+56]
	add	ebx, ecx
...
; 1446 : 					for(pLoopCity = m_pPlayer->firstCity(&iCityLoop); pLoopCity != NULL; pLoopCity = m_pPlayer->nextCity(&iCityLoop))
	...
	mov	ecx, DWORD PTR [edi]
	push	0
	lea	eax, DWORD PTR _iCityLoop$223093[esp+60]
	push	eax
...
; 1446 : 					for(pLoopCity = m_pPlayer->firstCity(&iCityLoop); pLoopCity != NULL; pLoopCity = m_pPlayer->nextCity(&iCityLoop))
	...
	mov	ecx, DWORD PTR [edi]
	push	0
	lea	edx, DWORD PTR _iCityLoop$223093[esp+60]
	push	edx
...
; 1846 : 		int iAdditionalValue = iItemValue * max(0,(int)(eTheirEra-eMyEra));
	...
	sub	eax, esi
	mov	DWORD PTR $T227099[esp+12], eax
	test	eax, eax
	mov	DWORD PTR $T227100[esp+12], 0
	lea	eax, DWORD PTR $T227099[esp+12]
...
; 2360 : 				float fVotesRatio = (float)iNumVotes / (float)pLeague->CalculateStartingVotesForMember(eOtherPlayer);
	...
	fstp	DWORD PTR _fVotesRatio$223422[esp+16]

; 2361 : 				if (fVotesRatio > 0.5f)

	fld	DWORD PTR _fVotesRatio$223422[esp+16]
...
; 2379 : 	iValue = MAX(iValue, 0);
	...
	mov	DWORD PTR $T227468[esp+16], 0
	lea	eax, DWORD PTR $T227468[esp+16]
	test	edi, edi
...
_TEXT	SEGMENT
__Tmp$228464 = -24					; size = 8
__Tmp$228393 = -16					; size = 8
__Tmp$228419 = -8					; size = 8
___$ReturnUdt$ = 8					; size = 4
__First$ = 12						; size = 4
__Last$ = 16						; size = 4
...
; 3050 : 				std::iter_swap(_Plast++, _Gfirst);
	...
	mov	ebp, DWORD PTR [edx+4]
	mov	edi, DWORD PTR [edx]
	mov	DWORD PTR __Tmp$228393[esp+44], ebp
	mov	ebp, DWORD PTR [eax]
	mov	DWORD PTR [edx], ebp
	mov	ebp, DWORD PTR [eax+4]
	mov	DWORD PTR [edx+4], ebp
	mov	edx, DWORD PTR __Tmp$228393[esp+44]
	mov	DWORD PTR [eax], edi
	mov	DWORD PTR [eax+4], edx
$LN20@Unguarded_:
	add	eax, 8
...
; 3057 : 				std::iter_swap(--_Pfirst, _Glast - 1);
	...
	mov	ebp, DWORD PTR [ecx+4]
	mov	edi, DWORD PTR [ecx]
	mov	DWORD PTR __Tmp$228419[esp+44], ebp
	mov	ebp, DWORD PTR [edx]
	mov	DWORD PTR [ecx], ebp
	mov	ebp, DWORD PTR [edx+4]
	mov	DWORD PTR [ecx+4], ebp
	mov	DWORD PTR [edx], edi
	mov	edi, DWORD PTR __Tmp$228419[esp+44]
	mov	DWORD PTR [edx+4], edi
$LN13@Unguarded_:
	sub	ebx, 8
	sub	edx, 8
...
; 3066 : 			std::iter_swap(_Pfirst++, _Gfirst++);
	...
	mov	DWORD PTR __Tmp$228464[esp+40], ebp
	mov	ebp, DWORD PTR [edi+4]
	mov	DWORD PTR __Tmp$228464[esp+44], ebp
	mov	ebp, DWORD PTR [edx]
	mov	DWORD PTR [edi], ebp
	mov	ebp, DWORD PTR [edx+4]
	mov	DWORD PTR [edi+4], ebp
	mov	edi, DWORD PTR __Tmp$228464[esp+40]
	mov	DWORD PTR [edx], edi
	mov	edi, DWORD PTR __Tmp$228464[esp+44]
	mov	DWORD PTR [edx+4], edi
	jmp	$LL23@Unguarded_
$LN6@Unguarded_:
...
_iGPT$222574 = -120					; size = 4
_eMilitaryStrength$222543 = -120			; size = 4
_iModdedGoldValue$222576 = -116				; size = 4
_eMilitaryPosture$222544 = -116				; size = 4
_eFromPlayer$ = -112					; size = 4
_pDllDeal$222715 = -108					; size = 4
_eMyPlayer$ = -108					; size = 4
_this$ = -104						; size = 4
$T228761 = -100						; size = 4
_iTempGold$222575 = -100				; size = 4
$T228760 = -96						; size = 8
$T228758 = -96						; size = 8
_kDeal$222713 = -88					; size = 76
__$EHRec$ = -12						; size = 12
_pDeal$ = 8						; size = 4
...
; 304  : 		AggressivePostureTypes eMilitaryPosture = pDiploAI->GetMilitaryAggressivePosture(eFromPlayer);
	...
	push	ebx
	mov	ecx, esi
	mov	DWORD PTR _eMilitaryStrength$222543[esp+148], eax
...
; 305  : 		PlayerProximityTypes eProximity = GET_PLAYER(eMyPlayer).GetProximityToPlayer(eFromPlayer);
	...
	add	ecx, edi
	push	ebx
	mov	DWORD PTR _eMilitaryPosture$222544[esp+148], eax
	call	?GetProximityToPlayer@CvPlayer@@QBE?AW4PlayerProximityTypes@@W4PlayerTypes@@@Z ; CvPlayer::GetProximityToPlayer
...
; 316  : 		else if(eMilitaryStrength < STRENGTH_AVERAGE)
	...
	cmp	DWORD PTR _eMilitaryStrength$222543[esp+144], 3
...
; 320  : 		else if(eProximity <= PLAYER_PROXIMITY_FAR && eMilitaryPosture == AGGRESSIVE_POSTURE_NONE)
	...
	cmp	DWORD PTR _eMilitaryPosture$222544[esp+144], 0
...
; 341  : 				switch(eMilitaryStrength)
	...
	mov	eax, DWORD PTR _eMilitaryStrength$222543[esp+144]
	cmp	eax, 6
...
; 402  : 		for(it = pDeal->m_TradedItems.begin(); it != pDeal->m_TradedItems.end(); ++it)
	...
	mov	DWORD PTR _iGPT$222574[esp+144], eax
	lea	eax, DWORD PTR $T228758[esp+144]
	add	esi, 44					; 0000002cH
	push	eax
	mov	ecx, esi
	...
	mov	ebp, DWORD PTR [eax]
	mov	ebx, DWORD PTR [eax+4]
	lea	ecx, DWORD PTR $T228760[esp+144]
	push	ecx
	mov	ecx, esi
...
; 413  : 					if (iGPT > 0)
	...
	cmp	DWORD PTR _iGPT$222574[esp+144], 0
	mov	ecx, DWORD PTR [eax+20]
	mov	DWORD PTR _iTempGold$222575[esp+144], ecx
...
; 414  : 						iModdedGoldValue = iTempGold * 10 / iGPT;
	...
	add	eax, eax
	cdq
	idiv	DWORD PTR _iGPT$222574[esp+144]
...
; 416  : 						iModdedGoldValue = 0;
	...
	xor	eax, eax
$LN202@DoHumanDem:
	mov	DWORD PTR _iModdedGoldValue$222576[esp+144], eax

; 417  : 
; 418  : 					iValueDemanded += max(iTempGold, iModdedGoldValue);

	cmp	ecx, eax
	lea	eax, DWORD PTR _iModdedGoldValue$222576[esp+144]
	jl	SHORT $LN121@DoHumanDem
	lea	eax, DWORD PTR _iTempGold$222575[esp+144]
$LN121@DoHumanDem:
...
; 484  : 		CvDeal kDeal = *pDeal;
	...
	push	ecx
	lea	ecx, DWORD PTR _kDeal$222713[esp+144]
	call	??0CvDeal@@QAE@ABV0@@Z			; CvDeal::CvDeal
...
; 488  : 		auto_ptr<ICvDeal1> pDllDeal = GC.WrapDealPointer(&kDeal);
	...
	lea	ecx, DWORD PTR _kDeal$222713[esp+140]
	push	ecx
	lea	edx, DWORD PTR $T228761[esp+144]
	push	edx
	mov	ecx, OFFSET ?gGlobals@@3VCvGlobals@@A	; gGlobals
	call	?WrapDealPointer@CvGlobals@@QAE?AV?$auto_ptr@VICvDeal1@@@std@@PAVCvDeal@@@Z ; CvGlobals::WrapDealPointer
	mov	esi, DWORD PTR [eax]
	mov	DWORD PTR [eax], edi
	mov	DWORD PTR _pDllDeal$222715[esp+140], esi
	mov	eax, DWORD PTR $T228761[esp+140]
...
; 817  : 	for(it = pDeal->m_TradedItems.begin(); it != pDeal->m_TradedItems.end(); ++it)
	...
	mov	ecx, DWORD PTR [eax+44]
	push	edi
	lea	edx, DWORD PTR $T229175[esp+40]
	...
	mov	edi, DWORD PTR [eax]
	mov	ebp, DWORD PTR [eax+4]
	lea	eax, DWORD PTR $T229177[esp+40]
	push	eax
	mov	ecx, esi
	call	?end@?$FFastList@UCvTradedItem@@$0BF@$0A@@@QAE?AViterator@1@XZ ; FFastList<CvTradedItem,21,0>::end
...
$LN121@GetDealVal:
	lea	ecx, DWORD PTR $T229177[esp+40]
	push	ecx
...
_TEXT	SEGMENT
_this$ = -120						; size = 4
_bRepeal$223455 = -116					; size = 1
_eMyPlayer$223444 = -112				; size = 4
_vDesiredCommitments$223446 = -108			; size = 96
__$EHRec$ = -12						; size = 12
_pDeal$ = 8						; size = 4
_eThem$ = 12						; size = 4
tv779 = 16						; size = 4
...
; 2409 : 			if(!pDeal->IsVoteCommitmentTrade(eThem) && !pDeal->IsVoteCommitmentTrade(eMyPlayer))
	...
	push	edi
	mov	ecx, ebp
	mov	DWORD PTR _eMyPlayer$223444[esp+140], ebx
...
; 2411 : 				CvLeagueAI::VoteCommitmentList vDesiredCommitments = GetPlayer()->GetLeagueAI()->GetDesiredVoteCommitments(eThem);
	...
	mov	ecx, DWORD PTR [esi]
	push	edi
	lea	edx, DWORD PTR _vDesiredCommitments$223446[esp+140]
	push	edx
	call	?GetLeagueAI@CvPlayer@@QBEPAVCvLeagueAI@@XZ ; CvPlayer::GetLeagueAI
	mov	ecx, eax
...
; 2412 : 				for (CvLeagueAI::VoteCommitmentList::iterator it = vDesiredCommitments.begin(); it != vDesiredCommitments.end(); ++it)
	...
	mov	ebp, DWORD PTR _vDesiredCommitments$223446[esp+140]
	mov	ecx, DWORD PTR _vDesiredCommitments$223446[esp+136]
...
; 2417 : 					bool bRepeal = !it->bEnact;
	...
	mov	ebx, DWORD PTR [eax+4]
	sete	dl
	mov	BYTE PTR _bRepeal$223455[esp+136], dl
...
; 2419 : 					if (iProposalID != -1 && pDeal->IsPossibleToTradeItem(eThem, eMyPlayer, TRADE_ITEM_VOTE_COMMITMENT, iProposalID, iVoteChoice, iNumVotes, bRepeal))
	...
	cmp	esi, -1
	je	$LN4@DoAddVoteC
	mov	ebp, DWORD PTR _bRepeal$223455[esp+136]
	mov	eax, DWORD PTR _eMyPlayer$223444[esp+136]
...
$LN251@DoAddVoteC:
	lea	eax, DWORD PTR _vDesiredCommitments$223446[esp+148]
	cmp	edi, eax
...
__unwindfunclet$?DoAddVoteCommitmentToThem@CvDealAI@@QAEXPAVCvDeal@@W4PlayerTypes@@_NAAH33H2@Z$0:
	lea	ecx, DWORD PTR _vDesiredCommitments$223446[ebp]
...
_TEXT	SEGMENT
_eMyPlayer$223472 = -120				; size = 4
_this$ = -116						; size = 4
_bRepeal$223483 = -112					; size = 1
_vDesiredCommitments$223474 = -108			; size = 96
__$EHRec$ = -12						; size = 12
_pDeal$ = 8						; size = 4
_eThem$ = 12						; size = 4
tv557 = 16						; size = 4
...
; 2450 : 			if(!pDeal->IsVoteCommitmentTrade(eThem) && !pDeal->IsVoteCommitmentTrade(eMyPlayer))
	...
	push	edi
	mov	ecx, ebx
	mov	DWORD PTR _eMyPlayer$223472[esp+136], esi
	call	?IsVoteCommitmentTrade@CvDeal@@QAE_NW4PlayerTypes@@@Z ; CvDeal::IsVoteCommitmentTrade
	test	al, al
...
; 2452 : 				CvLeagueAI::VoteCommitmentList vDesiredCommitments = GET_PLAYER(eThem).GetLeagueAI()->GetDesiredVoteCommitments(eMyPlayer);
	...
	push	ebp
	push	esi
	lea	edx, DWORD PTR _vDesiredCommitments$223474[esp+140]
	push	edx
	call	?GetLeagueAI@CvPlayer@@QBEPAVCvLeagueAI@@XZ ; CvPlayer::GetLeagueAI
	mov	ecx, eax
	call	?GetDesiredVoteCommitments@CvLeagueAI@@QAE?AV?$FStaticVector@UVoteCommitment@CvLeagueAI@@$03$0A@$0BCJ@$0A@@@W4PlayerTypes@@@Z ; CvLeagueAI::GetDesiredVoteCommitments
...
; 2453 : 				for (CvLeagueAI::VoteCommitmentList::iterator it = vDesiredCommitments.begin(); it != vDesiredCommitments.end(); ++it)
	...
	mov	ebp, DWORD PTR _vDesiredCommitments$223474[esp+140]
	mov	ecx, DWORD PTR _vDesiredCommitments$223474[esp+136]
	lea	eax, DWORD PTR [ebp+ebp*4]
	lea	edx, DWORD PTR [ecx+eax*4]
	mov	DWORD PTR __$EHRec$[esp+144], 0
	cmp	ecx, edx
...
; 2458 : 					bool bRepeal = !it->bEnact;
	...
	mov	ebx, DWORD PTR [eax+4]
	sete	dl
	mov	BYTE PTR _bRepeal$223483[esp+136], dl
...
; 2460 : 					if (iProposalID != -1 && pDeal->IsPossibleToTradeItem(eMyPlayer, eThem, TRADE_ITEM_VOTE_COMMITMENT, iProposalID, iVoteChoice, iNumVotes, bRepeal))
	...
	cmp	esi, -1
	je	$LN4@DoAddVoteC@2
	mov	ebp, DWORD PTR _bRepeal$223483[esp+136]
	mov	eax, DWORD PTR _eThem$[esp+132]
	mov	ecx, DWORD PTR _eMyPlayer$223472[esp+136]
	push	0
	push	1
	push	ebp
	push	ebx
...
; 2467 : 							pDeal->AddVoteCommitment(eMyPlayer, iProposalID, iVoteChoice, iNumVotes, bRepeal);
	...
	mov	eax, DWORD PTR _eMyPlayer$223472[esp+136]
	push	ebp
	push	ebx
	push	edi
	push	esi
...
$LN129@DoAddVoteC@2:
	lea	eax, DWORD PTR _vDesiredCommitments$223474[esp+148]
	pop	ebp
	cmp	edi, eax
...
__unwindfunclet$?DoAddVoteCommitmentToUs@CvDealAI@@QAEXPAVCvDeal@@W4PlayerTypes@@_NAAH33H2@Z$0:
	lea	ecx, DWORD PTR _vDesiredCommitments$223474[ebp]
	jmp	??1?$FStaticVector@UVoteCommitment@CvLeagueAI@@$03$0A@$0BCJ@$0A@@@QAE@XZ ; FStaticVector<CvLeagueAI::VoteCommitment,4,0,297,0>::~FStaticVector<CvLeagueAI::VoteCommitment,4,0,297,0>
...
$T230637 = 8						; size = 4
_pDeal$ = 8						; size = 4
_iResourceQuantity$223505 = 12				; size = 4
_eThem$ = 12						; size = 4
_eMyPlayer$223501 = 16					; size = 4
_bDontChangeTheirExistingItems$ = 16			; size = 1
_iTotalValue$ = 20					; size = 4
_iValueImOffering$ = 24					; size = 4
_iValueTheyreOffering$ = 28				; size = 4
...
; 2501 : 			for(iResourceLoop = 0; iResourceLoop < GC.getNumResourceInfos(); iResourceLoop++)
	...
	mov	ecx, OFFSET ?gGlobals@@3VCvGlobals@@A	; gGlobals
	mov	DWORD PTR _eMyPlayer$223501[esp+16], ebx
	xor	edi, edi
	...
	npad	9
$LL489@DoAddResou:
	mov	ebx, DWORD PTR _eMyPlayer$223501[esp+16]
$LN19@DoAddResou:
...
; 2549 : 				iResourceQuantity = GET_PLAYER(eThem).getNumResourceAvailable(eResource, false);
	...
	push	edi
	call	?getNumResourceAvailable@CvPlayer@@QBEHW4ResourceTypes@@_N@Z ; CvPlayer::getNumResourceAvailable
	mov	DWORD PTR _iResourceQuantity$223505[esp+16], eax
...
; 2556 : 				iResourceQuantity = min(5, iResourceQuantity);	// 5 or what they have, whichever is less
	...
	cmp	eax, 5
	mov	DWORD PTR $T230637[esp+16], 5
	lea	eax, DWORD PTR _iResourceQuantity$223505[esp+16]
	jl	SHORT $LN260@DoAddResou
	lea	eax, DWORD PTR $T230637[esp+16]
$LN260@DoAddResou:
	mov	ebx, DWORD PTR [eax]
...
; 2559 : 				if(pDeal->IsPossibleToTradeItem(eThem, eMyPlayer, TRADE_ITEM_RESOURCES, eResource, iResourceQuantity))
	...
	mov	eax, DWORD PTR _eMyPlayer$223501[esp+16]
	push	0
	push	1
	push	0
	push	-1
...
_this$ = -8						; size = 4
$T232011 = -4						; size = 4
_iResourceQuantity$223547 = 8				; size = 4
_pDeal$ = 8						; size = 4
_eThem$ = 12						; size = 4
tv458 = 16						; size = 4
_bDontChangeMyExistingItems$ = 16			; size = 1
...
; 2603 : 				iResourceQuantity = GET_PLAYER(eMyPlayer).getNumResourceAvailable(eResource, false);
	...
	call	?getNumResourceAvailable@CvPlayer@@QBEHW4ResourceTypes@@_N@Z ; CvPlayer::getNumResourceAvailable
	mov	edi, eax
	mov	DWORD PTR _iResourceQuantity$223547[esp+20], edi
...
; 2626 : 					iResourceQuantity = min(5, iResourceQuantity);	// 5 or what we have, whichever is less
	...
	cmp	edi, 5
	mov	DWORD PTR $T232011[esp+24], 5
	lea	eax, DWORD PTR _iResourceQuantity$223547[esp+20]
	jl	SHORT $LN29@DoAddResou@2
	lea	eax, DWORD PTR $T232011[esp+24]
$LN29@DoAddResou@2:
	mov	edi, DWORD PTR [eax]
$LN4@DoAddResou@2:
...
; 2910 : 				iNumGold = min(iNumGold, pDeal->GetGoldAvailable(eThem, TRADE_ITEM_GOLD));
	...
	push	ebp
	mov	ecx, ebx
	mov	DWORD PTR _iNumGold$223906[esp+24], esi
	call	?GetGoldAvailable@CvDeal@@QAEHW4PlayerTypes@@W4TradeableItems@@@Z ; CvDeal::GetGoldAvailable
	mov	DWORD PTR $T234273[esp+16], eax
	cmp	eax, esi
	lea	eax, DWORD PTR $T234273[esp+16]
	jl	SHORT $LN62@DoAddGoldT
	lea	eax, DWORD PTR _iNumGold$223906[esp+16]
$LN62@DoAddGoldT:
	mov	esi, DWORD PTR [eax]
...
; 2943 : 				iNumGold = min(iNumGold, pDeal->GetGoldAvailable(eMyPlayer, TRADE_ITEM_GOLD));
	...
	push	esi
	mov	ecx, ebx
	mov	DWORD PTR _iNumGold$223924[esp+24], edi
	call	?GetGoldAvailable@CvDeal@@QAEHW4PlayerTypes@@W4TradeableItems@@@Z ; CvDeal::GetGoldAvailable
	mov	DWORD PTR $T234383[esp+16], eax
	cmp	eax, edi
	lea	eax, DWORD PTR $T234383[esp+16]
	jl	SHORT $LN16@DoAddGoldT@2
	lea	eax, DWORD PTR _iNumGold$223924[esp+16]
$LN16@DoAddGoldT@2:
	mov	edi, DWORD PTR [eax]
...
; 2978 : 					iNumGPT = min(iNumGPT, GET_PLAYER(eThem).calculateGoldRate());
	...
	add	esi, edi
	lea	ecx, DWORD PTR [eax+ebp]
	mov	DWORD PTR _iNumGPT$223944[esp+16], esi
	call	?calculateGoldRate@CvPlayer@@QBEHXZ	; CvPlayer::calculateGoldRate
	mov	DWORD PTR $T234410[esp+16], eax
	cmp	eax, esi
	lea	eax, DWORD PTR $T234410[esp+16]
	jl	SHORT $LN68@DoAddGPTTo
	lea	eax, DWORD PTR _iNumGPT$223944[esp+16]
$LN68@DoAddGPTTo:
	mov	esi, DWORD PTR [eax]
...
; 3013 : 					iNumGPT = min(iNumGPT, GET_PLAYER(eMyPlayer).calculateGoldRate());
	...
	add	esi, ebx
	add	ecx, edi
	mov	DWORD PTR _iNumGPT$223964[esp+16], esi
	call	?calculateGoldRate@CvPlayer@@QBEHXZ	; CvPlayer::calculateGoldRate
	mov	DWORD PTR $T234532[esp+16], eax
	cmp	eax, esi
	lea	eax, DWORD PTR $T234532[esp+16]
	jl	SHORT $LN21@DoAddGPTTo@2
	lea	eax, DWORD PTR _iNumGPT$223964[esp+16]
$LN21@DoAddGPTTo@2:
	mov	esi, DWORD PTR [eax]
...
_this$ = -4						; size = 4
_pDeal$ = 8						; size = 4
_iNumGoldPerTurnToRemove$223980 = 12			; size = 4
_eThem$ = 12						; size = 4
_iTotalValue$ = 16					; size = 4
_iValueImOffering$ = 20					; size = 4
_iValueTheyreOffering$ = 24				; size = 4
_iNumGoldPerTurnInThisDeal$223981 = 28			; size = 4
...
; 3044 : 			int iNumGoldPerTurnInThisDeal = pDeal->GetGoldPerTurnTrade(eThem);
	...
	push	ebx
	mov	ecx, esi
	mov	DWORD PTR _iNumGoldPerTurnToRemove$223980[esp+20], edi
	call	?GetGoldPerTurnTrade@CvDeal@@QAEHW4PlayerTypes@@@Z ; CvDeal::GetGoldPerTurnTrade
	mov	DWORD PTR _iNumGoldPerTurnInThisDeal$223981[esp+16], eax
...
; 3048 : 				iNumGoldPerTurnToRemove = min(iNumGoldPerTurnToRemove, iNumGoldPerTurnInThisDeal);
	...
	cmp	eax, edi
	lea	ecx, DWORD PTR _iNumGoldPerTurnInThisDeal$223981[esp+16]
	jl	SHORT $LN58@DoRemoveGP
	lea	ecx, DWORD PTR _iNumGoldPerTurnToRemove$223980[esp+16]
$LN58@DoRemoveGP:
...
_TEXT	SEGMENT
_pDeal$ = 8						; size = 4
_iNumGoldPerTurnInThisDeal$224000 = 12			; size = 4
_eThem$ = 12						; size = 4
_iTotalValue$ = 16					; size = 4
_iValueImOffering$ = 20					; size = 4
_iValueTheyreOffering$ = 24				; size = 4
_iDealDuration$ = 28					; size = 4
_bUseEvenValue$ = 32					; size = 1
_iNumGoldPerTurnToRemove$223998 = 32			; size = 4
...
; 3091 : 			int iNumGoldPerTurnInThisDeal = pDeal->GetGoldPerTurnTrade(eMyPlayer);
	...
	mov	edi, DWORD PTR _pDeal$[esp+12]
	mov	DWORD PTR _iNumGoldPerTurnToRemove$223998[esp+12], eax
	mov	eax, DWORD PTR [esi]
	mov	ebx, DWORD PTR [eax+44]
	push	ebx
	mov	ecx, edi
	call	?GetGoldPerTurnTrade@CvDeal@@QAEHW4PlayerTypes@@@Z ; CvDeal::GetGoldPerTurnTrade
	mov	DWORD PTR _iNumGoldPerTurnInThisDeal$224000[esp+12], eax
...
; 3095 : 				iNumGoldPerTurnToRemove = min(iNumGoldPerTurnToRemove, iNumGoldPerTurnInThisDeal);
	...
	cmp	eax, DWORD PTR _iNumGoldPerTurnToRemove$223998[esp+12]
	lea	ecx, DWORD PTR _iNumGoldPerTurnInThisDeal$224000[esp+12]
	jl	SHORT $LN17@DoRemoveGP@2
	lea	ecx, DWORD PTR _iNumGoldPerTurnToRemove$223998[esp+12]
$LN17@DoRemoveGP@2:
...
_TEXT	SEGMENT
$T234697 = -4						; size = 4
_iNumGoldInThisDeal$224015 = 8				; size = 4
_pDeal$ = 8						; size = 4
_eThem$ = 12						; size = 4
_iTotalValue$ = 16					; size = 4
_iValueImOffering$ = 20					; size = 4
...
; 3130 : 			int iNumGoldInThisDeal = pDeal->GetGoldTrade(eThem);
	...
	mov	ecx, ebp
	call	?GetGoldTrade@CvDeal@@QAEHW4PlayerTypes@@@Z ; CvDeal::GetGoldTrade
	mov	DWORD PTR _iNumGoldInThisDeal$224015[esp+12], eax
...
$LN34@DoRemoveGo:
	...
	mov	esi, eax
$LN8@DoRemoveGo:
	mov	eax, DWORD PTR _iNumGoldInThisDeal$224015[esp+16]
	cmp	esi, eax
	mov	DWORD PTR $T234697[esp+20], esi
	pop	edi
	lea	ecx, DWORD PTR $T234697[esp+16]
	jl	SHORT $LN57@DoRemoveGo
	lea	ecx, DWORD PTR _iNumGoldInThisDeal$224015[esp+12]
$LN57@DoRemoveGo:
...
_TEXT	SEGMENT
_eMyPlayer$224032 = -4					; size = 4
_iNumGoldInThisDeal$224033 = 8				; size = 4
_pDeal$ = 8						; size = 4
_eThem$ = 12						; size = 4
$T234794 = 16						; size = 4
_iTotalValue$ = 16					; size = 4
...
; 3171 : 			int iNumGoldInThisDeal = pDeal->GetGoldTrade(eMyPlayer);
	...
	push	eax
	mov	ecx, ebx
	mov	DWORD PTR _eMyPlayer$224032[esp+24], eax
	call	?GetGoldTrade@CvDeal@@QAEHW4PlayerTypes@@@Z ; CvDeal::GetGoldTrade
	mov	esi, eax
	mov	DWORD PTR _iNumGoldInThisDeal$224033[esp+16], esi
...
; 3175 : 				int iNumGoldToRemove = min(iNumGoldInThisDeal, GetGoldForForValueExchange(-iTotalValue, /*bNumGoldFromValue*/ true, /*bFromMe*/ true, eThem, bUseEvenValue, /*bRoundUp*/ true));
	...
	mov	ecx, edi
	call	?GetGoldForForValueExchange@CvDealAI@@QAEHH_N0W4PlayerTypes@@00@Z ; CvDealAI::GetGoldForForValueExchange
	mov	DWORD PTR $T234794[esp+16], eax
	cmp	eax, esi
	lea	eax, DWORD PTR $T234794[esp+16]
	jl	SHORT $LN17@DoRemoveGo@2
	lea	eax, DWORD PTR _iNumGoldInThisDeal$224033[esp+16]
$LN17@DoRemoveGo@2:
...
; 3187 : 					if(!pDeal->ChangeGoldTrade(eMyPlayer, iNumGoldInThisDeal))
	...
	mov	ecx, DWORD PTR _eMyPlayer$224032[esp+20]
	push	esi
	push	ecx
	mov	ecx, ebx
	call	?ChangeGoldTrade@CvDeal@@QAE_NW4PlayerTypes@@H@Z ; CvDeal::ChangeGoldTrade
...
_iValueTheyThinkTheyreOffering$222813 = 8		; size = 4
_iValueIThinkImOffering$222809 = 8			; size = 4
_pDeal$ = 8						; size = 4
_iValueTheyThinkTheyreGetting$222814 = 12		; size = 4
_iValueIThinkImGetting$222810 = 12			; size = 4
_eOtherPlayer$ = 12					; size = 4
...
; 768  : 			GetDealValue(pDeal, iValueIThinkImOffering, iValueIThinkImGetting, /*bUseEvenValue*/ false);
	...
	push	0
	lea	ecx, DWORD PTR _iValueIThinkImGetting$222810[esp+40]
	push	ecx
	lea	edx, DWORD PTR _iValueIThinkImOffering$222809[esp+44]
	push	edx
	push	edi
	mov	ecx, esi
	call	?GetDealValue@CvDealAI@@QAEHPAVCvDeal@@AAH1_N@Z ; CvDealAI::GetDealValue
...
; 771  : 			int iLowEndOfWhatIWillAccept = iValueIThinkImOffering - (iValueIThinkImOffering * -iPercentUnderWeWillOffer / 100);
	...
	mov	ecx, DWORD PTR _iValueIThinkImOffering$222809[esp+36]
	mov	edx, ecx
	imul	edx, 25					; 00000019H
	mov	eax, 1374389535				; 51eb851fH
	imul	edx
...
; 772  : 			if(iValueIThinkImGetting < iLowEndOfWhatIWillAccept)
	...
	cmp	DWORD PTR _iValueIThinkImGetting$222810[esp+36], ecx
...
; 778  : 			GET_PLAYER(eOtherPlayer).GetDealAI()->GetDealValue(pDeal, iValueTheyThinkTheyreOffering, iValueTheyThinkTheyreGetting, /*bUseEvenValue*/ false);
	...
	imul	ebp, 63236				; 0000f704H
	push	0
	lea	edx, DWORD PTR _iValueTheyThinkTheyreGetting$222814[esp+40]
	push	edx
	lea	eax, DWORD PTR _iValueTheyThinkTheyreOffering$222813[esp+44]
	push	eax
	add	ecx, ebp
	push	edi
	call	?GetDealAI@CvPlayer@@QBEPAVCvDealAI@@XZ	; CvPlayer::GetDealAI
...
; 781  : 			int iLowEndOfWhatTheyWillAccept = iValueTheyThinkTheyreOffering - (iValueTheyThinkTheyreOffering * GET_PLAYER(eOtherPlayer).GetDealAI()->GetDealPercentLeewayWithAI() / 100);
	...
	add	ecx, ebp
	call	?GetDealAI@CvPlayer@@QBEPAVCvDealAI@@XZ	; CvPlayer::GetDealAI
	mov	ecx, DWORD PTR _iValueTheyThinkTheyreOffering$222813[esp+36]
	mov	edx, ecx
	imul	edx, 25					; 00000019H
	mov	eax, 1374389535				; 51eb851fH
	imul	edx
...
; 782  : 			if(iValueTheyThinkTheyreGetting < iLowEndOfWhatTheyWillAccept)
	...
	cmp	DWORD PTR _iValueTheyThinkTheyreGetting$222814[esp+36], ecx
...
; 3087 : 			std::_Unguarded_partition(_First, _Last);
	...
	push	edi
	lea	eax, DWORD PTR __Mid$224568[esp+28]
	push	ebx
	push	eax
...
; 3090 : 		if (_Mid.first - _First < _Last - _Mid.second)
	...
	mov	ebp, DWORD PTR __Mid$224568[esp+40]
	mov	eax, esi
	cdq
	sub	eax, edx
	sar	eax, 1
	...
	sar	eax, 1
	add	esi, eax
	mov	eax, DWORD PTR __Mid$224568[esp+36]
	mov	ecx, edi
	mov	edx, eax
	sub	ecx, ebp
	sub	edx, ebx
...
; 3098 : 			_Last = _Mid.first;
	...
	mov	edi, DWORD PTR __Mid$224568[esp+36]
$LN26@Sort:
	mov	eax, edi
	sub	eax, ebx
	sar	eax, 3
...
_pDllDeal$222470 = -92					; size = 4
_iAmountOverWeWillRequest$ = -92			; size = 4
_kDeal$222421 = -88					; size = 76
__$EHRec$ = -12						; size = 12
_pDeal$ = 8						; size = 4
...
; 125  : 		CvDeal kDeal = *pDeal;
	...
	push	ebp
	lea	ecx, DWORD PTR _kDeal$222421[esp+148]
	call	??0CvDeal@@QAE@ABV0@@Z			; CvDeal::CvDeal
...
; 131  : 			auto_ptr<ICvDeal1> pDllDeal = GC.WrapDealPointer(&kDeal);
	...
	lea	eax, DWORD PTR _kDeal$222421[esp+144]
	push	eax
	lea	ecx, DWORD PTR $T236304[esp+148]
	push	ecx
	mov	ecx, OFFSET ?gGlobals@@3VCvGlobals@@A	; gGlobals
	call	?WrapDealPointer@CvGlobals@@QAE?AV?$auto_ptr@VICvDeal1@@@std@@PAVCvDeal@@@Z ; CvGlobals::WrapDealPointer
	mov	ebp, DWORD PTR [eax]
	mov	DWORD PTR [eax], 0
	mov	DWORD PTR _pDllDeal$222470[esp+144], ebp
	mov	eax, DWORD PTR $T236304[esp+144]
...
; 132  : 			gDLL->sendNetDealAccepted(eFromPlayer, GetPlayer()->GetID(), pDllDeal.get(), iDealValueToMe, iValueImOffering, iValueTheyreOffering);
	...
	mov	DWORD PTR $T236374[esp+144], edx
	...
	push	edx
	mov	edx, DWORD PTR $T236374[esp+156]
	push	ebp
	push	edx
	push	esi
	call	eax
...
; 137  : 			DoAcceptedDeal(eFromPlayer, kDeal, iDealValueToMe, iValueImOffering, iValueTheyreOffering);
	...
	push	ecx
	push	edx
	lea	eax, DWORD PTR _kDeal$222421[esp+156]
	push	eax
	push	esi
	mov	ecx, edi
...
; 139  : 	}
	...
	lea	ecx, DWORD PTR _kDeal$222421[esp+144]
...
; 2841 : 			viCityProximities.push_back(pLoopCity->GetID(), iCityDistanceFromWinnersCapital);
	...
	push	ebp
	lea	ecx, DWORD PTR $T236467[esp+76]
	push	ecx
	lea	ecx, DWORD PTR _viCityProximities$[esp+80]
	mov	DWORD PTR $T236467[esp+80], eax
...
_iCityDistanceFromWinnersCapital$224158 = -68		; size = 4
_iPercentGPTToGive$ = -68				; size = 4
_iPercentCitiesGiveUp$ = -64				; size = 4
_iSortedCityIndex$224176 = -60				; size = 4
_iWinnerCapitalY$224160 = -60				; size = 4
_iDuration$ = -60					; size = 4
_iCityLoop$ = -56					; size = 4
_this$ = -52						; size = 4
_iWinnerCapitalX$224159 = -48				; size = 4
$T236718 = -48						; size = 4
$T236719 = -44						; size = 4
_pWinnerCapital$224161 = -40				; size = 4
_pWinningPlayer$ = -40					; size = 4
_viCityProximities$224164 = -36				; size = 24
__$EHRec$ = -12						; size = 12
_eOtherPlayer$ = 8					; size = 4
_pDeal$ = 12						; size = 4
tv77 = 16						; size = 4
...
; 3456 : 		iGPT = min(pLosingPlayer->calculateGoldRate(), pWinningPlayer->calculateGoldRate() / /*3*/ GC.getARMISTICE_GPT_DIVISOR());
	...
	mov	esi, eax
	mov	DWORD PTR $T236718[esp+96], esi
	call	?calculateGoldRate@CvPlayer@@QBEHXZ	; CvPlayer::calculateGoldRate
	mov	DWORD PTR $T236719[esp+96], eax
	cmp	esi, eax
	lea	eax, DWORD PTR $T236718[esp+96]
...
; 3564 : 		CvCity* pWinnerCapital = pWinningPlayer->getCapitalCity();
	...
	xor	esi, esi
	xor	edi, edi
	mov	DWORD PTR _iCityDistanceFromWinnersCapital$224158[esp+96], esi
	mov	DWORD PTR _iWinnerCapitalX$224159[esp+96], eax
	mov	DWORD PTR _iWinnerCapitalY$224160[esp+96], eax
	call	?getCapitalCity@CvPlayer@@QAEPAVCvCity@@XZ ; CvPlayer::getCapitalCity
	mov	DWORD PTR _pWinnerCapital$224161[esp+96], eax
...
; 3568 : 			iWinnerCapitalY = pWinnerCapital->getY();
	...
	mov	DWORD PTR _iWinnerCapitalX$224159[esp+96], edx
	mov	DWORD PTR _iWinnerCapitalY$224160[esp+96], eax
$LN100@DoAddItems:
...
; 3572 : 		CvWeightedVector<int> viCityProximities;
	...
	lea	ecx, DWORD PTR _viCityProximities$224164[esp+108]
	mov	DWORD PTR _viCityProximities$224164[esp+100], esi
	mov	DWORD PTR _viCityProximities$224164[esp+104], 1
	mov	DWORD PTR _viCityProximities$224164[esp+96], ecx
...
; 3581 : 			if(pWinnerCapital != NULL)
	...
	cmp	DWORD PTR _pWinnerCapital$224161[esp+96], 0
...
; 3583 : 				iCityDistanceFromWinnersCapital = plotDistance(iWinnerCapitalX, iWinnerCapitalY, pLoopCity->getX(), pLoopCity->getY());
	...
	mov	ecx, DWORD PTR [esi+96]
	push	eax
	mov	eax, DWORD PTR _iWinnerCapitalY$224160[esp+100]
	push	ecx
	mov	ecx, DWORD PTR _iWinnerCapitalX$224159[esp+104]
	push	eax
	push	ecx
	call	?plotDistance@@YAHHHHH@Z		; plotDistance
	add	esp, 16					; 00000010H
	mov	DWORD PTR _iCityDistanceFromWinnersCapital$224158[esp+96], eax
$LN10@DoAddItems:
...
; 3589 : 				iCityDistanceFromWinnersCapital /= 3;
	...
	imul	DWORD PTR _iCityDistanceFromWinnersCapital$224158[esp+96]
	mov	eax, edx
	shr	eax, 31					; 0000001fH
	add	eax, edx
	mov	DWORD PTR _iCityDistanceFromWinnersCapital$224158[esp+96], eax
...
; 3595 : 				viCityProximities.push_back(pLoopCity->GetID(), iCityDistanceFromWinnersCapital);
	...
	mov	BYTE PTR _viCityProximities$224164[esp+116], al
	mov	eax, DWORD PTR _viCityProximities$224164[esp+104]
	cmp	DWORD PTR _viCityProximities$224164[esp+100], eax
	jne	SHORT $LN139@DoAddItems
	push	eax
	lea	ecx, DWORD PTR _viCityProximities$224164[esp+100]
	call	?GrowSize@?$FStaticVector@UWeightedElement@?$CvWeightedVector@H$00$0A@@@$00$0A@$0A@$0A@@@IAEXI@Z ; FStaticVector<CvWeightedVector<int,1,0>::WeightedElement,1,0,0,0>::GrowSize
$LN139@DoAddItems:
	mov	ecx, DWORD PTR _viCityProximities$224164[esp+96]
	mov	edx, DWORD PTR _viCityProximities$224164[esp+100]
	lea	eax, DWORD PTR [ecx+edx*8]
	test	eax, eax
	je	SHORT $LN142@DoAddItems
	mov	ecx, DWORD PTR _iCityDistanceFromWinnersCapital$224158[esp+96]
	mov	DWORD PTR [eax], esi
	mov	DWORD PTR [eax+4], ecx
$LN142@DoAddItems:
	inc	DWORD PTR _viCityProximities$224164[esp+100]
$LN12@DoAddItems:
...
; 3600 : 		viCityProximities.SortItems();
	...
	mov	eax, DWORD PTR _viCityProximities$224164[esp+96]
	mov	ecx, DWORD PTR _viCityProximities$224164[esp+100]
	lea	ecx, DWORD PTR [eax+ecx*8]
	mov	edx, ecx
	sub	edx, eax
	sar	edx, 3
...
; 3606 : 			iSortedCityID = viCityProximities.GetElement(viCityProximities.size() - 1);
	...
	mov	ecx, DWORD PTR _viCityProximities$224164[esp+96]
	mov	eax, DWORD PTR _viCityProximities$224164[esp+100]
...
; 3616 : 			for(int iSortedCityIndex = viCityProximities.size() - 1; iSortedCityIndex > -1 ; iSortedCityIndex--)
	...
	add	edi, edx
	cmp	eax, -1
	mov	DWORD PTR _iSortedCityIndex$224176[esp+96], eax
	jle	$LN3@DoAddItems
	jmp	SHORT $LN5@DoAddItems
$LL218@DoAddItems:
	mov	eax, DWORD PTR _iSortedCityIndex$224176[esp+96]
$LN5@DoAddItems:

; 3617 : 			{
; 3618 : 				iSortedCityID = viCityProximities.GetElement(iSortedCityIndex);

	mov	edx, DWORD PTR _viCityProximities$224164[esp+96]
...
__unwindfunclet$?DoAddItemsToDealForPeaceTreaty@CvDealAI@@QAEXW4PlayerTypes@@PAVCvDeal@@W4PeaceTreatyTypes@@_N@Z$0:
	lea	ecx, DWORD PTR _viCityProximities$224164[ebp]
	jmp	??1?$CvWeightedVector@H$00$0A@@@QAE@XZ	; CvWeightedVector<int,1,0>::~CvWeightedVector<int,1,0>
...
_TEXT	SEGMENT
_eMyPlayer$224295 = -28					; size = 4
_iValueImOffering$224308 = -24				; size = 4
_iValueTheyreOffering$224305 = -24			; size = 4
_ePeaceTreatyImWillingToOffer$224296 = -24		; size = 4
_iValueTheyreOffering$224309 = -20			; size = 4
_iValueImOffering$224304 = -20				; size = 4
_ePeaceTreatyImWillingToAccept$224297 = -20		; size = 4
_pUIDeal$224300 = -16					; size = 4
__$EHRec$ = -12						; size = 12
...
; 3955 : 		PeaceTreatyTypes ePeaceTreatyImWillingToOffer = GetPlayer()->GetDiplomacyAI()->GetTreatyWillingToOffer(eActivePlayer);
	...
	push	edi
	mov	DWORD PTR _eMyPlayer$224295[esp+44], eax
	call	?GetDiplomacyAI@CvPlayer@@QBEPAVCvDiplomacyAI@@XZ ; CvPlayer::GetDiplomacyAI
	mov	ecx, eax
...
; 3956 : 		PeaceTreatyTypes ePeaceTreatyImWillingToAccept = GetPlayer()->GetDiplomacyAI()->GetTreatyWillingToAccept(eActivePlayer);
	...
	mov	esi, eax
	push	edi
	mov	DWORD PTR _ePeaceTreatyImWillingToOffer$224296[esp+44], esi
	call	?GetDiplomacyAI@CvPlayer@@QBEPAVCvDiplomacyAI@@XZ ; CvPlayer::GetDiplomacyAI
	mov	ecx, eax
	...
	mov	DWORD PTR _ePeaceTreatyImWillingToAccept$224297[esp+40], eax
...
; 3962 : 			auto_ptr<ICvDeal1> pUIDeal(GC.GetEngineUserInterface()->GetScratchDeal());
	...
	push	ebx
	call	eax
	mov	DWORD PTR _pUIDeal$224300[esp+44], eax
...
; 3969 : 			pDeal->SetToPlayer(eMyPlayer);	// The order of these is very important!
	...
	mov	ecx, DWORD PTR _eMyPlayer$224295[esp+44]
	push	ecx
	mov	ecx, ebx
...
; 3972 : 			if(ePeaceTreatyImWillingToOffer > PEACE_TREATY_WHITE_PEACE)
	...
	cmp	DWORD PTR _ePeaceTreatyImWillingToOffer$224296[esp+44], 0
	jle	SHORT $LN5@DoTradeScr@2

; 3973 : 			{
; 3974 : 				pkUIDeal->SetSurrenderingPlayer(eMyPlayer);

	mov	edx, DWORD PTR _eMyPlayer$224295[esp+44]
	push	edx
	mov	ecx, esi
...
; 3975 : 				pkUIDeal->SetPeaceTreatyType(ePeaceTreatyImWillingToOffer);
	...
	mov	eax, DWORD PTR _ePeaceTreatyImWillingToOffer$224296[esp+44]
	push	eax
	mov	ecx, esi
...
; 3977 : 				DoAddItemsToDealForPeaceTreaty(eActivePlayer, pDeal, ePeaceTreatyImWillingToOffer, /*bMeSurrendering*/ true);
	...
	mov	ecx, DWORD PTR _ePeaceTreatyImWillingToOffer$224296[esp+44]
	push	1
	push	ecx
	push	ebx
	push	edi
...
; 3981 : 				GetDealValue(pDeal, iValueImOffering, iValueTheyreOffering, /*bUseEvenValue*/ false);
	...
	push	0
	lea	edx, DWORD PTR _iValueTheyreOffering$224305[esp+48]
	push	edx
	lea	eax, DWORD PTR _iValueImOffering$224304[esp+52]
	push	eax
	push	ebx
	mov	ecx, ebp
	call	?GetDealValue@CvDealAI@@QAEHPAVCvDeal@@AAH1_N@Z ; CvDealAI::GetDealValue
...
; 3982 : 				SetCachedValueOfPeaceWithHuman(-iValueImOffering);
	...
	mov	eax, DWORD PTR _iValueImOffering$224304[esp+44]
	neg	eax
...
; 3985 : 			else if(ePeaceTreatyImWillingToAccept > PEACE_TREATY_WHITE_PEACE)
	...
	cmp	DWORD PTR _ePeaceTreatyImWillingToAccept$224297[esp+44], 0
...
; 3988 : 				pkUIDeal->SetPeaceTreatyType(ePeaceTreatyImWillingToAccept);
	...
	mov	ecx, DWORD PTR _ePeaceTreatyImWillingToAccept$224297[esp+44]
	push	ecx
	mov	ecx, esi
	call	?SetPeaceTreatyType@CvDeal@@QAEXW4PeaceTreatyTypes@@@Z ; CvDeal::SetPeaceTreatyType
...
; 3990 : 				DoAddItemsToDealForPeaceTreaty(eActivePlayer, pDeal, ePeaceTreatyImWillingToAccept, /*bMeSurrendering*/ false);
	...
	mov	edx, DWORD PTR _ePeaceTreatyImWillingToAccept$224297[esp+44]
	push	0
	push	edx
	push	ebx
	push	edi
...
; 3994 : 				GetDealValue(pDeal, iValueImOffering, iValueTheyreOffering, /*bUseEvenValue*/ false);
	...
	push	0
	lea	eax, DWORD PTR _iValueTheyreOffering$224309[esp+48]
	push	eax
	lea	ecx, DWORD PTR _iValueImOffering$224308[esp+52]
	push	ecx
	push	ebx
	mov	ecx, ebp
	call	?GetDealValue@CvDealAI@@QAEHPAVCvDeal@@AAH1_N@Z ; CvDealAI::GetDealValue
...
; 3995 : 				SetCachedValueOfPeaceWithHuman(iValueTheyreOffering);
	...
	mov	edx, DWORD PTR _iValueTheyreOffering$224309[esp+44]
...
; 4002 : 			pkUIDeal->SetToPlayer(eMyPlayer);	// The order of these is very important!
	...
	mov	ebx, DWORD PTR _eMyPlayer$224295[esp+44]
	push	ebx
	mov	ecx, esi
	call	?SetToPlayer@CvDeal@@QAEXW4PlayerTypes@@@Z ; CvDeal::SetToPlayer
...
; 4013 : 			pkUIDeal->AddPeaceTreaty(eMyPlayer, iPeaceTreatyLength);
	...
	mov	eax, DWORD PTR _eMyPlayer$224295[esp+44]
	push	ebx
	push	eax
	mov	ecx, esi
...
; 4025 : 		}
	...
	mov	eax, DWORD PTR _pUIDeal$224300[esp+44]
...
__unwindfunclet$?DoTradeScreenOpened@CvDealAI@@QAEXXZ$0:
	lea	ecx, DWORD PTR _pUIDeal$224300[ebp]
	jmp	??1?$auto_ptr@VICvDeal1@@@std@@QAE@XZ	; std::auto_ptr<ICvDeal1>::~auto_ptr<ICvDeal1>
...
_iValueImOffering$224079 = -8				; size = 4
_iValueTheyreOffering$224075 = -8			; size = 4
_ePeaceTreatyTheyreWillingToAccept$224053 = -8		; size = 4
_iValueTheyreOffering$224080 = -4			; size = 4
_iValueImOffering$224074 = -4				; size = 4
_ePeaceTreatyImWillingToOffer$ = -4			; size = 4
_eMyPlayer$ = 8						; size = 4
_eOtherPlayer$ = 8					; size = 4
tv391 = 12						; size = 4
_pDeal$ = 12						; size = 4
_ePeaceTreatyTheyreWillingToOffer$224054 = 16		; size = 4
...
; 3226 : 		PeaceTreatyTypes ePeaceTreatyTheyreWillingToOffer = GET_PLAYER(eOtherPlayer).GetDiplomacyAI()->GetTreatyWillingToOffer(eMyPlayer);
	...
	mov	DWORD PTR _ePeaceTreatyTheyreWillingToAccept$224053[esp+28], eax
	mov	eax, DWORD PTR ?m_aPlayers@CvPlayerAI@@1PAV1@A ; CvPlayerAI::m_aPlayers
	add	ecx, eax
	push	edx
	call	?GetDiplomacyAI@CvPlayer@@QBEPAVCvDiplomacyAI@@XZ ; CvPlayer::GetDiplomacyAI
...
; 3229 : 		if(ePeaceTreatyImWillingToOffer < ePeaceTreatyTheyreWillingToAccept)
	...
	mov	edx, DWORD PTR _ePeaceTreatyTheyreWillingToAccept$224053[esp+28]
	cmp	ebp, edx
	mov	ecx, eax
	mov	DWORD PTR _ePeaceTreatyTheyreWillingToOffer$224054[esp+24], ecx
...
; 3242 : 			int iAmountToReduce = min(ePeaceTreatyImWillingToOffer, ePeaceTreatyTheyreWillingToOffer);
	...
	cmp	ecx, ebp
	lea	eax, DWORD PTR _ePeaceTreatyTheyreWillingToOffer$224054[esp+24]
...
; 3255 : 			ePeaceTreatyTheyreWillingToOffer = PeaceTreatyTypes((ePeaceTreatyTheyreWillingToOffer + ePeaceTreatyImWillingToAccept) / 2);
	...
	sub	eax, edx
	sar	eax, 1
	mov	DWORD PTR _ePeaceTreatyTheyreWillingToOffer$224054[esp+24], eax
	mov	ecx, eax
$LN15@IsOfferPea:
...
; 3273 : 			pDeal->SetPeaceTreatyType(ePeaceTreatyTheyreWillingToOffer);
	...
	mov	ebp, DWORD PTR _ePeaceTreatyTheyreWillingToOffer$224054[esp+24]
	push	ebp
	mov	ecx, esi
	call	?SetPeaceTreatyType@CvDeal@@QAEXW4PeaceTreatyTypes@@@Z ; CvDeal::SetPeaceTreatyType
...
; 3311 : 			GetDealValue(pDeal, iValueImOffering, iValueTheyreOffering, /*bUseEvenValue*/ false);
	...
	push	0
	lea	ecx, DWORD PTR _iValueTheyreOffering$224075[esp+32]
	push	ecx
	lea	edx, DWORD PTR _iValueImOffering$224074[esp+36]
	push	edx
	push	esi
	mov	ecx, edi
	call	?GetDealValue@CvDealAI@@QAEHPAVCvDeal@@AAH1_N@Z ; CvDealAI::GetDealValue
...
; 3314 : 				SetCachedValueOfPeaceWithHuman(-iValueImOffering);
	...
	mov	eax, DWORD PTR _iValueImOffering$224074[esp+28]
	neg	eax
...
; 3327 : 			GetDealValue(pDeal, iValueImOffering, iValueTheyreOffering, /*bUseEvenValue*/ false);
	...
	push	0
	lea	ecx, DWORD PTR _iValueTheyreOffering$224080[esp+32]
	push	ecx
	lea	edx, DWORD PTR _iValueImOffering$224079[esp+36]
	push	edx
	push	esi
	mov	ecx, edi
	call	?GetDealValue@CvDealAI@@QAEHPAVCvDeal@@AAH1_N@Z ; CvDealAI::GetDealValue
...
; 3330 : 				SetCachedValueOfPeaceWithHuman(iValueTheyreOffering);
	...
	mov	eax, DWORD PTR _iValueTheyreOffering$224080[esp+28]
	mov	DWORD PTR [edi+4], eax
...
_TEXT	SEGMENT
_iValueTheyreOffering$222777 = -20			; size = 4
_iValueImOffering$222776 = -16				; size = 4
_iDealDuration$ = -12					; size = 4
_iAmountUnderWeWillOffer$222779 = -8			; size = 4
_iAmountOverWeWillRequest$222778 = -4			; size = 4
_iTotalValueToMe$222775 = 8				; size = 4
_pDeal$ = 8						; size = 4
...
; 612  : 		bMakeOffer = IsDealWithHumanAcceptable(pDeal, GC.getGame().getActivePlayer(), /*Passed by reference*/ iTotalValueToMe, iValueImOffering, iValueTheyreOffering, iAmountOverWeWillRequest, iAmountUnderWeWillOffer, bCantMatchOffer);
	...
	push	ebx
	lea	eax, DWORD PTR _iAmountUnderWeWillOffer$222779[esp+40]
	push	eax
	lea	ecx, DWORD PTR _iAmountOverWeWillRequest$222778[esp+44]
	push	ecx
	lea	edx, DWORD PTR _iValueTheyreOffering$222777[esp+48]
	push	edx
	lea	eax, DWORD PTR _iValueImOffering$222776[esp+52]
	push	eax
	lea	ecx, DWORD PTR _iTotalValueToMe$222775[esp+52]
	push	ecx
	mov	ecx, DWORD PTR ?gGlobals@@3VCvGlobals@@A+48
	call	?getActivePlayer@CvGame@@QBE?AW4PlayerTypes@@XZ ; CvGame::getActivePlayer
	push	eax
...
; 614  : 		if (iTotalValueToMe < 0 && bDontChangeTheirExistingItems)
	...
	cmp	DWORD PTR _iTotalValueToMe$222775[esp+32], 0
...
; 640  : 			DoAddVoteCommitmentToThem(pDeal, eOtherPlayer, bDontChangeTheirExistingItems, iTotalValueToMe, iValueImOffering, iValueTheyreOffering, iAmountOverWeWillRequest, bUseEvenValue);
	...
	mov	ecx, DWORD PTR _iAmountOverWeWillRequest$222778[esp+36]
	mov	eax, DWORD PTR _bDealGoodToBeginWith$[esp+32]
	push	0
	push	ecx
	lea	edx, DWORD PTR _iValueTheyreOffering$222777[esp+44]
	push	edx
	mov	BYTE PTR [eax], 0
	lea	eax, DWORD PTR _iValueImOffering$222776[esp+48]
	push	eax
	lea	ecx, DWORD PTR _iTotalValueToMe$222775[esp+48]
	push	ecx
	push	ebx
	push	ebp
	push	esi
...
; 641  : 			DoAddVoteCommitmentToUs(pDeal, eOtherPlayer, bDontChangeMyExistingItems, iTotalValueToMe, iValueImOffering, iValueTheyreOffering, iAmountUnderWeWillOffer, bUseEvenValue);
	...
	mov	edx, DWORD PTR _iAmountUnderWeWillOffer$222779[esp+36]
	push	0
	push	edx
	lea	eax, DWORD PTR _iValueTheyreOffering$222777[esp+44]
	push	eax
	mov	eax, DWORD PTR _bDontChangeMyExistingItems$[esp+44]
	lea	ecx, DWORD PTR _iValueImOffering$222776[esp+48]
	push	ecx
	lea	edx, DWORD PTR _iTotalValueToMe$222775[esp+48]
	push	edx
	push	eax
	push	ebp
	push	esi
...
; 646  : 			DoAddResourceToThem(pDeal, eOtherPlayer, bDontChangeTheirExistingItems, iTotalValueToMe, iValueImOffering, iValueTheyreOffering, iAmountOverWeWillRequest, iDealDuration, bUseEvenValue);
	...
	mov	edx, DWORD PTR _iAmountOverWeWillRequest$222778[esp+36]
	push	0
	push	ecx
	push	edx
	lea	eax, DWORD PTR _iValueTheyreOffering$222777[esp+48]
	push	eax
	lea	ecx, DWORD PTR _iValueImOffering$222776[esp+52]
	push	ecx
	lea	edx, DWORD PTR _iTotalValueToMe$222775[esp+52]
	push	edx
	push	ebx
	push	ebp
	push	esi
...
; 647  : 			DoAddResourceToUs(pDeal, eOtherPlayer, bDontChangeMyExistingItems, iTotalValueToMe, iValueImOffering, iValueTheyreOffering, iAmountUnderWeWillOffer, iDealDuration, bUseEvenValue);
	...
	mov	ecx, DWORD PTR _iAmountUnderWeWillOffer$222779[esp+36]
	push	0
	push	eax
	push	ecx
	lea	edx, DWORD PTR _iValueTheyreOffering$222777[esp+48]
...
; 650  : 			DoAddOpenBordersToUs(pDeal, eOtherPlayer, bDontChangeMyExistingItems, iTotalValueToMe, iValueImOffering, iValueTheyreOffering, iAmountUnderWeWillOffer, iDealDuration, bUseEvenValue);
	...
	mov	eax, DWORD PTR _iAmountUnderWeWillOffer$222779[esp+36]
	push	0
	push	edx
	push	eax
	lea	ecx, DWORD PTR _iValueTheyreOffering$222777[esp+48]
	push	ecx
	mov	ecx, DWORD PTR _bDontChangeMyExistingItems$[esp+48]
	lea	edx, DWORD PTR _iValueImOffering$222776[esp+52]
	push	edx
	lea	eax, DWORD PTR _iTotalValueToMe$222775[esp+52]
	push	eax
	push	ecx
	push	ebp
	push	esi
...
; 653  : 			DoAddGPTToUs(pDeal, eOtherPlayer, bDontChangeMyExistingItems, iTotalValueToMe, iValueImOffering, iValueTheyreOffering, iDealDuration, bUseEvenValue);
	...
	push	0
	push	eax
	lea	ecx, DWORD PTR _iValueTheyreOffering$222777[esp+44]
	push	ecx
	mov	ecx, DWORD PTR _bDontChangeMyExistingItems$[esp+44]
	lea	edx, DWORD PTR _iValueImOffering$222776[esp+48]
	push	edx
	lea	eax, DWORD PTR _iTotalValueToMe$222775[esp+48]
	push	eax
	push	ecx
	push	ebp
	push	esi
...
; 655  : 			DoAddGoldToThem(pDeal, eOtherPlayer, bDontChangeTheirExistingItems, iTotalValueToMe, iValueImOffering, iValueTheyreOffering, bUseEvenValue);
	...
	push	0
	lea	edx, DWORD PTR _iValueTheyreOffering$222777[esp+40]
	push	edx
	lea	eax, DWORD PTR _iValueImOffering$222776[esp+44]
	push	eax
	lea	ecx, DWORD PTR _iTotalValueToMe$222775[esp+44]
	push	ecx
	push	ebx
	push	ebp
	push	esi
...
; 675  : 				bMakeOffer = IsDealWithHumanAcceptable(pDeal, GC.getGame().getActivePlayer(), /*Passed by reference*/ iTotalValueToMe, iValueImOffering, iValueTheyreOffering, iAmountOverWeWillRequest, iAmountUnderWeWillOffer, /*passed by reference*/bCantMatchOffer);
	...
	push	eax
	lea	ecx, DWORD PTR _iAmountUnderWeWillOffer$222779[esp+40]
	push	ecx
	lea	edx, DWORD PTR _iAmountOverWeWillRequest$222778[esp+44]
	push	edx
	lea	eax, DWORD PTR _iValueTheyreOffering$222777[esp+48]
	push	eax
	lea	ecx, DWORD PTR _iValueImOffering$222776[esp+52]
...
; 3809 : 			bDealAcceptable = DoEqualizeDealWithHuman(pDeal, eOtherPlayer, /*bDontChangeMyExistingItems*/ false, /*bDontChangeTheirExistingItems*/ true, bUselessReferenceVariable, bCantMatchOffer);	// Change the deal as necessary to make it work
	...
	lea	edx, DWORD PTR _bCantMatchOffer$224247[esp+12]
	push	edx
	lea	eax, DWORD PTR _bUselessReferenceVariable$224246[esp+16]
	push	eax
	push	1
	push	0
	push	edi
...
_TEXT	SEGMENT
_bCantMatchOffer$224262 = 8				; size = 1
_eOtherPlayer$ = 8					; size = 4
_bUselessReferenceVariable$224261 = 12			; size = 1
_pDeal$ = 12						; size = 4
...
; 3855 : 			bDealAcceptable = DoEqualizeDealWithHuman(pDeal, eOtherPlayer, false, true, bUselessReferenceVariable, bCantMatchOffer);	// Change the deal as necessary to make it work
	...
	lea	ecx, DWORD PTR _bCantMatchOffer$224262[esp+8]
	push	ecx
	lea	edx, DWORD PTR _bUselessReferenceVariable$224261[esp+12]
	push	edx
	push	1
	push	0
	push	esi
...
_TEXT	SEGMENT
_bCantMatchOffer$224277 = 8				; size = 1
_eOtherPlayer$ = 8					; size = 4
_bUselessReferenceVariable$224276 = 12			; size = 1
_pDeal$ = 12						; size = 4
...
; 3901 : 			bDealAcceptable = DoEqualizeDealWithHuman(pDeal, eOtherPlayer, false, true, bUselessReferenceVariable, bCantMatchOffer);	// Change the deal as necessary to make it work
	...
	lea	ecx, DWORD PTR _bCantMatchOffer$224277[esp+8]
	push	ecx
	lea	edx, DWORD PTR _bUselessReferenceVariable$224276[esp+12]
	push	edx
	push	1
	push	0
	push	esi
...
_TEXT	SEGMENT
_bCantMatchOffer$224288 = 8				; size = 1
_eOtherPlayer$ = 8					; size = 4
_bUselessReferenceVariable$224287 = 12			; size = 1
_pDeal$ = 12						; size = 4
...
; 3939 : 		bDealAcceptable = DoEqualizeDealWithHuman(pDeal, eOtherPlayer, true, false, bUselessReferenceVariable, bCantMatchOffer);	// Change the deal as necessary to make it work
	...
	lea	edx, DWORD PTR _bCantMatchOffer$224288[esp+8]
	push	edx
	lea	eax, DWORD PTR _bUselessReferenceVariable$224287[esp+12]
	push	eax
	push	0
	push	1
	push	edi
