; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\Users\EnormousApplePie\Desktop\Cleanup (v1)\Lekmod Files\Lekmod DLL versions\v30\LEKMOD_DLL\CvGameCoreDLL_Expansion2\CvGameCoreEnumSerialization.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG217148 DB	'NO_YIELD', 00H
	ORG $+3
$SG217151 DB	'YIELD_FOOD', 00H
	ORG $+1
$SG217154 DB	'YIELD_PRODUCTION', 00H
	ORG $+3
$SG217157 DB	'YIELD_GOLD', 00H
	ORG $+1
$SG217160 DB	'YIELD_SCIENCE', 00H
	ORG $+2
$SG217163 DB	'YIELD_CULTURE', 00H
	ORG $+2
$SG217166 DB	'YIELD_FAITH', 00H
$SG217169 DB	'INVALID ENUM VALUE', 00H
	ORG $+1
$SG217171 DB	'INVALID ENUM VALUE', 00H
CONST	ENDS
...
; File c:\users\enormousapplepie\desktop\cleanup (v1)\lekmod files\lekmod dll versions\v30\lekmod_dll\cvgamecoredll_expansion2\cvgamecoreenumserialization.cpp
...
; 13   : 	saveTo << static_cast<int>(readFrom);
	...
	lea	edx, DWORD PTR $T217282[esp]
	mov	DWORD PTR $T217282[esp], ecx
	push	edx
	mov	ecx, esi
	call	?Write@FDataStream@@IAEXABH@Z		; FDataStream::Write
