; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\Users\EnormousApplePie\Documents\GitHub\Lekmod\LEKMOD_DLL\CvGameCoreDLL_Expansion2\CvDllPlayerColorInfo.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File c:\users\enormousapplepie\documents\github\lekmod\lekmod_dll\cvgamecoredll_expansion2\cvdllplayercolorinfo.cpp
rdata$r	SEGMENT
...
; 540  : 	static GUID DLLCALL GetInterfaceId() { return guidICvPlayerColorInfo1; }
	...
	mov	eax, DWORD PTR $T219019[esp-4]
...
; 30   : 	        guidInterface == ICvPlayerColorInfo1::GetInterfaceId())
	...
	mov	DWORD PTR $T219039[esp+20], ecx
	lea	ecx, DWORD PTR $T219039[esp+16]
	mov	DWORD PTR $T219039[esp+24], edx
	mov	DWORD PTR $T219039[esp+16], eax
	mov	eax, DWORD PTR _guidICvPlayerColorInfo1+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T219039[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	jne	SHORT $LN1@QueryInter
