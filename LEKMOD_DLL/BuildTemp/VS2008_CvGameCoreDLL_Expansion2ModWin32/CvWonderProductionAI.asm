...
CONST	SEGMENT
$SG223786 DB	'LOAD ERROR: Building Type not found', 00H
$SG224035 DB	'GAMEOPTION_AI_TWEAKS', 00H
	ORG $+3
$SG224036 DB	'GAMEOPTION_AI_GIMP_NO_WORLD_WONDER', 00H
	ORG $+1
$SG224079 DB	'Choosing wonder from Top Choices', 00H
	ORG $+3
$SG224110 DB	'GAMEOPTION_AI_TWEAKS', 00H
	ORG $+3
$SG224111 DB	'GAMEOPTION_AI_GIMP_NO_WORLD_WONDER', 00H
	ORG $+1
$SG224141 DB	'Choosing wonder from Top Choices', 00H
	ORG $+3
$SG224160 DB	'%03d, ', 00H
	ORG $+1
$SG224162 DB	', ', 00H
	ORG $+1
$SG224172 DB	'Wonder, %s, %d', 00H
CONST	ENDS
...
$T225820 = -12						; size = 4
_elem$225880 = -8					; size = 8
$T225821 = -8						; size = 4
_iNumBuildings$223811 = 8				; size = 4
$T225818 = 8						; size = 4
_kStream$ = 8						; size = 4
...
; 139  : 	kStream << GC.getNumFlavorTypes();
	...
	lea	edx, DWORD PTR $T225818[esp+28]
	mov	DWORD PTR $T225818[esp+28], ecx
	push	edx
	mov	ecx, esi
	call	?Write@FDataStream@@IAEXABH@Z		; FDataStream::Write
...
; 144  : 		int iNumBuildings = m_pBuildings->GetNumBuildings();
	...
	mov	DWORD PTR _iNumBuildings$223811[esp+28], eax

; 145  : 		kStream << iNumBuildings;

	lea	eax, DWORD PTR _iNumBuildings$223811[esp+28]
	push	eax
	mov	ecx, esi
	call	?Write@FDataStream@@IAEXABH@Z		; FDataStream::Write
...
; 148  : 		for(int iI = 0; iI < iNumBuildings; iI++)
	...
	xor	ebx, ebx
	xor	edi, edi
	cmp	DWORD PTR _iNumBuildings$223811[esp+28], ebx
	jle	SHORT $LN4@Write
	npad	5
$LL6@Write:
...
; 155  : 				kStream << m_WonderAIWeights.GetWeight(iI);
	...
	add	esp, 8
	lea	edx, DWORD PTR $T225820[esp+32]
	mov	DWORD PTR _elem$225880[esp+32], ecx
	mov	DWORD PTR $T225820[esp+32], eax
	push	edx
...
; 159  : 				kStream << (int)0;
	...
	lea	eax, DWORD PTR $T225821[esp+32]
	mov	DWORD PTR $T225821[esp+32], ebx
	push	eax
$LN47@Write:
	mov	ecx, esi
	call	?Write@FDataStream@@IAEXABH@Z		; FDataStream::Write
	inc	edi
	cmp	edi, DWORD PTR _iNumBuildings$223811[esp+28]
	jl	SHORT $LL6@Write
$LN4@Write:
	pop	edi
	pop	esi
...
; 330  : 	return m_WonderAIWeights.GetWeight(eBldg);
	...
	mov	edx, DWORD PTR [eax+ecx*8]
	mov	eax, DWORD PTR [eax+ecx*8+4]
	mov	DWORD PTR _elem$225932[esp+8], edx
...
_TEXT	SEGMENT
_strDesc$224170 = -188					; size = 28
$T225937 = -188						; size = 28
_strBaseString$224159 = -160				; size = 28
_strOutBuf$224167 = -132				; size = 28
_playerName$224156 = -104				; size = 28
_strTemp$224171 = -76					; size = 28
_elem$226022 = -48					; size = 8
$T225936 = -40						; size = 28
__$EHRec$ = -12						; size = 12
...
$LN18@LogPossibl:
	push	eax
	lea	ecx, DWORD PTR _playerName$224156[esp+208]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z
...
; 667  : 		FILogFile* pLog = LOGFILEMGR.GetLog(m_pPlayer->GetCitySpecializationAI()->GetLogFileName(playerName), FILogFile::kDontTimeStamp);
	...
	mov	edi, eax
	lea	eax, DWORD PTR _playerName$224156[esp+204]
	push	eax
	lea	ecx, DWORD PTR $T225936[esp+208]
	push	ecx
	mov	ecx, DWORD PTR [esi+12]
	...
	mov	ecx, edi
	call	eax
	lea	ecx, DWORD PTR $T225936[esp+204]
	mov	ebx, eax
...
; 670  : 		CvString strBaseString;
	...
	lea	ecx, DWORD PTR _strBaseString$224159[esp+204]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
...
; 671  : 		strBaseString.Format("%03d, ", GC.getGame().getElapsedGameTurns());
	...
	push	eax
	lea	ecx, DWORD PTR _strBaseString$224159[esp+208]
...
; 672  : 		strBaseString += playerName + ", ";
	...
	lea	edx, DWORD PTR _playerName$224156[esp+220]
	push	edx
	lea	eax, DWORD PTR $T225937[esp+224]
	push	eax
	...
	lea	ecx, DWORD PTR $T225937[esp+204]
	mov	BYTE PTR __$EHRec$[esp+212], 2
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
...
; 679  : 			CvString strOutBuf = strBaseString;
	...
	lea	ecx, DWORD PTR _strBaseString$224159[esp+204]
	push	ecx
	lea	ecx, DWORD PTR _strOutBuf$224167[esp+208]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@ABV01@@Z
...
$LN46@LogPossibl:
	push	eax
	lea	ecx, DWORD PTR _strDesc$224170[esp+208]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z

; 685  : 				CvString strTemp;

	lea	ecx, DWORD PTR _strTemp$224171[esp+204]
...
; 686  : 				strTemp.Format("Wonder, %s, %d", strDesc.GetCString(), m_Buildables.GetWeight(iI));
	...
	mov	DWORD PTR _elem$226022[esp+204], ecx
	push	eax
	lea	ecx, DWORD PTR _strDesc$224170[esp+208]
	mov	BYTE PTR __$EHRec$[esp+216], 6
	call	DWORD PTR __imp_?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ
	push	eax
	lea	edx, DWORD PTR _strTemp$224171[esp+212]
...
; 687  : 				strOutBuf += strTemp;
	...
	lea	eax, DWORD PTR _strTemp$224171[esp+204]
	push	eax
	lea	ecx, DWORD PTR _strOutBuf$224167[esp+208]
	call	DWORD PTR __imp_??Y?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV01@ABV01@@Z
...
; 689  : 			}
	...
	mov	BYTE PTR __$EHRec$[esp+212], 5
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	lea	ecx, DWORD PTR _strDesc$224170[esp+204]
...
; 691  : 			pLog->Msg(strOutBuf);
	...
	lea	ecx, DWORD PTR _strOutBuf$224167[esp+204]
	call	DWORD PTR __imp_?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ
...
; 693  : 	}
	...
	mov	BYTE PTR __$EHRec$[esp+212], 0
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	lea	ecx, DWORD PTR _playerName$224156[esp+204]
...
__unwindfunclet$?LogPossibleWonders@CvWonderProductionAI@@QAEXXZ$0:
	lea	ecx, DWORD PTR _playerName$224156[ebp]
...
__unwindfunclet$?LogPossibleWonders@CvWonderProductionAI@@QAEXXZ$2:
	lea	ecx, DWORD PTR _strBaseString$224159[ebp]
	jmp	??1CvString@@QAE@XZ			; CvString::~CvString
...
_TEXT	SEGMENT
__Tmp$226760 = -24					; size = 8
__Tmp$226688 = -16					; size = 8
__Tmp$226714 = -8					; size = 8
___$ReturnUdt$ = 8					; size = 4
__First$ = 12						; size = 4
__Last$ = 16						; size = 4
...
; 3050 : 				std::iter_swap(_Plast++, _Gfirst);
	...
	mov	edi, DWORD PTR [edx]
	mov	DWORD PTR __Tmp$226688[esp+44], ebp
	mov	ebp, DWORD PTR [eax]
	mov	DWORD PTR [edx], ebp
	mov	ebp, DWORD PTR [eax+4]
	mov	DWORD PTR [edx+4], ebp
	mov	edx, DWORD PTR __Tmp$226688[esp+44]
	mov	DWORD PTR [eax], edi
	mov	DWORD PTR [eax+4], edx
$LN20@Unguarded_:
	add	eax, 8
...
; 3057 : 				std::iter_swap(--_Pfirst, _Glast - 1);
	...
	mov	ebp, DWORD PTR [ecx+4]
	mov	edi, DWORD PTR [ecx]
	mov	DWORD PTR __Tmp$226714[esp+44], ebp
	mov	ebp, DWORD PTR [edx]
	mov	DWORD PTR [ecx], ebp
	mov	ebp, DWORD PTR [edx+4]
	mov	DWORD PTR [ecx+4], ebp
	mov	DWORD PTR [edx], edi
	mov	edi, DWORD PTR __Tmp$226714[esp+44]
	mov	DWORD PTR [edx+4], edi
$LN13@Unguarded_:
	sub	ebx, 8
	sub	edx, 8
...
; 3066 : 			std::iter_swap(_Pfirst++, _Gfirst++);
	...
	mov	DWORD PTR __Tmp$226760[esp+40], ebp
	mov	ebp, DWORD PTR [edi+4]
	mov	DWORD PTR __Tmp$226760[esp+44], ebp
	mov	ebp, DWORD PTR [edx]
	mov	DWORD PTR [edi], ebp
	mov	ebp, DWORD PTR [edx+4]
	mov	DWORD PTR [edi+4], ebp
	mov	edi, DWORD PTR __Tmp$226760[esp+40]
	mov	DWORD PTR [edx], edi
	mov	edi, DWORD PTR __Tmp$226760[esp+44]
	mov	DWORD PTR [edx+4], edi
	jmp	$LL23@Unguarded_
$LN6@Unguarded_:
...
_TEXT	SEGMENT
_iI$223776 = -60					; size = 4
_iNumEntries$223774 = -56				; size = 4
_iNumFlavors$ = -52					; size = 4
_iWeight$ = -48						; size = 4
_uiVersion$ = -44					; size = 4
_szError$223785 = -40					; size = 28
__$EHRec$ = -12						; size = 12
_bValid$223780 = 8					; size = 1
_kStream$ = 8						; size = 4
...
; 106  : 		kStream >> iNumEntries;
	...
	lea	ecx, DWORD PTR _iNumEntries$223774[esp+76]
	push	ecx
	mov	ecx, ebx
	call	?Read@FDataStream@@IAEXAAH@Z		; FDataStream::Read
...
; 108  : 		for(int iI = 0; iI < iNumEntries; iI++)
	...
	cmp	DWORD PTR _iNumEntries$223774[esp+76], 0
	mov	DWORD PTR _iI$223776[esp+76], 0
	jle	$LN5@Read
	or	ebp, -1
	npad	1
$LL7@Read:
...
; 111  : 			iType = CvInfosSerializationHelper::ReadHashed(kStream, &bValid);
	...
	lea	edx, DWORD PTR _bValid$223780[esp+72]
	push	edx
	push	ebx
	mov	BYTE PTR _bValid$223780[esp+80], 1
...
; 112  : 			if(iType != -1 || !bValid)
	...
	cmp	edi, ebp
	jne	SHORT $LN3@Read
	cmp	BYTE PTR _bValid$223780[esp+72], 0
	jne	SHORT $LN6@Read
$LN3@Read:
...
; 121  : 					CvString szError;
	...
	lea	ecx, DWORD PTR _szError$223785[esp+76]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ

; 122  : 					szError.Format("LOAD ERROR: Building Type not found");

	lea	eax, DWORD PTR _szError$223785[esp+76]
...
; 125  : 				}
	...
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
$LN6@Read:
	mov	eax, DWORD PTR _iI$223776[esp+76]
	inc	eax
	cmp	eax, DWORD PTR _iNumEntries$223774[esp+76]
	mov	DWORD PTR _iI$223776[esp+76], eax
	jl	$LL7@Read
$LN5@Read:
...
__unwindfunclet$?Read@CvWonderProductionAI@@QAEXAAVFDataStream@@@Z$0:
	lea	ecx, DWORD PTR _szError$223785[ebp]
	jmp	??1CvString@@QAE@XZ			; CvString::~CvString
...
; 3087 : 			std::_Unguarded_partition(_First, _Last);
	...
	push	edi
	lea	eax, DWORD PTR __Mid$224531[esp+28]
	push	ebx
	push	eax
...
; 3090 : 		if (_Mid.first - _First < _Last - _Mid.second)
	...
	mov	ebp, DWORD PTR __Mid$224531[esp+40]
	mov	eax, esi
	cdq
	sub	eax, edx
	sar	eax, 1
	...
	sar	eax, 1
	add	esi, eax
	mov	eax, DWORD PTR __Mid$224531[esp+36]
	mov	ecx, edi
	mov	edx, eax
	sub	ecx, ebp
	sub	edx, ebx
...
; 3098 : 			_Last = _Mid.first;
	...
	mov	edi, DWORD PTR __Mid$224531[esp+36]
$LN26@Sort:
	mov	eax, edi
	sub	eax, ebx
	sar	eax, 3
...
_elem$227775 = -32					; size = 8
_elem$227760 = -32					; size = 8
$T227531 = -32						; size = 4
_iVotesNeededToWin$224044 = -32				; size = 4
_iTurnsRequired$ = -24					; size = 4
_kBuildingClassInfo$224032 = -20			; size = 4
_pkBuildingInfo$224029 = -16				; size = 4
...
; 383  : 		CvBuildingEntry* pkBuildingInfo = m_pBuildings->GetEntry(eBuilding);
	...
	call	?GetEntry@CvBuildingXMLEntries@@QAEPAVCvBuildingEntry@@H@Z ; CvBuildingXMLEntries::GetEntry
	mov	edi, eax
	mov	DWORD PTR _pkBuildingInfo$224029[esp+68], edi
...
; 389  : 			if ((GC.getGame().isOption("GAMEOPTION_AI_TWEAKS") || GC.getGame().isOption("GAMEOPTION_AI_GIMP_NO_WORLD_WONDER")) && isWorldWonderClass(kBuildingClassInfo))
	...
	mov	ecx, DWORD PTR ?gGlobals@@3VCvGlobals@@A+48
	mov	esi, eax
	push	OFFSET $SG224035
	mov	DWORD PTR _kBuildingClassInfo$224032[esp+72], esi
...
; 398  : 				iTurnsRequired = std::max(1, kBuilding.GetProductionCost() / iEstimatedProductionPerTurn);
	...
	mov	DWORD PTR $T227528[esp+68], 1
	mov	DWORD PTR $T227527[esp+68], eax
	cmp	eax, 1
	lea	eax, DWORD PTR $T227527[esp+68]
	jg	SHORT $LN112@ChooseWond
	lea	eax, DWORD PTR $T227528[esp+68]
$LN112@ChooseWond:
	mov	eax, DWORD PTR [eax]
...
; 402  : 				int iTempWeight = bAlreadyStarted ? m_WonderAIWeights.GetWeight(iBldgLoop) * 25 : m_WonderAIWeights.GetWeight(iBldgLoop);
	...
	mov	DWORD PTR _elem$227760[esp+68], ecx
	imul	eax, 25					; 00000019H
	jmp	SHORT $LN213@ChooseWond
$LN35@ChooseWond:
	mov	edx, DWORD PTR [eax+ebp*8]
	mov	eax, DWORD PTR [eax+ebp*8+4]
	mov	DWORD PTR _elem$227775[esp+68], edx
$LN213@ChooseWond:
...
; 405  : 				if(pkBuildingInfo->IsDiplomaticVoting())
	...
	mov	ecx, edi
	mov	DWORD PTR _iTempWeight$224042[esp+68], eax
...
; 409  : 					TeamTypes myTeamID = m_pPlayer->getTeam();
	...
	xor	edi, edi
	mov	DWORD PTR _iVotesNeededToWin$224044[esp+68], eax
	cmp	ebx, 63					; 0000003fH
	ja	SHORT $LN131@ChooseWond
	mov	edx, DWORD PTR ?sr_TeamTypes@CvPreGame@@3ABV?$vector@W4TeamTypes@@V?$allocator@W4TeamTypes@@@std@@@std@@B ; CvPreGame::sr_TeamTypes
	mov	eax, DWORD PTR [edx+4]
	mov	ecx, DWORD PTR [eax+ebx*4]
	mov	DWORD PTR $T227795[esp+68], ecx
	jmp	SHORT $LN132@ChooseWond
$LN131@ChooseWond:
	mov	DWORD PTR $T227795[esp+68], -1
$LN132@ChooseWond:
...
; 424  : 							if(GET_TEAM(eLoopTeam).GetLiberatedByTeam() == myTeamID)
	...
	cmp	eax, DWORD PTR $T227795[esp+68]
...
; 441  : 					int iNumberOfPlayersWeNeedToBuyOff = MAX(0, iVotesNeededToWin - iSecuredVotes);
	...
	mov	eax, DWORD PTR _iVotesNeededToWin$224044[esp+68]
	sub	eax, edi
	mov	DWORD PTR $T227531[esp+68], eax
	mov	DWORD PTR $T227532[esp+68], 0
	lea	esi, DWORD PTR $T227531[esp+68]
	test	eax, eax
	jg	SHORT $LN166@ChooseWond
	lea	esi, DWORD PTR $T227532[esp+68]
$LN166@ChooseWond:
...
; 445  : 						iTempWeight = 0;
	...
	mov	DWORD PTR _iTempWeight$224042[esp+68], 0
$LN206@ChooseWond:
...
; 449  : 				iWeight = CityStrategyAIHelpers::ReweightByTurnsLeft(iTempWeight, iTurnsRequired);
	...
	mov	eax, DWORD PTR _iTempWeight$224042[esp+68]
	push	edx
	push	eax
...
; 451  : 				if(bAdjustForOtherPlayers && ::isWorldWonderClass(kBuildingClassInfo))
	...
	mov	ecx, DWORD PTR _kBuildingClassInfo$224032[esp+68]
	push	ecx
	call	?isWorldWonderClass@@YA_NABVCvBuildingClassInfo@@@Z ; isWorldWonderClass
	add	esp, 4
	test	al, al
...
; 458  : 						if(GET_PLAYER(eLoopPlayer).getBuildingClassMaking((BuildingClassTypes)kBuilding.GetBuildingClassType()) > 0)
	...
	mov	edx, DWORD PTR ?m_aPlayers@CvPlayerAI@@1PAV1@A ; CvPlayerAI::m_aPlayers
	mov	ecx, DWORD PTR _pkBuildingInfo$224029[esp+68]
...
_elem$228198 = -20					; size = 8
$T227978 = -20						; size = 4
_iVotesNeededToWin$224116 = -20				; size = 4
_iCityLoop$ = -12					; size = 4
_fcn$ = -8						; size = 8
_iLoop$224145 = 8					; size = 4
_iBldgLoop$ = 8						; size = 4
_bUseAsyncRandom$ = 8					; size = 1
...
; 559  : 				if(pkBuildingInfo->IsDiplomaticVoting())
	...
	mov	ecx, esi
	mov	DWORD PTR _elem$228198[esp+48], edx
...
; 563  : 					TeamTypes myTeamID = m_pPlayer->getTeam();
	...
	xor	edi, edi
	mov	DWORD PTR _iVotesNeededToWin$224116[esp+48], eax
	cmp	ebp, 63					; 0000003fH
	ja	SHORT $LN119@ChooseWond@2
	mov	edx, DWORD PTR ?sr_TeamTypes@CvPreGame@@3ABV?$vector@W4TeamTypes@@V?$allocator@W4TeamTypes@@@std@@@std@@B ; CvPreGame::sr_TeamTypes
	mov	eax, DWORD PTR [edx+4]
	mov	ecx, DWORD PTR [eax+ebp*4]
	mov	DWORD PTR $T228218[esp+48], ecx
	jmp	SHORT $LN120@ChooseWond@2
$LN119@ChooseWond@2:
	mov	DWORD PTR $T228218[esp+48], -1
$LN120@ChooseWond@2:
...
; 578  : 							if(GET_TEAM(eLoopTeam).GetLiberatedByTeam() == myTeamID)
	...
	mov	ecx, eax
	call	?GetLiberatedByTeam@CvTeam@@QBE?AW4TeamTypes@@XZ ; CvTeam::GetLiberatedByTeam
	cmp	eax, DWORD PTR $T228218[esp+48]
...
; 595  : 					int iNumberOfPlayersWeNeedToBuyOff = MAX(0, iVotesNeededToWin - iSecuredVotes);
	...
	mov	eax, DWORD PTR _iVotesNeededToWin$224116[esp+48]
	sub	eax, edi
	mov	DWORD PTR $T227978[esp+48], eax
	mov	DWORD PTR $T227979[esp+48], 0
	lea	esi, DWORD PTR $T227978[esp+48]
	test	eax, eax
	jg	SHORT $LN154@ChooseWond@2
	lea	esi, DWORD PTR $T227979[esp+48]
$LN154@ChooseWond@2:
...
; 630  : 				for(pLoopCity = m_pPlayer->firstCity(&iLoop); pLoopCity != NULL; pLoopCity = m_pPlayer->nextCity(&iLoop))
	...
	mov	ecx, DWORD PTR [ebx+12]
	push	0
	lea	eax, DWORD PTR _iLoop$224145[esp+48]
	push	eax
	call	?firstCity@CvPlayer@@QAEPAVCvCity@@PAH_N@Z ; CvPlayer::firstCity
	mov	esi, eax
	test	esi, esi
...
; 632  : 					if(pLoopCity->canConstruct(eSelection))
	...
	jne	SHORT $LN184@ChooseWond@2
	push	0
	lea	ecx, DWORD PTR _iLoop$224145[esp+48]
	push	ecx
	mov	ecx, DWORD PTR [ebx+12]
	call	?nextCity@CvPlayer@@QAEPAVCvCity@@PAH_N@Z ; CvPlayer::nextCity
	mov	esi, eax
