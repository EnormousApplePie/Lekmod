; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\Users\EnormousApplePie\Desktop\Lekmod Files\Lekmod DLL versions\v29\LEKMOD_DLL\CvGameCoreDLL_Expansion2\CvInternalGameCoreUtils.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File c:\users\enormousapplepie\desktop\lekmod files\lekmod dll versions\v29\lekmod_dll\cvgamecoredll_expansion2\cvinternalgamecoreutils.cpp
...
; 67   : 	iMaxConscript *= std::max(0, (GC.getMap().getWorldInfo().getMaxConscriptModifier() + 100));
	...
	mov	DWORD PTR $T217212[esp+12], eax
	test	eax, eax
	mov	DWORD PTR $T217213[esp+12], 0
	lea	eax, DWORD PTR $T217212[esp+12]
	jg	SHORT $LN8@getWorldSi
	lea	eax, DWORD PTR $T217213[esp+12]
$LN8@getWorldSi:
