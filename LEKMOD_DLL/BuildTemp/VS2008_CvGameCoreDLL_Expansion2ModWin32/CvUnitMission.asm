; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\Users\EnormousApplePie\Desktop\Lekmod Files\Lekmod DLL versions\v29\LEKMOD_DLL\CvGameCoreDLL_Expansion2\CvUnitMission.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG217953 DB	'*** PROTOCOL ERROR *** : PushMission invoked for a human'
	DB	' controlled player outside of a network message!', 00H
	ORG $+3
$SG217970 DB	'FEATURE_FOREST', 00H
	ORG $+1
$SG217974 DB	'FEATURE_JUNGLE', 00H
	ORG $+1
$SG217978 DB	'FEATURE_MARSH', 00H
	ORG $+2
$SG217982 DB	'FEATURE_FALLOUT', 00H
	ORG $+4
$SG218107 DB	'*** PROTOCOL ERROR *** : PushMission invoked for a human'
	DB	' controlled player outside of a network message!', 00H
	ORG $+3
$SG218158 DB	'TXT_KEY_ADVISOR_CITY_ATTACK_BODY', 00H
	ORG $+3
$SG218169 DB	'TXT_KEY_ADVISOR_BAD_ATTACK_BODY', 00H
$SG218367 DB	'CanStartMission', 00H
CONST	ENDS
...
; Function compile flags: /Ogtpy
; File c:\users\enormousapplepie\desktop\lekmod files\lekmod dll versions\v29\lekmod_dll\cvgamecoredll_expansion2\cvstructs.h
...
; 40   : 		_THROW_NCEE(std::bad_alloc, NULL);
	...
	lea	eax, DWORD PTR $T219735[esp+8]
	push	eax
	lea	ecx, DWORD PTR $T219730[esp+16]
	mov	DWORD PTR $T219735[esp+12], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@ABQBD@Z
	push	OFFSET __TI2?AVbad_alloc@std@@
	lea	ecx, DWORD PTR $T219730[esp+16]
	push	ecx
	mov	DWORD PTR $T219730[esp+20], OFFSET ??_7bad_alloc@std@@6B@
...
__ehfuncinfo$?CanStartMission@CvUnitMission@@SA_NV?$FObjectHandle@VCvUnit@@@@HHHPAVCvPlot@@_N@Z DD 019930522H
	...
	DD	01H
; Function compile flags: /Ogtpy
; File c:\users\enormousapplepie\desktop\lekmod files\lekmod dll versions\v29\lekmod_dll\cvgamecoredll_expansion2\cvunitmission.cpp
xdata$x	ENDS
;	COMDAT ?CanStartMission@CvUnitMission@@SA_NV?$FObjectHandle@VCvUnit@@@@HHHPAVCvPlot@@_N@Z
_TEXT	SEGMENT
_bResult$218365 = -25					; size = 1
_args$218364 = -24					; size = 4
...
; 880  : 		CvLuaArgsHandle args;
	...
	lea	ecx, DWORD PTR _args$218364[esp+40]
...
; 881  : 		args->Push(hUnit->getOwner());
	...
	mov	ecx, DWORD PTR _args$218364[esp+40]
	mov	edx, DWORD PTR [ecx]
	push	eax
	mov	eax, DWORD PTR [edx+8]
...
; 888  : 		if(LuaSupport::CallTestAll(pkScriptSystem, "CanStartMission", args.get(), bResult))
	...
	mov	edx, DWORD PTR _args$218364[esp+40]
	lea	ecx, DWORD PTR _bResult$218365[esp+40]
	push	ecx
	push	edx
	push	OFFSET $SG218367
	push	edi
	mov	BYTE PTR _bResult$218365[esp+56], 0
...
; 891  : 			if(bResult == false)
	...
	cmp	BYTE PTR _bResult$218365[esp+40], 0
...
__unwindfunclet$?CanStartMission@CvUnitMission@@SA_NV?$FObjectHandle@VCvUnit@@@@HHHPAVCvPlot@@_N@Z$2:
	lea	ecx, DWORD PTR _args$218364[ebp]
...
; 2098 : 				UnitHandle pTargetUnit = GET_PLAYER((PlayerTypes)kMissionData.iData1).getUnit(kMissionData.iData2);
	...
	call	?getUnit@CvPlayer@@QAEPAVCvUnit@@H@Z	; CvPlayer::getUnit
	mov	esi, eax
	mov	DWORD PTR _pTargetUnit$218935[esp+36], esi
	mov	BYTE PTR _pTargetUnit$218935[esp+40], 0
	test	esi, esi
...
__unwindfunclet$?HasCompletedMoveMission@CvUnitMission@@SA_NV?$FObjectHandle@VCvUnit@@@@@Z$1:
	lea	ecx, DWORD PTR _pTargetUnit$218935[ebp]
	jmp	??1?$FObjectHandle@VCvUnit@@@@QAE@XZ	; FObjectHandle<CvUnit>::~FObjectHandle<CvUnit>
...
; 1834 : 			iTime = std::min(iTime, 1);
	...
	cmp	edi, 1
	mov	DWORD PTR $T222272[esp+40], 1
	lea	eax, DWORD PTR $T222272[esp+40]
...
; 1848 : 	hUnit->SetMissionTimer(CalculateMissionTimer(hUnit, iSteps));
	...
	mov	eax, ecx
	mov	DWORD PTR __$EHRec$[esp+32], 0
	mov	DWORD PTR $T222520[esp+20], esp
	test	eax, eax
...
; 1189 : 			_THROW(length_error, "map/set<T> too long");
	...
	lea	ecx, DWORD PTR $T222642[esp+88]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z
	lea	ecx, DWORD PTR $T222641[esp+84]
	mov	DWORD PTR __$EHRec$[esp+92], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@XZ
	lea	eax, DWORD PTR $T222642[esp+84]
	push	eax
	lea	ecx, DWORD PTR $T222641[esp+100]
	mov	BYTE PTR __$EHRec$[esp+96], 1
	mov	DWORD PTR $T222641[esp+88], OFFSET ??_7logic_error@std@@6B@
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@ABV01@@Z
	push	OFFSET __TI3?AVlength_error@std@@
	lea	ecx, DWORD PTR $T222641[esp+88]
	push	ecx
	mov	BYTE PTR __$EHRec$[esp+100], 0
	mov	DWORD PTR $T222641[esp+92], OFFSET ??_7length_error@std@@6B@
	call	__CxxThrowException@8
$LN228@Insert:
$LN17@Insert:
...
; 1762 : 			UnitHandle pTargetUnit = GET_PLAYER((PlayerTypes)pMissionNode->iData1).getUnit(pMissionNode->iData2);
	...
	call	?getUnit@CvPlayer@@QAEPAVCvUnit@@H@Z	; CvPlayer::getUnit
	mov	edi, eax
	mov	DWORD PTR _pTargetUnit$218779[esp+32], edi
	mov	BYTE PTR _pTargetUnit$218779[esp+36], 0
	test	edi, edi
...
__unwindfunclet$?LastMissionPlot@CvUnitMission@@SAPAVCvPlot@@V?$FObjectHandle@VCvUnit@@@@@Z$1:
	lea	ecx, DWORD PTR _pTargetUnit$218779[ebp]
	jmp	??1?$FObjectHandle@VCvUnit@@@@QAE@XZ	; FObjectHandle<CvUnit>::~FObjectHandle<CvUnit>
...
; 650  : 				return (_Pairib(_Insert(true, _Wherenode, _Val), true));
	...
	lea	ecx, DWORD PTR $T223532[esp+12]
	cmp	esi, DWORD PTR [eax]
...
; 656  : 				return (_Pairib(_Insert(_Addleft, _Wherenode, _Val), true));
	...
	push	esi
	push	ecx
	lea	edx, DWORD PTR $T223534[esp+24]
	push	edx
	mov	ecx, edi
	call	?_Insert@?$_Tree@V?$_Tset_traits@PAVFAutoVariableBase@@U?$less@PAVFAutoVariableBase@@@std@@V?$allocator@PAVFAutoVariableBase@@@3@$0A@@std@@@std@@IAE?AViterator@12@_NPAU_Node@?$_Tree_nod@V?$_Tset_traits@PAVFAutoVariableBase@@U?$less@PAVFAutoVariableBase@@@std@@V?$allocator@PAVFAutoVariableBase@@@3@$0A@@std@@@2@ABQAVFAutoVariableBase@@@Z ; std::_Tree<std::_Tset_traits<FAutoVariableBase *,std::less<FAutoVariableBase *>,std::allocator<FAutoVariableBase *>,0> >::_Insert
	mov	ecx, DWORD PTR [eax]
...
; 333  : 			gDLL->netMessageDebugLog("*** PROTOCOL ERROR *** : PushMission invoked for a human controlled player outside of a network message!");
	...
	lea	ecx, DWORD PTR $T223663[esp+64]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z
	mov	ecx, DWORD PTR ?gGlobals@@3VCvGlobals@@A+8564
	mov	edx, DWORD PTR [ecx]
	mov	edx, DWORD PTR [edx+76]
	lea	eax, DWORD PTR $T223663[esp+60]
	push	eax
	mov	BYTE PTR __$EHRec$[esp+72], 2
	call	edx
	lea	ecx, DWORD PTR $T223663[esp+60]
...
; 1913 : 		DeactivateHeadMission(hUnit, /*iUnitCycleTimer*/ 1);
	...
	mov	eax, DWORD PTR [eax]
	mov	DWORD PTR $T223816[esp+32], esp
	test	eax, eax
...
; 1922 : 		ActivateHeadMission(hUnit);
	...
	mov	BYTE PTR [eax+4], dl
	mov	eax, ecx
	mov	DWORD PTR $T223817[esp+28], esp
	test	eax, eax
...
; 59   : 		m_deltas.insert(&dirtyVariable);
	...
	lea	edx, DWORD PTR $T224048[esp+4]
	mov	DWORD PTR $T224048[esp+4], eax
	push	edx
	lea	eax, DWORD PTR $T224049[esp+12]
	push	eax
	add	ecx, 20					; 00000014H
...
; 228  : 		m_owner.touch(*this);
	...
	lea	ecx, DWORD PTR $T224058[esp+12]
	push	ecx
	mov	ecx, DWORD PTR [esi+8]
	lea	edx, DWORD PTR $T224059[esp+20]
	push	edx
	add	ecx, 20					; 00000014H
	mov	DWORD PTR $T224058[esp+20], esi
	call	?insert@?$_Tree@V?$_Tset_traits@PAVFAutoVariableBase@@U?$less@PAVFAutoVariableBase@@@std@@V?$allocator@PAVFAutoVariableBase@@@3@$0A@@std@@@std@@QAE?AU?$pair@Viterator@?$_Tree@V?$_Tset_traits@PAVFAutoVariableBase@@U?$less@PAVFAutoVariableBase@@@std@@V?$allocator@PAVFAutoVariableBase@@@3@$0A@@std@@@std@@_N@2@ABQAVFAutoVariableBase@@@Z ; std::_Tree<std::_Tset_traits<FAutoVariableBase *,std::less<FAutoVariableBase *>,std::allocator<FAutoVariableBase *>,0> >::insert
...
; 313  : 		auto_ptr<ICvUnit1> pDllUnit(new CvDllUnit(hUnit.pointer()));
	...
	add	esp, 4
	mov	DWORD PTR $T224065[esp+28], eax
...
$LN18@PopMission:
	xor	esi, esi
$LN19@PopMission:
	mov	DWORD PTR _pDllUnit$218087[esp+28], esi
...
; 321  : 		DeleteMissionQueueNode(hUnit, pTailNode);
	...
	mov	BYTE PTR [eax+4], cl
	mov	eax, DWORD PTR [eax]
	mov	DWORD PTR $T224068[esp+40], esp
	test	eax, eax
...
__unwindfunclet$?PopMission@CvUnitMission@@SAXV?$FObjectHandle@VCvUnit@@@@@Z$2:
	lea	ecx, DWORD PTR _pDllUnit$218087[ebp]
...
; 1942 : 	DeactivateHeadMission(hUnit, iUnitCycleTimerOverride);
	...
	mov	eax, ecx
	mov	DWORD PTR __$EHRec$[esp+36], 0
	mov	DWORD PTR $T224188[esp+24], esp
	test	eax, eax
...
; 1946 : 		PopMission(hUnit);
	...
	mov	BYTE PTR [eax+4], cl
	mov	eax, DWORD PTR [eax]
	mov	DWORD PTR $T224189[esp+20], esp
	test	eax, eax
...
; 204  : 		set(rhs);
	...
	mov	DWORD PTR $T224292[esp+12], ecx
	mov	ecx, DWORD PTR [ecx+8]
	lea	edx, DWORD PTR $T224292[esp+12]
	push	edx
	lea	eax, DWORD PTR $T224293[esp+20]
	push	eax
	add	ecx, 20					; 00000014H
	call	?insert@?$_Tree@V?$_Tset_traits@PAVFAutoVariableBase@@U?$less@PAVFAutoVariableBase@@@std@@V?$allocator@PAVFAutoVariableBase@@@3@$0A@@std@@@std@@QAE?AU?$pair@Viterator@?$_Tree@V?$_Tset_traits@PAVFAutoVariableBase@@U?$less@PAVFAutoVariableBase@@@std@@V?$allocator@PAVFAutoVariableBase@@@3@$0A@@std@@@std@@_N@2@ABQAVFAutoVariableBase@@@Z ; std::_Tree<std::_Tset_traits<FAutoVariableBase *,std::less<FAutoVariableBase *>,std::allocator<FAutoVariableBase *>,0> >::insert
...
_TEXT	SEGMENT
_bDone$218129 = -594					; size = 1
_bAction$218130 = -593					; size = 1
tv1646 = -592						; size = 4
$T224355 = -592						; size = 4
$T224419 = -592						; size = 4
_pDllPlot$218306 = -592					; size = 4
$T224304 = -592						; size = 4
_bBadAttackInterrupt$218145 = -585			; size = 1
$T225453 = -584						; size = 4
$T224311 = -584						; size = 4
$T224308 = -584						; size = 4
_pDllUnit$218333 = -584					; size = 4
$T224305 = -584						; size = 4
_pTargetUnit$218240 = -580				; size = 8
$T224303 = -572						; size = 8
$T225454 = -564						; size = 8
$T224356 = -564						; size = 8
_pTargetUnit$218207 = -556				; size = 8
_kPopup$218168 = -548					; size = 536
_kPopup$218152 = -548					; size = 536
__$EHRec$ = -12						; size = 12
_hUnit$ = 8						; size = 8
_iSteps$ = 16						; size = 4
_iETA$ = 20						; size = 4
...
; 410  : 		hUnit->m_iFlags = hUnit->m_iFlags | CvUnit::UNITFLAG_EVALUATING_MISSION;
	...
	mov	BYTE PTR _bDone$218129[esp+612], 0
	mov	BYTE PTR _bAction$218130[esp+612], 0
	cmp	esi, DWORD PTR [edi+4]
	je	SHORT $LN135@ContinueMi
	mov	eax, DWORD PTR [edi+8]
	lea	ecx, DWORD PTR $T224355[esp+612]
	push	ecx
	lea	edx, DWORD PTR $T224356[esp+616]
	push	edx
	lea	ecx, DWORD PTR [eax+20]
	mov	DWORD PTR $T224355[esp+620], edi
	call	?insert@?$_Tree@V?$_Tset_traits@PAVFAutoVariableBase@@U?$less@PAVFAutoVariableBase@@@std@@V?$allocator@PAVFAutoVariableBase@@@3@$0A@@std@@@std@@QAE?AU?$pair@Viterator@?$_Tree@V?$_Tset_traits@PAVFAutoVariableBase@@U?$less@PAVFAutoVariableBase@@@std@@V?$allocator@PAVFAutoVariableBase@@@3@$0A@@std@@@std@@_N@2@ABQAVFAutoVariableBase@@@Z ; std::_Tree<std::_Tset_traits<FAutoVariableBase *,std::less<FAutoVariableBase *>,std::allocator<FAutoVariableBase *>,0> >::insert
...
; 430  : 		if(iSteps >= 100)
	...
	jge	$ContinueMissionExit$218133
...
; 435  : 		if(pkMissionData->iPushTurn == GC.getGame().getGameTurn() || (pkMissionData->iFlags & MOVE_UNITS_THROUGH_ENEMY))
	...
	mov	ecx, DWORD PTR ?gGlobals@@3VCvGlobals@@A+48
	mov	DWORD PTR $T224419[esp+612], edi
	call	?getGameTurn@CvGame@@QAEHXZ		; CvGame::getGameTurn
...
$LN202@ContinueMi:
	...
	cmp	edx, edi
	jge	SHORT $LN182@ContinueMi
	mov	edi, DWORD PTR $T224419[esp+612]
	imul	ecx, edx
	add	ecx, esi
	imul	ecx, 484				; 000001e4H
...
; 453  : 					if(hUnit->isHuman() && !CvPreGame::isNetworkMultiplayerGame() && !GC.getGame().IsCombatWarned() && (bCityAttackInterrupt || bBadAttackInterrupt))
	...
	mov	ecx, DWORD PTR _hUnit$[esp+608]
	mov	BYTE PTR _bBadAttackInterrupt$218145[esp+612], al
	call	?isHuman@CvUnit@@QBE_NXZ		; CvUnit::isHuman
	test	al, al
	je	$LN86@ContinueMi
	...
	cmp	BYTE PTR _bBadAttackInterrupt$218145[esp+612], bl
	je	$LN86@ContinueMi
$LN97@ContinueMi:
...
; 468  : 										kPopup.iData2 = pPlot->GetPlotIndex();
	...
	mov	ecx, esi
	mov	DWORD PTR _kPopup$218152[esp+616], eax
	mov	DWORD PTR _kPopup$218152[esp+620], eax
	mov	DWORD PTR _kPopup$218152[esp+624], 0
	mov	BYTE PTR _kPopup$218152[esp+628], 0
	mov	BYTE PTR _kPopup$218152[esp+629], 0
	mov	DWORD PTR _kPopup$218152[esp+632], 72	; 00000048H
	mov	BYTE PTR _kPopup$218152[esp+636], 0
	mov	DWORD PTR _kPopup$218152[esp+612], 0
...
; 470  : 										strcpy_s(kPopup.szText, "TXT_KEY_ADVISOR_CITY_ATTACK_BODY");
	...
	lea	ecx, DWORD PTR _kPopup$218152[esp+636]
	push	OFFSET $SG218158
	push	ecx
	mov	DWORD PTR _kPopup$218152[esp+628], eax
...
; 472  : 										GC.GetEngineUserInterface()->AddPopup(kPopup);
	...
	mov	ecx, DWORD PTR ?gGlobals@@3VCvGlobals@@A+8568
	mov	BYTE PTR _kPopup$218152[esp+636], 1
	mov	edx, DWORD PTR [ecx]
	mov	edx, DWORD PTR [edx+180]
	add	esp, 8
	lea	eax, DWORD PTR _kPopup$218152[esp+612]
	push	eax
	call	edx

; 473  : 										goto ContinueMissionExit;

	jmp	$ContinueMissionExit$218133
$LN95@ContinueMi:
...
; 477  : 							else if(bBadAttackInterrupt)
	...
	cmp	BYTE PTR _bBadAttackInterrupt$218145[esp+612], 0
...
; 506  : 						bDone = true;
	...
	mov	BYTE PTR _bDone$218129[esp+612], 1
$LN84@ContinueMi:
...
; 523  : 		if(!bDone && hUnit->canMove() && !hUnit->IsDoingPartialMove())
	...
	cmp	BYTE PTR _bDone$218129[esp+612], 0
	jne	$LN36@ContinueMi
	call	?canMove@CvUnit@@QBE_NXZ		; CvUnit::canMove
	test	al, al
	je	$LN640@ContinueMi
...
; 561  : 					bAction = true;
	...
	mov	BYTE PTR _bAction$218130[esp+612], 1
...
; 614  : 					if(hUnit->plot()->getBestDefender(hUnit->getOwner()) == hUnit.pointer())
	...
	push	-1
	push	eax
	lea	eax, DWORD PTR $T224303[esp+640]
	push	eax
	call	?plot@CvUnit@@QBEPAVCvPlot@@XZ		; CvUnit::plot
	mov	ecx, eax
	...
	mov	ecx, DWORD PTR $T224303[esp+612]
	sete	bl
	test	ecx, ecx
...
$LN377@ContinueMi:
	test	bl, bl
	jne	$ContinueMissionExit$218133
$LN58@ContinueMi:
...
; 621  : 				UnitHandle pTargetUnit = GET_PLAYER((PlayerTypes)kMissionData.iData1).getUnit(kMissionData.iData2);
	...
	call	?getUnit@CvPlayer@@QAEPAVCvUnit@@H@Z	; CvPlayer::getUnit
	push	eax
	lea	ecx, DWORD PTR _pTargetUnit$218207[esp+616]
	call	??0?$FObjectHandle@VCvUnit@@@@QAE@PAVCvUnit@@@Z ; FObjectHandle<CvUnit>::FObjectHandle<CvUnit>

; 622  : 				if(pTargetUnit)

	mov	edi, DWORD PTR _pTargetUnit$218207[esp+612]
...
; 717  : 				UnitHandle pTargetUnit = GET_PLAYER((PlayerTypes)kMissionData.iData1).getUnit(kMissionData.iData2);
	...
	call	?getUnit@CvPlayer@@QAEPAVCvUnit@@H@Z	; CvPlayer::getUnit
	push	eax
	lea	ecx, DWORD PTR _pTargetUnit$218240[esp+616]
	call	??0?$FObjectHandle@VCvUnit@@@@QAE@PAVCvUnit@@@Z ; FObjectHandle<CvUnit>::FObjectHandle<CvUnit>

; 718  : 				if((!pTargetUnit) ||hUnit-> plot() == pTargetUnit->plot())

	mov	esi, DWORD PTR _pTargetUnit$218240[esp+612]
...
; 776  : 		if(HeadMissionQueueNode(kMissionQueue) != NULL)
	...
	cmp	DWORD PTR [ebp+4], 0
	jbe	$ContinueMissionExit$218133
	cmp	DWORD PTR [ebp], 0
	je	$ContinueMissionExit$218133
...
; 779  : 			if(bAction && (bDone || !hUnit->canMove()) && hUnit->plot()->isVisibleToWatchingHuman())
	...
	cmp	BYTE PTR _bAction$218130[esp+612], 0
	je	$LN517@ContinueMi
	cmp	BYTE PTR _bDone$218129[esp+612], 0
...
; 781  : 				UpdateMissionTimer(hUnit, iSteps);
	...
	mov	ecx, esp
	mov	DWORD PTR $T224304[esp+624], esp
	push	eax
...
; 785  : 					auto_ptr<ICvPlot1> pDllPlot = GC.WrapPlotPointer(hUnit->plot());
	...
	call	?plot@CvUnit@@QBEPAVCvPlot@@XZ		; CvUnit::plot
	push	eax
	lea	edx, DWORD PTR $T224305[esp+616]
	push	edx
	mov	ecx, OFFSET ?gGlobals@@3VCvGlobals@@A	; gGlobals
	call	?WrapPlotPointer@CvGlobals@@QAE?AV?$auto_ptr@VICvPlot1@@@std@@PAVCvPlot@@@Z ; CvGlobals::WrapPlotPointer
	mov	esi, DWORD PTR [eax]
	mov	DWORD PTR [eax], 0
	mov	DWORD PTR _pDllPlot$218306[esp+612], esi
	mov	eax, DWORD PTR $T224305[esp+612]
...
; 794  : 					auto_ptr<ICvUnit1> pDllUnit(new CvDllUnit(hUnit.pointer()));
	...
	call	??2CvDllUnit@@SAPAXI@Z			; CvDllUnit::operator new
	add	esp, 4
	mov	DWORD PTR $T224308[esp+612], eax
...
$LN112@ContinueMi:
	xor	esi, esi
$LN113@ContinueMi:
	mov	DWORD PTR _pDllUnit$218333[esp+612], esi
...
$LN581@ContinueMi:
	...
	mov	ecx, esp
	mov	DWORD PTR $T224311[esp+624], esp
	push	edx
	call	??0?$FObjectHandle@VCvUnit@@@@QAE@ABV0@@Z ; FObjectHandle<CvUnit>::FObjectHandle<CvUnit>
	call	?DeleteMissionQueueNode@CvUnitMission@@CAPAUMissionData@@V?$FObjectHandle@VCvUnit@@@@PAU2@@Z ; CvUnitMission::DeleteMissionQueueNode
	add	esp, 12					; 0000000cH
...
; 490  : 											kPopup.iData2 = pPlot->GetPlotIndex();
	...
	mov	ecx, esi
	mov	DWORD PTR _kPopup$218168[esp+616], eax
	mov	DWORD PTR _kPopup$218168[esp+620], eax
	mov	DWORD PTR _kPopup$218168[esp+624], edi
	mov	BYTE PTR _kPopup$218168[esp+628], 0
	mov	BYTE PTR _kPopup$218168[esp+629], 0
	mov	DWORD PTR _kPopup$218168[esp+632], 72	; 00000048H
	mov	BYTE PTR _kPopup$218168[esp+636], 0
	mov	DWORD PTR _kPopup$218168[esp+612], edi
	call	?GetPlotIndex@CvPlot@@QBEHXZ		; CvPlot::GetPlotIndex
...
; 492  : 											strcpy_s(kPopup.szText, "TXT_KEY_ADVISOR_BAD_ATTACK_BODY");
	...
	lea	eax, DWORD PTR _kPopup$218168[esp+636]
...
; 494  : 											GC.GetEngineUserInterface()->AddPopup(kPopup);
	...
	mov	edx, DWORD PTR [edx+180]
	add	esp, 8
	lea	eax, DWORD PTR _kPopup$218168[esp+612]
	push	eax
	call	edx

; 495  : 											goto ContinueMissionExit;

	jmp	SHORT $ContinueMissionExit$218133
$LN637@ContinueMi:
...
; 854  : 	hUnit->m_iFlags =hUnit-> m_iFlags & ~CvUnit::UNITFLAG_EVALUATING_MISSION;
	...
	mov	eax, DWORD PTR [edi+8]
	lea	ecx, DWORD PTR $T225453[esp+612]
	push	ecx
	lea	edx, DWORD PTR $T225454[esp+616]
	push	edx
	lea	ecx, DWORD PTR [eax+20]
	mov	DWORD PTR $T225453[esp+620], edi
	call	?insert@?$_Tree@V?$_Tset_traits@PAVFAutoVariableBase@@U?$less@PAVFAutoVariableBase@@@std@@V?$allocator@PAVFAutoVariableBase@@@3@$0A@@std@@@std@@QAE?AU?$pair@Viterator@?$_Tree@V?$_Tset_traits@PAVFAutoVariableBase@@U?$less@PAVFAutoVariableBase@@@std@@V?$allocator@PAVFAutoVariableBase@@@3@$0A@@std@@@std@@_N@2@ABQAVFAutoVariableBase@@@Z ; std::_Tree<std::_Tset_traits<FAutoVariableBase *,std::less<FAutoVariableBase *>,std::allocator<FAutoVariableBase *>,0> >::insert
	mov	DWORD PTR [edi+4], esi
$LN616@ContinueMi:
...
__unwindfunclet$?ContinueMission@CvUnitMission@@SAXV?$FObjectHandle@VCvUnit@@@@HH@Z$13:
	lea	ecx, DWORD PTR _pDllUnit$218333[ebp]
	jmp	??1?$auto_ptr@VICvUnit1@@@std@@QAE@XZ	; std::auto_ptr<ICvUnit1>::~auto_ptr<ICvUnit1>
...
$T225544 = -20						; size = 4
$T225541 = -20						; size = 4
_pDllUnit$218735 = -20					; size = 4
$T225537 = -20						; size = 4
_pDllUnit$218727 = -20					; size = 4
$T225533 = -20						; size = 4
_pDllUnit$218643 = -20					; size = 4
$T225531 = -20						; size = 4
$T225528 = -20						; size = 4
_pDllUnit$218628 = -20					; size = 4
$T225526 = -20						; size = 4
$T225525 = -20						; size = 4
$T225524 = -20						; size = 4
$T225546 = -16						; size = 4
...
; 1307 : 	const MissionData* pkQueueData = GetHeadMissionData(hUnit);
	...
	mov	BYTE PTR [eax+4], dl
	mov	eax, ecx
	mov	DWORD PTR $T225524[esp+48], esp
	test	eax, eax
...
; 1361 : 			pkQueueData = GetHeadMissionData(hUnit);
	...
	mov	DWORD PTR $T225525[esp+48], esp
	test	eax, eax
...
; 1417 : 					if (hUnit->plot()->isActiveVisible() && (!hUnit->isHuman() || !hUnit->plot()->isVisibleToWatchingHuman() || CalculateMissionTimer(hUnit) == 0))
	...
	mov	ecx, esp
	mov	DWORD PTR $T225526[esp+52], esp
	push	eax
	call	??0?$FObjectHandle@VCvUnit@@@@QAE@ABV0@@Z ; FObjectHandle<CvUnit>::FObjectHandle<CvUnit>
	call	?CalculateMissionTimer@CvUnitMission@@SAHV?$FObjectHandle@VCvUnit@@@@H@Z ; CvUnitMission::CalculateMissionTimer
	add	esp, 12					; 0000000cH
...
; 1419 : 						auto_ptr<ICvUnit1> pDllUnit(new CvDllUnit(hUnit.pointer()));
	...
	call	??2CvDllUnit@@SAPAXI@Z			; CvDllUnit::operator new
	add	esp, 4
	mov	DWORD PTR $T225528[esp+40], eax
	mov	BYTE PTR __$EHRec$[esp+48], 1
	test	eax, eax
...
$LN156@StartMissi:
	xor	esi, esi
$LN157@StartMissi:
	mov	DWORD PTR _pDllUnit$218628[esp+40], esi
...
; 1439 : 					if (hUnit->plot()->isActiveVisible() && (!hUnit->isHuman() || !hUnit->plot()->isVisibleToWatchingHuman() || CalculateMissionTimer(hUnit) == 0))
	...
	mov	ecx, esp
	mov	DWORD PTR $T225531[esp+52], esp
	push	edx
	call	??0?$FObjectHandle@VCvUnit@@@@QAE@ABV0@@Z ; FObjectHandle<CvUnit>::FObjectHandle<CvUnit>
	call	?CalculateMissionTimer@CvUnitMission@@SAHV?$FObjectHandle@VCvUnit@@@@H@Z ; CvUnitMission::CalculateMissionTimer
	add	esp, 12					; 0000000cH
...
; 1441 : 						auto_ptr<ICvUnit1> pDllUnit(new CvDllUnit(hUnit.pointer()));
	...
	call	??2CvDllUnit@@SAPAXI@Z			; CvDllUnit::operator new
	add	esp, 4
	mov	DWORD PTR $T225533[esp+40], eax
...
$LN158@StartMissi:
	xor	esi, esi
$LN159@StartMissi:
	mov	DWORD PTR _pDllUnit$218643[esp+40], esi
...
$LN160@StartMissi:
	xor	esi, esi
$LN161@StartMissi:
	mov	DWORD PTR _pDllUnit$218727[esp+40], esi
...
$LN162@StartMissi:
	xor	esi, esi
$LN163@StartMissi:
	mov	DWORD PTR _pDllUnit$218735[esp+40], esi
...
; 1717 : 					UpdateMissionTimer(hUnit);
	...
	lea	eax, DWORD PTR _hUnit$[esp+48]
	mov	ecx, esp
	mov	DWORD PTR $T225544[esp+52], esp
	push	eax
	call	??0?$FObjectHandle@VCvUnit@@@@QAE@ABV0@@Z ; FObjectHandle<CvUnit>::FObjectHandle<CvUnit>
	call	?UpdateMissionTimer@CvUnitMission@@SAXV?$FObjectHandle@VCvUnit@@@@H@Z ; CvUnitMission::UpdateMissionTimer
	add	esp, 12					; 0000000cH
...
; 1734 : 				DeleteMissionQueueNode(hUnit, hUnit->HeadMissionQueueNode());
	...
	mov	BYTE PTR [eax+4], dl
	mov	eax, ecx
	mov	DWORD PTR $T225545[esp+52], esp
	test	eax, eax
...
; 1738 : 				ContinueMission(hUnit);
	...
	mov	ecx, esp
	mov	DWORD PTR $T225546[esp+56], esp
	push	eax
	call	??0?$FObjectHandle@VCvUnit@@@@QAE@ABV0@@Z ; FObjectHandle<CvUnit>::FObjectHandle<CvUnit>
...
__unwindfunclet$?StartMission@CvUnitMission@@SAXV?$FObjectHandle@VCvUnit@@@@@Z$10:
	lea	ecx, DWORD PTR _pDllUnit$218727[ebp]
	jmp	??1?$auto_ptr@VICvUnit1@@@std@@QAE@XZ	; std::auto_ptr<ICvUnit1>::~auto_ptr<ICvUnit1>
...
__unwindfunclet$?StartMission@CvUnitMission@@SAXV?$FObjectHandle@VCvUnit@@@@@Z$12:
	lea	ecx, DWORD PTR _pDllUnit$218735[ebp]
	jmp	??1?$auto_ptr@VICvUnit1@@@std@@QAE@XZ	; std::auto_ptr<ICvUnit1>::~auto_ptr<ICvUnit1>
...
; 1970 : 			StartMission(hUnit);
	...
	mov	BYTE PTR [eax+4], dl
	mov	eax, ecx
	mov	DWORD PTR $T226334[esp+24], esp
	test	eax, eax
...
; 65   : 					ContinueMission(hUnit);
	...
	mov	ecx, esp
	mov	DWORD PTR $T226373[esp+36], esp
	push	eax
	call	??0?$FObjectHandle@VCvUnit@@@@QAE@ABV0@@Z ; FObjectHandle<CvUnit>::FObjectHandle<CvUnit>
	call	?ContinueMission@CvUnitMission@@SAXV?$FObjectHandle@VCvUnit@@@@HH@Z ; CvUnitMission::ContinueMission
	add	esp, 16					; 00000010H
...
; 69   : 					StartMission(hUnit);
	...
	mov	ecx, esp
	mov	DWORD PTR $T226374[esp+28], esp
	push	edx
	call	??0?$FObjectHandle@VCvUnit@@@@QAE@ABV0@@Z ; FObjectHandle<CvUnit>::FObjectHandle<CvUnit>
	call	?StartMission@CvUnitMission@@SAXV?$FObjectHandle@VCvUnit@@@@@Z ; CvUnitMission::StartMission
	add	esp, 8
...
; 374  : 				ContinueMission(hUnit);
	...
	mov	BYTE PTR [eax+4], dl
	mov	eax, ecx
	mov	DWORD PTR $T226509[esp+16], esp
	test	eax, eax
...
; 1888 : 		ActivateHeadMission(hUnit);
	...
	mov	BYTE PTR [eax+4], dl
	mov	eax, ecx
	mov	DWORD PTR $T226561[esp+28], esp
	test	eax, eax
...
$T226650 = -64						; size = 4
$T226648 = -64						; size = 4
_removeMission$217968 = -60				; size = 20
$T226647 = -40						; size = 28
__$EHRec$ = -12						; size = 12
_hUnit$ = 8						; size = 8
_eMission$ = 16						; size = 4
...
; 87   : 			gDLL->netMessageDebugLog("*** PROTOCOL ERROR *** : PushMission invoked for a human controlled player outside of a network message!");
	...
	lea	ecx, DWORD PTR $T226647[esp+84]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z
	mov	ecx, DWORD PTR ?gGlobals@@3VCvGlobals@@A+8564
	mov	edx, DWORD PTR [ecx]
	mov	edx, DWORD PTR [edx+76]
	lea	eax, DWORD PTR $T226647[esp+80]
	push	eax
	mov	BYTE PTR __$EHRec$[esp+92], 1
	call	edx
	lea	ecx, DWORD PTR $T226647[esp+80]
...
; 110  : 			CvBuildInfo* pkBuildInfo = GC.getBuildInfo(eBuild);
	...
	call	?getBuildInfo@CvGlobals@@QAEPAVCvBuildInfo@@W4BuildTypes@@@Z ; CvGlobals::getBuildInfo
	mov	edi, eax
	mov	DWORD PTR _pkBuildInfo$217961[esp+76], edi
...
; 127  : 						MissionData removeMission;
	...
	xor	eax, eax
	mov	DWORD PTR _removeMission$217968[esp+84], eax
	mov	DWORD PTR _removeMission$217968[esp+88], eax
	mov	DWORD PTR _removeMission$217968[esp+92], eax
	mov	DWORD PTR _removeMission$217968[esp+96], eax
...
; 136  : 							InsertAtEndMissionQueue(hUnit, removeMission, !bAppend);
	...
	mov	ecx, esp
	mov	DWORD PTR $T226648[esp+112], esp
	push	eax
...
; 156  : 							InsertAtEndMissionQueue(hUnit, removeMission, !bAppend);
	...
	lea	eax, DWORD PTR _hUnit$[esp+108]
	mov	ecx, esp
	mov	DWORD PTR $T226650[esp+112], esp
	push	eax
...
; 166  : 							InsertAtEndMissionQueue(hUnit, removeMission, !bAppend);
	...
	mov	ecx, esp
	mov	DWORD PTR $T226651[esp+112], esp
	push	edx
	mov	DWORD PTR [eax+16], edi
$LN174@PushMissio:
	call	??0?$FObjectHandle@VCvUnit@@@@QAE@ABV0@@Z ; FObjectHandle<CvUnit>::FObjectHandle<CvUnit>
...
; 176  : 				if(pkBuildInfo->getImprovement() != NO_IMPROVEMENT)
	...
	mov	esi, DWORD PTR _pkBuildInfo$217961[esp+76]
	or	ebp, -1
	mov	ecx, esi
	or	edi, ebp
	call	?getImprovement@CvBuildInfo@@QBEHXZ	; CvBuildInfo::getImprovement
...
; 232  : 	InsertAtEndMissionQueue(hUnit, mission, !bAppend);
	...
	mov	BYTE PTR [eax+4], dl
	mov	eax, ecx
	mov	DWORD PTR $T226652[esp+108], esp
	test	eax, eax
