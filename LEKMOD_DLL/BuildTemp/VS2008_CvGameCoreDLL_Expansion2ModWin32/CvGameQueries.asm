...
CONST	SEGMENT
$SG218138 DB	'Minor Civ Quest: Gift Unit - Adding random weight to Uni'
	DB	't Chosen', 00H
CONST	ENDS
...
; 243  : 		if(pkFirstUnitInfo->GetCombat() > 0 || pkFirstUnitInfo->GetRange() > 0)
	...
	mov	ecx, edi
	mov	BYTE PTR _bUnit1Combat$218203[esp+20], bl
...
; 245  : 			bUnit1Combat = true;
	...
	mov	BYTE PTR _bUnit1Combat$218203[esp+20], 1
$LN5@AreUnitsSa:
...
; 255  : 		if(bUnit1Combat == bUnit2Combat)
	...
	cmp	BYTE PTR _bUnit1Combat$218203[esp+20], bl
	jne	SHORT $LN1@AreUnitsSa
	pop	esi
	pop	edi
	pop	ebp
...
_TEXT	SEGMENT
_iNumEdges$218160 = -24					; size = 4
_iTeamTotalDist$218159 = -20				; size = 4
tv470 = -16						; size = 4
_iScore$ = -12						; size = 4
tv429 = -8						; size = 4
_iTeam$218153 = -4					; size = 4
...
; 149  : 	for(int iTeam = 0; iTeam < MAX_CIV_TEAMS; iTeam++)
	...
	mov	DWORD PTR _iTeam$218153[esp+40], ebx
...
; 153  : 			int iTeamTotalDist = 0;
	...
	mov	DWORD PTR _iTeamTotalDist$218159[esp+40], edi

; 154  : 			int iNumEdges = 0;

	mov	DWORD PTR _iNumEdges$218160[esp+40], edi
...
; 168  : 								int iOtherPlayerStart = aiStartingLocs[iOtherPlayer];
	...
	inc	DWORD PTR _iNumEdges$218160[esp+40]
...
; 180  : 								iTeamTotalDist += aaiDistances[iPlayerStart][iOtherPlayerStart];
	...
	add	DWORD PTR _iTeamTotalDist$218159[esp+40], edx
	mov	ebx, DWORD PTR _iTeam$218153[esp+40]
$LN8@GetTeamClo:
	inc	esi
...
; 188  : 			if(iNumEdges == 0)
	...
	cmp	DWORD PTR _iNumEdges$218160[esp+40], 0
...
; 194  : 				iTeamScore = iTeamTotalDist/iNumEdges; // the avg distance between team edges is the team score
	...
	mov	eax, DWORD PTR _iTeamTotalDist$218159[esp+40]
	cdq
	idiv	DWORD PTR _iNumEdges$218160[esp+40]
$LN1@GetTeamClo:
...
_TEXT	SEGMENT
__Tmp$219642 = -24					; size = 8
__Tmp$219574 = -16					; size = 8
__Tmp$219600 = -8					; size = 8
___$ReturnUdt$ = 8					; size = 4
__First$ = 12						; size = 4
__Last$ = 16						; size = 4
...
; 3050 : 				std::iter_swap(_Plast++, _Gfirst);
	...
	mov	edi, DWORD PTR [edx]
	mov	DWORD PTR __Tmp$219574[esp+44], ebp
	mov	ebp, DWORD PTR [eax]
	mov	DWORD PTR [edx], ebp
	mov	ebp, DWORD PTR [eax+4]
	mov	DWORD PTR [edx+4], ebp
	mov	edx, DWORD PTR __Tmp$219574[esp+44]
	mov	DWORD PTR [eax], edi
	mov	DWORD PTR [eax+4], edx
$LN20@Unguarded_:
	add	eax, 8
...
; 3057 : 				std::iter_swap(--_Pfirst, _Glast - 1);
	...
	mov	ebp, DWORD PTR [ecx+4]
	mov	edi, DWORD PTR [ecx]
	mov	DWORD PTR __Tmp$219600[esp+44], ebp
	mov	ebp, DWORD PTR [edx]
	mov	DWORD PTR [ecx], ebp
	mov	ebp, DWORD PTR [edx+4]
	mov	DWORD PTR [ecx+4], ebp
	mov	DWORD PTR [edx], edi
	mov	edi, DWORD PTR __Tmp$219600[esp+44]
	mov	DWORD PTR [edx+4], edi
$LN13@Unguarded_:
	sub	ebx, 8
	sub	edx, 8
...
; 3066 : 			std::iter_swap(_Pfirst++, _Gfirst++);
	...
	mov	DWORD PTR __Tmp$219642[esp+40], ebp
	...
	mov	edi, DWORD PTR __Tmp$219642[esp+40]
	mov	DWORD PTR [edx], edi
...
; 3087 : 			std::_Unguarded_partition(_First, _Last);
	...
	push	edi
	lea	eax, DWORD PTR __Mid$218349[esp+28]
	push	ebx
	push	eax
...
; 3090 : 		if (_Mid.first - _First < _Last - _Mid.second)
	...
	mov	ebp, DWORD PTR __Mid$218349[esp+40]
	mov	eax, esi
	cdq
	sub	eax, edx
	sar	eax, 1
	...
	sar	eax, 1
	add	esi, eax
	mov	eax, DWORD PTR __Mid$218349[esp+36]
	mov	ecx, edi
	mov	edx, eax
	sub	ecx, ebp
	sub	edx, ebx
...
; 3098 : 			_Last = _Mid.first;
	...
	mov	edi, DWORD PTR __Mid$218349[esp+36]
$LN26@Sort:
	mov	eax, edi
	sub	eax, ebx
	sar	eax, 3
...
_TEXT	SEGMENT
_i$218103 = -756					; size = 4
_pkTechInfo$218121 = -752				; size = 4
...
; 32   : 	for (int i = 0; i < GC.getNumUnitClassInfos(); i++)
	...
	mov	DWORD PTR _i$218103[esp+760], esi
...
; 72   : 			CvTechEntry* pkTechInfo = GC.getTechInfo(ePrereqTech);
	...
	mov	DWORD PTR _pkTechInfo$218121[esp+772], eax
...
; 86   : 					if (GET_PLAYER((PlayerTypes) iMajorLoop).getUnitClassCount(eUnitClass) > 0)
	...
	mov	edx, DWORD PTR _i$218103[esp+772]
	push	edx
...
; 107  : 			iWeight += (pkTechInfo->GetResearchCost() / 8);
	...
	mov	ecx, DWORD PTR _pkTechInfo$218121[esp+772]
	mov	esi, eax
...
; 115  : 			UnitClassesVector.push_back(i, iWeight);
	...
	push	esi
	lea	edx, DWORD PTR _i$218103[esp+776]
	push	edx
...
$LN22@GetLeastAd:
	mov	esi, DWORD PTR _i$218103[esp+772]
	inc	esi
	mov	ecx, OFFSET ?gGlobals@@3VCvGlobals@@A	; gGlobals
	mov	DWORD PTR _i$218103[esp+772], esi
	call	?getNumUnitClassInfos@CvGlobals@@QAEHXZ	; CvGlobals::getNumUnitClassInfos
	cmp	esi, eax
	jl	$LL113@GetLeastAd
	pop	edi
