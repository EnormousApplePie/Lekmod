...
_TEXT	SEGMENT
_szTemp$221235 = -640					; size = 4
_ar$221231 = -636					; size = 100
_FStringFixedBuffer_szTemp$221236 = -536		; size = 524
__$EHRec$ = -12						; size = 12
_L$ = 8							; size = 4
...
; 58   : 		if(lua_getstack(L, i, &ar))
	...
	lea	eax, DWORD PTR _ar$221231[esp+656]
	push	eax
	push	ebx
	push	ebp
	call	_lua_getstack
...
; 60   : 			lua_getinfo(L, "Sl", &ar);
	...
	lea	ecx, DWORD PTR _ar$221231[esp+656]
	push	ecx
...
; 61   : 			if(ar.currentline > 0)
	...
	cmp	DWORD PTR _ar$221231[esp+676], edi
	jle	$LN4@DumpCallSt
...
; 63   : 				FStringFixedBuffer(szTemp, 512);
	...
	call	?FStringA_GetStringInitData@@YAPAUFStringAData@FStringA@@XZ ; FStringA_GetStringInitData
	add	eax, 12					; 0000000cH
	mov	DWORD PTR _szTemp$221235[esp+656], eax
	lea	edx, DWORD PTR _szTemp$221235[esp+656]
	push	edx
	lea	ecx, DWORD PTR _FStringFixedBuffer_szTemp$221236[esp+660]
...
; 64   : 				szTemp.Format("%s:%d\n", (ar.source)?ar.source:"", ar.currentline);
	...
	mov	eax, DWORD PTR _ar$221231[esp+672]
	cmp	eax, edi
	jne	SHORT $LN9@DumpCallSt
	mov	eax, OFFSET $SG221237
$LN9@DumpCallSt:
	mov	ecx, DWORD PTR _ar$221231[esp+676]
	push	ecx
	push	eax
	lea	edx, DWORD PTR _szTemp$221235[esp+664]
...
; 66   : 			}
	...
	mov	esi, DWORD PTR _szTemp$221235[esp+672]
	...
	add	esp, 4
$LN23@DumpCallSt:
	mov	DWORD PTR _szTemp$221235[esp+656], edi
	call	?FStringA_GetStringInitData@@YAPAUFStringAData@FStringA@@XZ ; FStringA_GetStringInitData
	add	eax, 12					; 0000000cH
	mov	DWORD PTR _szTemp$221235[esp+656], eax
$LN4@DumpCallSt:
...
__unwindfunclet$?DumpCallStack@LuaSupport@@YAXPAUlua_State@@@Z$0:
	lea	ecx, DWORD PTR _szTemp$221235[ebp]
