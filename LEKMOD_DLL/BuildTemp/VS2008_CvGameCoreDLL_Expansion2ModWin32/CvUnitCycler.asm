; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\Users\EnormousApplePie\Desktop\Lekmod Files\Lekmod DLL versions\v29\LEKMOD_DLL\CvGameCoreDLL_Expansion2\CvUnitCycler.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; Function compile flags: /Ogtpy
; File c:\users\enormousapplepie\desktop\lekmod files\lekmod dll versions\v29\lekmod_dll\cvgamecoredllutil\include\linkedlist.h
...
; Function compile flags: /Ogtpy
; File c:\users\enormousapplepie\desktop\lekmod files\lekmod dll versions\v29\lekmod_dll\cvgamecoredll_expansion2\cvunitcycler.cpp
...
_TEXT	SEGMENT
_iLoop$ = -32						; size = 4
_iX$217636 = -28					; size = 4
_iNumUnits$217630 = -24					; size = 4
_pCurrentUnit$217629 = -20				; size = 8
__$EHRec$ = -12						; size = 12
_iY$217637 = 8						; size = 4
_pSelectedUnit$217607 = 8				; size = 4
...
; 40   : 		auto_ptr<ICvUnit1> pSelectedUnit(DLLUI->GetHeadSelectedUnit());
	...
	call	edx
	mov	ebx, eax
	mov	DWORD PTR _pSelectedUnit$217607[esp+44], ebx
...
; 75   : 		UnitHandle pCurrentUnit = pkStartUnit;
	...
	mov	ecx, esi
	mov	DWORD PTR [edi+12], eax
	mov	DWORD PTR _pCurrentUnit$217629[esp+48], esi
	mov	BYTE PTR _pCurrentUnit$217629[esp+52], 0
	call	?getDestructionNotification@CvUnit@@QAEAAU?$DestructionNotification@V?$FObjectHandle@VCvUnit@@@@@@XZ ; CvUnit::getDestructionNotification
...
; 80   : 		while(m_kNodeList.getLength() < iNumUnits)
	...
	mov	DWORD PTR _iNumUnits$217630[esp+48], eax
	jge	$LN2@Rebuild
	jmp	SHORT $LN9@Rebuild
	npad	6
$LL133@Rebuild:
	mov	esi, DWORD PTR _pCurrentUnit$217629[esp+48]
$LN9@Rebuild:
...
; 87   : 			for(pLoopUnit = m_pkPlayer->firstUnit(&iLoop); pLoopUnit != NULL; pLoopUnit = m_pkPlayer->nextUnit(&iLoop))
	...
	mov	DWORD PTR _iX$217636[esp+56], edx
	mov	DWORD PTR _iY$217637[esp+52], eax
	call	?firstUnit@CvPlayer@@QAEPAVCvUnit@@PAH_N@Z ; CvPlayer::firstUnit
	mov	esi, eax
	test	esi, esi
	je	$LN134@Rebuild
...
; 93   : 				int iScore = plotDistance(iX, iY, pLoopUnit->getX(), pLoopUnit->getY());
	...
	mov	edx, DWORD PTR _iY$217637[esp+44]
	push	eax
	mov	eax, DWORD PTR _iX$217636[esp+52]
	push	ecx
	push	edx
	push	eax
...
; 110  : 				pCurrentUnit = pBestUnit;
	...
	mov	ecx, DWORD PTR _pCurrentUnit$217629[esp+48]
	inc	DWORD PTR [edi+4]
	mov	DWORD PTR [edi+12], eax
	call	?getDestructionNotification@CvUnit@@QAEAAU?$DestructionNotification@V?$FObjectHandle@VCvUnit@@@@@@XZ ; CvUnit::getDestructionNotification
	mov	ecx, ebx
	mov	DWORD PTR _pCurrentUnit$217629[esp+48], ebx
	call	?getDestructionNotification@CvUnit@@QAEAAU?$DestructionNotification@V?$FObjectHandle@VCvUnit@@@@@@XZ ; CvUnit::getDestructionNotification
...
; 111  : 				pCurrentUnit->SetCycleOrder(1);
	...
	mov	ecx, ebx
	call	?SetCycleOrder@CvUnit@@QAEXH@Z		; CvUnit::SetCycleOrder
	mov	eax, DWORD PTR _iNumUnits$217630[esp+48]
	cmp	DWORD PTR [edi+4], eax
	jl	$LL133@Rebuild
$LN134@Rebuild:
...
__unwindfunclet$?Rebuild@CvUnitCycler@@QAEXPAVCvUnit@@@Z$0:
	lea	ecx, DWORD PTR _pSelectedUnit$217607[ebp-4]
...
__unwindfunclet$?Rebuild@CvUnitCycler@@QAEXPAVCvUnit@@@Z$1:
	lea	ecx, DWORD PTR _pCurrentUnit$217629[ebp]
	jmp	??1?$FObjectHandle@VCvUnit@@@@QAE@XZ	; FObjectHandle<CvUnit>::~FObjectHandle<CvUnit>
