...
_DATA	SEGMENT
_CIV5_XP2_DLL_VERSION DD FLAT:$SG221211
_DATA	ENDS
CONST	SEGMENT
$SG221211 DB	'1.0.0', 00H
	ORG $+2
...
; 92   : 	return m_pDiplomacyAI->GetDiploStringForMessage(eDiploMessage, eForPlayer, szOptionalKey1);
	...
	push	esi
	push	eax
	lea	ecx, DWORD PTR $T222537[esp+100]
	...
	lea	ecx, DWORD PTR $T222537[esp+96]
	push	ecx
...
; 306  : 	static GUID DLLCALL GetInterfaceId(){ return guidICvUnknown; }
	...
	mov	eax, DWORD PTR $T222572[esp-4]
...
; 968  : 	static GUID DLLCALL GetInterfaceId() { return guidICvDiplomacyAI1; }
	...
	mov	eax, DWORD PTR $T222576[esp-4]
...
; 31   : 	        guidInterface == ICvDiplomacyAI1::GetInterfaceId())
	...
	mov	DWORD PTR $T222586[esp+20], ecx
	lea	ecx, DWORD PTR $T222586[esp+16]
	mov	DWORD PTR $T222586[esp+24], edx
	mov	DWORD PTR $T222586[esp+16], eax
	mov	eax, DWORD PTR _guidICvUnknown+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T222586[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
