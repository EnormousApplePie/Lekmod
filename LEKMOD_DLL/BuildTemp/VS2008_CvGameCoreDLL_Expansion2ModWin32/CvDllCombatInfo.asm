...
; 97   : 	return (NULL != pkCity)? new CvDllCity(pkCity) : NULL;
	...
	add	esp, 4
	mov	DWORD PTR $T219385[esp+12], eax
	mov	DWORD PTR __$EHRec$[esp+24], 0
	test	eax, eax
	je	SHORT $LN5@GetCity
	push	esi
...
__unwindfunclet$?GetCity@CvDllCombatInfo@@UBGPAVICvCity1@@W4BattleUnitTypes@@@Z$0:
	mov	eax, DWORD PTR $T219385[ebp-4]
	push	eax
...
; 103  : 	return (NULL != pkPlot)? new CvDllPlot(pkPlot) : NULL;
	...
	add	esp, 4
	mov	DWORD PTR $T219401[esp+12], eax
	mov	DWORD PTR __$EHRec$[esp+24], 0
	test	eax, eax
	je	SHORT $LN5@GetPlot
	push	esi
...
__unwindfunclet$?GetPlot@CvDllCombatInfo@@UBGPAVICvPlot1@@XZ$0:
	mov	eax, DWORD PTR $T219401[ebp-4]
	push	eax
...
; 306  : 	static GUID DLLCALL GetInterfaceId(){ return guidICvUnknown; }
	...
	mov	eax, DWORD PTR $T219476[esp-4]
...
; 900  : 	static GUID DLLCALL GetInterfaceId() { return guidICvCombatInfo1; }
	...
	mov	eax, DWORD PTR $T219480[esp-4]
...
; 32   : 	        guidInterface == ICvCombatInfo1::GetInterfaceId())
	...
	mov	DWORD PTR $T219490[esp+20], ecx
	lea	ecx, DWORD PTR $T219490[esp+16]
	mov	DWORD PTR $T219490[esp+24], edx
	mov	DWORD PTR $T219490[esp+16], eax
	mov	eax, DWORD PTR _guidICvUnknown+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T219490[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	...
	mov	DWORD PTR $T219492[esp+20], ecx
	lea	ecx, DWORD PTR $T219492[esp+16]
	mov	DWORD PTR $T219492[esp+24], edx
	mov	DWORD PTR $T219492[esp+16], eax
	mov	eax, DWORD PTR _guidICvCombatInfo1+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T219492[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	jne	SHORT $LN1@QueryInter
