; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\Users\EnormousApplePie\Desktop\Cleanup (v1)\Lekmod Files\Lekmod DLL versions\v30\LEKMOD_DLL\CvGameCoreDLL_Expansion2\CvDllCombatInfo.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File c:\users\enormousapplepie\desktop\cleanup (v1)\lekmod files\lekmod dll versions\v30\lekmod_dll\cvgamecoredll_expansion2\cvdllcombatinfo.cpp
rdata$r	SEGMENT
...
; 97   : 	return (NULL != pkCity)? new CvDllCity(pkCity) : NULL;
	...
	add	esp, 4
	mov	DWORD PTR $T218828[esp+12], eax
	mov	DWORD PTR __$EHRec$[esp+24], 0
	test	eax, eax
	je	SHORT $LN5@GetCity
	push	esi
...
__unwindfunclet$?GetCity@CvDllCombatInfo@@UBGPAVICvCity1@@W4BattleUnitTypes@@@Z$0:
	mov	eax, DWORD PTR $T218828[ebp-4]
	push	eax
...
; 103  : 	return (NULL != pkPlot)? new CvDllPlot(pkPlot) : NULL;
	...
	add	esp, 4
	mov	DWORD PTR $T218844[esp+12], eax
	mov	DWORD PTR __$EHRec$[esp+24], 0
	test	eax, eax
	je	SHORT $LN5@GetPlot
	push	esi
...
__unwindfunclet$?GetPlot@CvDllCombatInfo@@UBGPAVICvPlot1@@XZ$0:
	mov	eax, DWORD PTR $T218844[ebp-4]
	push	eax
...
; 900  : 	static GUID DLLCALL GetInterfaceId() { return guidICvCombatInfo1; }
	...
	mov	eax, DWORD PTR $T218923[esp-4]
...
; 32   : 	        guidInterface == ICvCombatInfo1::GetInterfaceId())
	...
	mov	DWORD PTR $T218933[esp+20], ecx
	lea	ecx, DWORD PTR $T218933[esp+16]
	mov	DWORD PTR $T218933[esp+24], edx
	mov	DWORD PTR $T218933[esp+16], eax
	mov	eax, DWORD PTR _guidICvUnknown+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T218933[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	...
	mov	DWORD PTR $T218935[esp+20], ecx
	lea	ecx, DWORD PTR $T218935[esp+16]
	mov	DWORD PTR $T218935[esp+24], edx
	mov	DWORD PTR $T218935[esp+16], eax
	mov	eax, DWORD PTR _guidICvCombatInfo1+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T218935[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	jne	SHORT $LN1@QueryInter
