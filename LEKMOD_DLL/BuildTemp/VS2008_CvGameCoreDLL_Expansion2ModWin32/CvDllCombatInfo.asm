; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\Users\EnormousApplePie\Documents\GitHub\Lekmod\LEKMOD_DLL\CvGameCoreDLL_Expansion2\CvDllCombatInfo.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File c:\users\enormousapplepie\documents\github\lekmod\lekmod_dll\cvgamecoredll_expansion2\cvdllcombatinfo.cpp
rdata$r	SEGMENT
...
; 97   : 	return (NULL != pkCity)? new CvDllCity(pkCity) : NULL;
	...
	add	esp, 4
	mov	DWORD PTR $T219384[esp+12], eax
	mov	DWORD PTR __$EHRec$[esp+24], 0
	test	eax, eax
	je	SHORT $LN5@GetCity
	push	esi
...
__unwindfunclet$?GetCity@CvDllCombatInfo@@UBGPAVICvCity1@@W4BattleUnitTypes@@@Z$0:
	mov	eax, DWORD PTR $T219384[ebp-4]
	push	eax
...
; 103  : 	return (NULL != pkPlot)? new CvDllPlot(pkPlot) : NULL;
	...
	add	esp, 4
	mov	DWORD PTR $T219400[esp+12], eax
	mov	DWORD PTR __$EHRec$[esp+24], 0
	test	eax, eax
	je	SHORT $LN5@GetPlot
	push	esi
...
__unwindfunclet$?GetPlot@CvDllCombatInfo@@UBGPAVICvPlot1@@XZ$0:
	mov	eax, DWORD PTR $T219400[ebp-4]
	push	eax
...
; 306  : 	static GUID DLLCALL GetInterfaceId(){ return guidICvUnknown; }
	...
	mov	eax, DWORD PTR $T219475[esp-4]
...
; 900  : 	static GUID DLLCALL GetInterfaceId() { return guidICvCombatInfo1; }
	...
	mov	eax, DWORD PTR $T219479[esp-4]
...
; 32   : 	        guidInterface == ICvCombatInfo1::GetInterfaceId())
	...
	mov	DWORD PTR $T219489[esp+20], ecx
	lea	ecx, DWORD PTR $T219489[esp+16]
	mov	DWORD PTR $T219489[esp+24], edx
	mov	DWORD PTR $T219489[esp+16], eax
	mov	eax, DWORD PTR _guidICvUnknown+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T219489[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	...
	mov	DWORD PTR $T219491[esp+20], ecx
	lea	ecx, DWORD PTR $T219491[esp+16]
	mov	DWORD PTR $T219491[esp+24], edx
	mov	DWORD PTR $T219491[esp+16], eax
	mov	eax, DWORD PTR _guidICvCombatInfo1+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T219491[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	jne	SHORT $LN1@QueryInter
