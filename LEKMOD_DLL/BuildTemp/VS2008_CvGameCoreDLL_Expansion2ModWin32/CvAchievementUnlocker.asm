; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\Users\EnormousApplePie\Desktop\Lekmod Files\Lekmod DLL versions\v29\LEKMOD_DLL\CvGameCoreDLL_Expansion2\CvAchievementUnlocker.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_BSS	ENDS
CONST	SEGMENT
$SG218689 DB	'LEADER_ALEXANDER', 00H
	ORG $+3
$SG218728 DB	'BELIEF_PAPAL_PRIMACY', 00H
	ORG $+3
$SG218754 DB	'CIVILIZATION_ETHIOPIA', 00H
	ORG $+2
$SG218757 DB	'UNIT_PROPHET', 00H
	ORG $+3
$SG218769 DB	'CIVILIZATION_CARTHAGE', 00H
	ORG $+2
$SG218772 DB	'CIVILIZATION_ROME', 00H
	ORG $+2
$SG218775 DB	'UNIT_CARTHAGINIAN_FOREST_ELEPHANT', 00H
	ORG $+2
$SG218791 DB	'CIVILIZATION_BYZANTIUM', 00H
	ORG $+1
$SG218794 DB	'CIVILIZATION_GREECE', 00H
$SG218797 DB	'UNIT_BYZANTINE_DROMON', 00H
	ORG $+2
$SG218805 DB	'UNIT_SKY_FORTRESS', 00H
	ORG $+2
$SG218824 DB	'CIVILIZATION_SWEDEN', 00H
$SG218827 DB	'UNIT_GREAT_GENERAL', 00H
	ORG $+1
$SG218830 DB	'UNIT_SWEDISH_HAKKAPELIITTA', 00H
	ORG $+1
$SG218858 DB	'BUILDING_COLOSSUS', 00H
	ORG $+2
$SG218861 DB	'BUILDING_PETRA', 00H
	ORG $+1
$SG218864 DB	'BUILDING_CARAVANSARY', 00H
	ORG $+3
$SG218867 DB	'BUILDING_HARBOR', 00H
...
; File c:\users\enormousapplepie\desktop\lekmod files\lekmod dll versions\v29\lekmod_dll\cvgamecoredll_expansion2\cvachievementunlocker.cpp
...
_TEXT	SEGMENT
_szLeaderName$218685 = -40				; size = 28
__$EHRec$ = -12						; size = 12
_ePlayer$ = 8						; size = 4
...
$LN20@AlexanderC:
	push	esi
	push	eax
	lea	ecx, DWORD PTR _szLeaderName$218685[esp+56]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z

; 74   : 		if(szLeaderName == "LEADER_ALEXANDER")

	lea	eax, DWORD PTR _szLeaderName$218685[esp+52]
...
; 98   : 	}
	...
	lea	ecx, DWORD PTR _szLeaderName$218685[esp+52]
...
__unwindfunclet$?AlexanderConquest@CvAchievementUnlocker@@SAXW4PlayerTypes@@@Z$0:
	lea	ecx, DWORD PTR _szLeaderName$218685[ebp]
...
; 336  : 			for(const CvUnit* pUnit = m_kPlayer.firstUnit(&iLoop); pUnit != NULL; pUnit = m_kPlayer.nextUnit(&iLoop))
	...
	push	0
	lea	ecx, DWORD PTR _iLoop$218833[esp+16]
	push	ecx
	mov	ecx, DWORD PTR [edi]
	mov	DWORD PTR _iLoop$218833[esp+20], 0
...
; 336  : 			for(const CvUnit* pUnit = m_kPlayer.firstUnit(&iLoop); pUnit != NULL; pUnit = m_kPlayer.nextUnit(&iLoop))
	...
	mov	ecx, DWORD PTR [edi]
	push	0
	lea	edx, DWORD PTR _iLoop$218833[esp+24]
	push	edx
