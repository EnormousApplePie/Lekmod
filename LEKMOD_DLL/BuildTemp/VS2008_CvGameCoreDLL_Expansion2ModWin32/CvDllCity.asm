; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\Users\EnormousApplePie\Documents\GitHub\Lekmod\LEKMOD_DLL\CvGameCoreDLL_Expansion2\CvDllCity.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_DATA	SEGMENT
_CIV5_XP2_DLL_VERSION DD FLAT:$SG217737
_DATA	ENDS
CONST	SEGMENT
$SG217737 DB	'1.0.0', 00H
	ORG $+2
...
; File c:\users\enormousapplepie\documents\github\lekmod\lekmod_dll\cvgamecoredll_expansion2\cvdllcity.cpp
rdata$r	SEGMENT
...
; 109  : 	return (NULL != pkPlot)? new CvDllPlot(pkPlot) : NULL;
	...
	add	esp, 4
	mov	DWORD PTR $T219277[esp+12], eax
...
__unwindfunclet$?Plot@CvDllCity@@UBGPAVICvPlot1@@XZ$0:
	mov	eax, DWORD PTR $T219277[ebp-4]
	push	eax
...
; 205  : 	return (NULL != pkPlot)? new CvDllPlot(pkPlot) : NULL;
	...
	call	??2CvDllPlot@@SAPAXI@Z			; CvDllPlot::operator new
	add	esp, 4
	mov	DWORD PTR $T219367[esp+12], eax
	mov	DWORD PTR __$EHRec$[esp+24], 0
	test	eax, eax
	je	SHORT $LN5@GetCityPlo
	push	esi
...
__unwindfunclet$?GetCityPlotFromIndex@CvDllCity@@UBGPAVICvPlot1@@H@Z$0:
	mov	eax, DWORD PTR $T219367[ebp-4]
	push	eax
	call	??3CvDllPlot@@SAXPAX@Z			; CvDllPlot::operator delete
	pop	ecx
	ret	0
...
; 306  : 	static GUID DLLCALL GetInterfaceId(){ return guidICvUnknown; }
	...
	mov	eax, DWORD PTR $T219385[esp-4]
...
; 855  : 	static GUID DLLCALL GetInterfaceId() { return guidICvCity1; }
	...
	mov	eax, DWORD PTR $T219389[esp-4]
...
; 31   : 	        guidInterface == ICvCity1::GetInterfaceId())
	...
	mov	DWORD PTR $T219405[esp+20], ecx
	lea	ecx, DWORD PTR $T219405[esp+16]
	mov	DWORD PTR $T219405[esp+24], edx
	mov	DWORD PTR $T219405[esp+16], eax
	mov	eax, DWORD PTR _guidICvUnknown+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T219405[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	...
	mov	DWORD PTR $T219407[esp+20], ecx
	lea	ecx, DWORD PTR $T219407[esp+16]
	mov	DWORD PTR $T219407[esp+24], edx
	mov	DWORD PTR $T219407[esp+16], eax
	mov	eax, DWORD PTR _guidICvCity1+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T219407[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	jne	SHORT $LN1@QueryInter
