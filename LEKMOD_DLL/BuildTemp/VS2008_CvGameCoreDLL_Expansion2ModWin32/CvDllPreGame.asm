; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\Users\EnormousApplePie\Desktop\Cleanup (v1)\Lekmod Files\Lekmod DLL versions\v30\LEKMOD_DLL\CvGameCoreDLL_Expansion2\CvDllPreGame.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_DATA	SEGMENT
_CIV5_XP2_DLL_VERSION DD FLAT:$SG217559
_DATA	ENDS
CONST	SEGMENT
$SG217559 DB	'1.0.0', 00H
	ORG $+2
...
; File c:\users\enormousapplepie\desktop\cleanup (v1)\lekmod files\lekmod dll versions\v30\lekmod_dll\cvgamecoredll_expansion2\cvdllpregame.cpp
rdata$r	SEGMENT
...
; 1068 : 	return new CvDllWorldInfo(const_cast<CvWorldInfo*>(pWorldInfo));
	...
	add	esp, 4
	mov	DWORD PTR $T222336[esp+20], eax
...
; 1103 : 	return new CvDllDlcPackageInfoList(CvPreGame::getDLCAllowed());
	...
	mov	esi, eax
	add	esp, 4
	mov	DWORD PTR $T222373[esp+20], esi
	xor	eax, eax
...
; 1108 : 	return new CvDllDlcPackageInfoList(CvPreGame::getDLCAvailable(p));
	...
	mov	esi, eax
	add	esp, 4
	mov	DWORD PTR $T222399[esp+20], esi
	xor	eax, eax
	mov	DWORD PTR __$EHRec$[esp+28], eax
	cmp	esi, eax
...
; 40   : 		_THROW_NCEE(std::bad_alloc, NULL);
	...
	lea	eax, DWORD PTR $T222509[esp+8]
	push	eax
	lea	ecx, DWORD PTR $T222504[esp+16]
	mov	DWORD PTR $T222509[esp+12], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@ABQBD@Z
	push	OFFSET __TI2?AVbad_alloc@std@@
	lea	ecx, DWORD PTR $T222504[esp+16]
	push	ecx
	mov	DWORD PTR $T222504[esp+20], OFFSET ??_7bad_alloc@std@@6B@
...
; 306  : 	static GUID DLLCALL GetInterfaceId(){ return guidICvUnknown; }
	...
	mov	eax, DWORD PTR $T222552[esp-4]
...
; 332  : 	static GUID DLLCALL GetInterfaceId(){ return guidICvEnumerator; }
	...
	mov	eax, DWORD PTR $T222559[esp-4]
...
; 384  : 	static GUID DLLCALL GetInterfaceId() { return guidICvDlcPackageInfo1; }
	...
	mov	eax, DWORD PTR $T222563[esp-4]
...
; 1421 : 	static GUID DLLCALL GetInterfaceId() { return guidICvPreGame1; }
	...
	mov	eax, DWORD PTR $T222567[esp-4]
...
; 133  : 	static GUID DLLCALL GetInterfaceId() { return guidICvPreGame2; }
	...
	mov	eax, DWORD PTR $T222571[esp-4]
...
; 27   : 		guidInterface == ICvPreGame2::GetInterfaceId())
	...
	mov	DWORD PTR $T222592[esp+20], ecx
	lea	ecx, DWORD PTR $T222592[esp+16]
	mov	DWORD PTR $T222592[esp+24], edx
	mov	DWORD PTR $T222592[esp+16], eax
	mov	eax, DWORD PTR _guidICvUnknown+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T222592[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	...
	mov	DWORD PTR $T222594[esp+20], ecx
	lea	ecx, DWORD PTR $T222594[esp+16]
	mov	DWORD PTR $T222594[esp+24], edx
	mov	DWORD PTR $T222594[esp+16], eax
	mov	eax, DWORD PTR _guidICvPreGame1+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T222594[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	jne	SHORT $LN1@QueryInter
	...
	mov	DWORD PTR $T222596[esp+20], ecx
	lea	ecx, DWORD PTR $T222596[esp+16]
	mov	DWORD PTR $T222596[esp+24], edx
	mov	DWORD PTR $T222596[esp+16], eax
	mov	eax, DWORD PTR _guidICvPreGame2+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T222596[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	jne	SHORT $LN1@QueryInter
...
; 87   : 	return CvPreGame::civilizationAdjective(p);
	...
	push	esi
	push	eax
	mov	DWORD PTR $T222633[esp+12], 0
...
; 92   : 	return CvPreGame::civilizationAdjectiveKey(p);
	...
	push	esi
	push	eax
	mov	DWORD PTR $T222644[esp+12], 0
...
; 97   : 	return CvPreGame::civilizationDescription(p);
	...
	push	esi
	push	eax
	mov	DWORD PTR $T222655[esp+12], 0
...
; 102  : 	return CvPreGame::civilizationDescriptionKey(p);
	...
	push	esi
	push	eax
	mov	DWORD PTR $T222666[esp+12], 0
...
; 112  : 	return CvPreGame::civilizationPassword(p);
	...
	push	esi
	push	eax
	mov	DWORD PTR $T222677[esp+12], 0
...
; 117  : 	return CvPreGame::civilizationShortDescription(p);
	...
	push	esi
	push	eax
	mov	DWORD PTR $T222688[esp+12], 0
...
; 122  : 	return CvPreGame::civilizationShortDescriptionKey(p);
	...
	push	esi
	push	eax
	mov	DWORD PTR $T222699[esp+12], 0
...
; 127  : 	return CvPreGame::civilizationKey(p);
	...
	push	esi
	push	eax
	mov	DWORD PTR $T222710[esp+12], 0
...
; 162  : 	return CvPreGame::emailAddress(p);
	...
	push	esi
	push	eax
	mov	DWORD PTR $T222721[esp+12], 0
...
_TEXT	SEGMENT
_this$ = 8						; size = 4
_nSourceBufferSize$219592 = 12				; size = 4
_uiIndex$ = 12						; size = 4
...
; 221  : 		const char* pszSourceBuffer = kOptions[uiIndex].GetName(nSourceBufferSize);
	...
	add	esi, eax
	add	esi, esi
	lea	edx, DWORD PTR _nSourceBufferSize$219592[esp+8]
	add	esi, esi
...
; 222  : 		if(nOptionNameBufferSize+1 > nSourceBufferSize)
	...
	inc	ecx
	cmp	ecx, DWORD PTR _nSourceBufferSize$219592[esp+8]
...
_TEXT	SEGMENT
_this$ = 8						; size = 4
_nSourceBufferSize$219611 = 12				; size = 4
_uiIndex$ = 12						; size = 4
_szOptionNameBuffer$ = 16				; size = 4
_nOptionNameBufferSize$ = 20				; size = 4
_iValue$ = 24						; size = 4
...
; 243  : 		const char* pszSourceBuffer = kOptions[uiIndex].GetName(nSourceBufferSize);
	...
	add	esi, eax
	add	esi, esi
	lea	edx, DWORD PTR _nSourceBufferSize$219611[esp+8]
	add	esi, esi
	lea	ecx, DWORD PTR [esi+edi]
	push	edx
	call	?GetName@CustomOption@CvPreGame@@QBEPBDAAI@Z ; CvPreGame::CustomOption::GetName
...
; 244  : 		if(nOptionNameBufferSize+1 > nSourceBufferSize)
	...
	mov	ecx, DWORD PTR _nOptionNameBufferSize$[esp+8]
	inc	ecx
	cmp	ecx, DWORD PTR _nSourceBufferSize$219611[esp+8]
...
; 377  : 	return CvPreGame::leaderName(p);
	...
	push	esi
	push	eax
	mov	DWORD PTR $T222800[esp+12], 0
...
; 382  : 	return CvPreGame::leaderNameKey(p);
	...
	push	esi
	push	eax
	mov	DWORD PTR $T222811[esp+12], 0
...
; 387  : 	return CvPreGame::leaderKey(p);
	...
	push	esi
	push	eax
	mov	DWORD PTR $T222822[esp+12], 0
...
; 462  : 	return CvPreGame::nickname(p);
	...
	push	esi
	push	eax
	mov	DWORD PTR $T222855[esp+12], 0
...
; 467  : 	return CvPreGame::nicknameDisplayed(p);
	...
	push	esi
	push	eax
	mov	DWORD PTR $T222866[esp+12], 0
...
; 1862 : 			auto_ptr<ICvUnknown> pValue(m_Enumerator->GetCurrent());
	...
	call	edx
	mov	esi, eax
	mov	DWORD PTR _pValue$221053[esp+24], esi
	mov	DWORD PTR __$EHRec$[esp+32], 0
...
__unwindfunclet$?GetCurrent@?$CvEnumerator@VICvDlcPackageInfo1@@@@QAEPAVICvDlcPackageInfo1@@XZ$0:
	lea	ecx, DWORD PTR _pValue$221053[ebp]
...
; 1241 : 			_THROW(length_error, "list<T> too long");
	...
	lea	ecx, DWORD PTR $T223485[esp+84]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z
	lea	ecx, DWORD PTR $T223484[esp+80]
	mov	DWORD PTR __$EHRec$[esp+88], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@XZ
	lea	eax, DWORD PTR $T223485[esp+80]
	push	eax
	lea	ecx, DWORD PTR $T223484[esp+96]
	mov	BYTE PTR __$EHRec$[esp+92], 1
	mov	DWORD PTR $T223484[esp+84], OFFSET ??_7logic_error@std@@6B@
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@ABV01@@Z
	push	OFFSET __TI3?AVlength_error@std@@
	lea	ecx, DWORD PTR $T223484[esp+84]
	push	ecx
	mov	BYTE PTR __$EHRec$[esp+96], 0
	mov	DWORD PTR $T223484[esp+88], OFFSET ??_7length_error@std@@6B@
	call	__CxxThrowException@8
$LN20@Incsize:
$LN1@Incsize:
...
_TEXT	SEGMENT
_pPackageInfo$220811 = -44				; size = 4
...
; 1120 : 		auto_ptr<ICvDlcPackageInfo1> pPackageInfo(kEnum.GetCurrent());
	...
	mov	edi, eax
	mov	DWORD PTR _pPackageInfo$220811[esp+60], edi
...
; 1123 : 			kDLCList.push_back(pPackageInfo->GetPackageID());
	...
	mov	edx, DWORD PTR [eax+8]
	lea	ecx, DWORD PTR $T223872[esp+60]
	push	ecx
	push	edi
	call	edx
...
__unwindfunclet$?SetDLCAvailable@CvDllPreGame@@UAGXW4PlayerTypes@@PAVICvEnumerator@@@Z$2:
	lea	ecx, DWORD PTR _pPackageInfo$220811[ebp]
