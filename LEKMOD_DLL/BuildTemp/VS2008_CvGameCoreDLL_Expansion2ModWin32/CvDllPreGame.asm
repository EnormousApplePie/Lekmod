...
_DATA	SEGMENT
_CIV5_XP2_DLL_VERSION DD FLAT:$SG218116
_DATA	ENDS
CONST	SEGMENT
$SG218116 DB	'1.0.0', 00H
	ORG $+2
...
; 1068 : 	return new CvDllWorldInfo(const_cast<CvWorldInfo*>(pWorldInfo));
	...
	add	esp, 4
	mov	DWORD PTR $T222893[esp+20], eax
...
; 1103 : 	return new CvDllDlcPackageInfoList(CvPreGame::getDLCAllowed());
	...
	mov	esi, eax
	add	esp, 4
	mov	DWORD PTR $T222930[esp+20], esi
	xor	eax, eax
...
; 1108 : 	return new CvDllDlcPackageInfoList(CvPreGame::getDLCAvailable(p));
	...
	mov	esi, eax
	add	esp, 4
	mov	DWORD PTR $T222956[esp+20], esi
	xor	eax, eax
	mov	DWORD PTR __$EHRec$[esp+28], eax
	cmp	esi, eax
...
; 40   : 		_THROW_NCEE(std::bad_alloc, NULL);
	...
	lea	eax, DWORD PTR $T223066[esp+8]
	push	eax
	lea	ecx, DWORD PTR $T223061[esp+16]
	mov	DWORD PTR $T223066[esp+12], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@ABQBD@Z
	push	OFFSET __TI2?AVbad_alloc@std@@
	lea	ecx, DWORD PTR $T223061[esp+16]
	push	ecx
	mov	DWORD PTR $T223061[esp+20], OFFSET ??_7bad_alloc@std@@6B@
...
; 306  : 	static GUID DLLCALL GetInterfaceId(){ return guidICvUnknown; }
	...
	mov	eax, DWORD PTR $T223109[esp-4]
...
; 332  : 	static GUID DLLCALL GetInterfaceId(){ return guidICvEnumerator; }
	...
	mov	eax, DWORD PTR $T223116[esp-4]
...
; 384  : 	static GUID DLLCALL GetInterfaceId() { return guidICvDlcPackageInfo1; }
	...
	mov	eax, DWORD PTR $T223120[esp-4]
...
; 1421 : 	static GUID DLLCALL GetInterfaceId() { return guidICvPreGame1; }
	...
	mov	eax, DWORD PTR $T223124[esp-4]
...
; 133  : 	static GUID DLLCALL GetInterfaceId() { return guidICvPreGame2; }
	...
	mov	eax, DWORD PTR $T223128[esp-4]
...
; 27   : 		guidInterface == ICvPreGame2::GetInterfaceId())
	...
	mov	DWORD PTR $T223149[esp+20], ecx
	lea	ecx, DWORD PTR $T223149[esp+16]
	mov	DWORD PTR $T223149[esp+24], edx
	mov	DWORD PTR $T223149[esp+16], eax
	mov	eax, DWORD PTR _guidICvUnknown+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T223149[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	...
	mov	DWORD PTR $T223151[esp+20], ecx
	lea	ecx, DWORD PTR $T223151[esp+16]
	mov	DWORD PTR $T223151[esp+24], edx
	mov	DWORD PTR $T223151[esp+16], eax
	mov	eax, DWORD PTR _guidICvPreGame1+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T223151[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	jne	SHORT $LN1@QueryInter
	...
	mov	DWORD PTR $T223153[esp+20], ecx
	lea	ecx, DWORD PTR $T223153[esp+16]
	mov	DWORD PTR $T223153[esp+24], edx
	mov	DWORD PTR $T223153[esp+16], eax
	mov	eax, DWORD PTR _guidICvPreGame2+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T223153[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	jne	SHORT $LN1@QueryInter
...
; 87   : 	return CvPreGame::civilizationAdjective(p);
	...
	push	esi
	push	eax
	mov	DWORD PTR $T223190[esp+12], 0
...
; 92   : 	return CvPreGame::civilizationAdjectiveKey(p);
	...
	push	esi
	push	eax
	mov	DWORD PTR $T223201[esp+12], 0
...
; 97   : 	return CvPreGame::civilizationDescription(p);
	...
	push	esi
	push	eax
	mov	DWORD PTR $T223212[esp+12], 0
...
; 102  : 	return CvPreGame::civilizationDescriptionKey(p);
	...
	push	esi
	push	eax
	mov	DWORD PTR $T223223[esp+12], 0
...
; 112  : 	return CvPreGame::civilizationPassword(p);
	...
	push	esi
	push	eax
	mov	DWORD PTR $T223234[esp+12], 0
...
; 117  : 	return CvPreGame::civilizationShortDescription(p);
	...
	push	esi
	push	eax
	mov	DWORD PTR $T223245[esp+12], 0
...
; 122  : 	return CvPreGame::civilizationShortDescriptionKey(p);
	...
	push	esi
	push	eax
	mov	DWORD PTR $T223256[esp+12], 0
...
; 127  : 	return CvPreGame::civilizationKey(p);
	...
	push	esi
	push	eax
	mov	DWORD PTR $T223267[esp+12], 0
...
; 162  : 	return CvPreGame::emailAddress(p);
	...
	push	esi
	push	eax
	mov	DWORD PTR $T223278[esp+12], 0
...
_TEXT	SEGMENT
_this$ = 8						; size = 4
_nSourceBufferSize$220149 = 12				; size = 4
_uiIndex$ = 12						; size = 4
...
; 221  : 		const char* pszSourceBuffer = kOptions[uiIndex].GetName(nSourceBufferSize);
	...
	add	esi, eax
	add	esi, esi
	lea	edx, DWORD PTR _nSourceBufferSize$220149[esp+8]
	add	esi, esi
...
; 222  : 		if(nOptionNameBufferSize+1 > nSourceBufferSize)
	...
	inc	ecx
	cmp	ecx, DWORD PTR _nSourceBufferSize$220149[esp+8]
...
_TEXT	SEGMENT
_this$ = 8						; size = 4
_nSourceBufferSize$220168 = 12				; size = 4
_uiIndex$ = 12						; size = 4
_szOptionNameBuffer$ = 16				; size = 4
_nOptionNameBufferSize$ = 20				; size = 4
_iValue$ = 24						; size = 4
...
; 243  : 		const char* pszSourceBuffer = kOptions[uiIndex].GetName(nSourceBufferSize);
	...
	add	esi, eax
	add	esi, esi
	lea	edx, DWORD PTR _nSourceBufferSize$220168[esp+8]
	add	esi, esi
	lea	ecx, DWORD PTR [esi+edi]
	push	edx
	call	?GetName@CustomOption@CvPreGame@@QBEPBDAAI@Z ; CvPreGame::CustomOption::GetName
...
; 244  : 		if(nOptionNameBufferSize+1 > nSourceBufferSize)
	...
	mov	ecx, DWORD PTR _nOptionNameBufferSize$[esp+8]
	inc	ecx
	cmp	ecx, DWORD PTR _nSourceBufferSize$220168[esp+8]
...
; 377  : 	return CvPreGame::leaderName(p);
	...
	push	esi
	push	eax
	mov	DWORD PTR $T223357[esp+12], 0
...
; 382  : 	return CvPreGame::leaderNameKey(p);
	...
	push	esi
	push	eax
	mov	DWORD PTR $T223368[esp+12], 0
...
; 387  : 	return CvPreGame::leaderKey(p);
	...
	push	esi
	push	eax
	mov	DWORD PTR $T223379[esp+12], 0
...
; 462  : 	return CvPreGame::nickname(p);
	...
	push	esi
	push	eax
	mov	DWORD PTR $T223412[esp+12], 0
...
; 467  : 	return CvPreGame::nicknameDisplayed(p);
	...
	push	esi
	push	eax
	mov	DWORD PTR $T223423[esp+12], 0
...
; 1862 : 			auto_ptr<ICvUnknown> pValue(m_Enumerator->GetCurrent());
	...
	call	edx
	mov	esi, eax
	mov	DWORD PTR _pValue$221610[esp+24], esi
	mov	DWORD PTR __$EHRec$[esp+32], 0
...
__unwindfunclet$?GetCurrent@?$CvEnumerator@VICvDlcPackageInfo1@@@@QAEPAVICvDlcPackageInfo1@@XZ$0:
	lea	ecx, DWORD PTR _pValue$221610[ebp]
...
; 1241 : 			_THROW(length_error, "list<T> too long");
	...
	lea	ecx, DWORD PTR $T224042[esp+84]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z
	lea	ecx, DWORD PTR $T224041[esp+80]
	mov	DWORD PTR __$EHRec$[esp+88], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@XZ
	lea	eax, DWORD PTR $T224042[esp+80]
	push	eax
	lea	ecx, DWORD PTR $T224041[esp+96]
	mov	BYTE PTR __$EHRec$[esp+92], 1
	mov	DWORD PTR $T224041[esp+84], OFFSET ??_7logic_error@std@@6B@
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@ABV01@@Z
	push	OFFSET __TI3?AVlength_error@std@@
	lea	ecx, DWORD PTR $T224041[esp+84]
	push	ecx
	mov	BYTE PTR __$EHRec$[esp+96], 0
	mov	DWORD PTR $T224041[esp+88], OFFSET ??_7length_error@std@@6B@
	call	__CxxThrowException@8
$LN20@Incsize:
$LN1@Incsize:
...
_TEXT	SEGMENT
_pPackageInfo$221368 = -44				; size = 4
...
; 1120 : 		auto_ptr<ICvDlcPackageInfo1> pPackageInfo(kEnum.GetCurrent());
	...
	mov	edi, eax
	mov	DWORD PTR _pPackageInfo$221368[esp+60], edi
...
; 1123 : 			kDLCList.push_back(pPackageInfo->GetPackageID());
	...
	mov	edx, DWORD PTR [eax+8]
	lea	ecx, DWORD PTR $T224429[esp+60]
	push	ecx
	push	edi
	call	edx
...
__unwindfunclet$?SetDLCAvailable@CvDllPreGame@@UAGXW4PlayerTypes@@PAVICvEnumerator@@@Z$2:
	lea	ecx, DWORD PTR _pPackageInfo$221368[ebp]
