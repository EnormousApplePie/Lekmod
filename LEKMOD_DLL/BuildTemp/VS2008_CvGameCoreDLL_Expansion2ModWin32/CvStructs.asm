; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\Users\EnormousApplePie\Desktop\Lekmod Files\Lekmod DLL versions\v29\LEKMOD_DLL\CvGameCoreDLL_Expansion2\CvStructs.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File c:\users\enormousapplepie\desktop\lekmod files\lekmod dll versions\v29\lekmod_dll\cvgamecoredll_expansion2\cvstructs.cpp
...
; 1260 : 		_THROW(length_error, "vector<T> too long");
	...
	lea	ecx, DWORD PTR $T219054[esp+84]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z
	lea	ecx, DWORD PTR $T219053[esp+80]
	mov	DWORD PTR __$EHRec$[esp+88], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@XZ
	lea	eax, DWORD PTR $T219054[esp+80]
	push	eax
	lea	ecx, DWORD PTR $T219053[esp+96]
	mov	BYTE PTR __$EHRec$[esp+92], 1
	mov	DWORD PTR $T219053[esp+84], OFFSET ??_7logic_error@std@@6B@
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@ABV01@@Z
	push	OFFSET __TI3?AVlength_error@std@@
	lea	ecx, DWORD PTR $T219053[esp+84]
	push	ecx
	mov	BYTE PTR __$EHRec$[esp+96], 0
	mov	DWORD PTR $T219053[esp+88], OFFSET ??_7length_error@std@@6B@
...
; 1260 : 		_THROW(length_error, "vector<T> too long");
	...
	push	OFFSET ??_C@_0BD@OLBABOEK@vector?$DMT?$DO?5too?5long?$AA@
	lea	ecx, DWORD PTR $T219098[esp+84]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z
	lea	ecx, DWORD PTR $T219097[esp+80]
	mov	DWORD PTR __$EHRec$[esp+88], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@XZ
	lea	eax, DWORD PTR $T219098[esp+80]
	push	eax
	lea	ecx, DWORD PTR $T219097[esp+96]
	mov	BYTE PTR __$EHRec$[esp+92], 1
	mov	DWORD PTR $T219097[esp+84], OFFSET ??_7logic_error@std@@6B@
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@ABV01@@Z
	push	OFFSET __TI3?AVlength_error@std@@
	lea	ecx, DWORD PTR $T219097[esp+84]
	push	ecx
	mov	BYTE PTR __$EHRec$[esp+96], 0
	mov	DWORD PTR $T219097[esp+88], OFFSET ??_7length_error@std@@6B@
	call	__CxxThrowException@8
$LN13@Xlen@2:
$LN12@Xlen@2:
	int	3
...
; 40   : 		_THROW_NCEE(std::bad_alloc, NULL);
	...
	lea	eax, DWORD PTR $T219145[esp+8]
	push	eax
	lea	ecx, DWORD PTR $T219141[esp+16]
	mov	DWORD PTR $T219145[esp+12], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@ABQBD@Z
	push	OFFSET __TI2?AVbad_alloc@std@@
	lea	ecx, DWORD PTR $T219141[esp+16]
	push	ecx
	mov	DWORD PTR $T219141[esp+20], OFFSET ??_7bad_alloc@std@@6B@
	call	__CxxThrowException@8
$LN9@Allocate:
$LN8@Allocate:
	int	3
...
; 40   : 		_THROW_NCEE(std::bad_alloc, NULL);
	...
	lea	eax, DWORD PTR $T219155[esp+8]
	push	eax
	lea	ecx, DWORD PTR $T219151[esp+16]
	mov	DWORD PTR $T219155[esp+12], 0
	call	DWORD PTR __imp_??0exception@std@@QAE@ABQBD@Z
	push	OFFSET __TI2?AVbad_alloc@std@@
	lea	ecx, DWORD PTR $T219151[esp+16]
	push	ecx
	mov	DWORD PTR $T219151[esp+20], OFFSET ??_7bad_alloc@std@@6B@
	call	__CxxThrowException@8
$LN9@Allocate@2:
$LN8@Allocate@2:
	int	3
...
; 70   : 		m_saveTo << container.size();
	...
	lea	eax, DWORD PTR $T219218[esp]
	sar	edx, 2
	push	eax
	mov	DWORD PTR $T219218[esp+4], edx
	call	?Write@FDataStream@@IAEXABI@Z		; FDataStream::Write
...
; 487  : 	m_iDamageMemberCount = std::min(iDamageMemberCount, (int)MAX_DAMAGE_MEMBER_COUNT);
	...
	mov	DWORD PTR $T219402[esp+4], eax
	jle	SHORT $LN5@setDamageM
	lea	eax, DWORD PTR $T219402[esp+4]
...
; 52   : 	::new (_Vptr) _T1(_Val);
	...
	mov	DWORD PTR $T219593[esp+16], eax
...
; 69   : 	kStream << aVoteOptions.size();
	...
	add	esp, 8
	shr	eax, 31					; 0000001fH
	lea	ecx, DWORD PTR $T219818[esp+12]
	add	eax, edx
	push	ecx
	mov	ecx, edi
	mov	DWORD PTR $T219818[esp+16], eax
	call	?Write@FDataStream@@IAEXABI@Z		; FDataStream::Write
...
; 2754 : 		_First_dest_cat, _Ptr_cat(_First, _Dest), _Range_checked_iterator_tag());
	...
	mov	BYTE PTR $T219918[esp+4], 0
	mov	eax, DWORD PTR $T219918[esp+4]
	mov	ecx, DWORD PTR __Cat$219922[esp+4]
	push	eax
	mov	eax, DWORD PTR __Dest$[esp+4]
	push	ecx
...
; 199  : 	std::for_each(readFrom.begin(), readFrom.end(), SerializeFromSequenceContainer<const ElementType, const std::vector<ElementType> >(saveTo, readFrom));
	...
	push	edi
	lea	ecx, DWORD PTR $T219983[esp+8]
	sar	eax, 2
	push	ecx
	mov	ecx, ebx
	mov	DWORD PTR $T219983[esp+12], eax
	call	?Write@FDataStream@@IAEXABI@Z		; FDataStream::Write
...
; 3696 : 			_STD _Iter_random(_First, _Dest), _STD _Move_cat(_Dest), _STD _Range_checked_iterator_tag()));
	...
	mov	ecx, DWORD PTR __Cat$220252[esp]
	mov	edx, DWORD PTR $T220231[esp]
	mov	BYTE PTR $T220248[esp+4], 0
	mov	eax, DWORD PTR $T220248[esp+4]
	push	eax
	mov	eax, DWORD PTR __Dest$[esp+4]
	push	ecx
	mov	ecx, DWORD PTR __Last$[esp+8]
...
; 404  : 		_Al.construct(_First, _Val);
	...
	mov	DWORD PTR __Vptr$220302[ebp], esi
	mov	DWORD PTR $T220305[ebp], esi
...
__unwindfunclet$??$_Uninit_fill_n@PAUVoteSelectionSubData@@IU1@V?$allocator@UVoteSelectionSubData@@@std@@@std@@YAXPAUVoteSelectionSubData@@IABU1@AAV?$allocator@UVoteSelectionSubData@@@0@U_Nonscalar_ptr_iterator_tag@0@U_Range_checked_iterator_tag@0@@Z$2:
	mov	eax, DWORD PTR __Vptr$220302[ebp]
	push	eax
	mov	ecx, DWORD PTR $T220305[ebp]
	push	ecx
	call	??3@YAXPAX0@Z				; operator delete
	add	esp, 8
	ret	0
...
; 131  : 		_Al.construct(_Dest, *_First);
	...
	mov	DWORD PTR __Vptr$220412[ebp], esi
	mov	DWORD PTR $T220415[ebp], esi
	mov	BYTE PTR __$EHRec$[ebp+12], 1
	cmp	esi, ebx
...
__unwindfunclet$??$_Uninit_copy@PAUVoteSelectionSubData@@PAU1@V?$allocator@UVoteSelectionSubData@@@std@@@std@@YAPAUVoteSelectionSubData@@PAU1@00AAV?$allocator@UVoteSelectionSubData@@@0@U_Nonscalar_ptr_iterator_tag@0@U_Range_checked_iterator_tag@0@@Z$2:
	mov	eax, DWORD PTR __Vptr$220412[ebp]
	push	eax
...
; 942  : 		_STD _Ptr_cat(_First, _First), _STD _Range_checked_iterator_tag());
	...
	mov	BYTE PTR $T220717[esp+4], 0
	mov	eax, DWORD PTR $T220717[esp+4]
	mov	ecx, DWORD PTR __Cat$220721[esp+4]
	push	eax
	mov	eax, DWORD PTR __Val$[esp+4]
	push	ecx
...
; 822  : 		_STD _Ptr_cat(_First, _Dest), _STD _Range_checked_iterator_tag()));
	...
	mov	edx, DWORD PTR __Al$[esp]
	mov	BYTE PTR $T220726[esp+4], 0
	mov	eax, DWORD PTR $T220726[esp+4]
	mov	ecx, DWORD PTR __Cat$220730[esp+4]
	push	eax
	mov	eax, DWORD PTR __Dest$[esp+4]
	push	ecx
	mov	ecx, DWORD PTR __Last$[esp+8]
...
; 1254 : 		_STDEXT unchecked_uninitialized_fill_n(_Ptr, _Count, _Val, this->_Alval);
	...
	mov	edx, DWORD PTR __Cat$221131[esp]
	push	esi
	mov	esi, DWORD PTR __Count$[esp+4]
	push	edi
	mov	edi, DWORD PTR __Ptr$[esp+8]
	mov	BYTE PTR $T221128[esp+12], 0
	mov	eax, DWORD PTR $T221128[esp+12]
	push	eax
...
; 207  : 	return (_STDEXT unchecked_uninitialized_copy(_First, _Last, _Dest, _Al));
	...
	mov	ecx, DWORD PTR __Cat$221149[esp]
	mov	edx, DWORD PTR __Al$[esp]
	mov	BYTE PTR $T221146[esp+4], 0
	mov	eax, DWORD PTR $T221146[esp+4]
	push	eax
	mov	eax, DWORD PTR __Dest$[esp+4]
	push	ecx
	mov	ecx, DWORD PTR __Last$[esp+8]
...
; 864  : 		_STD _Move_cat(_Dest), _STD _Range_checked_iterator_tag()));
	...
	mov	ecx, DWORD PTR __Cat$221470[esp]
	mov	edx, DWORD PTR __Al$[esp]
	mov	BYTE PTR $T221467[esp+4], 0
	mov	eax, DWORD PTR $T221467[esp+4]
	push	eax
	mov	eax, DWORD PTR __Dest$[esp+4]
	push	ecx
	mov	ecx, DWORD PTR __Last$[esp+8]
...
; 1148 : 			_Ptr, this->_Alval));
	...
	mov	edx, DWORD PTR __Cat$221586[esp]
	mov	BYTE PTR $T221583[esp+4], 0
	mov	eax, DWORD PTR $T221583[esp+4]
	push	eax
	mov	eax, DWORD PTR __Ptr$[esp+4]
	push	edx
...
_TEXT	SEGMENT
__Tmp$217920 = -120					; size = 44
__Tmp$217910 = -76					; size = 44
_this$ = -32						; size = 4
__Whereoff$217896 = -28					; size = 4
__Ncopied$217897 = -24					; size = 4
__Newvec$217895 = -20					; size = 4
__$EHRec$ = -16						; size = 16
__Cat$222047 = 8					; size = 1
__Cat$221975 = 8					; size = 1
__Where$ = 8						; size = 4
tv559 = 12						; size = 4
__Count$ = 12						; size = 4
$T222044 = 16						; size = 1
...
; 1174 : 			size_type _Whereoff = _VEC_ITER_BASE(_Where) - _Myfirst;
	...
	shr	eax, 31					; 0000001fH
	add	eax, edx
	mov	DWORD PTR __Whereoff$217896[ebp], eax
...
; 1178 : 			_Ufill(_Newvec + _Whereoff, _Count, _Val);	// add new stuff
	...
	xor	edx, edx
	add	esp, 8
	mov	DWORD PTR __Ncopied$217897[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+12], edx
	mov	edx, DWORD PTR __Val$[ebp]
	push	edx
	add	eax, ecx
	push	edi
	mov	DWORD PTR __Newvec$217895[ebp], ecx
	push	eax
	mov	ecx, esi
...
; 1181 : 				_Newvec);	// move prefix
	...
	mov	edx, DWORD PTR __Cat$221975[ebp]
	mov	eax, DWORD PTR [esi+4]
	mov	BYTE PTR $T221972[ebp], 0
	mov	ecx, DWORD PTR $T221972[ebp]
	push	ecx
	mov	ecx, DWORD PTR __Newvec$217895[ebp]
	push	edx
	mov	edx, DWORD PTR __Where$[ebp]
	push	esi
	push	ecx
	push	edx
	push	eax
	mov	DWORD PTR __Ncopied$217897[ebp], 1
	call	??$_Uninit_copy@PAUVoteSelectionSubData@@PAU1@V?$allocator@UVoteSelectionSubData@@@std@@@std@@YAPAUVoteSelectionSubData@@PAU1@00AAV?$allocator@UVoteSelectionSubData@@@0@U_Nonscalar_ptr_iterator_tag@0@U_Range_checked_iterator_tag@0@@Z ; std::_Uninit_copy<VoteSelectionSubData *,VoteSelectionSubData *,std::allocator<VoteSelectionSubData> >
...
; 1184 : 				_Newvec + (_Whereoff + _Count));	// move suffix
	...
	mov	eax, DWORD PTR __Whereoff$217896[ebp]
	mov	ecx, DWORD PTR [esi+8]
	add	eax, edi
	imul	eax, 44					; 0000002cH
	add	eax, DWORD PTR __Newvec$217895[ebp]
	add	esp, 24					; 00000018H
	mov	BYTE PTR $T222044[ebp], 0
	mov	edx, DWORD PTR $T222044[ebp]
	push	edx
	mov	edx, DWORD PTR __Cat$222047[ebp]
	push	edx
	push	esi
	push	eax
	...
	push	ecx
	push	eax
	mov	DWORD PTR __Ncopied$217897[ebp], 2
	call	??$_Uninit_copy@PAUVoteSelectionSubData@@PAU1@V?$allocator@UVoteSelectionSubData@@@std@@@std@@YAPAUVoteSelectionSubData@@PAU1@00AAV?$allocator@UVoteSelectionSubData@@@0@U_Nonscalar_ptr_iterator_tag@0@U_Range_checked_iterator_tag@0@@Z ; std::_Uninit_copy<VoteSelectionSubData *,VoteSelectionSubData *,std::allocator<VoteSelectionSubData> >
...
; 1205 : 			_Myend = _Newvec + _Capacity;
	...
	mov	eax, DWORD PTR __Newvec$217895[ebp]
...
; 1186 : 			if (1 < _Ncopied)
	...
	mov	ebx, DWORD PTR __Ncopied$217897[ebp]
	cmp	ebx, 1

; 1187 : 				_Destroy(_Newvec, _Newvec + _Whereoff);

	mov	esi, DWORD PTR __Whereoff$217896[ebp]
	mov	edi, DWORD PTR __Newvec$217895[ebp]
...
; 1211 : 			_Ty _Tmp = _Val;	// in case _Val is in sequence
	...
	mov	edx, DWORD PTR __Val$[ebp]
	push	edx
	lea	ecx, DWORD PTR __Tmp$217910[ebp]
...
; 1218 : 				_Tmp);	// insert new stuff off end
	...
	lea	eax, DWORD PTR __Tmp$217910[ebp]
	push	eax
	mov	eax, 780903145				; 2e8ba2e9H
	imul	edx
	sar	edx, 3
...
; 1232 : 			}
	...
	lea	ecx, DWORD PTR __Tmp$217910[ebp+16]
...
; 1235 : 			_Ty _Tmp = _Val;	// in case _Val is in sequence
	...
	push	eax
	lea	ecx, DWORD PTR __Tmp$217920[ebp]
	call	??0VoteSelectionSubData@@QAE@ABU0@@Z
...
; 1248 : 				_Tmp);	// insert into hole
	...
	lea	eax, DWORD PTR __Tmp$217920[ebp]
	push	eax
	mov	eax, DWORD PTR __Where$[ebp]
	add	edi, eax
	push	edi
...
; 1249 : 			}
	...
	lea	ecx, DWORD PTR __Tmp$217920[ebp+16]
$LN106@Insert_n@2:
	mov	DWORD PTR __$EHRec$[ebp+12], -1
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
$LN1@Insert_n@2:
...
; 819  : 			_Mylast = _Ufill(_Mylast, 1, _Val);
	...
	mov	edx, DWORD PTR __Cat$222768[esp+12]
	mov	eax, DWORD PTR __Val$[esp+12]
	mov	BYTE PTR $T222765[esp+16], 0
	mov	ecx, DWORD PTR $T222765[esp+16]
	push	ecx
	push	edx
	push	esi
	push	eax
...
; 823  : 			insert(end(), _Val);
	...
	push	ecx
	push	edi
	lea	edx, DWORD PTR $T222736[esp+20]
	push	edx
	mov	ecx, esi
...
; 46   : 		VoteSelectionSubData kData;
	...
	push	OFFSET ??_C@_00CNPNBAHC@?$AA@
	lea	ecx, DWORD PTR _kData$217214[esp+96]
	mov	DWORD PTR _kData$217214[esp+80], edi
	mov	DWORD PTR _kData$217214[esp+84], edi
	mov	DWORD PTR _kData$217214[esp+88], edi
	mov	DWORD PTR _kData$217214[esp+92], edi
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z

; 47   : 		kStream >> kData.eVote;

	lea	eax, DWORD PTR _kData$217214[esp+76]
	push	eax
	push	esi
...
; 48   : 		kStream >> kData.ePlayer;
	...
	lea	ecx, DWORD PTR _kData$217214[esp+88]
	push	ecx
	push	esi
	call	??5@YAAAVFDataStream@@AAV0@AAW4PlayerTypes@@@Z ; operator>>
	add	esp, 16					; 00000010H
...
; 49   : 		kStream >> kData.iCityId;
	...
	lea	edx, DWORD PTR _kData$217214[esp+84]
	push	edx
	mov	ecx, esi
	call	?Read@FDataStream@@IAEXAAH@Z		; FDataStream::Read
...
; 50   : 		kStream >> kData.eOtherPlayer;
	...
	lea	eax, DWORD PTR _kData$217214[esp+88]
	push	eax
	push	esi
	call	??5@YAAAVFDataStream@@AAV0@AAW4PlayerTypes@@@Z ; operator>>
	add	esp, 8
...
; 51   : 		kStream >> kData.strText;
	...
	lea	ecx, DWORD PTR _kData$217214[esp+92]
	push	ecx
	mov	ecx, esi
	call	?Read@FDataStream@@IAEXAAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z ; FDataStream::Read
...
; 52   : 		aVoteOptions.push_back(kData);
	...
	lea	edx, DWORD PTR _kData$217214[esp+76]
	push	edx
	mov	ecx, ebp
...
__unwindfunclet$?read@VoteSelectionData@@QAEXAAVFDataStream@@@Z$0:
	lea	ecx, DWORD PTR _kData$217214[ebp]
	jmp	??1VoteSelectionSubData@@QAE@XZ
