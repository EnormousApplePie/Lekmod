; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\Users\EnormousApplePie\Desktop\Lekmod Files\Lekmod DLL versions\v29\LEKMOD_DLL\CvGameCoreDLL_Expansion2\CvProjectProductionAI.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG217199 DB	', ', 00H
	ORG $+1
$SG217205 DB	'Unknown', 00H
$SG217206 DB	'Project, %s, %d', 00H
CONST	ENDS
...
; Function compile flags: /Ogtpy
; File c:\users\enormousapplepie\desktop\lekmod files\lekmod dll versions\v29\lekmod_dll\cvgamecoredll_expansion2\cvprojectproductionai.cpp
;	COMDAT ?Write@CvProjectProductionAI@@QBEXAAVFDataStream@@@Z
_TEXT	SEGMENT
_uiVersion$ = -12					; size = 4
_elem$218301 = -8					; size = 8
$T218289 = 8						; size = 4
_kStream$ = 8						; size = 4
...
; 79   : 		kStream << m_ProjectAIWeights.GetWeight(i);
	...
	lea	edx, DWORD PTR $T218289[esp+20]
	mov	DWORD PTR _elem$218301[esp+24], ecx
	push	edx
	mov	ecx, ebx
	mov	DWORD PTR $T218289[esp+24], eax
	call	?Write@FDataStream@@IAEXABH@Z		; FDataStream::Write
	mov	ecx, OFFSET ?gGlobals@@3VCvGlobals@@A	; gGlobals
	inc	esi
	call	?GetGameProjects@CvGlobals@@QBEPAVCvProjectXMLEntries@@XZ ; CvGlobals::GetGameProjects
...
; 108  : 	return m_ProjectAIWeights.GetWeight(eProject);
	...
	mov	edx, DWORD PTR [eax+ecx*8]
	mov	eax, DWORD PTR [eax+ecx*8+4]
	mov	DWORD PTR _elem$218337[esp+8], edx
...
_TEXT	SEGMENT
_playerName$217185 = -328				; size = 28
_strDesc$217187 = -300					; size = 28
_strBaseString$217183 = -272				; size = 28
_cityName$217186 = -244					; size = 28
_strTemp$217184 = -216					; size = 28
_strOutBuf$217182 = -188				; size = 28
$T218347 = -160						; size = 28
$T218346 = -160						; size = 28
_strLogName$217188 = -132				; size = 28
$T218353 = -104						; size = 28
$T218348 = -104						; size = 28
_elem$218526 = -76					; size = 8
$T218350 = -68						; size = 28
$T218349 = -40						; size = 28
__$EHRec$ = -12						; size = 12
...
; 162  : 		CvString strOutBuf;
	...
	lea	ecx, DWORD PTR _strOutBuf$217182[esp+336]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	xor	ebp, ebp

; 163  : 		CvString strBaseString;

	lea	ecx, DWORD PTR _strBaseString$217183[esp+336]
	mov	DWORD PTR __$EHRec$[esp+344], ebp
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ

; 164  : 		CvString strTemp;

	lea	ecx, DWORD PTR _strTemp$217184[esp+336]
	mov	BYTE PTR __$EHRec$[esp+344], 1
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ

; 165  : 		CvString playerName;

	lea	ecx, DWORD PTR _playerName$217185[esp+336]
	mov	BYTE PTR __$EHRec$[esp+344], 2
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ

; 166  : 		CvString cityName;

	lea	ecx, DWORD PTR _cityName$217186[esp+336]
	mov	BYTE PTR __$EHRec$[esp+344], 3
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ

; 167  : 		CvString strDesc;

	lea	ecx, DWORD PTR _strDesc$217187[esp+336]
	mov	BYTE PTR __$EHRec$[esp+344], 4
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ

; 168  : 		CvString strLogName;

	lea	ecx, DWORD PTR _strLogName$217188[esp+336]
...
; 175  : 		cityName = m_pCity->getName();
	...
	push	ebx
	push	edi
	lea	eax, DWORD PTR $T218346[esp+344]
	push	eax
	call	?getName@CvCity@@QBE?BVCvString@@XZ	; CvCity::getName
	push	eax
	lea	ecx, DWORD PTR _cityName$217186[esp+348]
	mov	BYTE PTR __$EHRec$[esp+356], 7
	call	DWORD PTR __imp_??4?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV01@ABV01@@Z
	lea	ecx, DWORD PTR $T218346[esp+344]
...
; 179  : 		pLog = LOGFILEMGR.GetLog(m_pCity->GetCityStrategyAI()->GetLogFileName(playerName, cityName), FILogFile::kDontTimeStamp);
	...
	lea	ecx, DWORD PTR _cityName$217186[esp+344]
	push	ecx
	mov	ecx, DWORD PTR [esi]
	lea	edx, DWORD PTR _playerName$217185[esp+348]
	mov	edi, eax
	push	edx
	lea	eax, DWORD PTR $T218347[esp+352]
	push	eax
	...
	mov	ecx, edi
	call	eax
	lea	ecx, DWORD PTR $T218347[esp+344]
	mov	ebx, eax
	mov	BYTE PTR __$EHRec$[esp+352], 6
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
...
; 184  : 		strBaseString.Format("%03d, ", GC.getGame().getElapsedGameTurns());
	...
	push	eax
	lea	ecx, DWORD PTR _strBaseString$217183[esp+348]
	push	OFFSET $SG217194
	push	ecx
...
; 185  : 		strBaseString += playerName + ", " + cityName + ", ";
	...
	lea	edx, DWORD PTR _playerName$217185[esp+360]
	push	edx
	lea	eax, DWORD PTR $T218348[esp+364]
	push	eax
	call	edi
	lea	ecx, DWORD PTR _cityName$217186[esp+368]
	push	ecx
	push	eax
	lea	edx, DWORD PTR $T218349[esp+376]
	push	edx
	mov	BYTE PTR __$EHRec$[esp+388], 9
	call	DWORD PTR __imp_??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@0@Z
	push	OFFSET $SG217198
	push	eax
	lea	eax, DWORD PTR $T218350[esp+388]
	push	eax
	...
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	lea	ecx, DWORD PTR $T218349[esp+344]
	mov	BYTE PTR __$EHRec$[esp+352], 9
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	lea	ecx, DWORD PTR $T218348[esp+344]
	mov	BYTE PTR __$EHRec$[esp+352], 6
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
...
; 192  : 			strDesc = (pProjectEntry != NULL)? pProjectEntry->GetDescription() : "Unknown";
	...
	push	eax
	lea	ecx, DWORD PTR _strDesc$217187[esp+348]
	call	DWORD PTR __imp_?assign@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV12@PBD@Z
	jmp	SHORT $LN119@LogPossibl
$LN9@LogPossibl:
	mov	eax, OFFSET $SG217205
	push	eax
	lea	ecx, DWORD PTR _strDesc$217187[esp+348]
	call	DWORD PTR __imp_?assign@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV12@PBD@Z
	jmp	SHORT $LN119@LogPossibl
$LN120@LogPossibl:
	lea	ecx, DWORD PTR _strDesc$217187[esp+344]
	call	DWORD PTR __imp_?clear@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXXZ
$LN119@LogPossibl:
...
; 193  : 			strTemp.Format("Project, %s, %d", strDesc.GetCString(), m_Buildables.GetWeight(iI));
	...
	push	eax
	lea	ecx, DWORD PTR _strDesc$217187[esp+348]
	mov	DWORD PTR _elem$218526[esp+348], edx
	call	DWORD PTR __imp_?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ
	push	eax
	lea	eax, DWORD PTR _strTemp$217184[esp+352]
	push	OFFSET $SG217206
	push	eax
	call	?Format@CvString@@QAAXPBDZZ		; CvString::Format

; 194  : 			strOutBuf = strBaseString + strTemp;

	lea	ecx, DWORD PTR _strTemp$217184[esp+360]
	push	ecx
	lea	edx, DWORD PTR _strBaseString$217183[esp+364]
	push	edx
	lea	eax, DWORD PTR $T218353[esp+368]
	push	eax
	call	DWORD PTR __imp_??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@0@Z
	...
	call	DWORD PTR __imp_?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ
	push	eax
	lea	ecx, DWORD PTR _strOutBuf$217182[esp+348]
	call	DWORD PTR __imp_?assign@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV12@PBD@Z
...
; 195  : 			pLog->Msg(strOutBuf);
	...
	lea	ecx, DWORD PTR _strOutBuf$217182[esp+344]
	call	DWORD PTR __imp_?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ
...
; 197  : 	}
	...
	lea	ecx, DWORD PTR _strLogName$217188[esp+344]
	...
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	lea	ecx, DWORD PTR _playerName$217185[esp+344]
	mov	BYTE PTR __$EHRec$[esp+352], 2
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	lea	ecx, DWORD PTR _strTemp$217184[esp+344]
	mov	BYTE PTR __$EHRec$[esp+352], 1
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	lea	ecx, DWORD PTR _strBaseString$217183[esp+344]
...
_TEXT	SEGMENT
__Tmp$218966 = -24					; size = 8
__Tmp$218895 = -16					; size = 8
__Tmp$218921 = -8					; size = 8
___$ReturnUdt$ = 8					; size = 4
__First$ = 12						; size = 4
__Last$ = 16						; size = 4
...
; 3050 : 				std::iter_swap(_Plast++, _Gfirst);
	...
	mov	edi, DWORD PTR [edx]
	mov	DWORD PTR __Tmp$218895[esp+44], ebp
	mov	ebp, DWORD PTR [eax]
	mov	DWORD PTR [edx], ebp
	mov	ebp, DWORD PTR [eax+4]
	mov	DWORD PTR [edx+4], ebp
	mov	edx, DWORD PTR __Tmp$218895[esp+44]
	mov	DWORD PTR [eax], edi
	mov	DWORD PTR [eax+4], edx
$LN20@Unguarded_:
	add	eax, 8
...
; 3057 : 				std::iter_swap(--_Pfirst, _Glast - 1);
	...
	mov	ebp, DWORD PTR [ecx+4]
	mov	edi, DWORD PTR [ecx]
	mov	DWORD PTR __Tmp$218921[esp+44], ebp
	mov	ebp, DWORD PTR [edx]
	mov	DWORD PTR [ecx], ebp
	mov	ebp, DWORD PTR [edx+4]
	mov	DWORD PTR [ecx+4], ebp
	mov	DWORD PTR [edx], edi
	mov	edi, DWORD PTR __Tmp$218921[esp+44]
	mov	DWORD PTR [edx+4], edi
$LN13@Unguarded_:
	sub	ebx, 8
	sub	edx, 8
...
; 3066 : 			std::iter_swap(_Pfirst++, _Gfirst++);
	...
	mov	DWORD PTR __Tmp$218966[esp+40], ebp
	mov	ebp, DWORD PTR [edi+4]
	mov	DWORD PTR __Tmp$218966[esp+44], ebp
	mov	ebp, DWORD PTR [edx]
	mov	DWORD PTR [edi], ebp
	mov	ebp, DWORD PTR [edx+4]
	mov	DWORD PTR [edi+4], ebp
	mov	edi, DWORD PTR __Tmp$218966[esp+40]
	mov	DWORD PTR [edx], edi
	mov	edi, DWORD PTR __Tmp$218966[esp+44]
	mov	DWORD PTR [edx+4], edi
	jmp	$LL23@Unguarded_
$LN6@Unguarded_:
...
; 3087 : 			std::_Unguarded_partition(_First, _Last);
	...
	push	edi
	lea	eax, DWORD PTR __Mid$217356[esp+28]
	push	ebx
	push	eax
...
; 3090 : 		if (_Mid.first - _First < _Last - _Mid.second)
	...
	mov	ebp, DWORD PTR __Mid$217356[esp+40]
	mov	eax, esi
	cdq
	sub	eax, edx
	sar	eax, 1
	...
	sar	eax, 1
	add	esi, eax
	mov	eax, DWORD PTR __Mid$217356[esp+36]
	mov	ecx, edi
	mov	edx, eax
	sub	ecx, ebp
	sub	edx, ebx
...
; 3098 : 			_Last = _Mid.first;
	...
	mov	edi, DWORD PTR __Mid$217356[esp+36]
$LN26@Sort:
	mov	eax, edi
	sub	eax, ebx
	sar	eax, 3
...
; 137  : 			iWeight = CityStrategyAIHelpers::ReweightByTurnsLeft(m_ProjectAIWeights.GetWeight((ProjectTypes)iProjectLoop), iTurnsLeft);
	...
	push	eax
	push	ecx
	mov	DWORD PTR _elem$219672[esp+32], edx
