; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\Users\EnormousApplePie\Desktop\Lekmod Files\Lekmod DLL versions\v29\LEKMOD_DLL\CvGameCoreDLL_Expansion2\CvProcessProductionAI.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG217597 DB	', ', 00H
	ORG $+1
$SG217604 DB	'Unknown', 00H
$SG217605 DB	'Process, %s, %d', 00H
CONST	ENDS
...
; Function compile flags: /Ogtpy
; File c:\users\enormousapplepie\desktop\lekmod files\lekmod dll versions\v29\lekmod_dll\cvgamecoredll_expansion2\cvprocessproductionai.cpp
;	COMDAT ?Write@CvProcessProductionAI@@QBEXAAVFDataStream@@@Z
_TEXT	SEGMENT
_uiVersion$ = -12					; size = 4
_elem$218094 = -8					; size = 8
$T218079 = 8						; size = 4
$T218078 = 8						; size = 4
_kStream$ = 8						; size = 4
...
; 81   : 	kStream << GC.getNumProcessInfos();
	...
	lea	ecx, DWORD PTR $T218078[esp+20]
	push	ecx
	mov	ecx, edi
	mov	DWORD PTR $T218078[esp+24], eax
	call	?Write@FDataStream@@IAEXABH@Z		; FDataStream::Write
...
; 89   : 		kStream << m_ProcessAIWeights.GetWeight(i);
	...
	mov	DWORD PTR $T218079[esp+28], eax
	add	esp, 8
	lea	eax, DWORD PTR $T218079[esp+20]
	push	eax
	mov	ecx, edi
	mov	DWORD PTR _elem$218094[esp+28], edx
	call	?Write@FDataStream@@IAEXABH@Z		; FDataStream::Write
	mov	ecx, OFFSET ?gGlobals@@3VCvGlobals@@A	; gGlobals
	inc	esi
	call	?getNumProcessInfos@CvGlobals@@QAEHXZ	; CvGlobals::getNumProcessInfos
...
; 118  : 	return m_ProcessAIWeights.GetWeight(eProject);
	...
	mov	edx, DWORD PTR [eax+ecx*8]
	mov	eax, DWORD PTR [eax+ecx*8+4]
	mov	DWORD PTR _elem$218135[esp+8], edx
...
_TEXT	SEGMENT
_playerName$217583 = -328				; size = 28
_strDesc$217585 = -300					; size = 28
_strBaseString$217581 = -272				; size = 28
_cityName$217584 = -244					; size = 28
_strTemp$217582 = -216					; size = 28
_strOutBuf$217580 = -188				; size = 28
$T218140 = -160						; size = 28
$T218139 = -160						; size = 28
_strLogName$217586 = -132				; size = 28
$T218146 = -104						; size = 28
$T218141 = -104						; size = 28
_elem$218324 = -76					; size = 8
$T218143 = -68						; size = 28
$T218142 = -40						; size = 28
__$EHRec$ = -12						; size = 12
...
; 127  : 		CvString strOutBuf;
	...
	lea	ecx, DWORD PTR _strOutBuf$217580[esp+336]
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	xor	ebp, ebp

; 128  : 		CvString strBaseString;

	lea	ecx, DWORD PTR _strBaseString$217581[esp+336]
	mov	DWORD PTR __$EHRec$[esp+344], ebp
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ

; 129  : 		CvString strTemp;

	lea	ecx, DWORD PTR _strTemp$217582[esp+336]
	mov	BYTE PTR __$EHRec$[esp+344], 1
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ

; 130  : 		CvString playerName;

	lea	ecx, DWORD PTR _playerName$217583[esp+336]
	mov	BYTE PTR __$EHRec$[esp+344], 2
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ

; 131  : 		CvString cityName;

	lea	ecx, DWORD PTR _cityName$217584[esp+336]
	mov	BYTE PTR __$EHRec$[esp+344], 3
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ

; 132  : 		CvString strDesc;

	lea	ecx, DWORD PTR _strDesc$217585[esp+336]
	mov	BYTE PTR __$EHRec$[esp+344], 4
	call	DWORD PTR __imp_??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ

; 133  : 		CvString strLogName;

	lea	ecx, DWORD PTR _strLogName$217586[esp+336]
...
; 140  : 		cityName = m_pCity->getName();
	...
	push	ebx
	push	edi
	lea	eax, DWORD PTR $T218139[esp+344]
	push	eax
	call	?getName@CvCity@@QBE?BVCvString@@XZ	; CvCity::getName
	push	eax
	lea	ecx, DWORD PTR _cityName$217584[esp+348]
	mov	BYTE PTR __$EHRec$[esp+356], 7
	call	DWORD PTR __imp_??4?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV01@ABV01@@Z
	lea	ecx, DWORD PTR $T218139[esp+344]
...
; 144  : 		pLog = LOGFILEMGR.GetLog(m_pCity->GetCityStrategyAI()->GetLogFileName(playerName, cityName), FILogFile::kDontTimeStamp);
	...
	lea	ecx, DWORD PTR _cityName$217584[esp+344]
	push	ecx
	mov	ecx, DWORD PTR [esi]
	lea	edx, DWORD PTR _playerName$217583[esp+348]
	mov	edi, eax
	push	edx
	lea	eax, DWORD PTR $T218140[esp+352]
	push	eax
	...
	mov	ecx, edi
	call	eax
	lea	ecx, DWORD PTR $T218140[esp+344]
	mov	ebx, eax
	mov	BYTE PTR __$EHRec$[esp+352], 6
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
...
; 149  : 		strBaseString.Format("%03d, ", GC.getGame().getElapsedGameTurns());
	...
	push	eax
	lea	ecx, DWORD PTR _strBaseString$217581[esp+348]
...
; 150  : 		strBaseString += playerName + ", " + cityName + ", ";
	...
	lea	edx, DWORD PTR _playerName$217583[esp+360]
	push	edx
	lea	eax, DWORD PTR $T218141[esp+364]
	push	eax
	call	edi
	lea	ecx, DWORD PTR _cityName$217584[esp+368]
	push	ecx
	push	eax
	lea	edx, DWORD PTR $T218142[esp+376]
	push	edx
	mov	BYTE PTR __$EHRec$[esp+388], 9
	call	DWORD PTR __imp_??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@0@Z
	push	OFFSET $SG217596
	push	eax
	lea	eax, DWORD PTR $T218143[esp+388]
	push	eax
	...
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	lea	ecx, DWORD PTR $T218142[esp+344]
	mov	BYTE PTR __$EHRec$[esp+352], 9
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	lea	ecx, DWORD PTR $T218141[esp+344]
	mov	BYTE PTR __$EHRec$[esp+352], 6
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
...
; 156  : 			strDesc = (pProcessInfo != NULL)? pProcessInfo->GetDescription() : "Unknown";
	...
	push	eax
	lea	ecx, DWORD PTR _strDesc$217585[esp+348]
	call	DWORD PTR __imp_?assign@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV12@PBD@Z
	jmp	SHORT $LN119@LogPossibl
$LN9@LogPossibl:
	mov	eax, OFFSET $SG217604
	push	eax
	lea	ecx, DWORD PTR _strDesc$217585[esp+348]
	call	DWORD PTR __imp_?assign@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV12@PBD@Z
	jmp	SHORT $LN119@LogPossibl
$LN120@LogPossibl:
	lea	ecx, DWORD PTR _strDesc$217585[esp+344]
	call	DWORD PTR __imp_?clear@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXXZ
$LN119@LogPossibl:
...
; 157  : 			strTemp.Format("Process, %s, %d", strDesc.GetCString(), m_Buildables.GetWeight(iI));
	...
	push	eax
	lea	ecx, DWORD PTR _strDesc$217585[esp+348]
	mov	DWORD PTR _elem$218324[esp+348], edx
	call	DWORD PTR __imp_?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ
	push	eax
	lea	eax, DWORD PTR _strTemp$217582[esp+352]
...
; 158  : 			strOutBuf = strBaseString + strTemp;
	...
	lea	ecx, DWORD PTR _strTemp$217582[esp+360]
	push	ecx
	lea	edx, DWORD PTR _strBaseString$217581[esp+364]
	push	edx
	lea	eax, DWORD PTR $T218146[esp+368]
	push	eax
	call	DWORD PTR __imp_??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@0@Z
	...
	call	DWORD PTR __imp_?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ
	push	eax
	lea	ecx, DWORD PTR _strOutBuf$217580[esp+348]
	call	DWORD PTR __imp_?assign@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV12@PBD@Z
...
; 159  : 			pLog->Msg(strOutBuf);
	...
	lea	ecx, DWORD PTR _strOutBuf$217580[esp+344]
	call	DWORD PTR __imp_?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ
...
; 161  : 	}
	...
	lea	ecx, DWORD PTR _strLogName$217586[esp+344]
	...
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	lea	ecx, DWORD PTR _playerName$217583[esp+344]
	mov	BYTE PTR __$EHRec$[esp+352], 2
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	lea	ecx, DWORD PTR _strTemp$217582[esp+344]
	mov	BYTE PTR __$EHRec$[esp+352], 1
	call	DWORD PTR __imp_??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	lea	ecx, DWORD PTR _strBaseString$217581[esp+344]
...
; 64   : 	for(int i = 0; i < iNumProcess; i++)
	...
	mov	DWORD PTR _i$217542[esp+24], 0
	jle	SHORT $LN2@Read
$LL47@Read:
...
$LN3@Read:
	mov	eax, DWORD PTR _i$217542[esp+24]
	inc	eax
	cmp	eax, DWORD PTR _iNumProcess$[esp+28]
	mov	DWORD PTR _i$217542[esp+24], eax
	jl	SHORT $LL47@Read
$LN2@Read:
	pop	edi
	pop	esi
