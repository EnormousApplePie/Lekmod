; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\Users\EnormousApplePie\Desktop\Lekmod Files\Lekmod DLL versions\v29\LEKMOD_DLL\CvGameCoreDLL_Expansion2\CvDllPlayer.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	ENDS
_DATA	SEGMENT
_CIV5_XP2_DLL_VERSION DD FLAT:$SG217249
_DATA	ENDS
CONST	SEGMENT
$SG217249 DB	'1.0.0', 00H
	ORG $+2
...
; Function compile flags: /Ogtpy
; File c:\users\enormousapplepie\desktop\lekmod files\lekmod dll versions\v29\lekmod_dll\cvgamecoredll_expansion2\cvdllplayer.cpp
...
; 147  : 	return (NULL != pkUnit)? new CvDllUnit(const_cast<CvUnit*>(pkUnit)) : NULL;
	...
	add	esp, 4
	mov	DWORD PTR $T221073[esp+12], eax
...
__unwindfunclet$?GetFirstReadyUnit@CvDllPlayer@@UAGPAVICvUnit1@@XZ$0:
	mov	eax, DWORD PTR $T221073[ebp-4]
	push	eax
...
; 174  : 	return (NULL != pkCity)? new CvDllCity(pkCity) : NULL;
	...
	add	esp, 4
	mov	DWORD PTR $T221135[esp+12], eax
	mov	DWORD PTR __$EHRec$[esp+24], 0
	test	eax, eax
	je	SHORT $LN5@GetCapital
	push	esi
...
__unwindfunclet$?GetCapitalCity@CvDllPlayer@@UAGPAVICvCity1@@XZ$0:
	mov	eax, DWORD PTR $T221135[ebp-4]
	push	eax
...
; 270  : 	return (NULL != pkCity)? new CvDllCity(pkCity) : NULL;
	...
	call	??2CvDllCity@@SAPAXI@Z			; CvDllCity::operator new
	add	esp, 4
	mov	DWORD PTR $T221193[esp+12], eax
	mov	DWORD PTR __$EHRec$[esp+24], 0
	test	eax, eax
	je	SHORT $LN5@FirstCity
	push	esi
...
__unwindfunclet$?FirstCity@CvDllPlayer@@UAGPAVICvCity1@@PAH_N@Z$0:
	mov	eax, DWORD PTR $T221193[ebp-4]
	push	eax
	call	??3CvDllCity@@SAXPAX@Z			; CvDllCity::operator delete
	pop	ecx
	ret	0
...
; 276  : 	return (NULL != pkCity)? new CvDllCity(pkCity) : NULL;
	...
	call	??2CvDllCity@@SAPAXI@Z			; CvDllCity::operator new
	add	esp, 4
	mov	DWORD PTR $T221209[esp+12], eax
	mov	DWORD PTR __$EHRec$[esp+24], 0
	test	eax, eax
	je	SHORT $LN5@NextCity
	push	esi
...
__unwindfunclet$?NextCity@CvDllPlayer@@UAGPAVICvCity1@@PAH_N@Z$0:
	mov	eax, DWORD PTR $T221209[ebp-4]
	push	eax
	call	??3CvDllCity@@SAXPAX@Z			; CvDllCity::operator delete
	pop	ecx
	ret	0
...
; 287  : 	return (NULL != pkCity)? new CvDllCity(pkCity) : NULL;
	...
	call	??2CvDllCity@@SAPAXI@Z			; CvDllCity::operator new
	add	esp, 4
	mov	DWORD PTR $T221228[esp+12], eax
	mov	DWORD PTR __$EHRec$[esp+24], 0
	test	eax, eax
	je	SHORT $LN5@GetCity
	push	esi
...
__unwindfunclet$?GetCity@CvDllPlayer@@UAGPAVICvCity1@@H@Z$0:
	mov	eax, DWORD PTR $T221228[ebp-4]
	push	eax
	call	??3CvDllCity@@SAXPAX@Z			; CvDllCity::operator delete
	pop	ecx
	ret	0
...
; 295  : 		return new CvDllUnit(pkUnit);
	...
	call	??2CvDllUnit@@SAPAXI@Z			; CvDllUnit::operator new
	add	esp, 4
	mov	DWORD PTR $T221244[esp+12], eax
	mov	DWORD PTR __$EHRec$[esp+24], 0
	test	eax, eax
	je	SHORT $LN1@GetUnit
	push	esi
...
__unwindfunclet$?GetUnit@CvDllPlayer@@UAGPAVICvUnit1@@H@Z$0:
	mov	eax, DWORD PTR $T221244[ebp-4]
	push	eax
	call	??3CvDllUnit@@SAXPAX@Z			; CvDllUnit::operator delete
	pop	ecx
	ret	0
...
; 304  : 	return (NULL != pkUnit)? new CvDllUnit(pkUnit) : NULL;
	...
	call	??2CvDllUnit@@SAPAXI@Z			; CvDllUnit::operator new
	add	esp, 4
	mov	DWORD PTR $T221258[esp+12], eax
	mov	DWORD PTR __$EHRec$[esp+24], 0
	test	eax, eax
	je	SHORT $LN5@FirstUnit
	push	esi
...
__unwindfunclet$?FirstUnit@CvDllPlayer@@UAGPAVICvUnit1@@PAH_N@Z$0:
	mov	eax, DWORD PTR $T221258[ebp-4]
	push	eax
	call	??3CvDllUnit@@SAXPAX@Z			; CvDllUnit::operator delete
	pop	ecx
	ret	0
...
; 395  : 	return (NULL != pAI)? new CvDllDiplomacyAI(pAI) : NULL;
	...
	add	esp, 4
	mov	DWORD PTR $T221330[esp+12], eax
	mov	DWORD PTR __$EHRec$[esp+24], 0
	test	eax, eax
	je	SHORT $LN5@GetDiploma
	push	esi
...
__unwindfunclet$?GetDiplomacyAI@CvDllPlayer@@UAGPAVICvDiplomacyAI1@@XZ$0:
	mov	eax, DWORD PTR $T221330[ebp-4]
	push	eax
...
; 401  : 	return (NULL != pAI)? new CvDllDealAI(pAI) : NULL;
	...
	add	esp, 4
	mov	DWORD PTR $T221346[esp+12], eax
	mov	DWORD PTR __$EHRec$[esp+24], 0
	test	eax, eax
	je	SHORT $LN5@GetDealAI
	push	esi
...
__unwindfunclet$?GetDealAI@CvDllPlayer@@UAGPAVICvDealAI1@@XZ$0:
	mov	eax, DWORD PTR $T221346[ebp-4]
	push	eax
...
; 306  : 	static GUID DLLCALL GetInterfaceId(){ return guidICvUnknown; }
	...
	mov	eax, DWORD PTR $T221392[esp-4]
...
; 44   : 		guidInterface == ICvPlayer3::GetInterfaceId())
	...
	mov	DWORD PTR $T221443[esp+20], ecx
	lea	ecx, DWORD PTR $T221443[esp+16]
	mov	DWORD PTR $T221443[esp+24], edx
	mov	DWORD PTR $T221443[esp+16], eax
	mov	eax, DWORD PTR _guidICvUnknown+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T221443[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
	jne	$LN1@QueryInter
	...
	mov	DWORD PTR $T221445[esp+20], ecx
	lea	ecx, DWORD PTR $T221445[esp+16]
	mov	DWORD PTR $T221445[esp+24], edx
	mov	DWORD PTR $T221445[esp+16], eax
	mov	eax, DWORD PTR _guidICvPlayer1+12
	push	ecx
	lea	edx, DWORD PTR _guidInterface$[esp+16]
	push	edx
	mov	DWORD PTR $T221445[esp+36], eax
	call	_IsEqualGUID
	add	esp, 8
	test	eax, eax
