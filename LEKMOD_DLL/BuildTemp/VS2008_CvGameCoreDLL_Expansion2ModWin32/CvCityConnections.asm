...
; 131  : 	kStream << m_aiCityPlotIDs.size();
	...
	lea	ecx, DWORD PTR $T222222[esp+16]
	push	ecx
	mov	ecx, edi
	mov	DWORD PTR $T222222[esp+20], eax
	call	?Write@FDataStream@@IAEXABI@Z		; FDataStream::Write
...
; 657  : 	m_aRouteInfos = new RouteInfo[uiNewSize * uiNewSize];
	...
	mov	ebx, eax
	add	esp, 4
	mov	DWORD PTR $T222372[esp+24], ebx
	xor	eax, eax
...
__unwindfunclet$?ResizeRouteInfo@CvCityConnections@@IAEXI@Z$0:
	mov	eax, DWORD PTR $T222372[ebp-4]
	push	eax
	call	??_V@YAXPAX@Z				; operator delete[]
	pop	ecx
	ret	0
...
; 112  : 		kStream >> iValue;
	...
	lea	eax, DWORD PTR _iValue$221224[esp+24]
	push	eax
	mov	ecx, ebp
	call	?Read@FDataStream@@IAEXAAH@Z		; FDataStream::Read
...
$LN29@Read:
	...
	test	eax, eax
	je	SHORT $LN32@Read
	mov	ecx, DWORD PTR _iValue$221224[esp+24]
	mov	DWORD PTR [eax], ecx
$LN32@Read:
	inc	DWORD PTR [esi+4]
	inc	edi
...
; 160  : 	for(uint ui = 0; ui < MAX_CIV_PLAYERS; ui++)
	...
	mov	DWORD PTR _ui$221251[esp+28], ebx
	xor	ebp, ebp
	npad	8
$LL11@UpdateCity:
...
$LN7@UpdateCity:
	mov	eax, DWORD PTR _ui$221251[esp+28]
	push	eax
	mov	ecx, edi
...
; 160  : 	for(uint ui = 0; ui < MAX_CIV_PLAYERS; ui++)
	...
	inc	DWORD PTR _ui$221251[esp+28]
...
; 641  : 		m_aPlotRouteInfos.push_back(info);
	...
	or	ebx, -1
	mov	edi, ecx
	mov	BYTE PTR _info$221626[esp+28], 0
	mov	BYTE PTR [esi+812], 0
	cmp	DWORD PTR [esi+4], eax
...
$LN22@ConnectPlo:
	...
	mov	edx, DWORD PTR _info$221626[esp+28]
...
_TEXT	SEGMENT
_bAnyRouteFound$221514 = -330				; size = 1
_bFirstCityHasHarbor$221501 = -330			; size = 1
_bAllowWaterRoutes$ = -329				; size = 1
tv1253 = -328						; size = 2
_bSecondCityHasHarbor$221502 = -328			; size = 1
_pSecondCity$221480 = -328				; size = 4
_pNode$221528 = -324					; size = 4
_pRouteInfo$221493 = -324				; size = 4
tv1251 = -320						; size = 4
_iPass$221472 = -320					; size = 4
_pFirstCity$221479 = -316				; size = 4
_uiFirstCityIndex$221482 = -312				; size = 4
_ui$221447 = -312					; size = 4
tv1249 = -308						; size = 4
_uiSecondCityIndex$221487 = -308			; size = 4
_eBestRouteType$ = -304					; size = 4
_pkLandRouteFinder$221481 = -300			; size = 4
tv1255 = -296						; size = 4
tv1247 = -296						; size = 8
_iFirstCityArrayIndex$221486 = -296			; size = 4
_iLoop$ = -288						; size = 4
...
; 237  : 	for(uint ui = 0; ui < MAX_CIV_PLAYERS; ui++)
	...
	mov	DWORD PTR _ui$221447[esp+348], esi
...
; 237  : 	for(uint ui = 0; ui < MAX_CIV_PLAYERS; ui++)
	...
	mov	ecx, DWORD PTR tv1251[esp+348]
	mov	esi, DWORD PTR _ui$221447[esp+348]
...
; 292  : 	for(int iPass = 0; iPass < 2; iPass++)
	...
	xor	eax, eax
	mov	DWORD PTR _iPass$221472[esp+348], eax
	jmp	SHORT $LN39@UpdateRout
	npad	4
$LL272@UpdateRout:
	mov	eax, DWORD PTR _iPass$221472[esp+348]
$LN39@UpdateRout:
...
; 310  : 		for(uint uiFirstCityIndex = 0; uiFirstCityIndex < vpCities.size(); uiFirstCityIndex++)
	...
	xor	esi, esi
	mov	DWORD PTR _pkLandRouteFinder$221481[esp+348], eax
	mov	DWORD PTR _uiFirstCityIndex$221482[esp+348], esi
...
; 313  : 			int iFirstCityArrayIndex = GetIndexFromCity(pFirstCity);
	...
	push	eax
	mov	ecx, ebx
	mov	DWORD PTR _pFirstCity$221479[esp+352], eax
...
; 315  : 			for(uint uiSecondCityIndex = 0; uiSecondCityIndex < vpCities.size(); uiSecondCityIndex++)
	...
	mov	edi, eax
	xor	eax, eax
	mov	DWORD PTR _iFirstCityArrayIndex$221486[esp+348], edi
	mov	DWORD PTR _uiSecondCityIndex$221487[esp+348], eax
	test	ecx, ecx
	jbe	$LN32@UpdateRout
	jmp	SHORT $LN30@UpdateRout
	npad	3
$LL274@UpdateRout:
	mov	edi, DWORD PTR _iFirstCityArrayIndex$221486[esp+348]
$LN30@UpdateRout:
...
; 323  : 				int iSecondCityArrayIndex = GetIndexFromCity(pSecondCity);
	...
	push	ebp
	mov	ecx, ebx
	mov	DWORD PTR _pSecondCity$221480[esp+352], ebp
	call	?GetIndexFromCity@CvCityConnections@@QAEIPAVCvCity@@@Z ; CvCityConnections::GetIndexFromCity
...
$LN119@UpdateRout:
	xor	esi, esi
$LN283@UpdateRout:
	mov	DWORD PTR _pRouteInfo$221493[esp+348], esi
...
; 335  : 				if(pInverseRouteInfo->m_cPassEval > iPass)
	...
	mov	ecx, DWORD PTR _iPass$221472[esp+348]
	movsx	edi, dl
	cmp	edi, ecx
...
; 353  : 					if(pFirstCity->IsBlockaded() || pSecondCity->IsBlockaded())
	...
	mov	ecx, DWORD PTR _pFirstCity$221479[esp+348]
...
; 362  : 					for(int i = 0; i < (int)m_aBuildingsAllowWaterRoutes.size(); i++)
	...
	mov	BYTE PTR _bFirstCityHasHarbor$221501[esp+348], al
	mov	BYTE PTR _bSecondCityHasHarbor$221502[esp+348], al
	jle	$LN29@UpdateRout
$LL20@UpdateRout:
	mov	eax, DWORD PTR [ebx+284]
...
; 366  : 							bFirstCityHasHarbor = true;
	...
	mov	BYTE PTR _bFirstCityHasHarbor$221501[esp+348], 1
$LN17@UpdateRout:
...
; 371  : 							bSecondCityHasHarbor = true;
	...
	mov	BYTE PTR _bSecondCityHasHarbor$221502[esp+348], 1
$LN19@UpdateRout:
...
; 375  : 					if(bFirstCityHasHarbor && bSecondCityHasHarbor)
	...
	cmp	BYTE PTR _bFirstCityHasHarbor$221501[esp+348], 0
	je	$LN29@UpdateRout
	cmp	BYTE PTR _bSecondCityHasHarbor$221502[esp+348], 0
	je	$LN29@UpdateRout
...
; 377  : 						if(GC.GetWaterRouteFinder().GeneratePath(pFirstCity->getX(), pFirstCity->getY(), pSecondCity->getX(), pSecondCity->getY(), m_pPlayer->GetID(), true))
	...
	mov	edi, DWORD PTR _pFirstCity$221479[esp+348]
...
; 379  : 							pRouteInfo->m_cRouteState |= HAS_ANY_ROUTE | HAS_WATER_ROUTE;
	...
	mov	eax, DWORD PTR _pRouteInfo$221493[esp+348]
	or	BYTE PTR [eax], 3
...
; 392  : 					if(pkLandRouteFinder->GeneratePath(pFirstCity->getX(), pFirstCity->getY(), pSecondCity->getX(), pSecondCity->getY(), iPathfinderFlags | m_pPlayer->GetID(), true))
	...
	mov	esi, DWORD PTR _pSecondCity$221480[esp+348]
	mov	edx, DWORD PTR [esi+108]
	mov	esi, DWORD PTR [esi+96]
	mov	ebp, DWORD PTR _pFirstCity$221479[esp+348]
	...
	or	ecx, eax
	push	ecx
	mov	ecx, DWORD PTR _pkLandRouteFinder$221481[esp+356]
	push	edx
	push	esi
	push	edi
	push	ebp
	mov	BYTE PTR _bAnyRouteFound$221514[esp+372], 0
	call	?GeneratePath@CvAStar@@QAE_NHHHHH_N@Z	; CvAStar::GeneratePath
	test	al, al
...
; 408  : 						pRouteInfo->m_cRouteState |= HAS_BEST_ROUTE | HAS_ANY_ROUTE;
	...
	mov	eax, DWORD PTR _pRouteInfo$221493[esp+348]
	or	BYTE PTR [eax], 5
	mov	BYTE PTR _bAnyRouteFound$221514[esp+348], 1
...
; 400  : 						if(pkLandRouteFinder->GeneratePath(pFirstCity->getX(), pFirstCity->getY(), pSecondCity->getX(), pSecondCity->getY(), MOVE_ANY_ROUTE | m_pPlayer->GetID(), true))
	...
	mov	edx, DWORD PTR [ebx]
	mov	eax, DWORD PTR [edx+44]
	mov	edx, DWORD PTR _pSecondCity$221480[esp+348]
	mov	ecx, DWORD PTR [edx+108]
	...
	push	eax
	push	ecx
	mov	ecx, DWORD PTR _pkLandRouteFinder$221481[esp+360]
	push	edx
	push	esi
	push	edi
	call	?GeneratePath@CvAStar@@QAE_NHHHHH_N@Z	; CvAStar::GeneratePath
...
; 416  : 					if(pFirstCity->isCapital() || pSecondCity->isCapital())
	...
	mov	ecx, DWORD PTR _pSecondCity$221480[esp+348]
	call	?isCapital@CvCity@@QBE_NXZ		; CvCity::isCapital
	test	al, al
	je	$LN29@UpdateRout
$LN4@UpdateRout:
...
; 418  : 						if(bAnyRouteFound)
	...
	cmp	BYTE PTR _bAnyRouteFound$221514[esp+348], 0
	je	$LN29@UpdateRout
...
; 421  : 							CvAStarNode* pNode = pkLandRouteFinder->GetLastNode();
	...
	mov	eax, DWORD PTR _pkLandRouteFinder$221481[esp+348]
	mov	esi, DWORD PTR [eax+96]
	mov	DWORD PTR _pNode$221528[esp+348], esi
...
$LN221@UpdateRout:
	...
	mov	edx, DWORD PTR ?gGlobals@@3VCvGlobals@@A+52
	add	ecx, esi
	mov	esi, DWORD PTR _pNode$221528[esp+348]
...
; 430  : 							pSecondCity->SetRouteToCapitalConnected(true);
	...
	call	?SetRouteToCapitalConnected@CvCity@@QAEX_N@Z ; CvCity::SetRouteToCapitalConnected
$LN29@UpdateRout:
	mov	eax, DWORD PTR _uiSecondCityIndex$221487[esp+348]
	mov	ecx, DWORD PTR _vpCities$[esp+352]
	mov	esi, DWORD PTR _uiFirstCityIndex$221482[esp+348]
	inc	eax
	mov	DWORD PTR _uiSecondCityIndex$221487[esp+348], eax
	cmp	eax, ecx
	jb	$LL274@UpdateRout
