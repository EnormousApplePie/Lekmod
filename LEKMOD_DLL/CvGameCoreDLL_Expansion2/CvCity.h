...
public:
	...
	int getCurrentProductionDifference(bool bDisregardIsFoodProduction, bool bOverflow) const;
	...
	int getCurrentProductionDifferenceTimes100(bool bDisregardIsFoodProduction, bool bOverflow) const;
