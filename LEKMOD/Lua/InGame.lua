...
-----------------------------------------------------------------------------------------
-- Lekmod: Load LUA files
-----------------------------------------------------------------------------------------
--
ContextPtr:LoadNewContext("ChooseLegacyPopup")
-- From NQ
ContextPtr:LoadNewContext("Exploration1_Colonialism")
ContextPtr:LoadNewContext("Exploration5_TreasureFleets")

-- General Lekmod files
ContextPtr:LoadNewContext("prophetreplace")
ContextPtr:LoadNewContext("Lekmod_global_dummies")
ContextPtr:LoadNewContext("Lekmod_utilities")
...
-- Lekmod Civilization
ContextPtr:LoadNewContext("Lekmod_tonga")
ContextPtr:LoadNewContext("Lekmod_philippines")
ContextPtr:LoadNewContext("Lekmod_nabatea")
--ContextPtr:LoadNewContext("MC_NabateaAddin")
ContextPtr:LoadNewContext("Lekmod_moors")
ContextPtr:LoadNewContext("Lekmod_uae")
ContextPtr:LoadNewContext("Lekmod_oman")
ContextPtr:LoadNewContext("Lekmod_cuba")
ContextPtr:LoadNewContext("Lekmod_bolivia")
ContextPtr:LoadNewContext("Lekmod_mongolia")
ContextPtr:LoadNewContext("Lekmod_romania")
ContextPtr:LoadNewContext("Lekmod_maori")
ContextPtr:LoadNewContext("Lekmod_newzealand")
ContextPtr:LoadNewContext("Lekmod_aksum")
ContextPtr:LoadNewContext("Lekmod_kilwa")
ContextPtr:LoadNewContext("Lekmod_ottomans")
ContextPtr:LoadNewContext("Lekmod_venice")
ContextPtr:LoadNewContext("Lekmod_palmyra")
ContextPtr:LoadNewContext("Lekmod_akkad")
ContextPtr:LoadNewContext("Lekmod_yugoslavia")
ContextPtr:LoadNewContext("Lekmod_switzerland")
ContextPtr:LoadNewContext("Lekmod_italy")
ContextPtr:LoadNewContext("Lekmod_phoenicia")
...
ContextPtr:LoadNewContext("Lekmod_arabia")
ContextPtr:LoadNewContext("Lekmod_mughals")
ContextPtr:LoadNewContext("Lekmod_macedonia")
