...
function OnEndTurnClicked()
	...
	if (blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_POLICY
		...
		or blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_CHOOSE_IDEOLOGY
		or blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_CHOOSE_LEGACY) then
...
function OnEndTurnDirty()
	...
	elseif (EndTurnBlockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_CHOOSE_IDEOLOGY) then
		...
		buttonDisabled = false;
		iFlashingState = FLASHING_END_TURN;
	elseif (EndTurnBlockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_CHOOSE_LEGACY) then
		strEndTurnMessage = "TXT_KEY_CHOOSE_LEGACY";
		buttonDisabled = false;
		iFlashingState = FLASHING_END_TURN;
	else
