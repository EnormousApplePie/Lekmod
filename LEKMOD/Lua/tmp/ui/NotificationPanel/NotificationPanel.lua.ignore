...
Controls["ChooseLegacyButton"]:RegisterCallback(Mouse.eRClick, GenericRightClick);
...
g_NameTable[ NotificationTypes.NOTIFICATION_CHOOSE_LEGACY ] = "ChooseLegacy";
g_NameTable[ NotificationTypes.NOTIFICATION_LEGACY_CHOSEN ] = "LegacyChosen";
------------------------------------------------------------------------------------
------------------------------------------------------------------------------------
...
function OnNotificationAdded( Id, type, toolTip, strSummary, iGameValue, iExtraGameData, ePlayer )
    ...
    if( name == "Production" or
		...
		name == "ChooseIdeology" or
		name == "ChooseLegacy") then
