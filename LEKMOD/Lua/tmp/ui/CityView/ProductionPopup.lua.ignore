...
function UpdateWindow( city )
	...
	Controls.GoldenAgePoints:SetText( "[ICON_GOLDENAGE]" .. city:GetYieldRate( YieldTypes.YIELD_GOLDEN_AGE_POINTS ) ); -- v34 Golden Age Points
	...
	local strGoldenAgeToolTip = GetGoldenAgePointsTooltip(city);
	Controls.GoldenAgePoints:SetToolTipString(strGoldenAgeToolTip);
...
Events.SerialEventEnterCityScreen.Add( OnClose );
