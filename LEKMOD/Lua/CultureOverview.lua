...
-- Refresh great work info if dirty (SerialEventCityInfoDirty & SerialEventGreatWorksScreenDirty is called when great works are swapped).
function RefreshGreatWorkInfo()
	if (not ContextPtr:IsHidden()) then
		g_Tabs["YourCulture"].RefreshContent();
	end
end
Events.SerialEventGreatWorksScreenDirty.Add(RefreshGreatWorkInfo);
